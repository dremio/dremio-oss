...
/**
 * Class-level unit test for {@link TypeConvertingSqlAccessor}. (Also see {@link
 * com.dremio.jdbc.ResultSetGetMethodConversionsTest}.
 */
public class TypeConvertingSqlAccessorTest {

  /**
   * Base test stub(?) for accessors underlying TypeConvertingSqlAccessor. Carries type and (Object
   * form of) one value.
   */
  private abstract static class BaseStubAccessor extends AbstractSqlAccessor
  ...
  public void test_getByte_on_TINYINT_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new TinyIntStubAccessor((byte) 127));
    assertThat(uut1.getByte(0)).isEqualTo((byte) 127);
    final SqlAccessor uut2 = new TypeConvertingSqlAccessor(new TinyIntStubAccessor((byte) -128));
  ...
  public void test_getByte_on_SMALLINT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new SmallIntStubAccessor((short) 127));
    assertThat(uut.getByte(0)).isEqualTo((byte) 127);
  }

  @Test
  public void test_getByte_on_SMALLINT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new SmallIntStubAccessor((short) 128));
  ...
  public void test_getByte_on_INTEGER_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new IntegerStubAccessor(-128));
    assertThat(uut.getByte(0)).isEqualTo((byte) -128);
  }

  @Test
  public void test_getByte_on_INTEGER_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new IntegerStubAccessor(-129));
    assertThatThrownBy(() -> uut.getByte(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getByte_on_BIGINT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(-128));
    assertThat(uut.getByte(0)).isEqualTo((byte) -128);
  }

  @Test
  public void test_getByte_on_BIGINT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(129));
    assertThatThrownBy(() -> uut.getByte(0))
        .isInstanceOf(SQLConversionOverflowException.class)
        .hasMessageContaining("129")
        .hasMessageContaining("getByte")
  ...
  public void test_getByte_on_FLOAT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(-128.0f));
    assertThat(uut.getByte(0)).isEqualTo((byte) -128);
  }

  @Test
  public void test_getByte_on_FLOAT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(-130f));
    assertThatThrownBy(() -> uut.getByte(0))
        .isInstanceOf(SQLConversionOverflowException.class)
        ...
        .satisfiesAnyOf(
            e -> assertThat(e.getMessage()).contains("REAL"),
            e -> assertThat(e.getMessage()).contains("FLOAT"));
  }

  @Test
  public void test_getByte_on_DOUBLE_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(127.0d));
    assertThat(uut.getByte(0)).isEqualTo((byte) 127);
  }

  @Test
  public void test_getByte_on_DOUBLE_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(-130));
    assertThatThrownBy(() -> uut.getByte(0))
        .isInstanceOf(SQLConversionOverflowException.class)
        .hasMessageContaining("-130")
        .hasMessageContaining("getByte")
        ...
        .satisfiesAnyOf(
            e -> assertThat(e.getMessage()).contains("DOUBLE PRECISION"),
            e -> assertThat(e.getMessage()).contains("FLOAT("));
  }
  ...
  public void test_getShort_on_SMALLINT_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new SmallIntStubAccessor((short) 32767));
  ...
  public void test_getShort_on_INTEGER_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new IntegerStubAccessor(32767));
    assertThat(uut1.getShort(0)).isEqualTo((short) 32767);
    final SqlAccessor uut2 = new TypeConvertingSqlAccessor(new IntegerStubAccessor(-32768));
    assertThat(uut2.getShort(0)).isEqualTo((short) -32768);
  }

  @Test
  public void test_getShort_on_INTEGER_thatOverflows_throws() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new IntegerStubAccessor(-32769));
  ...
  public void test_getShort_BIGINT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(-32678));
    assertThat(uut.getShort(0)).isEqualTo((short) -32678);
  }

  @Test
  public void test_getShort_on_BIGINT_thatOverflows_throws() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(65535));
    assertThatThrownBy(() -> uut.getShort(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getShort_on_FLOAT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(-32768f));
    assertThat(uut.getShort(0)).isEqualTo((short) -32768);
  }

  @Test
  public void test_getShort_on_FLOAT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(-32769f));
    assertThatThrownBy(() -> uut.getShort(0))
        .isInstanceOf(SQLConversionOverflowException.class)
        .hasMessageContaining("-32769")
        .hasMessageContaining("getShort")
  ...
  public void test_getShort_on_DOUBLE_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(32767d));
    assertThat(uut.getShort(0)).isEqualTo((short) 32767);
  }

  @Test
  public void test_getShort_on_DOUBLE_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(32768));
    assertThatThrownBy(() -> uut.getShort(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getInt_on_INTEGER_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new IntegerStubAccessor(2147483647));
    assertThat(uut1.getInt(0)).isEqualTo(2147483647);
    final SqlAccessor uut2 = new TypeConvertingSqlAccessor(new IntegerStubAccessor(-2147483648));
  ...
  public void test_getInt_on_BIGINT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(2147483647));
    assertThat(uut.getInt(0)).isEqualTo(2147483647);
  }

  @Test
  public void test_getInt_on_BIGINT_thatOverflows_throws() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new BigIntStubAccessor(2147483648L));
  ...
  public void test_getInt_on_FLOAT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(1e9f));
    assertThat(uut.getInt(0)).isEqualTo(1_000_000_000);
  }

  @Test
  public void test_getInt_on_FLOAT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(1e10f));
    assertThatThrownBy(() -> uut.getInt(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getInt_on_DOUBLE_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(-2147483648.0d));
    assertThat(uut.getInt(0)).isEqualTo(-2147483648);
  }

  @Test
  public void test_getInt_on_DOUBLE_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(-2147483649.0d));
    assertThatThrownBy(() -> uut.getInt(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getLong_on_FLOAT_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut =
        new TypeConvertingSqlAccessor(new FloatStubAccessor(9223372036854775807L * 1.0f));
    assertThat(uut.getLong(0)).isEqualTo(9223372036854775807L);
  }

  @Test
  public void test_getLong_on_FLOAT_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new FloatStubAccessor(1.5e20f));
  ...
  public void test_getLong_on_DOUBLE_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut =
        new TypeConvertingSqlAccessor(new DoubleStubAccessor(9223372036854775807L * 1.0d));
    assertThat(uut.getLong(0)).isEqualTo(9223372036854775807L);
  }

  @Test
  public void test_getLong_on_DOUBLE_thatOverflows_rejectsIt() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(1e20));
    assertThatThrownBy(() -> uut.getLong(0))
        .isInstanceOf(SQLConversionOverflowException.class)
  ...
  public void test_getFloat_on_FLOAT_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new FloatStubAccessor(1.23f));
    assertThat(uut1.getFloat(0)).isEqualTo(1.23f);
    final SqlAccessor uut2 = new TypeConvertingSqlAccessor(new FloatStubAccessor(Float.MAX_VALUE));
    assertThat(uut2.getFloat(0)).isEqualTo(Float.MAX_VALUE);
    final SqlAccessor uut3 = new TypeConvertingSqlAccessor(new FloatStubAccessor(Float.MIN_VALUE));
  ...
  public void test_getFloat_on_DOUBLE_thatFits_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new DoubleStubAccessor(1.125));
    assertThat(uut1.getFloat(0)).isEqualTo(1.125f);
    final SqlAccessor uut2 = new TypeConvertingSqlAccessor(new DoubleStubAccessor(Float.MAX_VALUE));
    assertThat(uut2.getFloat(0)).isEqualTo(Float.MAX_VALUE);
  }

  @Test
  public void test_getFloat_on_DOUBLE_thatOverflows_throws() {
    final SqlAccessor uut = new TypeConvertingSqlAccessor(new DoubleStubAccessor(1e100));
  ...
  public void test_getDouble_on_FLOAT_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new FloatStubAccessor(6.02e23f));
  ...
  public void test_getDouble_on_DOUBLE_getsIt() throws InvalidAccessException {
    final SqlAccessor uut1 = new TypeConvertingSqlAccessor(new DoubleStubAccessor(-1e100));
