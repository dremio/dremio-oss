...
public class TestJdbcDistQuery extends JdbcWithServerTestBase {
  ...
  /**
   * Calls {@link ResultSet#next} on given {@code ResultSet} until it returns false. (For TEMPORARY
   * workaround for query cancelation race condition.)
   */
  ...
  public static void initRefresh() throws Exception {
    ...
    testQuery(String.format("REFRESH DATASET " + "dfs_root.\"%s/regionsSF/\"", SAMPLE_DATA_PATH));
    testQuery(String.format("REFRESH DATASET " + "dfs_root.\"%s/regionsMF/\"", SAMPLE_DATA_PATH));
  }
  ...
  public void testSimpleQuerySingleFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY, R_NAME " + "from dfs_root.\"%s/regionsSF/\"", SAMPLE_DATA_PATH));
  }
  ...
  public void testSimpleQueryMultiFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY, R_NAME " + "from dfs_root.\"%s/regionsMF/\"", SAMPLE_DATA_PATH));
  }
  ...
  public void testAggSingleFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY " + "from dfs_root.\"%s/regionsSF/\" " + "group by R_REGIONKEY",
            SAMPLE_DATA_PATH));
  }
  ...
  public void testAggMultiFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY " + "from dfs_root.\"%s/regionsMF/\" " + "group by R_REGIONKEY",
            SAMPLE_DATA_PATH));
  }
  ...
  public void testAggOrderByDiffGKeyMultiFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY, SUM(cast(R_REGIONKEY AS int)) As S "
                + "from dfs_root.\"%s/regionsMF/\" "
  ...
  public void testJoinSingleFile() throws Exception {
    testQuery(
        String.format(
            "select T1.R_REGIONKEY "
                + "from dfs_root.\"%s/regionsSF/\" as T1 "
                + "join dfs_root.\"%s/nationsSF/\" as T2 "
  ...
  public void testJoinMultiFile() throws Exception {
    testQuery(
        String.format(
            "select T1.R_REGIONKEY "
                + "from dfs_root.\"%s/regionsMF/\" as T1 "
                + "join dfs_root.\"%s/nationsMF/\" as T2 "
                + "on T1.R_REGIONKEY = T2.N_REGIONKEY",
            SAMPLE_DATA_PATH, SAMPLE_DATA_PATH));
  }
  ...
  public void testJoinMFileWhere() throws Exception {
    testQuery(
        String.format(
            "select T1.R_REGIONKEY, T1.R_NAME "
                + "from dfs_root.\"%s/regionsMF/\" as T1 "
                + "join dfs_root.\"%s/nationsMF/\" as T2 "
                + "on T1.R_REGIONKEY = T2.N_REGIONKEY "
  ...
  public void testSortSingleFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY " + "from dfs_root.\"%s/regionsSF/\" " + "order by R_REGIONKEY",
            SAMPLE_DATA_PATH));
  }
  ...
  public void testSortMultiFile() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY " + "from dfs_root.\"%s/regionsMF/\" " + "order by R_REGIONKEY",
            SAMPLE_DATA_PATH));
  }
  ...
  public void testJoinAggSortWhere() throws Exception {
    testQuery(
        String.format(
            "select T1.R_REGIONKEY, COUNT(1) as CNT "
                + "from dfs_root.\"%s/regionsMF/\" as T1 "
                + "join dfs_root.\"%s/nationsMF/\" as T2 "
                + "on T1.R_REGIONKEY = T2.N_REGIONKEY "
                + "WHERE T1.R_REGIONKEY  = 3 "
  ...
  public void testSelectLimit() throws Exception {
    testQuery(
        String.format(
            "select R_REGIONKEY, R_NAME " + "from dfs_root.\"%s/regionsMF/\" " + "limit 2",
            SAMPLE_DATA_PATH));
  }
