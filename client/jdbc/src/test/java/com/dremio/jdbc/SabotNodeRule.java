...
public class SabotNodeRule extends ExternalResource {
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(SabotNodeRule.class);

  private static final SabotConfig dConfig =
      SabotConfig.create()
  ...
  protected void before() throws Throwable {
    ...
    TestUtilities.addDefaultTestPlugins(
        node.getBindingProvider().lookup(CatalogService.class), tmpDirPath);
