...
public class DremioColumnMetaDataListTest {
  ...
  private DremioColumnMetaDataList oneElementList;
  ...
  public void setUp() throws Exception {
    emptyList = new DremioColumnMetaDataList();

    // Create mock columns
    final Field exampleIntField = mock(Field.class);
    when(exampleIntField.getName()).thenReturn("/path/to/testInt");
    when(exampleIntField.getType()).thenReturn(MinorType.INT.getType());

    final Field exampleStringField = mock(Field.class);
    when(exampleStringField.getName()).thenReturn("/path/to/testString");
    when(exampleStringField.getType()).thenReturn(MinorType.VARCHAR.getType());

    oneElementList = new DremioColumnMetaDataList();
