...
public class IntervalYearAccessor extends AbstractSqlAccessor {
  ...
  private static final MajorType TYPE = Types.optional(MinorType.INTERVALYEAR);

  private final IntervalYearVector ac;

  public IntervalYearAccessor(IntervalYearVector vector) {
    this.ac = vector;
  }
  ...
  public Object getObject(int index) {
    ...
    return DremioStringUtils.formatIntervalYear(DremioGetObject.getPeriodObject(ac, index));
  }
