 ...
 *
 * <p>{@code JdbcApiSqlException} is intended for errors in using the JDBC API, such as calling
 * {@link ResultSet#getString} before calling {@link ResultSet#next}.
 *
 * <p>({@code JdbcApiSqlException} is not for errors that are not under direct control of the
 * programmer writing JDBC API calls, for example, invalid SQL syntax errors (which should use
 * {@link SQLSyntaxErrorException}), errors from SQL-vs.-data mismatches (which likely should use
 * {@link SQLDataException}), data file format errors, resource availability errors (which might use
 * {@link SQLTransientException}), or internal Dremio errors.)
 *
 * <p>TODO: Consider using ANSI-/XOPEN-standard SQL State values. (See:
 *
 * <ul>
 *   <li><a href="
 ...
 *       http://www-01.ibm.com/support/knowledgecenter/api/content/nl/en-us/SSVHEW_6.2.0/com.ibm.rcp.tools.doc.db2e/adg/sql11.html
 *       </a>
 *   <li><a href=" ftp://ftp.software.ibm.com/ps/products/db2/info/vr6/htm/db2m0/db2state.htm ">
 *       ftp://ftp.software.ibm.com/ps/products/db2/info/vr6/htm/db2m0/db2state.htm </a>
 *   <li><a href=" https://docs.oracle.com/cd/E15817_01/appdev.111/b31230/ch2.htm ">
 *       https://docs.oracle.com/cd/E15817_01/appdev.111/b31230/ch2.htm </a>
 * </ul>
 *
 * <p>etc.)
 */
