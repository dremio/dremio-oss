...
// contract and classes generated by SqlAccessor template.

class SqlAccessorWrapper implements Accessor {
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(SqlAccessorWrapper.class);
  ...
  SqlAccessorWrapper(SqlAccessor sqlAccessor, DremioCursor cursor) {
    super();
