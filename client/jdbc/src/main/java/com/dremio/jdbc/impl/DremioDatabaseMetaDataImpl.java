...
import com.dremio.jdbc.DremioDatabaseMetaData;
...
class DremioDatabaseMetaDataImpl extends AvaticaDatabaseMetaData
  ...
  private String getServerName() throws SQLException {
    DremioConnectionImpl connection = (DremioConnectionImpl) getConnection();
        ...
        if (serverMeta == null) {
          ...
          try {
            ...
            if (resp.getStatus() != RequestStatus.OK) {
              DremioPBError error = resp.getError();
  ...
  public String getIdentifierQuoteString() throws SQLException {
    throwIfClosed();
    if (!getServerMetaSupported()) {
      return String.valueOf(SqlUtils.QUOTE);
    }
