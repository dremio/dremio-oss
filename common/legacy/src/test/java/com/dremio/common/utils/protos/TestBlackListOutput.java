...
public class TestBlackListOutput {
  ...
  public void writeInt32() throws IOException {
    ...
    BlackListOutput subject = new BlackListOutput(delegate, Collections.emptyMap(), new int[] {2});
  ...
  public void writeObject() throws IOException {
    ...
    BlackListOutput subject =
        new BlackListOutput(delegate, ImmutableMap.of(schemaName, subSet), new int[] {2});
