...
public class SabotConfigurationException extends RuntimeException {
  ...
  public SabotConfigurationException(String message, Throwable cause) {
    super(message, cause);
  }

  public SabotConfigurationException(String message) {
    super(message);
  }

  public SabotConfigurationException(Throwable cause) {
    super(cause);
  }
