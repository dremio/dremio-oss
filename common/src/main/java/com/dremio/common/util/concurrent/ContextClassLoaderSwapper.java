...
public class ContextClassLoaderSwapper implements Closeable {
  ...
  /**
   * Method returns a new ContextClassLoaderSwapper resource. When this method returns,
   * current thread's class loader is set to class loader of the argument passed
