...
/**
 * Tests for: 1) Lookup in Data Credential Provider through service. 2) Lookup for legacy pattern
 * (raw data) through service.
 */
public class TestCredentialsServiceImpl extends DremioTest {
  ...
  public void testServiceDataLookup() throws Exception {
    ...
    assertEquals(example1, credentialsService.lookup(example1));
  }
  ...
  public void testServiceLookupWithSpecialCharacter() throws Exception {
    ...
    assertEquals(originalString, credentialsService.lookup(originalString));
  }
}
