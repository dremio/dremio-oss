...
public class TestLocalSecretCredentialsProvider extends DremioTest {
  ...
  public void testSecretProviderLookupWithDefaultPassword() throws Exception {
    ...
    SimpleCredentialsService credentialsService = SimpleCredentialsService.newInstance(conf, ImmutableSet.of(LocalSecretCredentialsProvider.class));
    LocalSecretCredentialsProvider credentialsProvider = credentialsService.findProvider(LocalSecretCredentialsProvider.class);
  ...
  public void testSecretProviderLookupWithDataUriPassword() throws Exception {
    ...
    // emulate "dremio-admin encrypt secret"
    SimpleCredentialsService credentialsService = SimpleCredentialsService.newInstance(conf, ImmutableSet.of(LocalSecretCredentialsProvider.class, DataCredentialsProvider.class));
    LocalSecretCredentialsProvider credentialsProvider = credentialsService.findProvider(LocalSecretCredentialsProvider.class);
  ...
  public void testSecretProviderLookupWithEnvUriPassword() throws Exception {
    ...
    // emulate "dremio-admin encrypt secret"
    SimpleCredentialsService credentialsService = SimpleCredentialsService.newInstance(conf, ImmutableSet.of(LocalSecretCredentialsProvider.class, MockEnvCredentialsProvider.class));
    LocalSecretCredentialsProvider credentialsProvider = credentialsService.findProvider(LocalSecretCredentialsProvider.class);
  ...
  public void testSecretProviderLookupWithFileUriPassword() throws Exception {
    ...
    // emulate "dremio-admin encrypt secret"
    SimpleCredentialsService credentialsService = SimpleCredentialsService.newInstance(conf, ImmutableSet.of(LocalSecretCredentialsProvider.class, FileCredentialsProvider.class));
    LocalSecretCredentialsProvider credentialsProvider = credentialsService.findProvider(LocalSecretCredentialsProvider.class);
