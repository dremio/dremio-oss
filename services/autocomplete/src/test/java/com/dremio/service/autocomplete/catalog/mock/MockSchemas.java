...
public final class MockSchemas {
  public static final ImmutableList<ColumnSchema> CUSTOMER = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> DEPT = ImmutableList.<ColumnSchema>builder()
    .add(ColumnSchema.create("DEPTNO", INTEGER))
    .add(ColumnSchema.create("NAME", VARCHAR, 10))
    .build();

  public static final ImmutableList<ColumnSchema> EMP = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> LINEITEM = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> NATION = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> ORDER = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> PART = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> PART_SUPPLIER = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> REGION = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> SALGRADE = ImmutableList.<ColumnSchema>builder()
    .add(ColumnSchema.create("GRADE", INTEGER))
    .add(ColumnSchema.create("LOSAL", INTEGER))
    .add(ColumnSchema.create("HIGHSAL", INTEGER))
    .build();

  public static final ImmutableList<ColumnSchema> SUPPLIER = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> TEST_SCHEMA = ImmutableList.<ColumnSchema>builder()
  ...
  public static final ImmutableList<ColumnSchema> MIXED_TYPE_SCHEMA = ImmutableList.<ColumnSchema>builder()
  ...
  public static final class ColumnSchema {
    ...
    private static ColumnSchema create(String name, SqlTypeName sqlTypeName, Optional<Integer> precision) {
