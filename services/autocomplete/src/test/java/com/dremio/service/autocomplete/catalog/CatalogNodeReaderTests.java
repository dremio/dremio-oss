 ...
 */
public final class CatalogNodeReaderTests {
    ...
    ImmutableList.<CatalogNode>builder()
      .add(new SpaceCatalogNode(
        ...
        ImmutableList.<CatalogNode>builder()
          ...
          .build()))
      .build());
  public static final MockCatalogNodeReader MOCK_CATALOG_NODE_READER = new MockCatalogNodeReader(TEST_HOME_CATALOG_NODE);

  @Test
  public void testPathing() {
    {
      List<String> emptyPath = new ArrayList<>(Arrays.asList());
      Optional<CatalogNode> nodeAtEmptyPath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(emptyPath);
...

    {
      ...
      Optional<CatalogNode> nodeAtSpacePath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(spacePath);
...

    {
      ...
      Optional<CatalogNode> nodeAtFolderPath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(folderPath);
...

    {
      ...
      Optional<CatalogNode> nodeAtFilePath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(filePath);
...

    {
      ...
      Optional<CatalogNode> nodeAtPath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(sourcePath);
...

    {
      ...
      Optional<CatalogNode> nodeAtPath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(virtualDatasetPath);
      Assert.assertTrue(nodeAtPath.isPresent());
...

    {
      ...
      Optional<CatalogNode> nodeAtPath = MOCK_CATALOG_NODE_READER.tryGetCatalogNodeAtPath(nonExistentPath);
