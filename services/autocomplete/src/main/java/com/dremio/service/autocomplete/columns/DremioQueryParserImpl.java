...
/**
 * Implementation of DremioQueryParser used for autocomplete.
 */
public final class DremioQueryParserImpl extends DremioQueryParser {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(DremioQueryParserImpl.class);
  ...
  private <T extends SqlValidatorCatalogReader & Prepare.CatalogReader> DremioQueryParserImpl(
    FunctionImplementationRegistry func,
    T catalogReader,
    ContextInformation contextInformation) {
    this.catalogReader = catalogReader;
    this.contextInformation = contextInformation;
    SqlOperatorTable operatorTable = new OperatorTable(func);
  ...
  public DremioQueryParserImpl(FunctionImplementationRegistry func, SimpleCatalog<?> catalog, String user) {
    this(
      func,
      new DremioCatalogReader(catalog, JavaTypeFactoryImpl.INSTANCE),
      new DremioQueryParserImpl.ContextInfoImpl(user));
  }
