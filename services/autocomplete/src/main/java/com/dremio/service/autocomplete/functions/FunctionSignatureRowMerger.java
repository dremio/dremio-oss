...
import static com.dremio.service.autocomplete.functions.ParameterKind.OPTIONAL;
import static com.dremio.service.autocomplete.functions.ParameterKind.REGULAR;
import static com.dremio.service.autocomplete.functions.ParameterKind.VARARG;
...
public final class FunctionSignatureRowMerger {
  ...
  private static final class CommonRegularPrefixMergeRule extends MergeRule {
    ...
    protected Optional<FunctionSignature> tryMergeImplementation(FunctionSignature left, FunctionSignature right) {
      ...
      mergedParameters.add(Parameter.create(rightLastParameter.getType(), OPTIONAL));
