...
public final class ReferenceSuggestions implements AutocompleteV2Response {
  private final String suggestionsType;
  private final Integer count;
  private final Integer maxCount;
  private final List<SuggestionEntity> branches;

  @JsonCreator
  public ReferenceSuggestions(
    @JsonProperty("type") String suggestionsType,
    @JsonProperty("count") Integer count,
    @JsonProperty("maxCount") Integer maxCount,
    @JsonProperty("suggestions") List<SuggestionEntity> branches) {
  ...
  public List<SuggestionEntity> getBranches() {
    return branches;
  }
}
