...
public final class ColumnSuggestions implements AutocompleteV2Response {
  private final String suggestionsType;
  private final Integer count;
  private final Integer maxCount;
  private final List<SuggestionEntity> columns;
  ...
  public ColumnSuggestions(
    ...
    @JsonProperty("suggestions") List<SuggestionEntity> columns) {
  ...
  public List<SuggestionEntity> getColumns() {
    return columns;
  }
}
