...
/**
 * Implementation of CatalogNodeReader that just returns the HomeCatalogNode as is.
 */
public final class CatalogNodeReaderImpl extends CatalogNodeReader {
  private final HomeCatalogNode homeCatalogNode;

  public CatalogNodeReaderImpl(HomeCatalogNode homeCatalogNode) {
