...
public interface SourceNamespaceService {
   ...
   * @throws NamespaceException
   */
  void deleteSourceWithCallBack(NamespaceKey sourcePath, String version, DeleteCallback callback)
      throws NamespaceException;
  ...
  //// OTHER
  /**
   * Checks if a sourceConfig can be saved. Currently does concurrency checks for the config and any
   * passed in attributes
   *
   * @param newConfig the new config we want to save
   * @param attributes
   */
  void canSourceConfigBeSaved(
