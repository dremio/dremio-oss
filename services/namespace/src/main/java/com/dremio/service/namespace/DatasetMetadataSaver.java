 ...
 * The methods need to be invoked in order. In particular, one or more dataset splits for every partition chunk,
 * and one or more partition chunks for the dataset. Saving of the dataset always completes with the saving of the
 * dataset config
 * Order of invocation:
