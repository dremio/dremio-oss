...
public class SSLEngineFactoryImpl implements SSLEngineFactory {
  ...
  private SSLEngineFactoryImpl(SSLConfig sslConfig) throws SSLRpcException {
    ...
    try {
      ...
      throw new SSLRpcException(e);
    } catch (GeneralSecurityException | IOException e) {
      throw new SSLRpcException(new SSLException(e));
    }
  }
   ...
   * @throws RpcException if creation fails
   */
  public static Optional<SSLEngineFactory> create(Optional<SSLConfig> sslConfig) throws RpcException {
