...
public abstract class PromisingMessageToMessageEncoder<I> extends ChannelOutboundHandlerAdapter {
   ...
   *
   * @param ctx the {@link ChannelHandlerContext} which this {@link MessageToMessageEncoder} belongs
   *     to
  ...
  protected abstract void encode(
      ChannelHandlerContext ctx, I msg, List<Object> out, ChannelPromise promise) throws Exception;
}
