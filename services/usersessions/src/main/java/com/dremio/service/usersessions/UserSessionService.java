...
public interface UserSessionService extends Service {
   ...
   * @throws java.util.ConcurrentModificationException if the version is out of data and the @param
   *     newSession is not the same as the session currently stored
   */
