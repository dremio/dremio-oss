...
public class TestQueryMetadata {
  ...
  public void testGetSourcesPDS() {
    ...
    testGetSources(datasetConfig, ImmutableList.of("source_name"));
  }
  ...
  public void testGetSourcesVDS() {
    ...
    final FieldOrigin fieldOrigin =
        new FieldOrigin().setName("col1").setOriginsList(ImmutableList.of(origin));
    final VirtualDataset vds =
        new VirtualDataset().setFieldOriginsList(ImmutableList.of(fieldOrigin));
    final DatasetConfig datasetConfig =
        new DatasetConfig()
  ...
  public void testGetSourcesExtQueryWithParent() {
    final ParentDataset parentDataset =
        new ParentDataset().setDatasetPathList(ImmutableList.of("source_name", "external_query"));
    final VirtualDataset vds = new VirtualDataset().setParentsList(ImmutableList.of(parentDataset));
    final DatasetConfig datasetConfig =
        new DatasetConfig()
            .setType(DatasetType.VIRTUAL_DATASET)
  ...
  public void testGetSourcesExtQueryWithParents() {
    final ParentDataset parentDataset1 =
        new ParentDataset().setDatasetPathList(ImmutableList.of("source1", "external_query"));
    final ParentDataset parentDataset2 =
        new ParentDataset().setDatasetPathList(ImmutableList.of("source2", "external_query"));

    final VirtualDataset vds =
        new VirtualDataset().setParentsList(ImmutableList.of(parentDataset1, parentDataset2));
    ...
    testGetSources(datasetConfig, ImmutableList.of("source1", "source2"));
  }

  @Test
  public void testGetSourcesExtQueryWithParentsAndGrandParents() {
    final ParentDataset grandParentDataset1 =
        new ParentDataset().setDatasetPathList(ImmutableList.of("source1", "external_query"));
    final ParentDataset grandParentDataset2 =
        new ParentDataset().setDatasetPathList(ImmutableList.of("source2", "external_query"));

    final ParentDataset parentDataset =
        new ParentDataset().setDatasetPathList(ImmutableList.of("test_space", "test_table_1"));
  ...
  private void testGetSources(DatasetConfig datasetConfig, List<String> expected) {
    final List<String> actual1 = QueryMetadata.getSources(datasetConfig);
    final List<String> actual2 = QueryMetadata.getSources(DatasetMetadata.from(datasetConfig));
