...
/**
 * Provides methods for LocalJobsService to convert the SearchQuery in ActiveJobsRequest to the
 ...
 */
public class ActiveJobSearchUtils {
  private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(ActiveJobSearchUtils.class);
