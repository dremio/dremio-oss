...
public interface ExecutorSelectionService extends Service {
  ...
  StringValidator EXECUTOR_SELECTION_TYPE =
      new StringValidator("exec.selection.type", DEFAULT_SELECTOR_TYPE);
  PositiveLongValidator TARGET_NUM_FRAGS_PER_NODE =
      new PositiveLongValidator("exec.selection.frags_per_node", Integer.MAX_VALUE, 8);
