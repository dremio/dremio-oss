...
public class TestScriptServiceImpl {
  ...
  public void testCreateScript() throws Exception {
                ...
                DatasetProtobuf.SourceVersionReference.newBuilder()
                    ...
                    .setReference(
                        DatasetProtobuf.VersionContext.newBuilder()
                            ...
                            .build())
                    .build()));
    List<String> jobIds = new ArrayList<>(Arrays.asList(UUID.randomUUID().toString()));
    ...
    Assert.assertEquals(scriptRequest.getJobIdsList(), script.getJobIdsList());

    // --------------------update-----------------------------

    ScriptProto.ScriptRequest updateRequest =
    ...
    runWithUserContext(
        USER_ID_1, () -> scriptService.updateScript(script.getScriptId(), updateRequest));
    ...
    when(mockUserSessionService.getSession(anyString()))
        .thenReturn(new UserSessionService.UserSessionAndVersion(newSession, version));
    ...
    Assert.assertEquals(
        SourceVersionReferenceUtils.createSourceVersionReferenceListFromContextMap(referenceMap),
  ...
  public void testMaxLengthOfName() {
    ...
    assertThatThrownBy(
        ...
        .hasMessage(
            "Maximum 128 characters allowed in script name. You have typed in 129 characters.");
  }
  ...
  public void testMaxLengthOfContent() {
    ...
    assertThatThrownBy(
        ...
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage(
            "Maximum 250000 characters allowed in script content. You have typed in 250001 characters.");
  }
  ...
  public void testMaxLengthOfDescription() {
    ...
    assertThatThrownBy(
        ...
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage(
            "Maximum 1024 characters allowed in script description. You have typed in 1025 characters.");
  }
  ...
  public void testReadAccess() throws Exception {
    ...
    ScriptProto.Script fetchedScript =
        runWithUserContext(USER_ID_2, () -> scriptService.getScriptById(script.getScriptId()));
  ...
  public void testUpdateAccess() throws Exception {
    ...
    ScriptProto.Script updatedScript =
        runWithUserContext(
            USER_ID_2, () -> scriptService.updateScript(script.getScriptId(), scriptRequest));
  ...
  public void testSearchOnGetAll() throws Exception {
    ...
    ScriptProto.Script script3 =
        runWithUserContext(
            ...
            () ->
                scriptService.createScript(
                    scriptRequest.toBuilder().setName("RandomName").build()));
  ...
  // test sort feature
  @Test
  public void testSortOnGetAll() throws Exception {
    // given
    ScriptProto.ScriptRequest scriptRequest =
        ScriptProto.ScriptRequest.newBuilder()
            .setName("sortScript1")
    ...
    ScriptProto.Script script2 =
        runWithUserContext(
            ...
            () ->
                scriptService.createScript(
                    scriptRequest.toBuilder().setName("sortScript2").build()));
    ...
    runWithUserContext(
        ...
        () ->
            scriptService.updateScript(
                script1.getScriptId(),
                scriptRequest.toBuilder().setDescription("updated description").build()));
  ...
  public void testMaxScriptsLimitReachedException() throws Exception {
    ...
    when(mockedScriptStore.getCountByCondition(any(SearchTypes.SearchQuery.class)))
        .thenReturn(maxNumberOfScriptsPerUser);
    UserSessionService mockUserSessionService = Mockito.mock(UserSessionService.class);
    ScriptService testScriptService =
        new ScriptServiceImpl(() -> mockedScriptStore, () -> mockUserSessionService);
    testScriptService.start();

    // assert createScript raise MaxScriptsLimitReachedException
    assertThatThrownBy(
            () ->
                runWithUserContext(USER_ID_1, () -> testScriptService.createScript(scriptRequest)))
