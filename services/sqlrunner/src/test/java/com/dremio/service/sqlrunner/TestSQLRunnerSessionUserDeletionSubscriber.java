  ...
  public void testSQLRunnerSessionDeletedAfterDeleteUser() throws Exception {
    try (final LegacyKVStoreProvider kvstore =
      ...
      LegacyIndexedStore<UID, UserInfo> userGroupStore =
          kvstore.getStore(SimpleUserService.UserGroupStoreBuilder.class);
      // save an remote user
      ...
      SQLRunnerSessionUserDeletionSubscriber subscriber =
          new SQLRunnerSessionUserDeletionSubscriber(() -> sqlRunnerSessionService);
