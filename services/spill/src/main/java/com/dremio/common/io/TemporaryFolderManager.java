 ...
 *
 * <p>// TODO: This needs to move somewhere else for other services to reuse. Not sure where yet.
 */
public interface TemporaryFolderManager extends AutoCloseable {
  /**
   * Start folder monitoring.
   *
   * <p>Folder monitoring is only started if available executor(s) can be queried.
   */
  void startMonitoring();

  /**
   * Creates a new incarnation of the temporary directory. If an old incarnation is found for the
   * same executor under {@code rootPath}, a task will be internally scheduled to cleanup that
   * directory.
   *
