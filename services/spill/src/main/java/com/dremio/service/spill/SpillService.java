...
public interface SpillService extends Service {
  ...
  // Deprecated functions, used for supporting SpillManager-based code, while it moves to the
  // *SpillStream interfaces

  /**
   * Make a sub-directory 'id' in each of the healthy spill directories. Caller needs to later
   ...
   *     sub-directory 'id' in all spill directories
   */
  @Deprecated
   ...
   *
   * @param id Name of the directory being deleted. Should match the ID passed into {@link
