...
public class TestCancellableUserResponseHandler {
  ...
  private final UserBitShared.QueryProfile resultProfile =
  ...
  public void testSuccessfulResultPropagation() {
    ...
    final CancellableUserResponseHandler<BigDecimal> cancellableUserResponseHandler =
        new CancellableUserResponseHandler<>(
            externalId, userSession, mockedUserWorkerProvider, () -> false, BigDecimal.class);
  ...
  private void testClientCancelCaughtAndPropagatedToServer(Supplier<Boolean> isCancelled) {
    // Arrange
    final CancellableUserResponseHandler<BigDecimal> cancellableUserResponseHandler =
        new CancellableUserResponseHandler<BigDecimal>(
            externalId, userSession, mockedUserWorkerProvider, isCancelled, BigDecimal.class) {
          @Override
