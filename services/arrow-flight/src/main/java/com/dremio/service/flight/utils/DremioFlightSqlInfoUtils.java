...
public final class DremioFlightSqlInfoUtils {
  ...
  public static SqlInfoBuilder getNewSqlInfoBuilder(final UserProtos.ServerMeta serverMeta) {
    final UserBitShared.RpcEndpointInfos serverInfo =
        UserRpcUtils.getRpcEndpointInfos("Dremio Server");
    ...
    return new SqlInfoBuilder()
        ...
        .withSqlSupportsTableCorrelationNames(
            serverMeta.getCorrelationNamesSupport() == UserProtos.CorrelationNamesSupport.CN_ANY
                || serverMeta.getCorrelationNamesSupport()
                    == UserProtos.CorrelationNamesSupport.CN_DIFFERENT_NAMES)
        ...
        .withSqlSupportedGrammar(
            SQL_CORE_GRAMMAR,
            SQL_MINIMUM_GRAMMAR,
            SQL_EXTENDED_GRAMMAR) // Same as AvaticaDatabaseMetaData#supports**SQLGrammar
        .withSqlAnsi92SupportedLevel(
            ANSI92_ENTRY_SQL,
            ANSI92_INTERMEDIATE_SQL,
            ANSI92_FULL_SQL) // Same as AvaticaDatabaseMetaData#supportsANSI92**
        .withSqlSchemasSupportedActions(
            SQL_ELEMENT_IN_PROCEDURE_CALLS,
            SQL_ELEMENT_IN_INDEX_DEFINITIONS,
            SQL_ELEMENT_IN_PRIVILEGE_DEFINITIONS) // Same as
        // AvaticaDatabaseMetaData#supportsSchemasIn*
        .withSqlCatalogsSupportedActions(
            SQL_ELEMENT_IN_PROCEDURE_CALLS,
            SQL_ELEMENT_IN_INDEX_DEFINITIONS,
            SQL_ELEMENT_IN_PRIVILEGE_DEFINITIONS) // Same as
        // AvaticaDatabaseMetaData#supportsCatalogsIn*
        ...
        .withSqlMaxProcedureNameLength(
            0) // Same as AvaticaDatabaseMetaData#getMaxProcedureNameLength
        .withSqlProcedureTerm("procedure") // Same as AvaticaDatabaseMetaData#getProcedureTerm
        .withSqlSupportsNonNullableColumns(
            true) // Same as AvaticaDatabaseMetaData#supportsNonNullableColumns
        .withSqlStoredProceduresSupported(
            false) // Same as AvaticaDatabaseMetaData#supportsStoredProcedures*
        .withSqlSupportsIntegrityEnhancementFacility(
            false) // Same as AvaticaDatabaseMetaData#supportsIntegrityEnhancementFacility
        ...
        .withSqlNamedParametersSupported(
            false) // Same as AvaticaDatabaseMetaData#supportsNamedParameters
        ...
        .withSqlStoredFunctionsUsingCallSyntaxSupported(
            true) // Same as AvaticaDatabaseMetaData#supportsStoredFunctionsUsingCallSyntax
        ...
        .withSqlSupportedTransactionsIsolationLevels(
            FlightSql.SqlTransactionIsolationLevel
                .SQL_TRANSACTION_NONE) // Flight SQL doesn't support Transactions
        .withSqlDataDefinitionCausesTransactionCommit(
            false) // Flight SQL doesn't support Transactions
        .withSqlDataDefinitionsInTransactionsIgnored(
            false); // Flight SQL doesn't support Transactions
  }

  public static Map<Integer, List<Integer>> getSupportsConvert(
      final List<UserProtos.ConvertSupport> convertSupports) {
  ...
  public static int getSqlTypeFromMinorType(final TypeProtos.MinorType minorType)
    ...
    switch (minorType) {
      ...
      default:
        throw new UnsupportedOperationException(
            "'" + minorType + "' is not a supported MinorType in Flight SQL.");
    }
  }

  public static FlightSql.SqlSupportedUnions[] getSupportedUnions(
      final List<UserProtos.UnionSupport> supports) {
  ...
  public static FlightSql.SqlSupportedGroupBy getGroupBy(
      final UserProtos.GroupBySupport groupBySupport) {
    switch (groupBySupport) {
      ...
      default:
        throw new UnsupportedOperationException(
            "'" + groupBySupport + " is not a supported FlightSql.SqlSupportedGroupBy type.");
    }
  }
  ...
  public static FlightSql.SqlSupportedSubqueries[] getSubQuerySupport(
    ...
    final FlightSql.SqlSupportedSubqueries[] emptyFlightSqlSubQuerySupportArr =
        new FlightSql.SqlSupportedSubqueries[0];
    ...
    for (final UserProtos.SubQuerySupport subQuerySupport : userProtoSubQuerySupport) {
      switch (subQuerySupport) {
        ...
        case SQ_IN_COMPARISON:
          flightSqlSubQuerySupport.add(
              FlightSql.SqlSupportedSubqueries.SQL_SUBQUERIES_IN_COMPARISONS);
          break;
        case SQ_IN_QUANTIFIED:
          flightSqlSubQuerySupport.add(
              FlightSql.SqlSupportedSubqueries.SQL_SUBQUERIES_IN_QUANTIFIEDS);
          break;
        case SQ_UNKNOWN:
          flightSqlSubQuerySupport.add(FlightSql.SqlSupportedSubqueries.UNRECOGNIZED);
          break;
        ...
        default:
          throw new UnsupportedOperationException(
              "'"
                  + subQuerySupport
                  + "' is not a supported FlightSql.SqlSupportedSubqueries type.");
      }
    }
