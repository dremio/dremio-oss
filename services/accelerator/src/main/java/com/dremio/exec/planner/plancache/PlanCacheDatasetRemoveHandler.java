...
import com.dremio.service.reflection.DatasetRemovedEvent;
import com.dremio.service.reflection.DatasetRemovedHandler;
import java.util.function.Supplier;

public class PlanCacheDatasetRemoveHandler implements DatasetRemovedHandler {
  private Supplier<PlanCacheInvalidationHelper> planCacheInvalidationHelper;

  public PlanCacheDatasetRemoveHandler(
