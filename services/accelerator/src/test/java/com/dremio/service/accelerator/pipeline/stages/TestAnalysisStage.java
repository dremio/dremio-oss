...
/**
 * Unit tests analysis stage
 */
@RunWith(MockitoJUnitRunner.class)
public class TestAnalysisStage {
  @Mock(answer = Answers.RETURNS_DEEP_STUBS)
  private StageContext context;

  @Test(expected = ConcurrentModificationException.class)
  public void testAnalysisStagePropagatesConcurrentModificationException() {
    // set up
    when(context.getCurrentAcceleration()).thenThrow(ConcurrentModificationException.class);

    // test
    final AnalysisStage stage = new AnalysisStage();
