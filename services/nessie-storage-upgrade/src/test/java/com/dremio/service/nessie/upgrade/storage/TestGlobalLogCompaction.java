...
class TestGlobalLogCompaction {
  ...
  void testUpgrade() throws Exception {
    // Validate only that the maintenance call was made.
    Assertions.assertThat(task.upgrade(storeProvider)).containsKey("compactGlobalLog");
  }
}
