...
/**
 * Wrapper around outgoing JobResultsRequest from grpc client side. Its similar to JobResultsRequest
 * except JobResultsRequest.data is not on heap memory but on direct memory using arrow/netty
 * buffers.
 */
public class JobResultsRequestWrapper implements AutoCloseable {
  ...
  public JobResultsRequestWrapper(
