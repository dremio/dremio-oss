 ...
 * ...
 */
public class BoundedExponentialDelayWithUnlimitedRetry implements RetryPolicy {
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(BoundedExponentialDelayWithUnlimitedRetry.class);

  private final int baseSleepTimeMs;
  private final int maxSleepMs;

  BoundedExponentialDelayWithUnlimitedRetry(int baseSleepTimeMs, int maxSleepMs) {
