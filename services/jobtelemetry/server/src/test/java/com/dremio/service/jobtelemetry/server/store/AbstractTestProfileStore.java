...
public abstract class AbstractTestProfileStore {
  ...
  public void testTailProfile() {
    ...
    UserBitShared.QueryProfile tailProfile = UserBitShared.QueryProfile.newBuilder()
    ...
    // overwrite and verify.
    tailProfile = UserBitShared.QueryProfile.newBuilder()
      .setErrorNode("ERROR_NODE")
  ...
  public void testExecutorProfile() {
    final UserBitShared.QueryId queryId = UserBitShared.QueryId.newBuilder()
      ...
      .setPart2(2030)
      .build();
    final CoordinationProtos.NodeEndpoint e1 = CoordinationProtos.NodeEndpoint.newBuilder()
      .setAddress("10.10.20.20")
      .build();
    final CoordinationProtos.NodeEndpoint e2 = CoordinationProtos.NodeEndpoint.newBuilder()
    ...
    CoordExecRPC.ExecutorQueryProfile executorQueryProfile1 =
      CoordExecRPC.ExecutorQueryProfile.newBuilder()
        .setProgress(
          CoordExecRPC.QueryProgressMetrics
            .newBuilder()
            .setRowsProcessed(10)
            .build()
        )
  ...
  private static <T extends Message> boolean compareUnordered(Stream<T> left,
                                                              Stream<T> right) {
