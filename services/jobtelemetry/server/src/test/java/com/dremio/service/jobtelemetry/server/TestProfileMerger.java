...
public class TestProfileMerger {
  ...
  public void testMergeWithOnlyPlanningProfile() {
    final UserBitShared.QueryProfile planningProfile =
        UserBitShared.QueryProfile.newBuilder()
            ...
            .addStateList(
                AttemptEvent.newBuilder().setState(State.COMPLETED).setStartTime(20L).build())
            .build();

    final UserBitShared.QueryProfile expectedMergedProfile =
        planningProfile.toBuilder().setTotalFragments(0).setFinishedFragments(0).build();

    assertEquals(expectedMergedProfile, ProfileMerger.merge(planningProfile, null, Stream.empty()));
  }
  ...
  public void testMergeWithOnlyPlanningAndTailProfile() {
    ...
    assertEquals(
        expectedMergedProfile, ProfileMerger.merge(planningProfile, tailProfile, Stream.empty()));
  }

  @Test
  public void testMergeWithOnlyPlanningAndExecutorProfiles() {
    final CoordinationProtos.NodeEndpoint nodeEndPoint =
        CoordinationProtos.NodeEndpoint.newBuilder().setAddress("190.190.0.666").build();
  ...
  public void testMergeWithMultipleExecutorProfiles() {
    final CoordinationProtos.NodeEndpoint nodeEndPoint1 =
        CoordinationProtos.NodeEndpoint.newBuilder().setAddress("190.190.0.66").build();
    final CoordinationProtos.NodeEndpoint nodeEndPoint2 =
        CoordinationProtos.NodeEndpoint.newBuilder().setAddress("190.190.0.67").build();
    ...
    CoordExecRPC.NodePhaseStatus node1Phase0 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
            .setMajorFragmentId(0)
            .setMaxMemoryUsed(10)
            .setPhaseWeight(1)
            .build();

    CoordExecRPC.NodePhaseStatus node1Phase1 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
    ...
    CoordExecRPC.FragmentStatus node1Frag0 =
        CoordExecRPC.FragmentStatus.newBuilder()
            .setHandle(ExecProtos.FragmentHandle.newBuilder().setMajorFragmentId(0).build())
            .setProfile(
                UserBitShared.MinorFragmentProfile.newBuilder()
                    .setEndTime(116)
                    .setState(FragmentState.FINISHED)
                    .build())
            .build();

    CoordExecRPC.FragmentStatus node1Frag1 =
        CoordExecRPC.FragmentStatus.newBuilder()
    ...
    CoordExecRPC.NodePhaseStatus node2Phase0 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
            .setMajorFragmentId(0)
            .setMaxMemoryUsed(20)
            .setPhaseWeight(1)
    ...
    CoordExecRPC.NodePhaseStatus node2Phase1 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
            .setMajorFragmentId(1)
            .setMaxMemoryUsed(21)
            .setPhaseWeight(2)
    ...
    CoordExecRPC.FragmentStatus node2Frag0 =
        CoordExecRPC.FragmentStatus.newBuilder()
            .setHandle(ExecProtos.FragmentHandle.newBuilder().setMajorFragmentId(0).build())
            .setProfile(
                UserBitShared.MinorFragmentProfile.newBuilder()
    ...
    CoordExecRPC.FragmentStatus node2Frag1 =
        CoordExecRPC.FragmentStatus.newBuilder()
            .setHandle(ExecProtos.FragmentHandle.newBuilder().setMajorFragmentId(1).build())
    ...
    assertEquals(
        expectedMergedProfile,
        ProfileMerger.merge(
            planningProfile, null, Stream.of(executorQueryProfile1, executorQueryProfile2)));
  }
  ...
  public void testFragmentCountFromPlanningProfile() {
    ...
    final UserBitShared.QueryProfile expectedMergedProfile =
        planningProfile.toBuilder().setTotalFragments(5).setFinishedFragments(0).build();
  ...
  public void testMergeWithInconsistentExecutorProfiles() {
    ...
    CoordExecRPC.NodePhaseStatus phase0 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
            .setMajorFragmentId(0)
            .setMaxMemoryUsed(20)
            .build();

    CoordExecRPC.FragmentStatus frag0 =
        CoordExecRPC.FragmentStatus.newBuilder()
            .setHandle(ExecProtos.FragmentHandle.newBuilder().setMajorFragmentId(0).build())
            .setProfile(
                UserBitShared.MinorFragmentProfile.newBuilder()
    ...
    CoordExecRPC.FragmentStatus frag1 =
        CoordExecRPC.FragmentStatus.newBuilder()
            .setHandle(ExecProtos.FragmentHandle.newBuilder().setMajorFragmentId(1).build())
            .setProfile(
                UserBitShared.MinorFragmentProfile.newBuilder()
  ...
  public void testMergeWithInconsistentExecutorProfiles2() {
    ...
    CoordExecRPC.NodePhaseStatus phase1 =
        CoordExecRPC.NodePhaseStatus.newBuilder()
            .setMajorFragmentId(1)
            .setMaxMemoryUsed(30)
            .build();
