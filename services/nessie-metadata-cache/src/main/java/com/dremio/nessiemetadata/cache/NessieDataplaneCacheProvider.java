...
public interface NessieDataplaneCacheProvider {

  <K extends String, V> NessieDataplaneCache<K, V> get(
      OptionManager optionManager,
      DataplaneCacheLoader<K, V> cacheLoader,
      NessieDataplaneCacheStoreProvider provider);
}
