...
final class ProtobufFormat<P extends com.google.protobuf.Message> implements Format<P> {
  private final Class<P> clazz;

  ProtobufFormat(Class<P> pClass) {
    this.clazz = pClass;
  }
  ...
  public <RET> RET apply(FormatVisitor<RET> visitor) throws DatastoreFatalException {
    return visitor.visitProtobufFormat(clazz);
  }
}
