 ...
 * @param <V> value
 */
public final class StoreBuilderHelper<K, V> {
  ...
  public StoreBuilderHelper<K, V> keyFormat(Format<K> keyFormat) {
  ...
  public StoreBuilderHelper<K, V> valueFormat(Format<V> valueFormat) {
