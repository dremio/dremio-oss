...
public interface IndexedStore<K, V> extends KVStore<K, V> {
   ...
   */
  Iterable<Entry<K, V>> find(FindByCondition find);
   ...
   */
  public static class FindByCondition {
    ...
    public FindByCondition setCondition(String condition, FilterIndexMapping mapping) {
      this.condition = SearchFilterToQueryConverter.toQuery(condition, mapping);
      return this;
    }

    public FindByCondition setCondition(SearchQuery query) {
      this.condition = query;
      return this;
    }

    public FindByCondition setPageSize(int pageSize) {
      this.pageSize = pageSize;
      return this;
    }

    public FindByCondition addSorting(SearchFieldSorting sorting) {
      this.sort.add(sorting);
      return this;
    }

    public FindByCondition addSortings(Collection<SearchFieldSorting> sort) {
      this.sort.addAll(sort);
      return this;
    }


    public FindByCondition setLimit(int limit){
      this.limit = limit;
      return this;
    }

    public FindByCondition setOffset(int offset){
      this.offset = offset;
      return this;
    }
    ...
    public boolean equals(final Object other) {
      if (!(other instanceof FindByCondition)) {
        return false;
      }
      FindByCondition castOther = (FindByCondition) other;
