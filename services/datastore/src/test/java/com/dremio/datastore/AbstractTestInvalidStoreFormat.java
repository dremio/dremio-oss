...
/**
 * Tests retrieval of stores with invalid key format.
 * @param <K> key type K.
 * @param <V> value type V.
 */
public abstract class AbstractTestInvalidStoreFormat<K, V> {
  /**
   * Creates a store with a byte[] keys and values.
   * This store cannot be created by LegacyStoreLoader.
   * Retrieval of this store should result in a NullPointerException.
   */
  public static class ByteKeyStore implements StoreCreationFunction<KVStore<byte[], byte[]>> {
    @Override
    public KVStore<byte[], byte[]> build(StoreBuildingFactory factory) {
   ...
   * Retrieval of this store should result in a NullPointerException.
   */
  public static class ByteContainerKeyStore implements StoreCreationFunction<KVStore<ByteContainerStoreGenerator.ByteContainer, ByteContainerStoreGenerator.ByteContainer>> {
    @Override
    public KVStore<ByteContainerStoreGenerator.ByteContainer, ByteContainerStoreGenerator.ByteContainer> build(StoreBuildingFactory factory) {
      return factory.<ByteContainerStoreGenerator.ByteContainer, ByteContainerStoreGenerator.ByteContainer>newStore()
        .name("byte-container-key-store")
  ...
  protected KVStoreProvider provider;

  protected abstract KVStoreProvider createProvider() throws Exception;
