...
public class TestFormatVisitor {
  ...
  public void visitString() {
    assertEquals(
        "{ class = java.lang.String, I am a string, key1name = null, key2name = null, key3name = null } ",
        getVisitable(Format.ofString()).toString());
  }

  @Test
  public void visitUUID() {
    assertEquals(
        "{ class = java.util.UUID, 79b4881b-9ea3-45a8-bae1-63c274b4a90b, key1name = null, key2name = null, key3name = null } ",
        getVisitable(Format.ofUUID()).toString());
  }
  ...
  public void visitBytes() {
    assertEquals(
        ...
        getVisitable(Format.ofBytes()).toString());
  }

  @Test
  public void visitProtostuff() {
    assertEquals(
        "{ class = com.dremio.datastore.proto.DummyObj, no value, key1name = null, key2name = null, key3name = null } ",
        getVisitable(Format.ofProtostuff(DummyObj.class)).toString());
  }

  @Test
  public void visitProtobuf() {
    assertEquals(
        "{ class = com.dremio.datastore.proto.Dummy$DummyObj, no value, key1name = null, key2name = null, key3name = null } ",
        getVisitable(Format.ofProtobuf(Dummy.DummyObj.class)).toString());
  }
  ...
  public void visitWrapped() {
    assertEquals(
        ...
        getVisitable(Format.wrapped(Doughnut.class, new DoughnutConverter(), Format.ofBytes()))
            .toString());
  }
