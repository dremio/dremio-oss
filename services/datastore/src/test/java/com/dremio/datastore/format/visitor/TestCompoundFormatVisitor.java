...
public class TestCompoundFormatVisitor<T> {
  ...
  public static Collection<Object[]> input() {
    return Arrays.asList(new Object[][]{
      ...
      {Format.ofCompoundFormat("key1", Format.ofString(), "key2", Format.ofString(), "key3", Format.ofUUID()), true},
      ...
      {Format.ofCompoundFormat(
        ...
        "key3", Format.ofUUID()),
        true},
      {Format.wrapped(ByteContainerStoreGenerator.ByteContainer.class, ByteContainerStoreGenerator.ByteContainer::getBytes, ByteContainerStoreGenerator.ByteContainer::new, Format.ofBytes()), false},
      {Format.wrapped(
      ...
      {Format.wrapped(
        ...
        Format.ofCompoundFormat("k1", Format.ofString(), "k2", Format.ofString())), true},
      {Format.wrapped(
        ...
        Format.ofCompoundFormat("k1", Format.ofString(), "k2", Format.ofString(), "k3", Format.ofString())), true},
    });
  }
