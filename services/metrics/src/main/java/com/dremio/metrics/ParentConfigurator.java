...
/**
 * The core wrapping class for all configurators. Capture common properties as well as reporter configuration to do
 * comparison, etc.
 */
class ParentConfigurator implements AutoCloseable {
  ...
  public boolean equals(Object other) {
    ...
    ParentConfigurator o = (ParentConfigurator) other;
  ...
  @VisibleForTesting
  ReporterConfigurator getConfigurator() {
    return configurator;
  }
