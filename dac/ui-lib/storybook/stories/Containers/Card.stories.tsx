...
export const Default = () => {
  return (
    <Card title="Example Card" style={{ width: "max-content" }}>
      <p className="dremio-prose">
        <strong>Lorem ipsum dolor sit amet,</strong> consectetur adipiscing
        elit. Nam neque ante, porttitor vel convallis in, ullamcorper sed arcu.
        In ultrices magna nec auctor feugiat. Quisque aliquam, nulla et
        ...
        tincidunt quis vitae lectus. Cras cursus turpis arcu, quis facilisis sem
        eleifend ac. Suspendisse aliquet, lacus eu auctor pellentesque, lorem
        odio venenatis tortor, quis mollis libero ipsum vitae massa. Sed
