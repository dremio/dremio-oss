...
/**
 * normalize all namespace keys
 */
public class NormalizeNamespace extends UpgradeTask {

  public NormalizeNamespace() {
    super("Normalize all namespace keys", VERSION_106, VERSION_108);
  }
