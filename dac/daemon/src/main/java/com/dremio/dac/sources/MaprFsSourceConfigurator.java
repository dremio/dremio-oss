...
import static com.dremio.service.namespace.source.proto.SourceType.MAPRFS;
...
/**
 * generates a StoragePluginConfig from an MaprFs Source
 */
public class MaprFsSourceConfigurator extends SingleSourceToStoragePluginConfig<MapRFSConfig> {

  public MaprFsSourceConfigurator() {
    super(MAPRFS);
  }
