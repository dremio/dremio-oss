...
const updateContextUrl = (scriptId: string) =>
  getApiContext().createSonarUrl(`scripts/${scriptId}/update_context`);

type path = paths["/scripts/{id}/update_context"]["put"];
...
export const updateContext = (
  ...
  return getApiContext()
    .fetch(updateContextUrl(scriptId), {
      method: "put",
