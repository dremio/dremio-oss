...
export class DefaultApi extends runtime.BaseAPI {
   ...
   */
  async assignBranchRaw(
    requestParameters: AssignBranchRequest,
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "branchName",
        "Required parameter requestParameters.branchName was null or undefined when calling assignBranch."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/trees/branch/{branchName}`.replace(
          `{${"branchName"}}`,
   ...
   */
  async assignTagRaw(
    requestParameters: AssignTagRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<void>> {
    if (
      ...
      throw new runtime.RequiredError(
        "tagName",
        "Required parameter requestParameters.tagName was null or undefined when calling assignTag."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/trees/tag/{tagName}`.replace(
          `{${"tagName"}}`,
  ...
  async commitMultipleOperationsRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Branch>> {
    if (
      requestParameters.branchName === null ||
      requestParameters.branchName === undefined
    ) {
   ...
   */
  async deleteBranchRaw(
    requestParameters: DeleteBranchRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.branchName === null ||
      ...
      throw new runtime.RequiredError(
        "branchName",
        "Required parameter requestParameters.branchName was null or undefined when calling deleteBranch."
      );
    }
  ...
  async deleteTagRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "tagName",
        "Required parameter requestParameters.tagName was null or undefined when calling deleteTag."
      );
    }
  ...
  async getAllReferencesRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<ReferencesResponse>> {
    const queryParameters: any = {};
  ...
  async getCommitLogRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<LogResponse>> {
  ...
  async getDiffRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<DiffResponse>> {
    if (
      ...
      throw new runtime.RequiredError(
        "fromRef",
        "Required parameter requestParameters.fromRef was null or undefined when calling getDiff."
      );
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "toRef",
        "Required parameter requestParameters.toRef was null or undefined when calling getDiff."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/diffs/{fromRef}...{toRef}`
          .replace(
            `{${"fromRef"}}`,
  ...
  async getEntriesRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<EntriesResponse>> {
    if (requestParameters.ref === null || requestParameters.ref === undefined) {
      throw new runtime.RequiredError(
        "ref",
  ...
  async getMultipleContentsRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<GetMultipleContentsResponse>> {
    const queryParameters: any = {};
  ...
  async getMultipleContents(
    requestParameters: GetMultipleContentsOperationRequest,
    initOverrides?: RequestInit
  ): Promise<GetMultipleContentsResponse> {
  ...
  async getRefLogRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<RefLogResponse>> {
    const queryParameters: any = {};
