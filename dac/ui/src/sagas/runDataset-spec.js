...
describe("runDataset saga", () => {
  ...
  describe("handleResumeRunDataset", () => {
    ...
    customTest(
      "should waitForRunToComplete if tableData.rows is not presented",
      () => {
        // get table data
        next = gen.next();
    ...
    customTest(
      "should waitForRunToComplete if tableData.rows is presented, but data reload is forced",
      () => {
        gen = handleResumeRunDataset(
          datasetVersion,
          jobId,
