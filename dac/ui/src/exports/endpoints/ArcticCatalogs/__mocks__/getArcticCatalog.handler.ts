...
import { getArcticCatalogUrl } from "../getArcticCatalog";
...
export const getArcticCatalogHandler = rest.get(
  getArcticCatalogUrl(":catalogId").replace(`//${window.location.host}`, ""),
  (_req, res, ctx) => {
