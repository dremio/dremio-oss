  ...
  render() {
    ...
    return (
      <div style={{ height: "100%" }}>
            ...
            <div style={{ ...formRow, display: "flex", marginBottom: 10 }}>
              ...
              >
                <div style={fieldWithErrorDivStyle}>
                  <TextField initialFocus {...name} style={textStyle} />
                </div>
              </FieldWithError>
            </div>
          </div>
        ...
        {this.props.children}
        {this.props.showAccelerationSection && (
          <AccelerationSection fields={this.props.fields} />
        )}
        {this.renderFooter(this.props.entityType, editing)}
      </div>
    );
  }
}
