...
describe("AggregateContent", () => {
  ...
  it("should render DragColumnMenu with available columns", () => {
    ...
    props.fields = {
      ...props.fields,
      columnsDimensions: [
        ...props.fields.columnsDimensions,
        { column: { value: "col3" } },
      ],
    };
...
canSelectMeasure or canUseFieldAsBothDimensionAndMeasure has changed`, () => {
  ...
  describe("#getDisabledColumnNames", () => {
    ...
    it(
      "should return columns that not present in both dimension and " +
    ...
    it(
      "should return columns that are absent in both dimension and measures lists " +
      ...
      () => {
        const props = {
          ...
          fields: {
            columnsDimensions: [{ column: { value: "col2" } }],
            columnsMeasures: [
              { column: { value: "col1" } },
              { column: { value: "col3" } },
            ],
