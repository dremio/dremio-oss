...
import * as classes from "./SummaryNotFoundItemLabel.module.less";

type SummaryNotFoundItemlabelProps = {
  iconName?: string;
  title?: string;
};

const SummaryNotFoundItemlabel = ({
  iconName,
  title,
}: SummaryNotFoundItemlabelProps) => {
...
export default SummaryNotFoundItemlabel;
