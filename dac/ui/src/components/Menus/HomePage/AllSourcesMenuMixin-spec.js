...
import {AllSourcesMenu as AllSourcesMenuBase} from 'components/Menus/HomePage/AllSourcesMenu';
import AllSourcesMenuMixin from './AllSourcesMenuMixin';

@AllSourcesMenuMixin
class AllSourcesMenu extends AllSourcesMenuBase {}

describe('AllSourcesMenuMixin', () => {
  let minimalProps;
  let commonProps;
  ...
  it('should render menu items', () => {
    const wrapper = shallow(<AllSourcesMenu {...commonProps} />, context);
    ...
    expect(findMenuItemByText(wrapper, 'Remove Source')).to.have.length(1);
  });
});
