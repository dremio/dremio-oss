...
// What follows is a copy of https://github.com/codemirror/CodeMirror/blob/master/mode/sql/sql.js
// With the following modifications:
// - UMD wrapper removed
// - text/x-dremiosql added
...
(function () {
  ...
  CodeMirror.defineMIME("text/x-dremiosql", {
    ...
    atoms: set(
      "current_date current_time current_timestamp localtime localtimestamp pi" +
        " " +
    ...
    // copied from text/x-sqlite (todo: make dremio-specific):
    dateSQL: set("date time timestamp datetime"),

    support: set("decimallessFloat zerolessFloat ODBCdotTable"),
