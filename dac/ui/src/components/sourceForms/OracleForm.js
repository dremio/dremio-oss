...
import { ORACLE } from 'dyn-load/constants/sourceTypes';
...
const SECTIONS = [General, SingleHost, InstanceSection, Credentials, JDBCOptions, MetadataRefresh];
const DEFAULT_PORT = 1521;

export class OracleForm extends Component {

  static sourceType = ORACLE;
...
}, SECTIONS, mapStateToProps, null)(OracleForm);
