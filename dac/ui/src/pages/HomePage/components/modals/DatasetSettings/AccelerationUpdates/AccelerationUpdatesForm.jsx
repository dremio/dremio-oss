...
export class AccelerationUpdatesForm extends Component {
  ...
  mapFormValues(values) {
    ...
    const requiredValues = {
      ...
      accelerationRefreshOnDataChanges: values.accelerationRefreshOnDataChanges,
    };
    ...
    return (
      <div>
        ...
        <DataFreshnessSection
          ...
          fileFormatType={this.props.fileFormatType}
        />
      </div>
    );
  }
...
const mapStateToProps = (state, ownProps) => {
  ...
  const accelerationRefreshOnDataChanges = settings.has(
    "accelerationRefreshOnDataChanges",
  )
    ? settings.get("accelerationRefreshOnDataChanges")
