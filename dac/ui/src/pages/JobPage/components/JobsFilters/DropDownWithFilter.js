...
class DropDownWithFilter extends PureComponent {
  static propTypes = {
  ...
  constructor(props) {
    ...
    this.customFilterInputRef = createRef();
  }

  onCustomFilterChange() {
    this.props.onCustomFilterChange(this.customFilterInputRef.current);
  }
  ...
  render() {
    ...
    return (
      <div className="drop-down-with-filter" style={[styles.base]}>
        ...
        {filter}
        <div className="scroll-box">{nonSelectedOptions}</div>
      </div>
    );
  }
}
