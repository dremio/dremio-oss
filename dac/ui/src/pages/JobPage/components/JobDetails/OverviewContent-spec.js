...
describe("OverviewContent", () => {
  ...
  describe("renderInfoAboutProfile", () => {
    ...
    it("should be metadata job", () => {
      ...
      wrapper = shallow(<OverviewContent {...props} />, { context });
      expect(wrapper.instance().isMetadataJob()).to.eql(true);
    });
    ...
    it("should be non-metadata job", () => {
      ...
      wrapper = shallow(<OverviewContent {...props} />, { context });
      expect(wrapper.instance().isMetadataJob()).to.eql(false);
    });
    ...
    it("should be no dataset available", () => {
      ...
      wrapper = shallow(<OverviewContent {...props} />, { context });
      expect(wrapper.instance().isDatasetAvailable()).to.eql(false);
    });
    ...
    it("should be no parents available", () => {
      ...
      wrapper = shallow(<OverviewContent {...props} />, { context });
      expect(wrapper.instance().isParentsBlockToBeShown()).to.eql(false);
    });
    ...
    it("should be parents available", () => {
      const props = {
        jobDetails: Immutable.fromJS({
          ...commonProps.jobDetails.toJS(),
          parentsList: [{ datasetPathList: ["a", "b"] }],
        }),
      };
      wrapper = shallow(<OverviewContent {...props} />, { context });
      expect(wrapper.instance().isParentsBlockToBeShown()).to.eql(true);
    });
