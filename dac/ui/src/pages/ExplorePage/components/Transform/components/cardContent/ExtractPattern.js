...
class ExtractPattern extends Component {
  ...
  static validate(values) {
    ...
    const validators = [
      isRequired("pattern.pattern", "Pattern"),
      isRegularExpression("pattern.pattern"),
    ];
    ...
    return (
      <div style={{ height: 108 }}>
        <div style={{ ...inlineFieldWrap, maxWidth: 550 }}>
          <span style={{ ...inlineLabel, display: "flex" }}>Extract</span>
          <Select
            dataQa="PatternValue"
            items={this.items}
            style={{ width: 200, ...bodySmall, background: "white" }}
            {...value.value}
          />
