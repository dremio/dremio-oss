...
export class ReplaceExactForm extends Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (
      newValues.replaceValues[0].value !== oldValues.replaceValues[0].value ||
  ...
  runLoadTransformValues(transformValues) {
    const value = [
      transformValues.replaceNull.value
        ? null
        : transformValues.replaceValues[0].value,
    ];
    ...
    return (
      ...
      >
        <Exact
          ...
          replaceValues={
            (fields.replaceValues.length !== 0 && fields.replaceValues[0]) || {}
          }
