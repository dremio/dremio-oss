...
export class QlikStateModal extends Component {
  ...
  renderErrorInfo() {
    ...
    const showIEMessage = code === "QLIK_CONNECT_FAILED";

    return (
      <div style={styles.contentStyle}>
        <dremio-icon
          name="job-state/error-solid"
          style={{
            blockSize: 120,
            inlineSize: 120,
          }}
        ...
        <div>
          ...
          {showIEMessage ? (
            <div style={{ marginTop: "1em" }}>
              ...
              <a
                href="https://docs.dremio.com/client-applications/qlik-sense.html"
                target="_blank"
        ...
        <div style={{ position: "relative", flex: 1 }}>
          <div style={styles.progressMessage}>
            {this.props.intl.formatMessage({
              id: "Qlik.EstablishingConnection",
            })}
          </div>
      ...
      <div style={styles.contentStyle}>
        ...
        <div style={{ position: "relative" }}>
          <p style={{ marginBottom: "1em" }}>
            <FormattedMessage
              id="Qlik.AppReady"
              values={{ appName: qlikAppInfo.appName }}
            />
          </p>
          <ol style={styles.list}>
            <li>
              Start Qlik Sense Desktop (or{" "}
              <Link to={qlikUrl} target="_blank">
                open in your browser
              </Link>
              ).
            </li>
            <li>
              When you first open the app, click <b>Open</b> to view the{" "}
              <b>Data load editor</b>.
            </li>
            <li>
              <FormattedMessage id="Qlik.ConfirmDimAndMes" />
            </li>
            <li>
              Click on <b>Load data</b>. Once done, you are ready to work with
              your data.
            </li>
          </ol>
        </div>
...
export default connect(mapStateToProps, { openQlikSense, hideQlikModal })(
  QlikStateModal,
);
...
const styles = {
  ...
  dashedBehind: {
    ...
    position: "absolute",
    borderColor: "var(--dremio--color--pale--navy)",
  },
  rightSide: {
    ...CENTER,
    width: 120,
