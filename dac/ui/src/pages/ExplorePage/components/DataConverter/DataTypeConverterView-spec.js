...
import { TEXT, BINARY, INTEGER } from "#oss/constants/DataTypes";
...
describe("DataTypeConverterView", () => {
  ...
  it("should render", () => {
    const wrapper = shallow(<DataTypeConverterView {...commonProps} />, {
  ...
  describe("#setTransformationInLocalStorage", () => {
    ...
    let instance;
    beforeEach(() => {
      wrapper = shallow(<DataTypeConverterView {...commonProps} />, {
        context: commonContext,
      });
