...
export class RecommendedJoinItem extends Component {
  ...
  renderJoinType() {
    ...
    const joinTypeToIconType = {
      Inner: "sql-editor/join-inner",
      LeftOuter: "sql-editor/join-left",
      RightOuter: "sql-editor/join-right",
      FullOuter: "sql-editor/join-full",
    };
    return (
      <dremio-icon
        dataQa="joinType"
        name={joinTypeToIconType[recommendation.get("joinType")]}
