...
export class JoinTables extends PureComponent {
  ...
  shouldRenderSecondTable() {
    const isOnCustomJoinSelectStep =
      this.props.joinTab === CUSTOM_JOIN && this.props.joinStep !== 2;
    return (
      isOnCustomJoinSelectStep &&
      !this.props.exploreViewState.get("isInProgress")
    );
  }
  ...
  renderSecondTable() {
    ...
    if (
      ...
      const customTableContent =
        joinViewState && joinViewState.get("isInProgress") ? (
  ...
  render() {
    ...
    const tableBlockStyle = !this.shouldRenderSecondTable()
      ? { maxWidth: "100%", width: "calc(100% - 10px)" }
      : {};
    return (
      <div style={styles.base}>
        <div style={{ ...styles.tableBlock, ...tableBlockStyle }}>
          <div style={styles.header}>
            <EllipsedText text={nameForDisplay} />
          </div>
          <ExploreTableController
            pageType={this.props.pageType}
            dataset={this.props.dataset}
        ...
        <div
          style={{
            ...styles.tableBlock,
            marginLeft: 5,
            ...(!this.shouldRenderSecondTable() && { display: "none" }),
          }}
        >
          <div
            style={{
              ...styles.header,
              ...(!this.props.joinDatasetFullPath && { fontStyle: "italic" }),
            }}
          >
            <EllipsedText
              text={
