...
describe("ExploreTableCell", () => {
  ...
  describe("#shouldComponentUpdate", function () {
    ...
    describe("should return false", function () {
      it("with no actual prop changes", () => {
        expect(instance.shouldComponentUpdate(instance.props, instance.state))
          .to.be.false;
      });
  ...
  describe("#onMouseUp", () => {
    ...
    beforeEach(() => {
      ...
      sinon
        .stub(exploreUtils, "getSelection")
        .returns({ model: "selectionModel" });
    });
    ...
    it("should call selectItemsOfList from props when selected column type is LIST", () => {
      instance.onMouseUp();
      expect(props.selectItemsOfList).to.be.calledWith(
        "column_text",
        "col1",
        "LIST",
        selectionData,
    ...
    it("should call selectAll for other column types (not TEXT, MAP, LIST)", () => {
      ...
      instance.onMouseUp();
      expect(props.selectAll).to.be.calledWith(
