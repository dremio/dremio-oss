...
export const RUN_SELECTION_TRANSFORM_SUCCESS =
  "RUN_SELECTION_TRANSFORM_SUCCESS";
export const RUN_SELECTION_TRANSFORM_FAILURE =
  "RUN_SELECTION_TRANSFORM_FAILURE";
...
function fetchTransformCardPreview(
  data,
  transform,
  dataset,
  actionType,
...
export function loadTransformCardPreview(
  data,
  transform,
  dataset,
  actionType,
...
export const RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_START =
  "RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_START";
export const RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_SUCCESS =
  "RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_SUCCESS";
export const RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_FAILURE =
  "RUN_SELECTION_TRANSFORM_PREVIEW_VALUES_FAILURE";
...
export function loadTransformValuesPreview(
  data,
  transform,
  dataset,
  actionType,
