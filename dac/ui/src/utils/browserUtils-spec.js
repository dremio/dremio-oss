...
describe("browserUtils", () => {
  ...
  describe("compareVersions", () => {
    it("should return positive number if first version greater than second", () => {
      expect(
        browserUtils.compareVersions("54.0.2353.56", "40.0.301.0.2")
      ).to.be.above(0);
      expect(
        browserUtils.compareVersions("54.1.2353.56", "54.0.301.0.2")
      ).to.be.above(0);
      expect(
        browserUtils.compareVersions("54.1.302.56", "54.1.301.0.2")
      ).to.be.above(0);
      expect(
        browserUtils.compareVersions("54.1.302.56", "54.1.302")
      ).to.be.above(0);
    });
    it("should return negative number if first version less than second", () => {
      expect(
        browserUtils.compareVersions("40.0.301.0.2", "54.0.2353.56")
      ).to.be.below(0);
      expect(
        browserUtils.compareVersions("54.0.301.0.2", "54.1.2353.56")
      ).to.be.below(0);
      expect(
        browserUtils.compareVersions("54.0.301.0.2", "54.1.302.56")
      ).to.be.below(0);
      expect(
        browserUtils.compareVersions("54.1.302", "54.1.302.56")
      ).to.be.below(0);
    });
    it("should return 0 if versions are equal", () => {
      expect(
        browserUtils.compareVersions("40.0.301.0.2", "40.0.301.0.2")
      ).to.be.eql(0);
      expect(
        browserUtils.compareVersions("54.0.301.0.2", "54.0.301.0.2")
      ).to.be.eql(0);
      expect(
        browserUtils.compareVersions("54.0.301.0.2", "54.0.301.0.2")
      ).to.be.eql(0);
