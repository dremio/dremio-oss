    ...
    return {
      ...
      position: {
        startIndex: {
          ...
          direction:
            hash[rule.position.startIndex.direction] || "FROM_THE_START",
        },
        endIndex: {
  ...
  mapPatternRule(rule) {
    ...
    return {
      ...
      pattern: {
        ...
        indexType:
          (rule.pattern.value && hash[rule.pattern.value.value]) || "INDEX",
      },
    };
  }
    ...
    return {
      ...
      selection: {
        start: {
          ...
          direction:
            hash[rule.multiple.startIndex.direction] || "FROM_THE_START",
        },
        end: {
