...
describe("SourceFormJsonPolicy", () => {
  ...
  describe("combineFunctionalAndPresentationalSourceTypeConfig", () => {
    ...
    beforeEach(() => {
      ...
      functionalConfig = {
        sourceType: "S3",
        label: "s3",
        elements: [{ propertyName: "a", type: "text", defaultValue: "9" }],
      };
    });
    ...
    describe("convertJsonConfigToObjects", () => {
      it("should return falsy argument", () => {
        expect(SourceFormJsonPolicy.convertJsonConfigToObjects(null, [])).to.be
          .null;
        expect(SourceFormJsonPolicy.convertJsonConfigToObjects()).to.be
          .undefined;
      });
              ...
              elements: [
                {
                  ...
                  size: "half",
                  errMsg:
                    "Both access secret and key are required for private S3 buckets.",
                },
                {
  ...
  describe("applyJsonPolicyToFormConfig", () => {
    ...
    it("should move loose sections to general tab", () => {
      ...
      uiConfig = {
        sourceType: "S3",
        form: new FormConfig({ sections: looseSections }),
      };
      const config = SourceFormJsonPolicy.applyJsonPolicyToFormConfig(
        uiConfig,
        functionalConfig
    ...
    it("should move loose elements to general tab", () => {
      ...
      uiConfig = {
        sourceType: "S3",
        form: new FormConfig({ elements: looseElements }),
      };
      const config = SourceFormJsonPolicy.applyJsonPolicyToFormConfig(
        uiConfig,
        functionalConfig
    ...
    const findConfigContainer = (configContainers, field, value) =>
      configContainers.find((container) => {
