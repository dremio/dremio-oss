...
public class SearchContainer {
  ...
  SearchContainer(NameSpaceContainer namespaceContainer, CollaborationTag collaborationTag) {
    this.namespaceContainer = namespaceContainer;
    this.collaborationTag = collaborationTag;
  }

  public CollaborationTag getCollaborationTag() {
    return collaborationTag;
  }
  ...
  void setCollaborationTag(CollaborationTag collaborationTag) {
    this.collaborationTag = collaborationTag;
  }
}
