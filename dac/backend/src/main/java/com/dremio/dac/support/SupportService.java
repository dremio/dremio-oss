...
/**
 * Service responsible for generating cluster identity and upload data to Dremio when a user asks
 * for support help.
 */
@Options
public interface SupportService extends Service {
  ...
  TypeValidators.BooleanValidator USERS_CHAT =
      new TypeValidators.BooleanValidator("support.users.chat", false);
  TypeValidators.BooleanValidator USERS_UPLOAD =
      new TypeValidators.BooleanValidator("support.users.upload", true);
  TypeValidators.BooleanValidator USERS_DOWNLOAD =
      new TypeValidators.BooleanValidator("support.users.download", true);
  TypeValidators.BooleanValidator USERS_EMAIL =
      new TypeValidators.BooleanValidator("support.users.email", true);

  TypeValidators.StringValidator SUPPORT_EMAIL_ADDR =
      new TypeValidators.StringValidator("support.email.addr", "");
  TypeValidators.StringValidator SUPPORT_EMAIL_SUBJECT =
      new TypeValidators.StringValidator("support.email.jobs.subject", "");

  TypeValidators.StringValidator SUPPORT_UPLOAD_BASE =
      new TypeValidators.StringValidator(
          "support.upload.base", "https://s3-us-west-2.amazonaws.com/supportuploads.dremio.com/");
  TypeValidators.StringValidator TEMPORARY_SUPPORT_PATH =
      new TypeValidators.StringValidator("support.temp", "/tmp/dremio-support/");
   ...
   */
  SupportResponse uploadSupportRequest(String userId, JobId jobId)
