...
public class ShowBranchesHandler extends BaseVersionHandler<ReferenceInfo> {
  ...
  public List<ReferenceInfo> toResult(String sql, SqlNode sqlNode) throws ForemanSetupException {
    ...
    final SqlShowBranches showBranches =
        requireNonNull(SqlNodeUtil.unwrap(sqlNode, SqlShowBranches.class));
