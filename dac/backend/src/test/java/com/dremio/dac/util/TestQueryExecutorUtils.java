...
public class TestQueryExecutorUtils {
  ...
  public void testCreateSourceVersionMapping() {
    ...
    Map<String, com.dremio.catalog.model.VersionContext> sourceVersionMappingExpected =
        new HashMap<>();
    sourceVersionMappingExpected.put(
        "source1", com.dremio.catalog.model.VersionContext.ofBranch("branch"));
    sourceVersionMappingExpected.put(
        "source2", com.dremio.catalog.model.VersionContext.ofTag("tag"));
    sourceVersionMappingExpected.put(
        "source3",
        com.dremio.catalog.model.VersionContext.ofCommit(
            "d0628f078890fec234b98b873f9e1f3cd140988a"));

    assertThat(QueryExecutorUtils.createSourceVersionMapping(referencesList))
