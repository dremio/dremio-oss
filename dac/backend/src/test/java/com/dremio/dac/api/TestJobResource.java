...
public class TestJobResource extends BaseTestServer {
  ...
  public void testGetJobResultsAreCorrect() throws InterruptedException {
    ...
    assertTrue(
        body.contains(
            "\"schema\":[{\"name\":\"version\",\"type\":{\"name\":\"VARCHAR\"}},{\"name\":\"commit_id\",\"type\":{\"name\":\"VARCHAR\"}},{\"name\":\"commit_message\",\"type\":{\"name\":\"VARCHAR\"}},{\"name\":\"commit_time\",\"type\":{\"name\":\"VARCHAR\"}},{\"name\":\"build_email\",\"type\":{\"name\":\"VARCHAR\"}},{\"name\":\"build_time\",\"type\":{\"name\":\"VARCHAR\"}}]"));
  ...
  public void testCancelJob() throws InterruptedException {
    ...
    while (true) {
      ...
      Assert.assertTrue(
          "Job is expected to be canceled eventually. But job is in unexpected jobState:"
              + jobState,
          Arrays.asList(
                  JobState.PLANNING,
                  JobState.RUNNING,
      ...
      if (jobState == JobState.CANCELED) {
        ...
        // the job could complete before the cancel request, so make sure the test doesn't fail in
        // that case.
        break;
      } else {
        Thread.sleep(TimeUnit.MILLISECONDS.toMillis(100));
