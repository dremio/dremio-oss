...
public class TestCardGenerator {
  ...
  private List<TransformRuleWrapper<ReplacePatternRule>> rules =
      asList(
  ...
  public void exampleGeneratorQuery() {
    ...
    String outputQuery1 =
        cardGenerator.generateCardGenQuery(
            "col.with.dots", "TABLE(\"jobstore\".\"path\"(type => 'arrow))", rules);
    String expQuery1 =
        "SELECT\n"
    ...
    String outputQuery2 =
        cardGenerator.generateCardGenQuery(
            "normalCol", "TABLE(\"jobstore\".\"path\"(type => 'arrow))", rules);
    String expQuery2 =
        "SELECT\n"
  ...
  public void matchCountGeneratorQuery() {
    // Expect backticks around column name as it has special characters in it.
    String outputQuery1 =
        cardGenerator.generateMatchCountQuery(
            "col with spaces", "TABLE(\"jobstore\".\"path\"(type => 'arrow))", rules);
    String expQuery1 =
        "SELECT\n"
