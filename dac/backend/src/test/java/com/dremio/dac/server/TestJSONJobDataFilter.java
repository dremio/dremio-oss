...
public class TestJSONJobDataFilter {
  ...
  @Parameterized.Parameters(name = "Request header {0}, response media type = {1}, expected value = {2}")
  public static Collection<TestData> data() {
    return asList(
      new TestData(WebServer.X_DREMIO_JOB_DATA_NUMBERS_AS_STRINGS, WebServer.X_DREMIO_JOB_DATA_NUMBERS_AS_STRINGS_SUPPORTED_VALUE,
        MediaType.APPLICATION_JSON_TYPE, true),
      new TestData(WebServer.X_DREMIO_JOB_DATA_NUMBERS_AS_STRINGS, "not supported header value",
        MediaType.APPLICATION_JSON_TYPE, false),
      new TestData( null, null, MediaType.APPLICATION_JSON_TYPE, false),
      new TestData(WebServer.X_DREMIO_JOB_DATA_NUMBERS_AS_STRINGS, WebServer.X_DREMIO_JOB_DATA_NUMBERS_AS_STRINGS_SUPPORTED_VALUE,
        MediaType.MULTIPART_FORM_DATA_TYPE, false),
      new TestData(WebServer.X_DREMIO_HOSTNAME, "not supported header value",
        MediaType.MULTIPART_FORM_DATA_TYPE, false)
    );
  }
