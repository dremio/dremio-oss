...
public class TestDataJsonOutput {
  @Parameterized.Parameters(
      name = "Test isNumberAsString. Attribute value = {0}, expected value = {1}")
  ...
  @Test
  public void test() {
    Mockito.when(context.getAttribute(DataJsonOutput.DREMIO_JOB_DATA_NUMBERS_AS_STRINGS_ATTRIBUTE))
        .thenReturn(this.inputValue);
