...
public class TestDatasetDependencyChanges extends BaseTestServer {
  ...
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(TestDatasetDependencyChanges.class);
  ...
  public TestDatasetDependencyChanges(
      String datasetDefOne,
      String datasetDefTwo,
      String datasetDefThree,
      String datasetDefRedefined,
      int datasetToChange,
      boolean expectError) {
