...
/**
 * Dictionary of all the KeywordOrFunctionDetectors mapping name to the corresponding detector. This
 * list only covers the tokens that overlap with function in the system.
 */
public final class TokenTypeDetector {
  private static final TokenTypeDetectorImplementation ALWAYS_KEYWORD =
      TokenTypeDetectorImplementation.AlwaysKeyword.INSTANCE;
  private static final TokenTypeDetectorImplementation ALWAYS_FUNCTION =
      TokenTypeDetectorImplementation.AlwaysFunction.INSTANCE;
  private static final TokenTypeDetectorImplementation LEFT_RIGHT =
      TokenTypeDetectorImplementation.LeftRight.INSTANCE;
  private static final TokenTypeDetectorImplementation AGGREGATE =
      TokenTypeDetectorImplementation.Aggregate.INSTANCE;

  private static final ImmutableMap<String, TokenTypeDetectorImplementation> map =
      ImmutableMap.<String, TokenTypeDetectorImplementation>builder()
          // Binary Operators
          .put(",", ALWAYS_KEYWORD)
          .put("!=", ALWAYS_KEYWORD)
          .put("%", ALWAYS_KEYWORD)
