...
public class TestJSONElementLocator {
  ...
  public void validateSelection(Selection selection, String expected)
      throws JsonParseException, IOException {
    JSONElementLocator locator = new JSONElementLocator(selection.getCellText());
    JsonSelection location =
        locator.locate(selection.getOffset(), selection.getOffset() + selection.getLength());
    String selectedText =
        selection
            .getCellText()
  ...
  public void testListSelection() throws Exception {
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 10, 3),
        "bar Selection[s:[1], e:[1]]");
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 3, 3), "foo Selection[s:[0], e:[0]]");
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 17, 3),
        "baz Selection[s:[2], e:[2]]");
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 10, 10),
        "bar\", \"baz Selection[s:[1], e:[2]]");
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 9, 12),
        "\"bar\", \"baz\" Selection[s:[1], e:[2]]");
    validateSelection(
        new Selection("foo", "[ \"foo\", \"bar\", \"baz\" ]", 11, 8),
        "ar\", \"ba Selection[s:[1], e:[2]]");
    validateSelection(
        new Selection("foo", "{ \"bar\" :[ \"foo\", \"bar\", \"baz\" ]}", 18, 12),
        "\"bar\", \"baz\" Selection[s:.bar[1], e:.bar[2]]");
  }
  ...
  public void testMapSelection() throws Exception {
    validateSelection(
        new Selection(
            "a",
            "{\"Tuesday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Friday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Monday\":{}}",
            11,
            32),
        "{\"close\":\"19:00\",\"open\":\"10:00\"} Selection[s:.Tuesday, e:.Tuesday]");
  }
  ...
  public void testMapHighlightInt() throws Exception {
    validateSelection(
        ".Price Range",
        "1",
        "{\"Ambience\":{\"romantic\":false,\"intimate\":false,\"touristy\":false,\"hipster\":false,\"divey\":false,\"classy\":false,\"trendy\":false,\"upscale\":false,\"casual\":false},\"Coat Check\":false,\"Price Range\":1,\"Music\":{},\"Good For\":{},\"Parking\":{},\"Hair Types Specialized In\":{}}");
    validateSelection(
        ".Price Range",
        "1",
        "{\"Ambience\":{\"romantic\":false,\"intimate\":false,\"touristy\":false,\"hipster\":false,\"divey\":false,\"classy\":false,\"trendy\":false,\"upscale\":false,\"casual\":false},\"Coat Check\":false,\"Price Range\": 1   ,\"Music\":{},\"Good For\":{},\"Parking\":{},\"Hair Types Specialized In\":{}}");
  ...
  public void testMapHighlightBool() throws Exception {
    validateSelection(
        ".Tuesday.bool",
        "true",
        "{\"Tuesday\":{\"bool\":true,\"open\":\"10:00\"},\"Friday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Monday\":{}}");
    validateSelection(
        ".Tuesday.bool",
        "false",
        "{\"Tuesday\":{\"bool\":    false     ,\"open\":\"10:00\"},\"Friday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Monday\":{}}");
  }
  ...
  public void testMapHighlightArray() throws Exception {
    validateSelection(
        ".Tuesday.array",
        "[\"a\"]",
        "{\"Tuesday\":{\"array\":[\"a\"],\"open\":\"10:00\"},\"Friday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Monday\":{}}");
    validateSelection(
        ".Tuesday.array",
        "[ \"a\", \"b\"  ]",
        "{\"Tuesday\":{\"array\":  [ \"a\", \"b\"  ]   ,\"open\":\"10:00\"},\"Friday\":{\"close\":\"19:00\",\"open\":\"10:00\"},\"Monday\":{}}");
  }
  ...
  public void testMapHighlightFloat() throws Exception {
    validateSelection(
        ".Price Range",
        "1.1",
        "{\"Ambience\":{\"romantic\":false,\"intimate\":false,\"touristy\":false,\"hipster\":false,\"divey\":false,\"classy\":false,\"trendy\":false,\"upscale\":false,\"casual\":false},\"Coat Check\":false,\"Price Range\":1.1,\"Music\":{},\"Good For\":{},\"Parking\":{},\"Hair Types Specialized In\":{}}");
    validateSelection(
        ".Price Range",
        "1.2",
        "{\"Ambience\":{\"romantic\":false,\"intimate\":false,\"touristy\":false,\"hipster\":false,\"divey\":false,\"classy\":false,\"trendy\":false,\"upscale\":false,\"casual\":false},\"Coat Check\":false,\"Price Range\": 1.2   ,\"Music\":{},\"Good For\":{},\"Parking\":{},\"Hair Types Specialized In\":{}}");
  }
  ...
  public void testParseJsonPath2() throws Exception {
    ...
    assertEquals(
        new JsonPath(
            new ObjectJsonPathElement("a"),
            new ObjectJsonPathElement("b"),
            new ObjectJsonPathElement("c")),
        p);
  }
  ...
  public void testParseJsonPath3() throws Exception {
    ...
    assertEquals(
        new JsonPath(
            new ArrayJsonPathElement(0), new ArrayJsonPathElement(1), new ArrayJsonPathElement(2)),
        p);
  }
  ...
  public void testParseJsonPath4() throws Exception {
    ...
    assertEquals(
        new JsonPath(
            new ArrayJsonPathElement(0),
            new ObjectJsonPathElement("a"),
            new ArrayJsonPathElement(1)),
        p);
  }
