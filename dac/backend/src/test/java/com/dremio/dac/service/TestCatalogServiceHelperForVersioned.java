...
public class TestCatalogServiceHelperForVersioned extends DremioTest {
  ...
  public void setup() throws NamespaceNotFoundException {
    sourceConfig =
      new SourceConfig()
        .setName("versionedSource")
        .setId(new EntityId(sourceId));
    sourceContainer =
    ...
    when(namespaceService.getEntities(eq(Collections.singletonList(new NamespaceKey("versionedSource")))))
  ...
  public void getCatalogSourceEntityById() throws NamespaceException {
    ...
    contents.addFolder(new com.dremio.dac.model.folder.Folder(
      ...
      null,
      0));
    contents.addDataset(com.dremio.dac.explore.model.Dataset.newInstance(
      ...
      VersionedDatasetId.newBuilder()
        ...
        .build()
        .asString()));
    contents.addPhysicalDataset(PhysicalDataset.newInstance(
      new SourceName("versionedSource"),
      Collections.emptyList(),
      "table",
      VersionedDatasetId.newBuilder()
    ...
    when(sourceService.listSource(any(SourceName.class), any(SourceConfig.class), eq("user123"), eq(null), eq(null)))
      .thenReturn(contents);
  ...
  public void getCatalogFolderEntityById() throws NamespaceException {
    final VersionedDatasetId folderId = VersionedDatasetId.newBuilder()
      .setTableVersionContext(TableVersionContext.of(VersionContext.ofBranch("main")))
    ...
    ResolvedVersionContext resolvedVersionContext = ResolvedVersionContext.ofBranch("main", "abc123");
    ...
    when(securityContext.getUserPrincipal()).thenReturn(() -> "user123");
    when(sourceService.listFolder(any(SourceName.class), any(SourceFolderPath.class), eq("user123"), eq("BRANCH"), eq("main")))
      .thenReturn(contents);

    final Optional<CatalogEntity> catalogEntity =
      catalogServiceHelper.getCatalogEntityById(folderId.asString(), ImmutableList.of(), ImmutableList.of());
  ...
  public void getCatalogTableEntityById() throws NamespaceException {
    final String tableId = VersionedDatasetId.newBuilder()
      .setTableVersionContext(TableVersionContext.of(VersionContext.ofBranch("main")))
      .setContentId(UUID.randomUUID().toString())
      .setTableKey(Arrays.asList("versionedSource", "table"))
      .build()
    ...
    when(catalog.getTable(eq(tableId)))
  ...
  public void getCatalogViewEntityById() throws NamespaceException {
    final String viewId = VersionedDatasetId.newBuilder()
      .setTableVersionContext(TableVersionContext.of(VersionContext.ofBranch("main")))
      .setContentId(UUID.randomUUID().toString())
      .setTableKey(Arrays.asList("versionedSource", "view"))
      .build()
    ...
    when(catalog.getTable(eq(viewId)))
      .thenReturn(dremioTable);
    final DatasetConfig datasetConfig =
      new DatasetConfig()
    ...
    assertThatThrownBy(
            () ->
                catalogServiceHelper.getCatalogEntityByPath(
                    Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), "BRANCH", null))
  ...
  public void getCatalogEntityByPathWithoutVersionType() throws Exception {
    assertThatThrownBy(
      () ->
        catalogServiceHelper.getCatalogEntityByPath(
          Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), null, "main"))
      .isInstanceOf(ClientErrorException.class)
      .hasMessageContaining("Missing a valid versionType/versionValue");
  }
  ...
  public void getCatalogEntityByPathWithoutVersionContext() throws Exception {
    ...
    final Optional<CatalogEntity> catalogEntity =
      catalogServiceHelper.getCatalogEntityByPath(
        Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), null, null);
  ...
  public void getCatalogEntityByPathNotFound() throws Exception {
    ...
    final Optional<CatalogEntity> catalogEntity =
        catalogServiceHelper.getCatalogEntityByPath(
            Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), "BRANCH", "main");
  ...
  public void getCatalogEntityByPathForSnapshot() throws Exception {
    ...
    final Optional<CatalogEntity> catalogEntity =
      catalogServiceHelper.getCatalogEntityByPath(
        Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), "SNAPSHOT", "1128544236092645872");
  ...
  public void getCatalogEntityByPathForTimestamp() throws Exception {
    ...
    final Optional<CatalogEntity> catalogEntity =
        catalogServiceHelper.getCatalogEntityByPath(
            Arrays.asList("versionedSource", "table"), ImmutableList.of(), ImmutableList.of(), "TIMESTAMP", "1679029735226");
  ...
  public void getCatalogEntityByPathForView() throws Exception {
    ...
    final Optional<CatalogEntity> catalogEntity =
      catalogServiceHelper.getCatalogEntityByPath(
        Arrays.asList("versionedSource", "view"), ImmutableList.of(), ImmutableList.of(), "BRANCH", "main");
  ...
  public void getCatalogEntityByPathForFolder() throws Exception {
    final SourceConfig sourceConfig = new SourceConfig()
        .setName("versionedSource");
    final NameSpaceContainer source = new NameSpaceContainer()
      .setSource(sourceConfig)
      .setType(NameSpaceContainer.Type.SOURCE);
    final ResolvedVersionContext resolvedVersionContext = ResolvedVersionContext.ofBranch("main", "abc123");
    final NamespaceTree contents = new NamespaceTree();
    contents.addFolder(new com.dremio.dac.model.folder.Folder(
      VersionedDatasetId.newBuilder()
        .setTableKey(Arrays.asList("versionedSource", "myfolder", "nested"))
    ...
    contents.addPhysicalDataset(PhysicalDataset.newInstance(
      ...
      VersionedDatasetId.newBuilder()
        ...
        .build()
        .asString()));
    VersionedDatasetId testVersionedDatasetId = VersionedDatasetId.newBuilder()
      .setTableKey(Arrays.asList("versionedSource", "myfolder"))
    ...
    final Optional<CatalogEntity> catalogEntity =
      catalogServiceHelper.getCatalogEntityByPath(
        Arrays.asList("versionedSource", "myfolder"), ImmutableList.of(), ImmutableList.of(), "BRANCH", "main");
  ...
  public void dropView() throws Exception {
    ...
    when(catalog.resolveVersionContext("versionedSource", VersionContext.ofBranch("main"))).thenReturn(resolvedVersionContext);

    catalogServiceHelper.deleteCatalogItem(viewId, null);

    verify(catalog).dropView(
