...
public class TestUserServices extends BaseTestServer {
  ...
  public void testUserOCC() throws Exception {
    ...
    final User uc =
        SimpleUser.newBuilder()
            .setUserName(testUserName("test11"))
            .setEmail("test11@dremio.test")
            .setFirstName("test11")
            .setLastName("dremio")
            .build();
    expectSuccess(
    ...
    String expectedErrorMessage =
        String.format(
            "Cannot delete user \"%s\", version provided \"%s\" is different from version found \"%s\"",
  ...
  public void testUserSearch() throws Exception {
    ...
    User md =
        SimpleUser.newBuilder()
            .setUserName(testUserName("MarkDavid"))
            .setCreatedAt(System.currentTimeMillis())
    ...
    User dw =
        SimpleUser.newBuilder()
            .setUserName(testUserName("DavidWilson"))
            .setCreatedAt(System.currentTimeMillis())
  ...
  public void testUserLogin() throws Exception {
    ...
    assertTrue(
        userLoginToken.getExpires() > (now + 30 * 3600 * 1000)
            && userLoginToken.getExpires() < (now + (30 * 3600 + 5 * 60) * 1000));
    ...
    User userConfig1 =
        SimpleUser.newBuilder()
            .setUserName(testUserName("test1"))
            .setEmail("test1@dremio.test")
            .setFirstName("test1")
            .setLastName("dremio")
            .build();
    ...
    userConfig2 =
        SimpleUser.newBuilder()
            .setUserName(testUserName("test2"))
            .setEmail("test2@dremio.test")
            .setFirstName("test2")
            .setLastName("dremio")
            .build();
    ...
    User userConfig3 =
        SimpleUser.newBuilder()
            .setUserName(testUserName("test3"))
            .setEmail("test3@dremio.test")
            .setFirstName("test3")
            .setLastName("dremio")
            .build();
  ...
  public void testUserAuthorization() throws Exception {
    ...
    User admin =
        SimpleUser.newBuilder()
            .setUserName(testUserName("admin"))
            .setEmail("admin@dremio.test")
            .setFirstName("admin")
            .setLastName("dremio")
            .build();
    ...
    User user1 =
        SimpleUser.newBuilder()
            .setUserName(testUserName("user1"))
            .setEmail("user1@dremio.test")
            .setFirstName("user1")
            .setLastName("user1")
            .build();
    ...
    User user2 =
        SimpleUser.newBuilder()
            .setUserName(testUserName("user2"))
            .setEmail("user2@dremio.test")
            .setFirstName("user2")
            .setLastName("user2")
            .build();
    ...
    UserUI user =
        expectSuccess(
            getAPIv2()
                ...
                .buildPut(Entity.json(new UserForm(user2, testPassword("user2")))),
            UserUI.class);
    ...
    user =
        expectSuccess(
            getAPIv2()
                ...
                .request(JSON)
                .header(HttpHeader.AUTHORIZATION.toString(), "_dremio" + adminLoginToken.getToken())
                .buildPost(Entity.json(new UserForm(user2, testPassword("user2")))),
            UserUI.class);
    assertEquals(testUserName("user2"), user.getUserName().getName());
    ...
    user =
        expectSuccess(
            getAPIv2()
                ...
                .request(JSON)
                .header(HttpHeader.AUTHORIZATION.toString(), "_dremio" + adminLoginToken.getToken())
                .buildPost(Entity.json(new UserForm(testPassword("user2_new")))),
            UserUI.class);
    assertEquals(testUserName("user2"), user.getUserName().getName());
    assertEquals(user2.getEmail(), user.getUser().getEmail());
            ...
            getAPIv2()
                ...
                .buildPost(
                    Entity.json(
                        new UserForm(
                            SimpleUser.newBuilder()
                                .setUserName(testUserName("user2_new"))
                                .build()))),
            UserUI.class);
    assertEquals(user2.getEmail(), user.getUser().getEmail());
  ...
  public void testInvalidUsername() throws Exception {
    ...
    User invalidUserConfig2 =
        SimpleUser.newBuilder(invalidUserConfig1).setUserName(testUserName("vali:d")).build();
