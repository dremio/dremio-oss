...
public final class TokenResolver {
  private static final DremioTokenNGramFrequencyTable N_GRAM_FREQUENCY_TABLE = DremioTokenNGramFrequencyTable.create("autocomplete/markov_chain_queries.sql", 4);
