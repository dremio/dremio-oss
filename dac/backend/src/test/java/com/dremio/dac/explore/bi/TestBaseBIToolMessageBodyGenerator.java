...
public class TestBaseBIToolMessageBodyGenerator {
  ...
  private static final String TEST_DREMIO_WEB_SERVER_HOSTNAME_OVERRIDE =
      "test.dremio.web.server.hostname";

  private static final OptionManager OPTION_MANAGER = mock(OptionManager.class);
  private static final BaseBIToolMessageBodyGenerator GENERATOR =
      new MockBaseBIToolMessageBodyGenerator(
  ...
  private static class MockBaseBIToolMessageBodyGenerator extends BaseBIToolMessageBodyGenerator {
    protected MockBaseBIToolMessageBodyGenerator(
