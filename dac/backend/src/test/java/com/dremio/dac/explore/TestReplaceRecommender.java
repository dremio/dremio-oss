...
public class TestReplaceRecommender extends RecommenderTestBase {
  ...
  public void ruleSuggestionsSelectMiddleNumber() {
    ...
    Selection selection =
        new Selection("col", "There are 20 types of people", 10, 2); // "20" is selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
    assertEquals(2, rules.size());
  ...
  public void ruleSuggestionsSelectBeginningText() {
    ...
    Selection selection =
        new Selection("col", "There are 20 types of people", 0, 5); // "There" is selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
  ...
  public void ruleSuggestionsSelectEndingText() {
    ...
    Selection selection =
        new Selection("col", "There are 20 types of people", 22, 6); // "people" is selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
    assertEquals(4, rules.size());
  ...
  public void ruleSuggestionsSelectAllText() {
    ...
    Selection selection =
        new Selection("col", "There are 20 types of people", 0, 28); // everything selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
  ...
  public void ruleSuggestionsSelectNumberAtTheEnd() {
    ...
    Selection selection =
        new Selection(
            "col", "883 N Shoreline Blvd, Mountain View, CA 94043", 40, 5); // "94043" is selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
  ...
  public void ruleSuggestionsSelectNumberAtBeginning() {
    ...
    Selection selection =
        new Selection(
            "col", "883 N Shoreline Blvd, Mountain View, CA 94043", 0, 3); // "883" is selected
    List<ReplacePatternRule> rules = recommender.getRules(selection, TEXT);
    assertEquals(3, rules.size());
  ...
  private void compare(
      ReplaceSelectionType type, String pattern, boolean ignoreCase, ReplacePatternRule r) {
  ...
  public void contains() throws Exception {
    ...
    ReplacePatternRule rule =
        new ReplacePatternRule(ReplaceSelectionType.CONTAINS).setSelectionPattern("amazing");
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '.*?\\Qamazing\\E.*?') THEN "
            + // selection replace
    ...
    List<Object> outputCompleteReplace =
        list(
            (Object) "AMAZING",
            "This is a worst restaurant. bad food.",
            "Amazing environment. \nAmazing food.",
    ...
    validate(
        ...
        ruleWrapper,
        new Object[] {ReplaceType.SELECTION, "AMAZING"},
        outputSelReplace,
    ...
    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.VALUE, "AMAZING"},
        outputCompleteReplace,
        asList(true, false, false, false),
        asList(asList(new CardExamplePosition(11, 7)), null, null, null));
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '(?i)(?u).*?\\Qamazing\\E.*?') THEN "
            + // selection replace
    ...
    outputCompleteReplace =
        list((Object) "AMAZING", "This is a worst restaurant. bad food.", "AMAZING", "Not good.");
    ...
    validate(
        ...
        asList(
            asList(new CardExamplePosition(11, 7)),
            null,
  ...
  public void endsWith() throws Exception {
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '.*?\\Qfood\\E$') THEN "
            + // selection replace
    ...
    List<Object> outputCompleteReplace =
        list((Object) "dinner", "dinner", "Amazing environment. Amazing Food", "Not good");

    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.SELECTION, "dinner"},
        outputSelReplace,
        asList(true, true, false, false),
        asList(
            asList(new CardExamplePosition(30, 4)),
            asList(new CardExamplePosition(32, 4)),
            null,
            null));
    ...
    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.VALUE, "dinner"},
        outputCompleteReplace,
        asList(true, true, false, false),
        asList(
            asList(new CardExamplePosition(30, 4)),
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '(?i)(?u).*?\\Qfood\\E$') THEN "
            + // selection replace
    ...
    outputCompleteReplace = list((Object) "dinner", "dinner", "dinner", "Not good");
    ...
    validate(
        ...
        asList(
            asList(new CardExamplePosition(30, 4)),
            asList(new CardExamplePosition(32, 4)),
            asList(new CardExamplePosition(29, 4)),
            null));
  ...
  public void exact() throws Exception {
    ...
    validateExpressions(
        ...
        "CASE WHEN \"input.expr\" = 'Los Angeles' THEN NULL ELSE \"input.expr\" END", // null
        // replace
        "CASE WHEN \"input.expr\" = 'Los Angeles' THEN "
            + // selection replace
    ...
    List<Object> outputSelReplace =
        list((Object) "LOS ANGELES", "LOS ANGELES", "LOS ANGELES, CA", null);
    ...
    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.SELECTION, "LOS ANGELES"},
        outputSelReplace,
        asList(true, false, false, false),
    ...
    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.VALUE, "LOS ANGELES"},
        outputCompleteReplace,
        asList(true, false, false, false),
        asList(asList(new CardExamplePosition(0, 11)), null, null, null));
    ...
    validateExpressions(
        ...
        "CASE WHEN lower(\"input.expr\") = lower('Los Angeles') THEN "
            + // selection replace
            "'new''''value' ELSE \"input.expr\" END",
    ...
    outputSelReplace = list((Object) "LosAngeles", "LosAngeles", "LOS ANGELES, CA", null);

    outputCompleteReplace = list((Object) "LosAngeles", "LosAngeles", "LOS ANGELES, CA", null);

    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.SELECTION, "LosAngeles"},
        outputSelReplace,
        asList(true, true, false, false),
        asList(
            asList(new CardExamplePosition(0, 11)),
            asList(new CardExamplePosition(0, 11)),
            null,
            null));
    ...
    validate(
        dataFile.getAbsolutePath(),
        ruleWrapper,
        new Object[] {ReplaceType.VALUE, "LosAngeles"},
        outputCompleteReplace,
        asList(true, true, false, false),
        asList(
            asList(new CardExamplePosition(0, 11)),
  ...
  public void matches() throws Exception {
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '.*?Los.*Angeles.*?') THEN "
            + // selection replace
    ...
    List<Object> outputSelReplace =
        list((Object) "LOS ANGELES", "LOS Angeles", "LOSANGELES", "LOS ANGELES, CA");

    List<Object> outputCompleteReplace =
        list((Object) "LOS ANGELES", "LOS Angeles", "LOSANGELES", "LOS ANGELES");
    ...
    validate(
        ...
        asList(
            ...
            null,
            null,
            asList(new CardExamplePosition(0, 10))));
    ...
    validateExpressions(
        ...
        "CASE WHEN regexp_like(\"input.expr\", '(?i)(?u).*?Los.*Angeles.*?') THEN "
            + // selection replace
    ...
    outputSelReplace =
        list((Object) "LOS ANGELES", "LOS ANGELES", "LOS ANGELES", "LOS ANGELES, CA");

    outputCompleteReplace =
        list((Object) "LOS ANGELES", "LOS ANGELES", "LOS ANGELES", "LOS ANGELES");
  ...
  public void isNull() throws Exception {
    ...
    ReplacePatternRule rule =
        new ReplacePatternRule().setSelectionType(ReplaceSelectionType.IS_NULL);

    TransformRuleWrapper<ReplacePatternRule> ruleWrapper = recommender.wrapRule(rule);

    assertEquals(
        "CASE WHEN \"input.expr\" IS NULL THEN 'new''''value' ELSE \"input.expr\" END",
    ...
    assertEquals(
        "\"user\".\"col.with.dots\" IS NULL",
        ruleWrapper.getMatchFunctionExpr("\"user\".\"col.with.dots\""));

    List<Object> output = list((Object) "Los Angeles", "Los Angeles");
   ...
   *
   * @param ruleWrapper
   * @param exampleExpr Example generation expression when the given input expression is:
   *     <i>"table.with.dots".col</i>
   * @param nullReplaceExpr expression for replacing the selected expression with null when the
   *     input expression is: <i>"input.expr"</i>
   * @param selReplaceExpr expression for replacing selected value with <i>new''value</i> when the
   *     input expression is: <i>"input.expr"</i>
   * @param valueReplaceExpr expression for replacing the whole cell value with <i>new value</i>
   *     when the input expression is: <i>"input.expr"</i>
   * @param matchExpr matching expression for given table <i>user</i> and column
   *     <i>col.with.dots</i>
   */
  private void validateExpressions(
      TransformRuleWrapper<ReplacePatternRule> ruleWrapper,
      String exampleExpr,
      String nullReplaceExpr,
      String selReplaceExpr,
      String valueReplaceExpr,
      String matchExpr) {
