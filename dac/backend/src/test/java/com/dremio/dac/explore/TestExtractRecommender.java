...
public class TestExtractRecommender extends RecommenderTestBase {
  ...
  public void ruleSuggestionsSelNumberInTheBeginning() {
    Selection selection =
        new Selection("col", "883 N Shoreline Blvd., Mountain View, CA 94043", 0, 3);
  ...
  public void ruleSuggestionsSelNumberAtTheEnd() {
    Selection selection =
        new Selection("col", "883 N Shoreline Blvd., Mountain View, CA 94043", 41, 5);
    List<ExtractRule> rules = recommender.getRules(selection, TEXT);
  ...
  public void ruleSuggestionsSelStateAtTheEnd() {
    Selection selection =
        new Selection("col", "883 N Shoreline Blvd., Mountain View, CA 94043", 38, 2);
    List<ExtractRule> rules = recommender.getRules(selection, TEXT);
  ...
  private void comparePos(
      int start, boolean sFromBegin, int end, boolean eFromBegin, ExtractRulePosition rule) {
  ...
  private void comparePattern(
      String pattern, int index, IndexType indexType, ExtractRulePattern rule) {
  ...
  public void testRecommendCharacterGroup() {
    List<ExtractRule> cards =
        recommender.recommendCharacterGroup(new Selection("col", "abc def,ghi", 4, 3));
  ...
  public void testExtractPatternExprs() throws Exception {
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '\\d+12', 0, 'INDEX') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '\\d+12', 0, 'INDEX')", wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '\\d+12', 0, 'INDEX')",
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '\\d+', 0, 'INDEX_BACKWARDS') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '\\d+', 0, 'INDEX_BACKWARDS')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '\\d+', 0, 'INDEX_BACKWARDS')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) null, null, "3", null, null),
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '\\w+', 1, 'INDEX') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '\\w+', 1, 'INDEX')", wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '\\w+', 1, 'INDEX')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "bbb", "dfa", null, null, null),
          list(true, true, false, false, false),
          asList(
              asList(new CardExamplePosition(4, 3)),
              asList(new CardExamplePosition(4, 3)),
              null,
              null,
              null));
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 1, 'CAPTURE_GROUP') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 1, 'CAPTURE_GROUP')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 1, 'CAPTURE_GROUP')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "bbb", null, null, null, null),
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 2, 'CAPTURE_GROUP') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 2, 'CAPTURE_GROUP')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '(\\w+)\\.(\\w+)\\.(\\w+)\\..*', 2, 'CAPTURE_GROUP')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "ccc", null, null, null, null),
          list(true, false, false, false, false),
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\..*', 0, 'CAPTURE_GROUP') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '(\\w+)\\.(\\w+)\\..*', 0, 'CAPTURE_GROUP')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '(\\w+)\\.(\\w+)\\..*', 0, 'CAPTURE_GROUP')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "aaa", "ABC", null, null, null),
          list(true, true, false, false, false),
          asList(
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '.*(\\d+).*', 0, 'CAPTURE_GROUP') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '.*(\\d+).*', 0, 'CAPTURE_GROUP')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '.*(\\d+).*', 0, 'CAPTURE_GROUP')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '(?i)(?u)[a-z]{3}', 0, 'INDEX') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '(?i)(?u)[a-z]{3}', 0, 'INDEX')",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '(?i)(?u)[a-z]{3}', 0, 'INDEX')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "aaa", "ABC", "def", "tyu", null),
    ...
    }
    {
      ...
      assertEquals(
          "extract_pattern(tbl.foo, '[a-z]{3}', 0, 'INDEX') IS NOT NULL",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern(tbl.foo, '[a-z]{3}', 0, 'INDEX')", wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_pattern_example(tbl.foo, '[a-z]{3}', 0, 'INDEX')",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "aaa", "dfa", "def", "tyu", null),
          list(true, true, true, true, false),
          asList(
              asList(new CardExamplePosition(0, 3)),
              asList(new CardExamplePosition(4, 3)),
  ...
  public void testExtractPositionExprs() throws Exception {
    ...
    }
    {
      ...
      assertEquals(
          "CASE WHEN length(substr(tbl.foo, 2, 4)) > 0 THEN substr(tbl.foo, 2, 4) ELSE NULL END",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_position_example(tbl.foo, 2, 4)", wrapper.getExampleFunctionExpr("tbl.foo"));
      assertEquals("Elements: 1 - 4", wrapper.describe());
      validate(
          file.getAbsolutePath(),
          wrapper,
          new Object[0],
          list((Object) "abbb", "dde", "ffff", null),
          list(true, true, true, false),
          asList(
              asList(new CardExamplePosition(1, 4)),
              asList(new CardExamplePosition(1, 3)),
              asList(new CardExamplePosition(1, 4)),
              null));
    }
    {
      ...
      assertEquals(
          "CASE WHEN length(substr(tbl.foo, -5, 3)) > 0 THEN substr(tbl.foo, -5, 3) ELSE NULL END",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_position_example(tbl.foo, -5, 3)", wrapper.getExampleFunctionExpr("tbl.foo"));
      assertEquals("Elements: 4 - 2 (both from the end)", wrapper.describe());
      validate(
          file.getAbsolutePath(),
          wrapper,
          new Object[0],
          list((Object) "bcc", null, "fff", null),
    ...
    }
    {
      ...
      assertEquals(
          "length(substr(tbl.foo, 2, length(tbl.foo) - 2)) > 0",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "CASE WHEN length(substr(tbl.foo, 2, length(tbl.foo) - 2)) > 0 THEN substr(tbl.foo, 2, length(tbl.foo) - 2) ELSE NULL END",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_position_example(tbl.foo, 2, length(tbl.foo) - 2)",
          wrapper.getExampleFunctionExpr("tbl.foo"));
      ...
      validate(
          ...
          wrapper,
          new Object[0],
          list((Object) "abbbccc", "dd", "fff", null),
          list(true, true, true, false),
          asList(
              asList(new CardExamplePosition(1, 7)),
              asList(new CardExamplePosition(1, 2)),
              asList(new CardExamplePosition(1, 3)),
              null));
    }
    {
      ...
      assertEquals(
          "length(substr(tbl.foo, -5, -length(tbl.foo) + 10)) > 0",
          wrapper.getMatchFunctionExpr("tbl.foo"));
      assertEquals(
          "CASE WHEN length(substr(tbl.foo, -5, -length(tbl.foo) + 10)) > 0 THEN substr(tbl.foo, -5, -length(tbl.foo) + 10) ELSE NULL END",
          wrapper.getFunctionExpr("tbl.foo"));
      assertEquals(
          "extract_position_example(tbl.foo, -5, -length(tbl.foo) + 10)",
          wrapper.getExampleFunctionExpr("tbl.foo"));
