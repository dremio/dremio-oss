...
public class ITTestReflectionSuggester extends ITBaseTestReflection {
  ...
  public static void testSetup() {
    ...
    JobsServiceTestUtils.submitJobAndWaitUntilCompletion(
      l(JobsService.class), createNewJobRequestFromSql(createTagQuery("dev", DEFAULT_BRANCH_NAME)), JobStatusListener.NO_OP);
  }
  ...
  public void testSnapshotSuggestions() {
    ...
    String snapshotId = String.valueOf(config.getPhysicalDataset().getIcebergMetadata().getSnapshotId());
