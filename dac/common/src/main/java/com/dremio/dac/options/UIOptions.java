...
public final class UIOptions {
  public static final BooleanValidator ALLOW_LOWER_PROVISIONING_SETTINGS =
      new BooleanValidator("ui.allow.lower.provisioning_settings", false);
  ...
  public static final StringValidator WHITE_LABEL_URL =
      new StringValidator("ui.whitelabel.url", "dremio");

  public static final BooleanValidator ALLOW_FORMATTING =
      new BooleanValidator("ui.formatter.allow", true);

  /*
   * Specifies weather non admin users are able to perform CRUD operations for spaces
   */
  public static final BooleanValidator ALLOW_SPACE_MANAGEMENT =
      new BooleanValidator("ui.space.allow-manage", false);

  public static final BooleanValidator ALLOW_HIVE_SOURCE =
      new BooleanValidator("ui.hive.allow", true);

  /*
   * Specifies whether new jobs UI should be shown
   */
  public static final BooleanValidator JOBS_UI_CHECK =
      new BooleanValidator("dremio.jobs.new.ui", true);

  /*
   * False (Default) - Shows new reflections UI
   * True - Shows old reflections UI
   */
  public static final BooleanValidator REFLECTIONSLISTING_UI_CHECK =
      new BooleanValidator("ui.reflectionslisting.disable", false);

  /** Specifies the Content Security Policy (CSP) header used by the Dremio UI. */
  public static final StringValidator CSP_HEADER_VALUE =
      new StringValidator(
          "ui.csp.value",
   ...
   */
  public static final BooleanValidator JOBS_PROFILE_UI_CHECK =
      new BooleanValidator("dremio.query.visualiser.enabled", false);
   ...
   */
  public static final BooleanValidator ASYNC_DOWNLOAD_CHECK =
      new BooleanValidator("dremio.async.download.enable", true);

  /*
   * Specifies whether the UI will enable nextgen search modal and page UI
   */
  public static final BooleanValidator NEXTGEN_SEARCH_UI =
      new BooleanValidator("nextgen_search.ui.enable", false);
