...
/**
 * Hive 2.x storage plugin configuration for hive-universal mode: here Hive2 source type works in compatibility mode,
 * without the use of Hive2 libraries, making use of Hive3 plugin instead
 */
@SourceType(value = SourceConfigAwareConnectionConfDeserializer.HIVE2_SOURCE_TYPE, label = "Hive 2.x", uiConfig = "hive2-layout.json")
