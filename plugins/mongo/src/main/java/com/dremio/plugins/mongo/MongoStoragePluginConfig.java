...
public class MongoStoragePluginConfig extends StoragePluginConfig {
  ...
  /** Connection options not supported directly by mongo but supported by Dremio */
  public static final class ExtraConnectionOptions {
     ...
     *
     * <p>This is not something recommended as it exposes user to man-in-the-middle attacks
     */
  ...
  @JsonCreator
  public MongoStoragePluginConfig(
      @JsonProperty("authenticationTimeoutMillis") int authTimeoutMillis, // default 2s
