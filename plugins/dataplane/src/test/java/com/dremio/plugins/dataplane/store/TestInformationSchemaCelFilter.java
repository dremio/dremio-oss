...
public class TestInformationSchemaCelFilter {
  ...
  private static final String DATAPLANE_PLUGIN_NAME_PATTERN_MATCHES_EXACTLY_WITH_UNDERSCORE = "test\\_dataplane";
  ...
  private static final String FULL_PATH_PATTERN_MATCHES_EXACTLY_WITH_UNDERSCORE = "test\\_dataplane.folder1.folder2";
  ...
  private static final String QUOTED_PATH_ESCAPED = "\"this\\.is\\.a\\.single\\.folder\"\\.subfolder\\.table";
  ...
  public static void setup() {
    ...
    PATTERN_TO_MATCHER.put(FULL_PATH_PATTERN_MATCHES_EXACTLY_WITH_UNDERSCORE, "test_dataplane\\.folder1\\.folder2");
    PATTERN_TO_MATCHER.put(DATAPLANE_PLUGIN_NAME_PATTERN_MATCHES_EXACTLY_WITH_UNDERSCORE, "test_dataplane");
  ...
  public void testBasicEqualSearchQueryToCel(String equalValue) {
    Equals equals = Equals.newBuilder()
      ...
      .setStringValue(equalValue)
      .build();
    SearchQuery searchQuery = SearchQuery.newBuilder()
      .setEquals(equals)
      .build();
    assertThat(getInformationSchemaFilter(searchQuery, false, DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN))
  ...
  public void testBasicLikeSearchQueryToCel(String pattern) {
    ...
    SearchQuery searchQuery = SearchQuery.newBuilder()
      ...
      .build();
    assertThat(getInformationSchemaFilter(searchQuery, false, DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN))
      .isEqualTo(String.format("entry.name.matches(r'^.*%s.*$')", PATTERN_TO_MATCHER.get(pattern)));
  }
  ...
  public void testTableauGetExactTableName(String tableNamePattern, String fullPathPattern, String sourceName) {
  ...
  public void testTableauStartWith(String tableNamePattern, String fullPathPattern, String sourceName) {
    Like tableNameLike = Like.newBuilder()
      .setField(SEARCH_NAME)
  ...
  public void testTableauContains(String tableNamePattern, String fullPathPattern, String sourceName) {
    Like tableNameLike = Like.newBuilder()
      .setField(SEARCH_NAME)
      .setPattern(String.format("%%%s%%", tableNamePattern))
      .setEscape("\\")
  ...
  public void testComplexQuery(String tableNamePattern, String fullPathPattern, String sourceName) {
    ...
    Equals tablePathEqual = Equals.newBuilder()
      .setField(SEARCH_SCHEMA)
      .setStringValue(fullPathPattern)
      .build();
  ...
  public void testInvalidQuery() {
    ...
    SearchQuery searchQuery = SearchQuery.newBuilder()
      .setEquals(equals)
      .build();
    Assertions.assertThrows(IllegalStateException.class, () -> getInformationSchemaFilter(searchQuery, false, DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN));
  }

  @Test
  public void testNullQuery() {
    assertThat(getInformationSchemaFilter(null, false, DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN))
      .isEqualTo(null);
  }
  ...
  public void testDotsInQuotes() {
    ...
    Like like = Like.newBuilder()
      .setField(SEARCH_SCHEMA)
      .setPattern(String.format("%s.%s", DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN, tableWithDotsInQuotes))
      .build();
    SearchQuery searchQuery = SearchQuery.newBuilder()
      .setLike(like)
      .build();
    assertThat(getInformationSchemaFilter(searchQuery, true, DATAPLANE_PLUGIN_NAME_HAS_UNDERSCORE_PATTERN))
      .isEqualTo(String.format(
