...
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinConditionWithFullyQualifiedTableName;
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinConditionWithTableName;
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinTablesQueryWithAtBranchSyntax;
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinTablesQueryWithAtBranchSyntaxAndExpression;
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinTablesQueryWithAtBranchSyntaxLeftSide;
import static com.dremio.exec.catalog.dataplane.test.DataplaneTestDefines.joinTablesQueryWithAtBranchSyntaxRightSide;
...
public class ITDataplanePluginJoin extends ITDataplanePluginTestSetup {
  ...
  public void testJoinWithFullyQualifiedTableNamesInOnCondition() throws Exception {
    ...
    List<List<String>> joinResults =
        runSqlWithResults(
            joinTablesQueryWithAtBranchSyntax(
                table1, DEFAULT_BRANCH_NAME, table2, temporaryBranchName, condition));
    ...
    expectedResults.add(
        Arrays.asList("2", "second row", "2000.000", "2", "second row", "2000.000"));
  ...
  public void testJoinReferenceWithATSyntaxAtRightSide() throws Exception {
    ...
    List<List<String>> joinResults =
        runSqlWithResults(
            joinTablesQueryWithAtBranchSyntaxRightSide(
                table1, table2, temporaryBranchName, condition));
  ...
  public void testJoinReferenceWithATSyntaxAtLeftSide() throws Exception {
    ...
    List<List<String>> joinResults =
        runSqlWithResults(
            joinTablesQueryWithAtBranchSyntaxLeftSide(
                table2, temporaryBranchName, table1, condition));
  ...
  public void testJoinReferencedWithATAndExpression() throws Exception {
    ...
    List<List<String>> joinResults =
        runSqlWithResults(
            joinTablesQueryWithAtBranchSyntaxAndExpression(
                table2, temporaryBranchName, table1, exprTableName, condition));
