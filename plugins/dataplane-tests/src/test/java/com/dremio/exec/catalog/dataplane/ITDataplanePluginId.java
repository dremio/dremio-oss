...
public class ITDataplanePluginId extends ITDataplanePluginTestSetup {
  ...
  public void checkUniqueIdAfterAlters() throws Exception {
    ...
    final List<String> tablePath = tablePathWithFolders(tableName);
    runSQL(createEmptyTableQuery(tablePath));
    String uniqueIdBeforeAlter =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    final List<String> addedColDef = Collections.singletonList("col2 int");
    // Add single column
    runSQL(alterTableAddColumnsQuery(tablePath, addedColDef));
    String uniqueIdAfterAlter =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
  ...
  public void checkContentIdAfterInsert() throws Exception {
    ...
    String contentIdBeforeInsert =
        getContentId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Act
    runSQL(insertTableQuery(tablePath));
    String contentIdAfterInsert =
        getContentId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Assert
  ...
  public void checkUniqueIdAfterInsert() throws Exception {
    ...
    assertNessieHasTable(tablePath, DEFAULT_BRANCH_NAME, this);
    assertNessieHasCommitForTable(tablePath, Operation.Put.class, DEFAULT_BRANCH_NAME, this);
    String uniqueIdBeforeInsert =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Act
    runSQL(insertTableQuery(tablePath));
    String uniqueIdAfterInsert =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Assert
  ...
  public void checkContentIdInNewBranch() throws Exception {
    ...
    String contentIdInMainBranch =
        getContentId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    // Act
    runSQL(useBranchQuery(newBranchName));
    String contentIdInNewBranch =
        getContentId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, newBranchName), this);
  ...
  public void checkUniqueIdAfterDMLInBranch() throws Exception {
    ...
    runSQL(insertTableQuery(tablePath));
    String uniqueIdBeforeBranching =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    // Act
    runSQL(useBranchQuery(newBranchName));
    String uniqueIdAfterBranching =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, newBranchName), this);
  ...
  public void checkDatasetIdInNewBranch() throws Exception {
    ...
    runSQL(insertTableQuery(tablePath));
    runSQL(createBranchAtBranchQuery(newBranchName, DEFAULT_BRANCH_NAME));
    String datasetIdInMainBranch =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    // Act
    runSQL(useBranchQuery(newBranchName));
    String datasetIdInNewBranch =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, newBranchName), this);
  ...
  public void checkDatasetIdAfterDMLInBranch() throws Exception {
    ...
    // insert in main branch
    runSQL(insertTableQuery(tablePath));
    String datasetIdBeforeBranching =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    // Act
    runSQL(useBranchQuery(newBranchName));
    String datasetIdIdAfterBranching =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, newBranchName), this);
  ...
  public void getTableWithIdSnapshot() throws Exception {
    ...
    String getSnapshotString =
        String.format(
            "SELECT snapshot_id FROM table(table_snapshot('%s.%s'))",
            DATAPLANE_PLUGIN_NAME, String.join(".", tablePath));
    List<String> results = runSqlWithResults(getSnapshotString).get(0);

    String datasetIdFromSnapshot =
        getVersionedDatatsetIdForTimeTravel(
            tablePath, new TableVersionContext(TableVersionType.SNAPSHOT_ID, results.get(0)), this);
  ...
  public void getTableWithIdTimestamp() throws Exception {
    ...
    String datasetIdWithTS =
        getVersionedDatatsetIdForTimeTravel(
            tablePath, new TableVersionContext(TableVersionType.TIMESTAMP, ts1), this);
  ...
  public void getTableWithIdAfterReCreate() throws Exception {
    ...
    final List<String> tablePath = tablePathWithFolders(tableName);
    runSQL(createEmptyTableQuery(tablePath));
    String datasetIdAfterFirstCreate =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    runSQL(dropTableQuery(tablePath));
    runSQL(createTableAsQuery(tablePath, 5));
    String datasetIdAfterRecreate =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    ...
    assertThat(dremioTableAfterRecreate.getSchema().toJSONString().contains("n_nationkey"))
        .isTrue();
  ...
  public void getTableWithInvalidId() throws Exception {
    ...
    String invalidDatasetId =
        StringUtils.replace(datasetIdAfterCreate, "contentId", "invalidContentIdToken");
  ...
  public void getTableWithIdFromNewBranch() throws Exception {
    ...
    String datasetIdFromMain =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);

    // Act
    runSQL(useBranchQuery(newBranchName));
    String datasetIdIdFromBranch =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, newBranchName), this);
    ...
    VersionedDatasetId versionedDatasetIdFromMain =
        VersionedDatasetId.fromString(tableFromMain.getDatasetConfig().getId().getId());
    VersionedDatasetId versionedDatasetIdFromBranch =
        VersionedDatasetId.fromString(tableFromBranch.getDatasetConfig().getId().getId());
    ...
    String uniqueIdFromMain =
        tableFromMain.getDatasetConfig().getPhysicalDataset().getIcebergMetadata().getTableUuid();
    String uniqueIdFromBranch =
        tableFromBranch.getDatasetConfig().getPhysicalDataset().getIcebergMetadata().getTableUuid();
  ...
  public void getTableWithIdFromTag() throws Exception {
    ...
    String versionAtTag =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.TAG, firstTag), this);
    String versionAtBranchTip =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    ...
    String uniqueIdAtTag =
        tableAtTag.getDatasetConfig().getPhysicalDataset().getIcebergMetadata().getTableUuid();
    String uniqueIdAtBranchTip =
        tableAtBranchTip
            .getDatasetConfig()
            .getPhysicalDataset()
            .getIcebergMetadata()
  ...
  public void getTableWithIdFromInvalidTag() throws Exception {
    ...
    String versionAtTag =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.TAG, invalidTag), this);
  ...
  public void getTableWithIdFromCommit() throws Exception {
    ...
    String versionAtCommitHash =
        getVersionedDatatsetId(
            tablePath,
            new TableVersionContext(TableVersionType.COMMIT, commitHashBeforeInsert),
            this);
    String versionAtBranchTip =
        getVersionedDatatsetId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
  ...
  public void checkContentIdWithAt() throws Exception {
    ...
    String contentIdWithSelectAtTag =
        getContentIdForTableAtRef(
            tablePath, new TableVersionContext(TableVersionType.TAG, tag1), this);
    String contentIdWithSelectAtMain =
        getContentId(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Assert
  ...
  public void checkUniqueIdWithAt() throws Exception {
    ...
    String uniqueIdWithSelectAtTag =
        getUniqueIdForTableAtRef(
            tablePath, new TableVersionContext(TableVersionType.TAG, tag1), this);
    String uniqueIdWithSelectAtMain =
        getUniqueIdForTable(
            tablePath, new TableVersionContext(TableVersionType.BRANCH, DEFAULT_BRANCH_NAME), this);
    // Assert
