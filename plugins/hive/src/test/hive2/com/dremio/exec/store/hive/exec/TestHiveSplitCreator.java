...
public class TestHiveSplitCreator {
  ...
  private static final HiveSplitCreator splitCreator = new HiveSplitCreator();
  ...
  private static SplitAndPartitionInfo buildSplit(String fileFormat) {
    ...
    SplitIdentity splitIdentity = new SplitIdentity("/path/to/data-1", null,  splitOffset, splitSize);
