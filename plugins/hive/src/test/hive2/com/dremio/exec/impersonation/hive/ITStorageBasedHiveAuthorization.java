...
public class ITStorageBasedHiveAuthorization extends BaseTestHiveImpersonation {
   ...
   */
  @Test
  @Ignore("DX-7652 - Namespace doesn't validate against ACLs in Hive metastore")
  ...
  @Test
  @Ignore("Namespace doesn't validate against ACLs in Hive metastore")
  ...
  public void selectUser0_db_u1g1_only() throws Exception {
    ...
    errorMsgTestHelper(
        ...
        String.format(
            "PERMISSION ERROR: Access denied reading dataset hive.%s.%s",
            db_u1g1_only, u1g1_student_all_755));
  }
