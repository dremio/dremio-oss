...
public class HiveStoragePlugin2 implements StoragePlugin2 {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(HiveStoragePlugin2.class);
