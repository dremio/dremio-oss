...
public class HiveSchemaTypeOptions {
  ...
  public HiveSchemaTypeOptions(
      boolean parquetComplexTypesEnabled,
      boolean mapTypeEnabled,
      boolean nativeComplexTypesEnabled) {
  ...
  public HiveSchemaTypeOptions(final OptionManager optionManager) {
    this(
        optionManager.getOption(ExecConstants.HIVE_COMPLEXTYPES_ENABLED),
