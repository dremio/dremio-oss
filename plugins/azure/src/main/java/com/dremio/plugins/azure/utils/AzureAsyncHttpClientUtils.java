...
public final class AzureAsyncHttpClientUtils {
  public static final String XMS_VERSION =
      "2019-07-07"; // represents version compatibility of the client.
  ...
  public static String getBaseEndpointURL(
      final String azureEndpoint, final String accountName, final boolean isSecure) {
  ...
  public static String toHttpDateFormat(final long timeInMillis) {
    final OffsetDateTime time =
        OffsetDateTime.ofInstant(Instant.ofEpochMilli(timeInMillis), ZoneId.systemDefault());
