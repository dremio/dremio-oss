...
//  }
  ...
  public static RuntimeException propagateFSRuntimeException(FSError e) throws RuntimeException {
    Throwables.propagateIfPossible(e.getCause(), RuntimeException.class);
