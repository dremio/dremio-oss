...
public interface Hive3PluginOptions {
   ...
   */
  BooleanValidator HIVE_ORC_READER_VECTORIZE = new BooleanValidator("store.hive3.orc.vectorize", true);
   ...
   */
  String HIVE_OPTIMIZE_SCAN_WITH_NATIVE_READERS = "store.hive3.optimize_scan_with_native_readers";
   ...
   */
  TypeValidators.LongValidator RESERVE = new TypeValidators.PositiveLongValidator("planner.op.scan.hive3.reserve_bytes", Long.MAX_VALUE, Prel.DEFAULT_RESERVE);
  TypeValidators.LongValidator LIMIT = new TypeValidators.PositiveLongValidator("planner.op.scan.hive3.limit_bytes", Long.MAX_VALUE, Prel.DEFAULT_LIMIT);
}
