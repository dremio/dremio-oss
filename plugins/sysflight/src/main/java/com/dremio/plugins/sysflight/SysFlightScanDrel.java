...
public class SysFlightScanDrel extends ScanRelBase implements Rel {
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new SysFlightScanDrel(getCluster(), traitSet, table, pluginId, tableMetadata, getProjectedColumns(), observedRowcountAdjustment);
  }

  @Override
  public ScanRelBase cloneWithProject(List<SchemaPath> projection) {
    return new SysFlightScanDrel(getCluster(), traitSet, table, pluginId, tableMetadata, projection, observedRowcountAdjustment);
  }
