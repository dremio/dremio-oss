...
<#elseif entry.type == "TimeStampMilli">
    ...
    <#else>
      ...
      return org.apache.hadoop.hive.common.type.Timestamp.ofEpochMilli(h.value);
    }
    ...
    <#else>
      ...
      return new TimestampWritableV2(org.apache.hadoop.hive.common.type.Timestamp.ofEpochMilli(h.value));
    }
...
<#elseif entry.type == "Date">
    ...
    <#else>
      ...
      return new DateWritableV2(org.apache.hadoop.hive.common.type.Date.ofEpochMilli(h.value));
    }
