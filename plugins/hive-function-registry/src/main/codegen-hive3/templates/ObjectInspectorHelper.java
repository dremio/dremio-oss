...
<#list typesOI.map as entry>
          ...
          <#elseif entry.hiveType == "TIMESTAMP">
            JVar tsVar = jc._else().decl(m.directClass(org.apache.hadoop.hive.common.type.Timestamp.class.getCanonicalName()), "ts",
              castedOI.invoke("getPrimitiveJavaObject").arg(returnValue));
            jc._else().assign(returnValueHolder.ref("value"), tsVar.invoke("toEpochMilli"));
          <#elseif entry.hiveType == "DATE">
            JVar dVar = jc._else().decl(m.directClass(org.apache.hadoop.hive.common.type.Date.class.getCanonicalName()), "d",
              castedOI.invoke("getPrimitiveJavaObject").arg(returnValue));
