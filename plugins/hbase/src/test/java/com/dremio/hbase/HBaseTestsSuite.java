...
import com.dremio.hbase.test.Drill2130StorageHBaseHamcrestConfigurationTest;
...
public class HBaseTestsSuite {
   ...
   */
  private static boolean manageHBaseCluster = System.getProperty("dremio.hbase.tests.manageHBaseCluster", "true").equalsIgnoreCase("true");
  private static boolean hbaseClusterCreated = false;

  private static boolean createTables = System.getProperty("dremio.hbase.tests.createTables", "true").equalsIgnoreCase("true");
  ...
  private static void createTestTables() throws Exception {
    ...
    /*
     * We are seeing some issues with (Dremio) Filter operator if a group scan span
