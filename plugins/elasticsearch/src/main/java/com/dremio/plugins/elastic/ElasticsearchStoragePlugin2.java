 ...
 *
 */
public class ElasticsearchStoragePlugin2 implements StoragePlugin2 {

  private static final Logger logger = LoggerFactory.getLogger(ElasticsearchStoragePlugin2.class);
