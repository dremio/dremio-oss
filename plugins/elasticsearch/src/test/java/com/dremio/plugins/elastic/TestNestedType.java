 ...
 */
public class TestNestedType extends ElasticBaseTestQuery {

  private static final Logger logger = LoggerFactory.getLogger(TestNestedType.class);
  ...
  public void testNestedType_SelectNamedSecondLevel() throws Exception {
    ...
    // The test above that runs a select *, rather than referencing the fields individually returns the correct schema
