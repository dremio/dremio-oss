...
public class TestExternal extends BaseTestQuery {
  ...
  @Rule public final TestRule timeoutRule = TestTools.getTimeoutRule(50000, TimeUnit.SECONDS);
  ...
  public void query() throws Exception {
    ...
    System.out.println(
        getResultString(
            testRunAndReturn(QueryType.SQL, "select * from elasticsearch.twitter.tweet"), ""));
  }
  ...
  public void query04() throws Exception {
    test(
        "explain plan for select count(*), sum(stars), avg(review_count) from elasticsearch.academic.business");
  ...
  public void query06() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for select count(*), min(review_count) from elasticsearch.academic.business where stars > 4 and "
            + "review_count > 100");
    test(
        "select count(*), min(review_count) from elasticsearch.academic.business where stars > 4 and "
            + "review_count > 100");
  }
  ...
  public void query07() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for select state, city, count(*) from elasticsearch.academic.business where review_count > 100 "
            + "group by state,city");
    test(
        "select state, city, count(*) from elasticsearch.academic.business where review_count > 100 group by state,city");
  }
  ...
  public void query08() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for SELECT * FROM elasticsearch.academic.business where review_count > 1000");
  ...
  public void query09() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for SELECT count(*), max(review_count) FROM elasticsearch.academic.business where review_count > "
            + "1000");
    test(
        "SELECT count(*), max(review_count) FROM elasticsearch.academic.business where review_count > 1000");
  }
  ...
  public void query10() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for SELECT state, count(*), max(review_count) FROM elasticsearch.academic.business where "
            + "review_count > 1000 group by state");
    test(
        "SELECT state, count(*), max(review_count) FROM elasticsearch.academic.business where "
            + "review_count > 1000 group by state");
  }
  ...
  public void query11() throws Exception {
    // test("alter session set \"planner.disable_exchanges\"=true");
    test(
        "explain plan for select yelping_since, count(*), avg(average_stars) from elasticsearch.academic.\"user\" where "
            + "review_count > 100 group by yelping_since");
    test(
        "select yelping_since, count(*), avg(average_stars) from elasticsearch.academic.\"user\" where "
            + "review_count > 100 group by yelping_since");
  }
  ...
  public void query12() throws Exception {
    test(
        "explain plan for select distinct t.votes.funny from elasticsearch.academic.review t limit 10");
  ...
  public void query13() throws Exception {
    test(
        "explain plan for select state as TYPEASTHIS, name from elasticsearch.academic.business limit 10000");
  ...
  public void query14() throws Exception {
    test(
        "explain plan for select state as TYPEASTHIS, name from elasticsearch.academic.business group by state, name");
    test(
        "select state as TYPEASTHIS, name from elasticsearch.academic.business group by state, name");
  }

  @Test
  public void query15() throws Exception {
    test(
        "explain plan for select count(distinct state), count(distinct city) from elasticsearch.academic.business");
  ...
  public void query22() throws Exception {
    test(
        "explain plan for select yelping_since, count(*), avg(average_stars) from elasticsearch.academic.\"user\" group by "
            + "yelping_since");
    test(
        "select yelping_since, count(*), avg(average_stars) from elasticsearch.academic.\"user\" group by "
            + "yelping_since");
  }
  ...
  public void query23() throws Exception {
    String query =
        "select count(stars), sum(review_count), count(*) from elasticsearch.academic.business where stars >=4";
  ...
  public void query24() throws Exception {
    String query =
        "SELECT * FROM (SELECT \"Custom_SQL_Query\".\"business_id\" AS \"business_id\" FROM \n"
  ...
  public void query25() throws Exception {
    test(
        "explain plan for select * from elasticsearch.academic.business b join elasticsearch.academic.review r on b._id = r._id limit 2");
    // test("select * from elasticsearch.academic.business b join elasticsearch.academic.review r on
    // b._id = r._id limit 2");
  }
  ...
  public void query26() throws Exception {
    ...
    test(
        "explain plan for select b.name, avg(r.votes.funny) as avg_funny, avg(r.votes.useful) as avg_useful, avg(r"
    ...
    // test("select b.name, avg(r.votes.funny) as avg_funny, avg(r.votes.useful) as avg_useful,
    // avg(r.votes.cool) " +
    //        "as avg_cool from elasticsearch.academic.business b join elasticsearch.academic.review
    // r on b._id = r.business_id group by b.name;");
  }
  ...
  public void query28() throws Exception {
    test(
        "explain plan for select t.categories[0] from elasticsearch.academic.business t limit 100");
  ...
  public void query29() throws Exception {
    test(
        "select * from elasticsearch.academic.business b join elasticsearch.academic.business r on b.business_id= r"
            + ".business_id limit 2");
    test(
        "select * from elasticsearch.academic.business b join elasticsearch.academic.business r on b._id= r._id limit 2");
  }

  @Test
  public void query30() throws Exception {
    test(
        "explain plan for select avg(stars) avg_stars, state from (select city,review_count,state,stars,business_id, name,flatten(categories) "
            + " from elasticsearch.academic.business order by stars desc limit 5000) where state <> 'WI' group by state");
    test(
        "select avg(stars) avg_stars, state from (select city,review_count,state,stars,business_id, name,flatten(categories) "
            + " from elasticsearch.academic.business order by stars desc limit 5000) where state <> 'WI' group by state");
  }
  ...
  public void query31() throws Exception {
    String query =
        "select state, stars, flatten(categories) from (select stars, state, name, categories "
  ...
  public void query32() throws Exception {
    String query =
        "SELECT * FROM (SELECT \"business\".\"state\" AS \"state\", SUM(1) AS \"sum_Number_of_Records_ok\"\n"
  ...
  public void query33() throws Exception {
    test(
        "explain plan for select stars, count(*) from elasticsearch.academic.business group by stars limit 0");
  ...
  public void query34() throws Exception {
    String query =
        "SELECT \"business\".\"longitude\", count(1) FROM \"elasticsearch.academic\".\"business\" \"business\"\n"
  ...
  public void query35() throws Exception {
    String query =
        "SELECT AVG(\"business\".\"longitude\") AS \"avg_longitude_ok\" FROM \"elasticsearch.academic\".\"business\" \"business\"\n"
  ...
  public void query36() throws Exception {
    String query =
        "SELECT * FROM (SELECT AVG(\"business\".\"longitude\") AS \"avg_longitude_ok\" FROM \"elasticsearch.academic\".\"business\" \"business\"\n"
  ...
  public void query37() throws Exception {
    String query =
        "SELECT \"review\".\"stars\" AS \"stars__review_\" FROM \"elasticsearch.academic\".\"review\" \"review\"\n"
  ...
  public void query38() throws Exception {
    String query =
        "SELECT * FROM (SELECT SUM(\"user\".\"fans\") AS \"sum_fans_ok\", \"user\".\"yelping_since\" AS \"yelping_since\"\n"
  ...
  public void query39() throws Exception {
    String query =
        "SELECT * FROM (SELECT AVG(\"user\".\"average_stars\") AS \"avg_average_stars_ok\",\n"
  ...
  public void query40() throws Exception {
    String query =
        "SELECT * FROM (SELECT \"user\".\"name\" AS \"name\",\n"
  ...
  public void query41() throws Exception {
    String query =
        "SELECT * FROM (SELECT COUNT(1) AS \"cnt_Number_of_Records_ok\",\n"
            + "  \"user\".\"name\" AS \"name\"\n"
            + "FROM \"elasticsearch.academic\".\"user\" \"user\"\n"
            + "GROUP BY \"user\".\"name\") T LIMIT 0";
    test("explain plan for " + query);
  ...
  public void query43() throws Exception {
    String query =
        "select count(stars), sum(review_count), count(1), sum(1)from elasticsearch.academic.business";
    test("explain plan for " + query);
    test(query);
  }
  ...
  public void query44() throws Exception {
    String query =
        "select \"open\", not \"open\" from elasticsearch.academic.business group by \"open\"";
    test(query);
  }
  ...
  public void query45() throws Exception {
    ...
    */
    ...
    String query =
        "select * from (select * from elasticsearch.academic.business limit 1000) t left join (select * from elasticsearch.academic.business limit 500) s on t.business_id = s.business_id";
    query =
        "select * from (select business_id as BID1, categories as CAT1 from elasticsearch.academic.business limit 1000) t left join (select business_id as BID2, categories as CAT2 from elasticsearch.academic.business limit 10) s on t.BID1 = s.BID2";
    test(query);
  }
  ...
  public void query46() throws Exception {
    String query =
        "select b.name, avg(r.votes.funny) as avg_funny, avg(r.votes.useful) as avg_useful, avg(r.votes.cool) as avg_cool from elasticsearch.academic.business b join elasticsearch.academic.review r on b.business_id =r.business_id group by b.name";
    test("explain plan for " + query);

    test(query);

    // query = "SELECT * FROM (SELECT SUM(\"user\".\"fans\") AS \"sum_fans_ok\",
    // \"user\".\"yelping_since\" AS \"yelping_since\"\n" +
    //        " FROM \"elasticsearch.academic\".\"user\" \"user\" GROUP BY
    // \"user\".\"yelping_since\") T LIMIT 0";
    // test("explain plan for " + query);
  }
  ...
  public void query47() throws Exception {
    String query =
        "select state, city, count(stars) as countStar, avg(stars) as avgStar, sum(review_count) as sumReview, avg( (stars-1)*2) as avgFunc from elastic.academic.business where state <> 'NV' and ((stars - 1)*2) > 4 and \"open\" group by state, city";
    test("explain plan for " + query);
    test(query);
  }
  ...
  public void query48() throws Exception {
    String query =
        "select t.attributes.\"Accepts Credit Cards\" from elasticsearch.academic.business t group by t.attributes.\"Accepts Credit Cards\"";
    test("explain plan for " + query);
    test(query);
  }
  ...
  public void query50() throws Exception {
    ...
    String query =
        "WITH dremio_limited_preview AS (\n"
