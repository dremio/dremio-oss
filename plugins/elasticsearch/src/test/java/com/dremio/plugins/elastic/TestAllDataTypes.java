...
public class TestAllDataTypes extends ElasticBaseTestQuery {
  ...
  public void loadTable() throws IOException, ParseException {
    ElasticsearchCluster.ColumnData[] data = new ElasticsearchCluster.ColumnData[]{
            ...
            new ElasticsearchCluster.ColumnData("ID", STRING, new Object[][]{  {"one"}, {"two"}  }),
            ...
            new ElasticsearchCluster.ColumnData("colBoolean", BOOLEAN, new Object[][]{  { "yea" }, { null } }),
            ...
            new ElasticsearchCluster.ColumnData("colArrayString", STRING, new Object[][]{
            ...
            new ElasticsearchCluster.ColumnData("colAttachment", ATTACHMENT, new Object[][]{
  ...
  @Test
  public void readNonNullRow() throws Exception {
    String query = "select ID, colString, colLong, colInt, colShort, colByte, colDouble, colFloat, colDate, colBoolean, colBinary, colArrayString, "
        + "colArrayObject, colObject, colNested, colIP, colAttachment, colGeoPoint, colGeoShapePoint, colGeoShapeLineString, "
        + "colGeoShapePolygon, colGeoShapeMultiPoint, colGeoShapeMultiLineString, colGeoShapeMultiPolygon, colGeoShapeGeometryCollection, "
        + "colGeoShapeEnvelope, colGeoShapeCircle from elasticsearch." + schema + "." + table + " where `ID` = 'one'";
    //String query = "select colGeoShapePolygon from elasticsearch." + schema + "." + table + " where `ID` = 'one'";
    testBuilder().sqlQuery(query).unOrdered()
            .baselineColumns(
                    ...
                    "colGeoPoint",
                    "colGeoShapePoint",
                    "colGeoShapeLineString",
                    "colGeoShapePolygon",
                    "colGeoShapeMultiPoint",
                    "colGeoShapeMultiLineString",
                    "colGeoShapeMultiPolygon",
                    "colGeoShapeGeometryCollection",
                    "colGeoShapeEnvelope",
                    "colGeoShapeCircle")
            .baselineValues(
                    "one",
                    ...
                    434.564D,
                    34.54321F,
                    new LocalDateTime(Timestamp.valueOf("2016-01-01 00:00:00")),
                    true,
                    DatatypeConverter.parseBase64Binary("U29tZSBiaW5hcnkgYmxvYg=="),
                    listOf("a", "bcd", "efg"), // we collapse arrays and arrays of arrays of scalar types (e.g. string) into a single list.
                    listOf(mapOf("a", "b"), mapOf("a", "c")),
                    mapOf("name", mapOf("first", "dremio", "last", "corporation")),
                    mapOf("size", 2L, "employees", listOf(mapOf("first", "emp1", "last", "last1"), mapOf("first", "emp2", "last", "last2"))),
                    "172.168.1.1",
                    DatatypeConverter.parseBase64Binary("e1xydGYxXGFuc2kNCkxvcmVtIGlwc3VtIGRvbG9yIHNpdCBhbWV0DQpccGFyIH0="),
                    mapOf("lat", 41.12, "lon", -71.34),
                    mapOf("type", "point", "coordinates", listOf(-77.03653, 38.897676)),
                    mapOf("type", "linestring", "coordinates", listOf(listOf(-77.03653, 38.897676), listOf(-77.009051, 38.889939))),
                    mapOf("type", "polygon", "coordinates",
                            listOf(
                                    listOf(
                                            listOf(100.0, 0.0), listOf(101.0, 0.0), listOf(101.0, 1.0), listOf(100.0, 1.0), listOf(100.0, 0.0)
                                    ),
                                    listOf(
                                            listOf(100.2, 0.2), listOf(100.8, 0.2), listOf(100.8, 0.8), listOf(100.2, 0.8), listOf(100.2, 0.2)
                                    )
                            )
                    ),
                    mapOf("type", "multipoint", "coordinates", listOf(listOf(102.0, 2.0), listOf(103.0, 2.0))),
                    mapOf("type", "multilinestring", "coordinates",
                            listOf(
                                    listOf(
                                            listOf(102.0, 2.0), listOf(103.0, 2.0), listOf(103.0, 3.0), listOf(102.0, 3.0)
                                    ),
                                    listOf(
                                            listOf(102.0, 2.0), listOf(103.0, 2.0), listOf(103.0, 3.0), listOf(102.0, 3.0)
                                    ),
                                    listOf(
                                            listOf(100.2, 0.2), listOf(100.8, 0.2), listOf(100.8, 0.8), listOf(100.2, 0.8)
                                    )
                            )
                    ),
                    mapOf("type", "multipolygon", "coordinates",
                            listOf(
                                    listOf(
                                            listOf(
                                                    listOf(102.0, 2.0), listOf(103.0, 2.0), listOf(103.0, 3.0), listOf(102.0, 3.0), listOf(102.0, 2.0)
                                            )
                                    ),
                                    listOf(
                                            listOf(
                    ...
                    mapOf("type", "geometrycollection", "geometries",
                            listOf(
                                    mapOf("type", "point", "coordinates", listOf(100.0, 0.0)),
                                    mapOf("type", "linestring", "coordinates", listOf(listOf(101.0, 0.0), listOf(102.0, 1.0)))
                            )
                    ),
                    mapOf("type", "envelope", "coordinates", listOf(listOf(-45.0, 45.0), listOf(45.0, -45.0))),
                    mapOf("type", "circle", "radius", "100m", "coordinates", listOf(45.0, -45.0)))
            .go();
  }
  ...
  @Test
  public void readNullRow() throws Exception {
    String query = "select ID, colString, colLong, colInt, colShort, colByte, colDouble, colFloat, colDate, colBoolean, colBinary, colArrayString, "
            + "colArrayObject, colObject, colNested, colIP, colAttachment, colGeoPoint, colGeoShapePoint, colGeoShapeLineString, "
            + "colGeoShapePolygon, colGeoShapeMultiPoint, colGeoShapeMultiLineString, colGeoShapeMultiPolygon, colGeoShapeGeometryCollection, "
            + "colGeoShapeEnvelope, colGeoShapeCircle from elasticsearch." + schema + "." + table + " where `ID` = 'two'";
    testBuilder().sqlQuery(query).unOrdered()
            .baselineColumns(
                    "ID",
                    "colString",
                    ...
                    "colGeoShapeEnvelope",
                    "colGeoShapeCircle")
            .baselineValues("two", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new byte[0], null, null, null, null, null, null, null, null, null, null)
            .go();
  }
