...
public class ITTestEmptyIndexType extends ElasticBaseTestQuery {
  ...
  public void testEmptyIndex() throws Exception {
    ...
    testBuilder()
      ...
      .baselineValues("city", "CHARACTER VARYING", "YES", null, null, "[]", null)
      .baselineValues("full_address", "CHARACTER VARYING", "YES", null, null, "[]", null)
      .baselineValues("review_count", "INTEGER", "YES", 32, 0, "[]",null)
      .baselineValues("stars", "FLOAT", "YES", 24, null, "[]", null)
      .go();
    testBuilder()
      .sqlQuery(query)
      .unOrdered()
