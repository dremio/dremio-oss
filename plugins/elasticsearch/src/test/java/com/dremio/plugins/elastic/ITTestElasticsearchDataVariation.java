...
public class ITTestElasticsearchDataVariation extends ElasticBaseTestQuery {

  private static final Logger logger =
      LoggerFactory.getLogger(ITTestElasticsearchDataVariation.class);
  ...
  public void testSelectVariableLongRepresentations() throws Exception {
    ...
    testBuilder().sqlQuery(sql).unOrdered().baselineColumns("field_a").baselineValues("TBD").go();
  }
}
