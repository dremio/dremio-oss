...
public class TestAliases extends ElasticBaseTestQuery {

  private static final Logger logger = LoggerFactory.getLogger(TestAliases.class);
...
//    test(String.format("describe elasticsearch.%s.%s", alias, table));
  ...
  public void testDifferentTypes() throws Exception {
    ...
    String table1 = table;
    ElasticsearchCluster.ColumnData[] data = new ElasticsearchCluster.ColumnData[]{
            new ElasticsearchCluster.ColumnData("location_1", STRING, new Object[][]{
                    {"San Francisco"},
                    {"San Jose"},
                    {"Oakland"}
            }),
    ...
    data = new ElasticsearchCluster.ColumnData[]{
            new ElasticsearchCluster.ColumnData("location_2", STRING, new Object[][]{
                    {"New York"},
                    {"Chicago"},
                    {"Los Angeles"}
            }),
