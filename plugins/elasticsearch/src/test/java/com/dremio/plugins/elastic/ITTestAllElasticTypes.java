...
public class ITTestAllElasticTypes extends ElasticBaseTestQuery {
    ...
    ElasticsearchCluster.ColumnData[] data =
        new ElasticsearchCluster.ColumnData[] {
          ...
          new ElasticsearchCluster.ColumnData(
              ...
              TEXT,
              ImmutableMap.of("index", "false"),
              new Object[][] {{"MA"}, {"CA"}, {"CA"}, {"MA"}, {"CA"}}),
          new ElasticsearchCluster.ColumnData(
              "state_analyzed", TEXT, new Object[][] {{"MA"}, {"CA"}, {"CA"}, {"MA"}, {"CA"}}),
          new ElasticsearchCluster.ColumnData(
              "review_count", INTEGER, new Object[][] {{11}, {22}, {33}, {11}, {1}}),
          new ElasticsearchCluster.ColumnData(
              "review_count_bigint", LONG, new Object[][] {{11L}, {22L}, {33L}, {11L}, {1L}}),
          new ElasticsearchCluster.ColumnData(
              "stars", FLOAT, new Object[][] {{4.5f}, {3.5f}, {5.0f}, {4.5f}, {1.0f}}),
          new ElasticsearchCluster.ColumnData(
              "stars_double", DOUBLE, new Object[][] {{4.5D}, {3.5D}, {5.0D}, {4.5D}, {1.0D}}),
          new ElasticsearchCluster.ColumnData(
              "location_field",
              GEO_POINT,
              new Object[][] {
          ...
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  com.dremio.common.util.DateTimes.toDateTime(
  ...
  //    - we should probably disallow in scripts, see if we get the source string or a date class in
  // groovy
  @Test
  public void testCastRoundTripsToVarchar() throws Exception {
    ...
    String[] allCastTypes = {
      INT_TYPE, BIGINT_TYPE, DOUBLE_TYPE, FLOAT_TYPE, SHORT_VARCHAR, LONG_VARCHAR, BOOLEAN_TYPE
    };
    String[] sourceFields = {
      "review_count", "review_count_bigint", "stars_double", "stars", "state", "city", "\"open\""
    };
