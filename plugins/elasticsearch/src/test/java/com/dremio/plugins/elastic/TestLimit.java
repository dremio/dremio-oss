  ...
  public final void runTestWithLeafLimitComplexArrayFetchOffset() throws Exception {
    try {
      ...
      verifyJsonInPlanHelper(sqlQuery, new String[]{
          ...
          "  },\n" +
          "  \"_source\" : {\n" +
          "    \"includes\" : [ \"_index\", \"_type\", \"_uid\", \"business_id\", \"city\", \"city_analyzed\", \"datefield\", \"full_address\", \"location_field\", \"name\", \"open\", \"review_count\", \"stars\", \"state\", \"state_analyzed\", \"test_map\" ],\n" +
          "    \"excludes\" : [ ]\n" +
          "  }\n" +
          "}]"},
        true);
