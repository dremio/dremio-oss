...
public class ITTestDateTypesWeekFormatsJodaTime extends ElasticBaseTestQuery {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(ITTestDateTypesWeekFormatsJodaTime.class);
  ...
  public void runTest() throws Exception {
    // These week related formats have been added to test cases dedicated for ES7 and bypassed here.
    // - ES7 testcases
    // -ITTestDateTypesWeekDateFormatsJavaTime/ITTestDateTypesWeekDateTimeFormatsJavaTime
