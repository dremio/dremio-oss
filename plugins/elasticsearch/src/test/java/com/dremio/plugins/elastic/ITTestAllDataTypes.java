...
public class ITTestAllDataTypes extends ElasticBaseTestQuery {
  ...
  protected static final String[] SPECIAL_COLUMNS =
      new String[] {
        SPECIAL_COLUMN_NAME_1, SPECIAL_COLUMN_NAME_2, SPECIAL_COLUMN_NAME_3, SPECIAL_COLUMN_NAME_4
      };
  ...
  public void loadTable() throws IOException, ParseException {
    ElasticsearchCluster.ColumnData[] data =
        new ElasticsearchCluster.ColumnData[] {
          new ElasticsearchCluster.ColumnData(
              SPECIAL_COLUMN_NAME_1, LONG, new Object[][] {{1}, {2}}),
          new ElasticsearchCluster.ColumnData(
              SPECIAL_COLUMN_NAME_2, LONG, new Object[][] {{3}, {4}}),
          new ElasticsearchCluster.ColumnData(
              SPECIAL_COLUMN_NAME_3, LONG, new Object[][] {{5}, {6}}),
          new ElasticsearchCluster.ColumnData(
              SPECIAL_COLUMN_NAME_4, LONG, new Object[][] {{7}, {8}}),
          new ElasticsearchCluster.ColumnData("ID", TEXT, new Object[][] {{"one"}, {"two"}}),
          new ElasticsearchCluster.ColumnData(
              "colString", TEXT, new Object[][] {{"abcde"}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colCompletion",
              ElasticsearchType.COMPLETION,
              new Object[][] {
                {"abcde"}, {"hello"}
              }), // unknown type should be treated as hidden field.
          // requires es5 // new ElasticsearchCluster.ColumnData("halfFloat",
          // ElasticsearchType.HALF_FLOAT, new Object[][]{  {1.0}, {-1.0}  }),
          new ElasticsearchCluster.ColumnData(
              "colLong", LONG, new Object[][] {{853848593.0}, {null}}),
          ...
          new ElasticsearchCluster.ColumnData(
              "colDouble", DOUBLE, new Object[][] {{434.564}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colFloat", FLOAT, new Object[][] {{34.54321}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colDate",
              DATE,
              new Object[][] {
                {formatter.parse("2016-01-01", TemporalQueries.localDate())}, {null}
              }),
          new ElasticsearchCluster.ColumnData(
              "colBoolean", BOOLEAN, new Object[][] {{"true"}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colBinary",
              BINARY,
              new Object[][] {
          ...
          new ElasticsearchCluster.ColumnData(
              "colArrayString",
              TEXT,
              new Object[][] {{ImmutableList.of("a", "bcd", "efg")}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colArrayObject",
              OBJECT,
              new Object[][] {
          ...
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of("name", ImmutableMap.of("first", "dremio", "last", "corporation"))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      "employees",
                      ImmutableList.of(
                          ImmutableMap.of("first", "emp1", "last", "last1"),
                          ImmutableMap.of("first", "emp2", "last", "last2")))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              "colIP", IP, new Object[][] {{"172.168.1.1"}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colGeoPoint",
              GEO_POINT,
              new Object[][] {{ImmutableMap.of("lat", 41.12, "lon", -71.34)}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "colGeoShapePoint",
              GEO_SHAPE,
              new Object[][] {
                {
                  ImmutableMap.of(
                      "type", "point", "coordinates", ImmutableList.of(-77.03653, 38.897676))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      ImmutableList.of(
                          ...
                          ImmutableList.of(-77.009051, 38.889939)))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      ImmutableList.of(
                          ImmutableList.of(
                              ImmutableList.of(100.0, 0.0),
                              ImmutableList.of(101.0, 0.0),
                              ImmutableList.of(101.0, 1.0),
                              ImmutableList.of(100.0, 1.0),
                              ImmutableList.of(100.0, 0.0)),
                          ImmutableList.of(
                              ImmutableList.of(100.2, 0.2),
                              ImmutableList.of(100.8, 0.2),
                              ImmutableList.of(100.8, 0.8),
                              ImmutableList.of(100.2, 0.8),
                              ImmutableList.of(100.2, 0.2))))
                },
                {null}
              }),
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      ImmutableList.of(
                          ImmutableList.of(
                              ImmutableList.of(102.0, 2.0),
                              ImmutableList.of(103.0, 2.0),
                              ImmutableList.of(103.0, 3.0),
                              ImmutableList.of(102.0, 3.0)),
                          ImmutableList.of(
                              ImmutableList.of(102.0, 2.0),
                              ImmutableList.of(103.0, 2.0),
                              ImmutableList.of(103.0, 3.0),
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      ImmutableList.of(
                          ImmutableMap.of(
                              "type", "point", "coordinates", ImmutableList.of(100.0, 0.0)),
                          ImmutableMap.of(
                              "type",
                              "linestring",
                              "coordinates",
                              ImmutableList.of(
                                  ImmutableList.of(101.0, 0.0), ImmutableList.of(102.0, 1.0)))))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      "envelope",
                      "coordinates",
                      ImmutableList.of(ImmutableList.of(-45.0, 45.0), ImmutableList.of(45.0, -45.)))
                },
                {null}
              }),
          new ElasticsearchCluster.ColumnData(
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      "100m",
                      "coordinates",
                      ImmutableList.of(45.0, -45.0))
                },
                {null}
              }),
        };

    if ((getConnection().getESVersionInCluster().getMajor() >= 6)) {
      List<ElasticsearchCluster.ColumnData> operatedList = new ArrayList<>();
      Arrays.stream(data)
          .filter(s -> !s.name.contains("colGeoShapeCircle"))
          .forEach(s -> operatedList.add(s));
  ...
  public void join() throws Exception {
    String query =
        "select t1.ID, t2.colIP, t2.colInt, t2.ID as t2ID from elasticsearch."
            + schema
            + "."
            + table
            + " t1 join elasticsearch."
            + schema
            + "."
            + table
            + " t2 on t1.colInt = t2.colInt";
    try {
      ...
      testBuilder()
          .sqlQuery(query)
          .unOrdered()
          .baselineColumns("ID", "colIP", "colInt", "t2ID")
  ...
  public void testHalfFloat() throws Exception {
    final String sqlQuery =
        "select halfFloat from elasticsearch." + schema + "." + table + " where abs(halfFloat) = 1";
    test(sqlQuery);
  }
