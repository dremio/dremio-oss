...
public class ITTestAllDataTypes extends ElasticBaseTestQuery {
  ...
  public void readNonNullRow() throws Exception {
    String query = "select ID, colString, colLong, colInt, colShort, colByte, colDouble, colFloat, colDate, colBoolean, colBinary, colArrayString, "
        + "colArrayObject, colObject, colNested, colIP, colGeoPoint, colGeoShapePoint, colGeoShapeLineString, "
  ...
  public void readNullRow() throws Exception {
    ...
    testBuilder().sqlQuery(query).unOrdered()
            .baselineColumns(
                    ...
                    "colGeoShapeEnvelope",
                    "colGeoShapeCircle")
            .baselineValues("two", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null)
            .go();
  }
