...
public class ITTestElasticsearchPushdownWithKeywordEnabled extends ElasticBaseTestQuery {
  ...
  @Rule public final TestRule timeoutRule = TestTools.getTimeoutRule(150, TimeUnit.SECONDS);
  ...
  public void testLike() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name like 'Norway'", TABLENAME);
    testBuilder().sqlQuery(sql).unOrdered().baselineColumns("name").baselineValues("Norway").go();
  }
  ...
  public void testLikeHyphen() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name like 'Denmark-Norway'",
            TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
  ...
  public void testLikeMulti() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name like 'Denmark' or l.location.name like 'Norway'",
            TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
  ...
  public void testLikeWithoutKeyword() throws Exception {
    ...
    ElasticsearchCluster.ColumnData[] data =
        new ElasticsearchCluster.ColumnData[] {
          new ElasticsearchCluster.ColumnData(
              "name", TEXT, new Object[][] {{"Denmark-Norway"}, {"Denmark"}, {"Norway"}})
        };

    elastic.load(schema, table, data);
    String sql = String.format("select name from %s where name like 'Norway'", TABLENAME);
    testBuilder().sqlQuery(sql).unOrdered().baselineColumns("name").expectsEmptyResultSet().go();
  }
  ...
  public void testLikePattern() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name like '%%Denmark%%'", TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
        .baselineColumns("name")
  ...
  public void testEquals() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name = 'Denmark'", TABLENAME);
    testBuilder().sqlQuery(sql).unOrdered().baselineColumns("name").baselineValues("Denmark").go();
  }
  ...
  public void testEqualsHyphen() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name = 'Denmark-Norway'", TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
        .baselineColumns("name")
  ...
  public void testEqualsMulti() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name = 'Denmark' or l.location.name = 'Norway'",
            TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
  ...
  public void testEqualsWithoutKeyword() throws Exception {
    ...
    elastic.load(schema, table, data);
    String sql =
        String.format("select name from %s where name = 'Norway' or name = 'Denmark'", TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
        .baselineColumns("name")
  ...
  public void testIn() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name in('Denmark')", TABLENAME);
    testBuilder().sqlQuery(sql).unOrdered().baselineColumns("name").baselineValues("Denmark").go();
  }
  ...
  public void testInHyphen() throws Exception {
    ...
    String sql =
        String.format(
            "select l.location.name from %s l where l.location.name in('Denmark-Norway')",
            TABLENAME);
    testBuilder()
        .sqlQuery(sql)
        .unOrdered()
