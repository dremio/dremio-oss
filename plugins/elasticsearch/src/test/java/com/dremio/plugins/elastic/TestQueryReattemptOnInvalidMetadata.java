...
public class TestQueryReattemptOnInvalidMetadata extends ElasticBaseTestQuery {

  public static ColumnData[] getGodFather(String title, int year) {
    return new ColumnData[]{
        new ColumnData("title", ElasticsearchType.STRING, new Object[][]{
            {title}
        }),
        new ColumnData("director", ElasticsearchType.STRING, new Object[][]{
            {DIR}
        }),
  ...
  private static final String GF3 = "The Godfather 3";
  ...
  private static ColumnData[] getGodFather3() {
    return getGodFather(GF3, 1990);
  }
