...
public class ITTestComplexMaps extends ElasticBaseTestQuery {
  ...
  public void before() throws Exception {
    ...
    ElasticsearchCluster.ColumnData[] data =
        new ElasticsearchCluster.ColumnData[] {
          new ElasticsearchCluster.ColumnData("simple", INTEGER, new Object[][] {{123}, {987}}),
          new ElasticsearchCluster.ColumnData(
              "@full address",
              NESTED,
              new Object[][] {
              ...
              new Object[][] {
                {
                  ImmutableMap.of(
                      ...
                      "map inside complex?",
                          ImmutableMap.of("inner1", true, "inner 2", false, "inner3!", "too deep"),
                      "two layers deep",
                          ImmutableMap.of(
                              "oneInner 1",
                              "one inner",
                              "oneInner 2",
                              ImmutableMap.of("twoInner 1", 123, "twoInner 2", "way too deep")),
                      "state", "MA")
                },
                {
                  ImmutableMap.of(
                      ...
                      "map inside complex?",
                          ImmutableMap.of(
                              "inner1", true, "inner 2", false, "inner3!", "also too deep"),
                      "two layers deep",
                          ImmutableMap.of(
                              "oneInner 1",
                              "repeat one inner",
                              "oneInner 2",
                              ImmutableMap.of(
                                  "twoInner 1", 789, "twoInner 2", "also way too deep")),
                      "state", "CA")
                }
              }),
          new ElasticsearchCluster.ColumnData(
              "@ a list!",
              TEXT,
              ImmutableMap.of("index", "false"),
              new Object[][] {{ImmutableList.of("ABC", "DEF", "GHI")}, {null}}),
          new ElasticsearchCluster.ColumnData(
              "secondList",
              TEXT,
              ImmutableMap.of("index", "false"),
              new Object[][] {
                {ImmutableList.of("ABC", "DEF", "GHI")}, {ImmutableList.of("singleElement")}
              }),
          new ElasticsearchCluster.ColumnData(
              "a nested list",
              TEXT,
              ...
              new Object[][] {
                {
                  ImmutableList.of(
                      ImmutableMap.of(
                          ...
                          "map inside complex?",
                              ImmutableMap.of(
                                  "inner1", true, "inner 2", false, "inner3!", "too deep"),
                          "two layers deep",
                              ImmutableMap.of(
                                  "oneInner 1",
                                  "one inner",
  ...
  public void testGroupByWithComplexMapsBoolean() throws Exception {
    final String query =
        "SELECT count(*), t.\"@complex map!\".\"map inside complex?\".\"inner1\" as myBool, "
            + "t.secondList[1], t.\"@ a list!\"[0], t.\"list of complex map!\"[0].\"list of numbers\"[1] as listInt FROM "
            + ELASTIC_TABLE
            + " as t "
  ...
  public void testGroupByWithComplexMaps() throws Exception {
    final String query =
        "SELECT t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 1\" as deepInt, "
            + "t.secondList[1], t.\"@ a list!\"[0], t.\"list of complex map!\"[0].\"list of numbers\"[1] as listInt FROM "
            + ELASTIC_TABLE
            + " as t "
  ...
  public void testAggCallWithComplexMaps() throws Exception {
    final String query =
        "SELECT SUM(t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 1\") as deepInt, "
            + "COUNT(t.secondList[1]), COUNT(t.\"@ a list!\"[0]), SUM(t.\"list of complex map!\"[0].\"list of numbers\"[1]) as listInt FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testGroupByAndAggCallWithComplexMaps() throws Exception {
    final String query =
        "SELECT t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 1\" as deepInt, "
            + "t.secondList[1], COUNT(t.\"@ a list!\"[0]), SUM(t.\"list of complex map!\"[0].\"list of numbers\"[1]) as listInt FROM "
            + ELASTIC_TABLE
            + " as t "
  ...
  public void testSelectComplexMapWithMessedUpList() throws Exception {
    final String query =
        "SELECT t.\"messedUpList\" as \"origList\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithMessedUpList2() throws Exception {
    final String query =
        "SELECT t.\"messedUpList2\" as \"origList\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithListOfComplexMap() throws Exception {
    final String query =
        "SELECT t.\"list of complex map!\" as \"origList\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
        ...
        .baselineValues(
            listOf(
                mapOf(
                    ...
                    "map inside complex?",
                        mapOf("inner1", true, "inner 2", false, "inner3!", "too deep"),
                    "two layers deep",
                        mapOf(
                            "oneInner 1",
                            "one inner",
                            "oneInner 2",
                            mapOf("twoInner 1", 123L, "twoInner 2", "way too deep")),
                    "state", "MA"),
                mapOf(
                    "boolean field", true,
                    "list of numbers", listOf(7L, 8L, 9L, 10L),
                    "map inside complex?",
                        mapOf("inner1", true, "inner 2", false, "inner3!", "also too deep"),
                    "two layers deep",
                        mapOf(
                            "oneInner 1",
                            "repeat one inner",
                            "oneInner 2",
                            mapOf("twoInner 1", 789L, "twoInner 2", "also way too deep")),
                    "state", "CA")),
            "way too deep")
        .baselineValues(
            listOf(
  ...
  public void testSelectComplexMapWithListOfComplexMap2() throws Exception {
    final String query =
        "SELECT t.\"list of complex map!\"[0] as \"origList\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithComplexMap() throws Exception {
    final String query =
        "SELECT t.\"@complex map!\".\"list of numbers\" as \"origMap\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithComplexMap2() throws Exception {
    final String query =
        "SELECT t.\"@complex map!\" as \"origMap\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithList() throws Exception {
    final String query =
        "SELECT t.\"@ a list!\" as \"@ a list!\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithNestedList() throws Exception {
    final String query =
        "SELECT t.\"secondList\" as \"secondList\", t.\"a nested list\" as \"a nested list\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectComplexMapWithNestedList2() throws Exception {
    final String query =
        "SELECT t.\"@ a list!\" as \"@ a list!\", t.\"a nested list\" as \"a nested list\", t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectTwoLayersInnerMapElement() throws Exception {
    final String query =
        "SELECT t.simple, t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 2\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectTwoLayersInnerMapElement2() throws Exception {
    final String query =
        "SELECT t.simple, t.\"@complex map!\".\"two layers deep\".\"oneInner 2\".\"twoInner 1\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testSelectInnerMapElement() throws Exception {
    final String query =
        "SELECT t.simple, t.\"@complex map!\".\"boolean field\" AS \"@complex map!\" FROM "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        query,
  ...
  public void testMapElement() throws Exception {
    final String sqlQuery =
        "select t.\"@full address\".\"street number\", t.\"@full address\".\"@street name\" from "
            + ELASTIC_TABLE
            + " as t";
    verifyJsonInPlan(
        sqlQuery,
