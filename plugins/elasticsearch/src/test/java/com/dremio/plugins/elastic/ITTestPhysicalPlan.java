  ...
  public void testQuery() throws Exception {
    ...
    ElasticsearchCluster.ColumnData[] data =
        new ElasticsearchCluster.ColumnData[] {
          new ElasticsearchCluster.ColumnData(
              "business_id", TEXT, new Object[][] {{"12345"}, {"abcde"}, {"7890"}}),
          new ElasticsearchCluster.ColumnData(
              "full_address",
              TEXT,
              new Object[][] {
          ...
          new ElasticsearchCluster.ColumnData(
              "city", TEXT, new Object[][] {{"Cambridge"}, {"SanFrancisco"}, {"SanDiego"}}),
          new ElasticsearchCluster.ColumnData(
              "state", TEXT, new Object[][] {{"MA"}, {"CA"}, {"CA"}}),
          new ElasticsearchCluster.ColumnData(
              "review_count", INTEGER, new Object[][] {{11}, {22}, {33}}),
          new ElasticsearchCluster.ColumnData("stars", FLOAT, new Object[][] {{4.5}, {3.5}, {4.9}}),
          new ElasticsearchCluster.ColumnData(
              "open", BOOLEAN, new Object[][] {{true}, {true}, {true}}),
          new ElasticsearchCluster.ColumnData(
              "name",
              TEXT,
              new Object[][] {
                {"Store in Cambridge"}, {"Store in San Francisco"}, {"Store in San Diego"}
              })
        };
    ...
    String sqlQuery =
        "explain plan for select state, city, review_count from elasticsearch."
            + schema
            + "."
            + table;
    testSql(sqlQuery);
