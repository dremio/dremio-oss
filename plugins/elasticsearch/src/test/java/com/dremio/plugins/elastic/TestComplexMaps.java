...
public class TestComplexMaps extends ElasticBaseTestQuery {
  ...
  public void before() throws Exception {
    ...
    ElasticsearchCluster.ColumnData[] data = new ElasticsearchCluster.ColumnData[]{
      ...
      new ElasticsearchCluster.ColumnData("@ a list!", STRING, ImmutableMap.of("index", "not_analyzed"), new Object[][] {
        {ImmutableList.of("ABC", "DEF", "GHI")},
        {null}
      }),
      new ElasticsearchCluster.ColumnData("secondList", STRING, ImmutableMap.of("index", "not_analyzed"), new Object[][] {
        {ImmutableList.of("ABC", "DEF", "GHI")},
        {ImmutableList.of("singleElement")}
      }),
      new ElasticsearchCluster.ColumnData("a nested list", STRING, new Object[][] {
      ...
      new ElasticsearchCluster.ColumnData("messedUpList", STRING, new Object[][] {
        {ImmutableList.of(ImmutableList.of("abc", "def"), ImmutableList.of("ghi"))},
        {"single"}
      }),
      new ElasticsearchCluster.ColumnData("messedUpList2", STRING, new Object[][] {
        {ImmutableList.of(ImmutableList.of("abc", "def"), ImmutableList.of("ghi"))},
  ...
  public void testGroupByWithComplexMapsBoolean() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "      \"terms\" : {\n" +
        "        \"script\" : {\n" +
        "          \"inline\" : \"(_source[\\\"@complex map!\\\"] == null || _source[\\\"@complex map!\\\"][\\\"map inside complex?\\\"] == null || _source[\\\"@complex map!\\\"][\\\"map inside complex?\\\"][\\\"inner1\\\"] == null) ? null : _source[\\\"@complex map!\\\"][\\\"map inside complex?\\\"][\\\"inner1\\\"]\"\n" +
        "        },\n" +
        ...
        "          \"terms\" : {\n" +
        "            \"script\" : {\n" +
        "              \"inline\" : \"(_source.secondList == null || _source.secondList[1] == null) ? null : _source.secondList[1]\"\n" +
        "            },\n" +
        ...
        "              \"terms\" : {\n" +
        "                \"script\" : {\n" +
        "                  \"inline\" : \"(_source[\\\"@ a list!\\\"] == null || _source[\\\"@ a list!\\\"][0] == null) ? null : _source[\\\"@ a list!\\\"][0]\"\n" +
        "                },\n" +
        "                \"missing\" : \"NULL_STRING_TAG\",\n" +
        "                \"size\" : 2147483647\n" +
        "              },\n" +
        ...
        "                  \"terms\" : {\n" +
        "                    \"script\" : {\n" +
        "                      \"inline\" : \"(_source[\\\"list of complex map!\\\"] == null || _source[\\\"list of complex map!\\\"][0] == null || _source[\\\"list of complex map!\\\"][0][\\\"list of numbers\\\"] == null || _source[\\\"list of complex map!\\\"][0][\\\"list of numbers\\\"][1] == null) ? null : _source[\\\"list of complex map!\\\"][0][\\\"list of numbers\\\"][1]\"\n" +
        "                    },\n" +
  ...
  public void testGroupByWithComplexMaps() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "      \"terms\" : {\n" +
        "        \"script\" : {\n" +
        "          \"inline\" : \"(_source[\\\"@complex map!\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"][\\\"twoInner 1\\\"] == null) ? null : _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"][\\\"twoInner 1\\\"]\"\n" +
        "        },\n" +
        "        \"missing\" : -9223372036854775808,\n" +
        "        \"size\" : 2147483647\n" +
        "      },\n" +
  ...
  public void testSelectComplexMapWithMessedUpList2() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"origList\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source.messedUpList2 == null) ? null : _source.messedUpList2\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@complex map!\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"] == null || _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"][\\\"twoInner 2\\\"] == null) ? null : _source[\\\"@complex map!\\\"][\\\"two layers deep\\\"][\\\"oneInner 2\\\"][\\\"twoInner 2\\\"]\"\n" +
        "      }\n" +
        "    }\n" +
        "  }\n" +
        "}]"});
  ...
  public void testSelectComplexMapWithListOfComplexMap() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"origList\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"list of complex map!\\\"] == null) ? null : _source[\\\"list of complex map!\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectComplexMapWithListOfComplexMap2() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"origList\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"list of complex map!\\\"] == null || _source[\\\"list of complex map!\\\"][0] == null) ? null : _source[\\\"list of complex map!\\\"][0]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
   ...
   final String query = "SELECT t.`@complex map!`.`list of numbers` as `origMap`, t.`@complex map!`.`two layers deep`.`oneInner 2`.`twoInner 2` AS `@complex map!` FROM " + ELASTIC_TABLE + " as t";
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"origMap\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@complex map!\\\"] == null || _source[\\\"@complex map!\\\"][\\\"list of numbers\\\"] == null) ? null : _source[\\\"@complex map!\\\"][\\\"list of numbers\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectComplexMapWithComplexMap2() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"origMap\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@complex map!\\\"] == null) ? null : _source[\\\"@complex map!\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectComplexMapWithList() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"@ a list!\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@ a list!\\\"] == null) ? null : _source[\\\"@ a list!\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectComplexMapWithNestedList() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"secondList\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source.secondList == null) ? null : _source.secondList\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"a nested list\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"a nested list\\\"] == null) ? null : _source[\\\"a nested list\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectComplexMapWithNestedListIndex() throws Exception {
    ...
    verifyJsonInPlan(query, new String[] {
      "[{\n" +
        ...
        "    \"a nested list\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"a nested list\\\"] == null || _source[\\\"a nested list\\\"][0] == null) ? null : _source[\\\"a nested list\\\"][0]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectTwoLayersInnerMapElement() throws Exception {
    ...
    verifyJsonInPlan(query, new String[]{
      "[{\n" +
        ...
        "    \"simple\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source.simple == null) ? null : (_source.simple).intValue()\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
  ...
  public void testSelectInnerMapElement() throws Exception {
    ...
    verifyJsonInPlan(query, new String[]{
      "[{\n" +
        ...
        "    \"@complex map!\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@complex map!\\\"] == null || _source[\\\"@complex map!\\\"][\\\"boolean field\\\"] == null) ? null : _source[\\\"@complex map!\\\"][\\\"boolean field\\\"]\"\n" +
        "      }\n" +
        "    }\n" +
        "  }\n" +
        "}]\n"
  ...
  public void testMapElement() throws Exception {
    ...
    verifyJsonInPlan(sqlQuery, new String[]{
      "[{\n" +
        ...
        "    \"EXPR$0\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@full address\\\"] == null || _source[\\\"@full address\\\"][\\\"street number\\\"] == null) ? null : _source[\\\"@full address\\\"][\\\"street number\\\"]\"\n" +
        "      }\n" +
        "    },\n" +
        "    \"EXPR$1\" : {\n" +
        "      \"script\" : {\n" +
        "        \"inline\" : \"(_source[\\\"@full address\\\"] == null || _source[\\\"@full address\\\"][\\\"@street name\\\"] == null) ? null : _source[\\\"@full address\\\"][\\\"@street name\\\"]\"\n" +
        "      }\n" +
        "    }\n" +
        "  }\n" +
        "}]"
