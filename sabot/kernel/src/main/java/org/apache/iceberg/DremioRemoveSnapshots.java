...
/**
 * This class is an exact copy of {@link org.apache.iceberg.RemoveSnapshots} without the GC_ENABLED
 * check enforced. This is done to allow VACUUM CATALOG operations - Nessie/Arctic sources have
 * GC_ENABLED table property set to false to prevent cleanup operations from non branch-aware means.
 */
public class DremioRemoveSnapshots implements ExpireSnapshots {
  private static final Logger LOG = LoggerFactory.getLogger(DremioRemoveSnapshots.class);
  ...
  public DremioRemoveSnapshots(TableOperations ops) {
    this.ops = ops;
