 ...
 */
public abstract class DremioReduceExpressionsRule<C extends RelRule.Config>
        extends RelRule<C>
   ...
   */
  public static class DremioFilterReduceExpressionsRule
          extends DremioReduceExpressionsRule<DremioFilterReduceExpressionsRule.Config> {
    ...
    protected DremioFilterReduceExpressionsRule(Config config) {

      super(config);
      this.treatDynamicCallsAsConstant = config.treatDynamicCallsAsConstant();
      this.unknownAsFalse = config.isUnknownAsFalse();
    }
    ...
    @Override public void onMatch(RelOptRuleCall call) {
      ...
      if (reduceExpressions(filter, expList, predicates, true,
              config.matchNullability(), treatDynamicCallsAsConstant)) {
    ...
    /** Rule configuration. */
    public interface Config extends DremioReduceExpressionsRule.Config {
      ...
      boolean isUnknownAsFalse();

      /** Sets {@link #isUnknownAsFalse()}. */
      Config withUnknownAsFalse(boolean unknownAsFalse);
      ...
      @Override default DremioFilterReduceExpressionsRule toRule() {
        return new DremioFilterReduceExpressionsRule(this);
      }
    }
  }
  ...
  public static class DremioProjectReduceExpressionsRule
          extends DremioReduceExpressionsRule<DremioProjectReduceExpressionsRule.Config> {
    ...
    protected DremioProjectReduceExpressionsRule(Config config) {
      super(config);
      this.treatDynamicCallsAsConstant = config.treatDynamicCallsAsConstant();
      this.unknownAsFalse = config.isUnknownAsFalse();
    }
    ...
    public interface Config extends RelRule.Config {
      ...
      default DremioReduceExpressionsRule.Config withOperandFor(Class<? extends RelNode> relClass) {
        return withOperandSupplier(b -> b.operand(relClass).anyInputs())
          .as(DremioReduceExpressionsRule.Config.class);
      }

      @Override default DremioProjectReduceExpressionsRule toRule() {
        return new DremioProjectReduceExpressionsRule(this);
      }
    }
  }
  ...
  public static class DremioJoinReduceExpressionsRule
          extends DremioReduceExpressionsRule<DremioJoinReduceExpressionsRule.Config> {
    ...
    protected DremioJoinReduceExpressionsRule(Config config) {
      super(config);
      this.treatDynamicCallsAsConstant = config.treatDynamicCallsAsConstant();
      this.unknownAsFalse = config.isUnknownAsFalse();
    }
    ...
    public interface Config extends RelRule.Config {
      Config DEFAULT = EMPTY.as(Config.class)
              ...
              .withTreatDynamicCallsAsConstant(false)
      ...
      @Override default DremioJoinReduceExpressionsRule toRule() {
        return new DremioJoinReduceExpressionsRule(this);
      }
    }
  }
   ...
   */
  public static class DremioCalcReduceExpressionsRule
          extends DremioReduceExpressionsRule<DremioCalcReduceExpressionsRule.Config> {
    ...
    protected DremioCalcReduceExpressionsRule(Config config) {
      super(config);
      this.treatDynamicCallsAsConstant = config.treatDynamicCallsAsConstant();
      this.unknownAsFalse = config.isUnknownAsFalse();
    }
    ...
    public interface Config extends RelRule.Config {
      ...
      @Override default DremioCalcReduceExpressionsRule toRule() {
        return new DremioCalcReduceExpressionsRule(this);
      }
    }
  }
  ...
  protected static boolean reduceExpressions(RelNode rel, List<RexNode> expList,
    ...
    return reduceExpressions(rel, expList, predicates,
      unknownAsFalse, matchNullability, false);
  }
  ...
  protected static boolean reduceExpressions(RelNode rel, List<RexNode> expList,
    ...
    boolean reduced = reduceExpressionsInternal(rel, simplify, expList,
        predicates, treatDynamicCallsAsConstant);
  ...
  protected static void findReducibleExps(RelDataTypeFactory typeFactory,
      ...
      List<RexNode> removableCasts, boolean treatDynamicCallsAsConstant) {
    ReducibleExprLocator gardener =
        new ReducibleExprLocator(typeFactory, constants, constExps,
            addCasts, removableCasts, treatDynamicCallsAsConstant);
  ...
  public interface Config extends RelRule.Config {
    ...
    Config DEFAULT_FILTER_OPTIONS = EMPTY.as(Config.class)
              .withMatchNullability(true)
              .withUnknownAsFalse(true)
              .withTreatDynamicCallsAsConstant(false);

    @Override DremioReduceExpressionsRule<?> toRule();
