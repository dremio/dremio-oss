...
public class View {
  ...
  public static class FieldType {
    ...
    /**
     * Gets the precision of the data type descriptor of this field. The precision is the precision
     * for a numeric type, the length for a string type, or the start unit precision for an interval
     * type.
     */
    ...
    /**
     * Gets the interval type qualifier of the interval data type descriptor of this field
    ...
    /**
     * Gets the time range start unit of the type qualifier of the interval data type descriptor of
    ...
    /**
     * Gets the time range end unit of the type qualifier of the interval data type descriptor of
     * this field (<i>iff</i> interval type).
     */
    ...
    /**
     * Gets the fractional second precision of the type qualifier of the interval data type
     * descriptor of this field (<i>iff</i> interval type). Gets the interval type descriptor's
     * fractional second precision (<i>iff</i> interval type).
     */
    public Integer getFractionalSecondPrecision() {
      return null == intervalQualifier
          ? null
  ...
  public View(
    ...
    this.workspaceSchemaPath =
        workspaceSchemaPath == null
            ? ImmutableList.<String>of()
            : ImmutableList.copyOf(workspaceSchemaPath);
  }
    ...
    for (FieldType field : fields) {
      ...
      if (SqlTypeFamily.INTERVAL_YEAR_MONTH == field.getType().getFamily()
        ...
        if (complexFieldType != null) {
          ...
          // Actual field information for complex type can be absent for the objects from previous
          // version. In this case, use ANY type.
  ...
  public int hashCode() {
    return Objects.hash(
        Objects.hash(fields), Objects.hash(fieldNames), name, sql, workspaceSchemaPath);
  }
