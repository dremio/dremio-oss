...
class NessieGrpcClient {
    ...
    public NessieGrpcClient(ContentsApiGrpc.ContentsApiBlockingStub nessieContentsApiBlockingStub,
    ...
    public TreeApiGrpc.TreeApiBlockingStub getTreeApi() {
        return treeApiBlockingStub;
    }

    public ContentsApiGrpc.ContentsApiBlockingStub getContentsApi() {
        return nessieContentsApiBlockingStub;
    }
