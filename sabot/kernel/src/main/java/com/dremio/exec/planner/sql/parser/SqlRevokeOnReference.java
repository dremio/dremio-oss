...
/*
 * Implements SQL to revoke privilege on reference for catalog.
 *
 * Represents statements like:
 * REVOKE priv1 [,...] ON BRANCH/TAG refValue IN CATALOG catalogName FROM granteeType grantee
 */
public final class SqlRevokeOnReference extends SqlCall {
      ...
      new SqlSpecialOperator("REVOKE", SqlKind.OTHER) {
        ...
        public SqlCall createCall(
          ...
          Preconditions.checkArgument(
              operands.length == 6, "SqlRevokeOnReference.createCall() has to get 7 operands!");

          return new SqlRevokeOnReference(
              pos,
