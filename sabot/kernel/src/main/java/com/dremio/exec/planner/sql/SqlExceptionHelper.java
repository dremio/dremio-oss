...
public final class SqlExceptionHelper {
  ...
  public static final String PLANNING_STACK_OVERFLOW_ERROR = "The query planner ran out of internal resources and " +
  ...
  private static UserException.Builder sqlError(
    ...
    if (message != null) {
      if (message.contains("Object") && message.contains("not found")){
        builder = builder.message(message + ". Please check that it exists in the selected context.");
      } else {
