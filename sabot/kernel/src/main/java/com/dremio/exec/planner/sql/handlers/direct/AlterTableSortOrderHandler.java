...
public class AlterTableSortOrderHandler extends SimpleDirectHandler{
  ...
  public List<SimpleCommandResult> toResult(String sql, SqlNode sqlNode) throws Exception {
    final SqlAlterTableSortOrder sqlAlterTableSortOrder = SqlNodeUtil.unwrap(sqlNode, SqlAlterTableSortOrder.class);
    ...
    NamespaceKey path = CatalogUtil.getResolvePathForTableManagement(catalog, sqlAlterTableSortOrder.getTable());
    ...
    Set<String> fieldSet = table.getSchema().getFields().stream()
      .map(Field::getName)
    ...
    catalog.alterSortOrder(path, table.getDatasetConfig(), table.getSchema(), sortOrderColumns, tableMutationOptions);
