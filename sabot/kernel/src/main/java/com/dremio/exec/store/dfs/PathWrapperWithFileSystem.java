...
/**
 * Wrapper around PathWrapperWithStats to collect IO Stats.
 */
public class PathWrapperWithFileSystem extends Path {
  private final FileSystemWrapper fs;

  PathWrapperWithFileSystem(Path p, FileSystemWrapper fs) {
    super(p.toUri());
    this.fs = fs;
  }
