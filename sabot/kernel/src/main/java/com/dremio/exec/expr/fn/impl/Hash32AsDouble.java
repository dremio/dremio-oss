...
/**
 * hash32 function definitions for numeric data types. These functions cast the input numeric value
 * to a double before doing the hashing. See comments in {@link Hash64AsDouble} for the reason for
 * doing this.
 */
