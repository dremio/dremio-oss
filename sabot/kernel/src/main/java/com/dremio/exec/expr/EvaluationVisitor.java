...
public class EvaluationVisitor {
  ...
  public EvaluationVisitor(FunctionContext functionContext) {
    ...
    this.constantArrayThreshold =
        functionContext.getCompilationOptions().getConstantArrayThreshold();
  }
  ...
  public HoldingContainer addExpr(
      LogicalExpression e, ClassGenerator<?> generator, boolean allowInnerMethods) {
    ...
    return e.accept(
        new ConstantFilter(constantBoundaries, functionContext, allowInnerMethods), generator);
  }
  ...
  private class ExpressionHolder {
    ...
    public boolean equals(Object obj) {
      ...
      return this.mappingSet == that.mappingSet
          && this.mapping == that.mapping
          && expression.accept(new EqualityVisitor(), that.expression);
    }
  }
  ...
  private HoldingContainer getPrevious(LogicalExpression expression, MappingSet mappingSet) {
    HoldingContainer previous =
        previousExpressions.get(new ExpressionHolder(expression, mappingSet));
    if (previous != null) {
      if (logger.isDebugEnabled()) {
        logger.debug(
            "Found previously evaluated expression: {}",
  ...
  private class EvalVisitor
      extends AbstractExprVisitor<HoldingContainer, ClassGenerator<?>, RuntimeException> {
    private final FunctionContext functionContext;
    ...
    @Override
    public HoldingContainer visitFunctionCall(FunctionCall call, ClassGenerator<?> generator)
    ...
    @Override
    public HoldingContainer visitBooleanOperator(BooleanOperator op, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitIfExpression(IfExpression ifExpr, ClassGenerator<?> generator)
        throws RuntimeException {
      ...
      if (ifExpr.getCompleteType().isComplex() || ifExpr.getCompleteType().isUnion()) {
        JVar complexOutput =
            generator.declareClassField(
                "inputReader", generator.getModel()._ref(FieldReader.class));

        final JConditional jc =
            conditionalBlock._if(
                holdingContainer
                    .getIsSet()
                    .eq(JExpr.lit(1))
        ...
        if (thenExpr.isConstant()) {
          JClass nrClass =
              generator.getModel().ref(org.apache.arrow.vector.complex.impl.NullReader.class);
          ...
          final JExpression fieldReader =
              fieldType.isUnion() ? thenExpr.getHolder().ref("reader") : thenExpr.getHolder();
        ...
        if (elseExpr.isConstant()) {
          ...
          final JExpression fieldReader =
              fieldType.isUnion() ? elseExpr.getHolder().ref("reader") : elseExpr.getHolder();
          jc._else().assign(complexOutput, fieldReader);
        }

        HoldingContainer out =
            new HoldingContainer(ifExpr.getCompleteType(), complexOutput, null, null, false, true);
    ...
    @Override
    public HoldingContainer visitCaseExpression(
        CaseExpression caseExpression, ClassGenerator<?> generator) throws RuntimeException {
        ...
        assigner =
            (expr, block) -> {
              if (expr.isConstant()) {
                ...
                final JExpression fieldReader =
                    fieldType.isUnion() ? expr.getHolder().ref("reader") : expr.getHolder();
                block.assign(complexOutput, fieldReader);
              }
            };
        outputSupplier =
            () -> new HoldingContainer(outputType, complexOutput, null, null, false, true);
      } else {
      ...
      if (doSwitch != null) {
        ...
        JExpression switchTest =
            doSwitch.getCompleteType().toMinorType().equals(TypeProtos.MinorType.VARCHAR)
                ? generator
                    .getModel()
                    .ref(StringFunctionHelpers.class)
                    .staticInvoke("getStringFromNullableVarCharHolder")
                    .arg(doSwitch.getHolder())
                : doSwitch.getValue();
    ...
    private JExpression extractLiteral(LogicalExpression whenExpr, Set<Object> literalsSoFar) {
      ...
      return (expr.args.get(0) instanceof ValueVectorReadExpression)
          ? extractLiteralFrom(expr.args.get(1), literalsSoFar)
          : extractLiteralFrom(expr.args.get(0), literalsSoFar);
    }
    ...
    private HoldingContainer checkIsSwitch(
        CaseExpression caseExpression, ClassGenerator<?> generator) {
    ...
    @Override
    public HoldingContainer visitSchemaPath(SchemaPath path, ClassGenerator<?> generator)
        throws RuntimeException {
      throw new UnsupportedOperationException(
          "All schema paths should have been replaced with ValueVectorExpressions.");
    }

    @Override
    public HoldingContainer visitLongConstant(LongExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitIntConstant(IntExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer out = generator.declare(e.getCompleteType());
    ...
    @Override
    public HoldingContainer visitDateConstant(DateExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer out = generator.declare(e.getCompleteType());
    ...
    @Override
    public HoldingContainer visitTimeConstant(TimeExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer out = generator.declare(e.getCompleteType());
    ...
    @Override
    public HoldingContainer visitIntervalYearConstant(
        IntervalYearExpression e, ClassGenerator<?> generator) throws RuntimeException {
      HoldingContainer out = generator.declare(e.getCompleteType());
    ...
    @Override
    public HoldingContainer visitTimeStampConstant(
        TimeStampExpression e, ClassGenerator<?> generator) throws RuntimeException {
      HoldingContainer out = generator.declare(e.getCompleteType());
    ...
    @Override
    public HoldingContainer visitUnknown(LogicalExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    public HoldingContainer visitInExpression(InExpression e, final ClassGenerator<?> generator) {
      ...
      buildInSet:
      {
        final List<HoldingContainer> constants =
            FluentIterable.from(e.getConstants())
                .transform(
                    new com.google.common.base.Function<LogicalExpression, HoldingContainer>() {
                      @Override
      ...
      if (inputContainer.isReader()) {
        JType writerImpl =
            generator
                .getModel()
                ._ref(
                    TypeHelper.getWriterImpl(
                        getArrowMinorType(inputContainer.getCompleteType().toMinorType())));
        JType writerIFace =
            generator
                .getModel()
                ._ref(
                    TypeHelper.getWriterInterface(
                        getArrowMinorType(inputContainer.getCompleteType().toMinorType())));
        ...
        if (child.getCompleteType().isUnion() || child.getCompleteType().isComplex()) {
          final JClass complexCopierClass =
              generator.getModel().ref(org.apache.arrow.vector.complex.impl.ComplexCopier.class);
          final JExpression castedWriter =
              JExpr.cast(generator.getModel().ref(FieldWriter.class), writer);
          generator
              .getEvalBlock()
              .add(
                  complexCopierClass
        ...
        final JInvocation setMeth =
            GetSetVectorHelper.write(
                e.getChild().getCompleteType().toMinorType(),
                vv,
                inputContainer,
                outIndex,
                e.isSafe() ? "setSafe" : "set");
    ...
    private HoldingContainer visitValueVectorReadExpression(
        ValueVectorReadExpression e, ClassGenerator<?> generator) throws RuntimeException {
      ...
      if (!hasReadPath && !complex) {
        ...
        GetSetVectorHelper.read(
            e.getCompleteType(), vv1, eval, out, generator.getModel(), indexVariable);
        ...
        if (isNullReaderLikely) {
          isNull =
              generator
                  .getEvalBlock()
                  .decl(generator.getModel().INT, generator.getNextVar("isNull"), JExpr.lit(0));
        }

        JLabel label = generator.getEvalBlock().label("complex");
        JBlock eval = generator.getEvalBlock().block();

        if (ListVector.class.equals(e.getFieldId().getIntermediateClass())
            && generator.hasVVDeclaration(
                generator.getMappingSet().getIncoming(), e.getFieldId())) {
        ...
        while (seg != null) {
          if (seg.isArray()) {
            ...
            JVar list =
                generator.declareClassField("list", generator.getModel()._ref(FieldReader.class));
            ...
            // get start position in reader
            eval.add(list.invoke("next"));
            JVar readerStartPosition =
                eval.decl(
                    generator.getModel().INT,
                    "readerStartPosition" + listNum,
                    list.invoke("reader").invoke("getPosition"));
            // needed position is start position + desired index
            eval.add(
                list.invoke("reader")
                    .invoke("setPosition")
                    .arg(desiredIndex.plus(readerStartPosition)));
        ...
        if (complex) {
          JVar complexReader =
              generator.declareClassField("reader", generator.getModel()._ref(FieldReader.class));
          ...
          HoldingContainer hc =
              new HoldingContainer(e.getCompleteType(), complexReader, null, null, false, true);
          return hc;
        } else {
          if (seg != null) {
            eval.add(
                expr.invoke("read")
                    .arg(JExpr.lit(seg.getArraySegment().getOptionalIndex()))
                    .arg(out.getHolder()));
          } else {
    ...
    private HoldingContainer visitReturnValueExpression(
        ReturnValueExpression e, ClassGenerator<?> generator) {
    ...
    @Override
    public HoldingContainer visitIntervalDayConstant(
        IntervalDayExpression e, ClassGenerator<?> generator) throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitCastExpression(CastExpression e, ClassGenerator<?> value)
        throws RuntimeException {
      throw new UnsupportedOperationException(
          "CastExpression is not expected here. "
              + "It should have been converted to FunctionHolderExpression in materialization");
    }
    ...
    private HoldingContainer visitBooleanAnd(BooleanOperator op, ClassGenerator<?> generator) {
      ...
      for (int i = 0; i < op.args.size(); i++) {
        ...
        earlyExit =
            eval._if(arg.getIsSet().eq(JExpr.lit(1)).cand(arg.getValue().ne(JExpr.lit(1))))._then();
        if (e == null) {
          e = arg.getIsSet();
        } else {
    ...
    private HoldingContainer visitBooleanOr(BooleanOperator op, ClassGenerator<?> generator) {
      ...
      for (int i = 0; i < op.args.size(); i++) {
        ...
        JBlock earlyExit =
            eval._if(arg.getIsSet().eq(JExpr.lit(1)).cand(arg.getValue().eq(JExpr.lit(1))))._then();
        if (e == null) {
          e = arg.getIsSet();
        } else {
          e = e.mul(arg.getIsSet());
  ...
  private class CSEFilter extends InnerMethodNester {
    ...
    @Override
    public HoldingContainer visitFunctionHolderExpression(
        FunctionHolderExpression holder, ClassGenerator<?> generator) throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitCaseExpression(
        CaseExpression caseExpr, ClassGenerator<?> generator) throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitBooleanOperator(BooleanOperator call, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer hc = getPrevious(call, generator.getMappingSet());
      if (hc == null) {
    ...
    @Override
    public HoldingContainer visitIntConstant(IntExpression intExpr, ClassGenerator<?> generator)
        throws RuntimeException {
      return super.visitIntConstant(intExpr, generator);
    }

    @Override
    public HoldingContainer visitFloatConstant(FloatExpression fExpr, ClassGenerator<?> generator)
        throws RuntimeException {
      return super.visitFloatConstant(fExpr, generator);
    }

    @Override
    public HoldingContainer visitLongConstant(LongExpression longExpr, ClassGenerator<?> generator)
        throws RuntimeException {
      return super.visitLongConstant(longExpr, generator);
    }

    @Override
    public HoldingContainer visitDateConstant(DateExpression dateExpr, ClassGenerator<?> generator)
        throws RuntimeException {
      return super.visitDateConstant(dateExpr, generator);
    }

    @Override
    public HoldingContainer visitTimeConstant(TimeExpression timeExpr, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitTimeStampConstant(
        TimeStampExpression timeStampExpr, ClassGenerator<?> generator) throws RuntimeException {
      return super.visitTimeStampConstant(timeStampExpr, generator);
    }

    @Override
    public HoldingContainer visitIntervalYearConstant(
        IntervalYearExpression intervalYearExpression, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitIntervalDayConstant(
        IntervalDayExpression intervalDayExpression, ClassGenerator<?> generator)
        throws RuntimeException {
      return super.visitIntervalDayConstant(intervalDayExpression, generator);
    }

    @Override
    public HoldingContainer visitDecimalConstant(
        DecimalExpression decExpr, ClassGenerator<?> generator) throws RuntimeException {
      return super.visitDecimalConstant(decExpr, generator);
    }

    @Override
    public HoldingContainer visitDoubleConstant(DoubleExpression dExpr, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    @Override
    public HoldingContainer visitNullExpression(NullExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    public HoldingContainer visitUnknown(LogicalExpression e, ClassGenerator<?> generator)
      ...
      if (e instanceof ValueVectorReadExpression) {
        ...
        if (hc == null
            || ListVector.class.equals(
                ((ValueVectorReadExpression) e).getFieldId().getIntermediateClass())) {
    ...
    @Override
    public HoldingContainer visitCastExpression(CastExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer hc = getPrevious(e, generator.getMappingSet());
      if (hc == null) {
    ...
    @Override
    public HoldingContainer visitConvertExpression(ConvertExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      HoldingContainer hc = getPrevious(e, generator.getMappingSet());
      if (hc == null) {
  ...
  /**
   * Keeps track of how many expression have been visited in the current eval block. A new method is
   * rolled out whenever the threshold is reached
   */
  private class InnerMethodNester extends EvalVisitor {
    ...
    private boolean shouldNestMethod() {
      ...
      if (caseConditionCount.isEmpty()) {
        ...
        return caseCount > newMethodThreshold
            || (numExprs != null && numExprs > newMethodThreshold);
      }
    }
  ...
  /**
   * Filter constants at the first level as constants can be treated at global scope. Also,
   * constants with the same literal value need be rendered only once.
   */
  private class ConstantFilter extends CSEFilter {
    ...
    private HoldingContainer preProcessIfConstant(
        LogicalExpression e,
      ...
      if (constantBoundaries.contains(e)) {
        ...
        return containerCreator
            .get()
            .setConstant(true)
            .setNullConstant(generator.getMappingSet().isNullConstant());
      } else {
        return (containerCreatorForVar != null)
            ? containerCreatorForVar.get()
            : containerCreator.get();
      }
    }

    @Override
    public HoldingContainer visitFunctionCall(FunctionCall e, ClassGenerator<?> generator)
        throws RuntimeException {
      throw new UnsupportedOperationException(
          "FunctionCall is not expected here. "
              + "It should have been converted to FunctionHolderExpression in materialization");
    ...
    @Override
    public HoldingContainer visitFunctionHolderExpression(
        FunctionHolderExpression e, ClassGenerator<?> generator) throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitFunctionHolderExpression(e, generator), null);
    }
    ...
    public HoldingContainer visitBooleanOperator(BooleanOperator e, ClassGenerator<?> generator)
      ...
      return preProcessIfConstant(
          e,
          generator,
          () -> super.visitBooleanOperator(e, generator),
          () -> {
            // want to optimize a non-constant boolean operator.
            if (functionContext.getCompilationOptions().enableOrOptimization()
                && "booleanOr".equals(e.getName())) {
              List<LogicalExpression> newExpressions =
              ...
              return super.visitBooleanOperator(
                  new BooleanOperator(e.getName(), newExpressions), generator);
            }
    ...
    @Override
    public HoldingContainer visitIfExpression(IfExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    public HoldingContainer visitCaseExpression(
        CaseExpression caseExpr, ClassGenerator<?> generator) throws RuntimeException {
      return preProcessIfConstant(
          caseExpr, generator, () -> super.visitCaseExpression(caseExpr, generator), null);
    }

    @Override
    public HoldingContainer visitSchemaPath(SchemaPath e, ClassGenerator<?> generator)
        throws RuntimeException {
    ...
    public HoldingContainer visitDecimalConstant(DecimalExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitDecimalConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitIntervalYearConstant(
        IntervalYearExpression e, ClassGenerator<?> generator) throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitIntervalYearConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitTimeStampConstant(
        TimeStampExpression e, ClassGenerator<?> generator) throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitTimeStampConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitDoubleConstant(DoubleExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitDoubleConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitBooleanConstant(BooleanExpression e, ClassGenerator<?> generator)
        throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitBooleanConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitQuotedStringConstant(QuotedString e, ClassGenerator<?> generator)
        throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitQuotedStringConstant(e, generator), null);
    }
    ...
    public HoldingContainer visitIntervalDayConstant(
        IntervalDayExpression e, ClassGenerator<?> generator) throws RuntimeException {
      return preProcessIfConstant(
          e, generator, () -> super.visitIntervalDayConstant(e, generator), null);
    }
     ...
     */
    private HoldingContainer renderConstantExpression(
        ClassGenerator<?> generator, HoldingContainer input) {
      final JType jType =
          CodeModelArrowHelper.getHolderType(input.getCompleteType(), generator.getModel());
      ...
      generator.getMappingSet().exitConstant();
      return new HoldingContainer(
              input.getCompleteType(), target, jType, target.ref("value"), target.ref("isSet"))
          .setConstant(true);
    }
  }

  /** Count total function and/or boolean expressions inside case conditions */
  private static class CaseExpressionCounter
