...
public class FragmentOptionManager extends BaseOptionManager {
  ...
  public FragmentOptionManager(
      OptionValidatorListing optionValidatorListing, OptionList nonDefaultOptions) {
  ...
  protected boolean supportsOptionType(OptionType type) {
    throw new UnsupportedOperationException(
        "FragmentOptionManager does not support the given option value.");
  }

  @Override
  public boolean setOption(OptionValue value) {
    throw new UnsupportedOperationException(
        "FragmentOptionManager does not support options mutation.");
  }

  @Override
  public boolean deleteOption(String name, OptionType type) {
    throw new UnsupportedOperationException(
        "FragmentOptionManager does not support options deletion.");
  }

  @Override
  public boolean deleteAllOptions(OptionType type) {
    throw new UnsupportedOperationException(
        "FragmentOptionManager does not support options deletions for all.");
  }
