 ...
 * modified table data (insert/update/delete)
 */
public class TableMetadataVerifyDataModifiedRequest implements TableMetadataVerifyRequest {
  private final String beginSnapshotId;
  private final String endSnapshotId;

  public TableMetadataVerifyDataModifiedRequest(String beginSnapshotId, String endSnapshotId) {
