...
public class AccelerationAwareSubstitutionProvider implements SubstitutionProvider, Observable {
  private static final Logger logger =
      LoggerFactory.getLogger(AccelerationAwareSubstitutionProvider.class);
  ...
  public AccelerationAwareSubstitutionProvider(
      final SubstitutionProvider delegate, final boolean enabled) {
