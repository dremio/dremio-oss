 ...
 *
 * <p>Due to the lazy instantiation of cache manager, the handle to cache manager instance is buried
 * in the CacheFileSystemCreator object. Sabot context does not have handle to the cache manager
 * instance but has the handle to file system creator. At the system table iterator creation, we
 * have handle only to the sabot context. So need to have the below interface implemented by file
 * system creator and get the cache manager statistics.
 */
