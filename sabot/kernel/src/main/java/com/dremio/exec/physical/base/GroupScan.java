...
public interface GroupScan<T extends CompleteWork> extends Scan {
   ...
   */
  static final ImmutableList<SchemaPath> ALL_COLUMNS = ImmutableList.of(SchemaPath.getSimplePath("*"));
   ...
   * Currently, this is used in {@link com.dremio.exec.planner.fragment.SimpleParallelizer}
