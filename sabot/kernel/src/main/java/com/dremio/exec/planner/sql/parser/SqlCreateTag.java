...
public final class SqlCreateTag extends SqlCreateVersionBase {
      ...
      new SqlSpecialOperator("CREATE_TAG", SqlKind.OTHER) {
        ...
        public SqlCall createCall(
          ...
          Preconditions.checkArgument(
              operands.length == 7, "SqlCreateTag.createCall() has to get 7 operands!");
  ...
  public SqlCreateTag(
      SqlParserPos pos,
      SqlLiteral shouldErrorIfTagExists,
    ...
    super(pos, shouldErrorIfTagExists, refType, refValue, timestamp, sourceName);
