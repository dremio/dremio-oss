...
/**
 * A sender is one half of an exchange node operations. It is responsible for subdividing/cloning
 * and sending a local record set to a set of destination locations. This is typically only utilized
 * at the level of the execution plan.
 */
public interface Sender extends FragmentRoot {
   ...
   *
   * @return List of receiver MinorFragmentIndexEndpoints each containing receiver fragment
   ...
   * @return List of receiver MinorFragmentEndpoints each containing receiver fragment
   *     MinorFragmentId and endpoint where it is running.
   */
