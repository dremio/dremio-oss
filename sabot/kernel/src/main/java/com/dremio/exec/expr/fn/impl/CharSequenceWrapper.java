...
public class CharSequenceWrapper implements CharSequence {
  ...
  // The adapted Arrow buffer (in the case of US-ASCII)
  ...
  // The start offset into the Arrow buffer
  private int start;
  // The end offset into the Arrow buffer
  private int end;
   ...
   * @param buffer
   */
  public void setBuffer(int start, int end, ArrowBuf buffer) {
   ...
   * @return
   */
  private boolean isAscii(int start, int end, ArrowBuf buffer) {
