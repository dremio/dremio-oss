...
@JsonTypeName("manifest-list-scan")
public class ManifestListScanTableFunctionContext extends TableFunctionContext {
  private final boolean isCarryForwardEnabled;    // Enable TF to carry forward processed rows' info

  public ManifestListScanTableFunctionContext(
    ...
    super(formatSettings, fullSchema, tableSchema, tablePath, scanFilter, pluginId, internalTablePluginId, columns, partitionColumns, globalDictionaryEncodedColumns,
