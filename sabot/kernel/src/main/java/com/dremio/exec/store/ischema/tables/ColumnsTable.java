 ...
 */
public class ColumnsTable extends BaseInfoSchemaTable<ColumnsTable.Column> {

  public static final ColumnsTable DEFINITION = new ColumnsTable();

  private ColumnsTable() {
    super("COLUMNS", ColumnsTable.Column.class);
  }
