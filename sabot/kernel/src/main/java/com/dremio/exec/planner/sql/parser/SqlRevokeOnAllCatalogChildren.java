 ...
 */
public class SqlRevokeOnAllCatalogChildren extends SqlRevokeOnAllDatasets
      ...
      new SqlSpecialOperator("GRANT", SqlKind.OTHER) {
        ...
        public SqlCall createCall(
          ...
          Preconditions.checkArgument(
              operands.length == 5,
              "SqlRevokeOnAllCatalogChildren.createCall() has to get 5 operands!");

          return new SqlRevokeOnAllCatalogChildren(
              pos,
  ...
  public SqlRevokeOnAllCatalogChildren(
      SqlParserPos pos,
  ...
  public SimpleDirectHandler toDirectHandler(QueryContext context) {
    try {
      final Class<?> cl =
          Class.forName("com.dremio.exec.planner.sql.handlers.RevokeOnAllCatalogChildrenHandler");
