...
/**
 * A custom implementation of a WriterCommitter Physical Operator used for handling COPY INTO errors.
 */
@JsonTypeName("copy-into-error-writer-committer")
public class CopyIntoErrorWriterCommitterPOP extends WriterCommitterPOP {

  private final SystemIcebergTablesStoragePlugin systemIcebergTablesStoragePlugin;

  /**
   * Constructs a new CopyIntoErrorWriterCommitterPOP instance with the given parameters.
   *
   ...
   */
  public CopyIntoErrorWriterCommitterPOP(
    ...
    @JsonProperty("systemIcebergTablesStoragePluginId") StoragePluginId systemIcebergTablesStoragePluginId
  ) {
    super(props, tempLocation, finalLocation, pluginId, icebergTableProps, datasetPath, datasetConfig, child,
      isPartialRefresh, isReadSignatureEnabled, sourceTablePluginId, tableFormatOptions, storagePluginResolver);
    this.systemIcebergTablesStoragePlugin = systemIcebergTablesStoragePluginId != null ? storagePluginResolver.getSource(systemIcebergTablesStoragePluginId) : null;
  }

  public CopyIntoErrorWriterCommitterPOP(OpProps props,
                                         String tempLocation,
    ...
    super(props, tempLocation, finalLocation, icebergTableProps, datasetPath, datasetConfig, child, plugin,
      sourceTablePlugin, isPartialRefresh, isReadSignatureEnabled, tableFormatOptions, sourceTablePluginId);
    this.systemIcebergTablesStoragePlugin = errorPlugin;
  }

  @Override
  protected PhysicalOperator getNewWithChild(PhysicalOperator child) {
    return new CopyIntoErrorWriterCommitterPOP(getProps(), getTempLocation(), getFinalLocation(), getIcebergTableProps(),
      getDatasetPath(), getDatasetConfig(), child, getPlugin(), (StoragePlugin) getSourceTablePlugin(),
      isPartialRefresh(), isReadSignatureEnabled(), getTableFormatOptions(), getSourceTablePluginId(), getSystemIcebergTablesStoragePlugin());
  }
  ...
  public StoragePluginId getSystemIcebergTablesStoragePluginId() {
    return systemIcebergTablesStoragePlugin != null ? systemIcebergTablesStoragePlugin.getId() : null;
  }
  ...
  @JsonIgnore
  public CopyIntoErrorsHandler getErrorHandler(OperatorContext context) {
    return new CopyIntoErrorsHandler(context, getSystemIcebergTablesStoragePlugin());
  }
}
