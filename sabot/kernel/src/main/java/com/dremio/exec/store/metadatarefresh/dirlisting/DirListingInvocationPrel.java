...
public class DirListingInvocationPrel extends ScanPrelBase implements Prel, PrelFinalizable, Rel {
  ...
  public DirListingInvocationPrel(RelOptCluster cluster, RelTraitSet traitSet, RelOptTable table, StoragePluginId pluginId,
                                  ...
                                  FileSystemPlugin<?> plugin, String uuid, boolean isPartialRefresh,
                                  UnlimitedSplitsMetadataProvider metadataProvider, List<String> partialRefreshPaths,
                                  final Function<RelMetadataQuery, Double> estimateRowCountFn, List<Info> runtimeFilters) {
    super(cluster, traitSet, table, pluginId, tableMetadata, PROJECTED_COLS, observedRowcountAdjustment, hints,
          runtimeFilters);
  ...
  public DirListingInvocationPrel copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new DirListingInvocationPrel(getCluster(), traitSet, table, pluginId, tableMetadata,
                                        observedRowcountAdjustment, getHints(), metaStoragePlugin, tableUUID,
                                        isPartialRefresh, metadataProvider, partialRefreshPaths, estimateRowCountFn,
                                        getRuntimeFilters());
  }
  ...
  public Prel finalizeRel() {
    ...
    Prel dirListingScanPrel = new DirListingScanPrel(getCluster(), traitSet, table, pluginId, tableMetadata,
      getObservedRowcountAdjustment(), getHints(), !isPartialRefresh, estimateRowCountFn, getRuntimeFilters());
