...
/**
 * Group-scan configuration, that walks over the tables present in the Versioned store, across
 * multiple branches.
 */
public class NessieCommitsGroupScan extends AbstractBase implements GroupScan<SplitWork> {
  ...
  public int getMinParallelizationWidth() {
    ...
    // If we move this code to supply branch as input splits, the width should be equal to number of
    // branches.
    return 1;
  }
