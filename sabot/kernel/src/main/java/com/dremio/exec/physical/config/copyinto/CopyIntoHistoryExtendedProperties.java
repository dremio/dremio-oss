...
public class CopyIntoHistoryExtendedProperties implements ExtendedProperty {
  private String originalJobId;
  private BatchSchema validatedTableSchema;

  public CopyIntoHistoryExtendedProperties() {
    // for serialization purposes
  }

  public CopyIntoHistoryExtendedProperties(String originalJobId, BatchSchema validatedTableSchema) {
