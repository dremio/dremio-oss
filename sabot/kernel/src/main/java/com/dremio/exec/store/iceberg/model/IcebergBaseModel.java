...
public abstract class IcebergBaseModel implements IcebergModel {
  ...
  private IcebergCommand getIcebergCommandWithMetricStat(
    ...
    try {
      ...
      if (operatorContext != null && operatorContext.getStats() != null) {
        operatorContext.getStats().addLongStat(WriterCommitterOperator.Metric.ICEBERG_COMMAND_CREATE_TIME, icebergCommandTime);
      }
    }
  }
  ...
  public IcebergOpCommitter getCreateTableCommitter(String tableName, IcebergTableIdentifier tableIdentifier,
                                                    BatchSchema batchSchema, List<String> partitionColumnNames, OperatorStats operatorStats, PartitionSpec partitionSpec, SortOrder sortOrder, Map<String, String> tableProperties) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.CREATE_TABLE);
    return new IcebergTableCreationCommitter(tableName, batchSchema, partitionColumnNames, icebergCommand, tableProperties, operatorStats, partitionSpec, sortOrder);
  }

  @Override
  public IcebergOpCommitter getInsertTableCommitter(IcebergTableIdentifier tableIdentifier, OperatorStats operatorStats) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.INSERT_TABLE);
  ...
  public IcebergOpCommitter getFullMetadataRefreshCommitter(String tableName, List<String> datasetPath, String tableLocation,
                                                            ...
                                                            DatasetConfig datasetConfig, OperatorStats operatorStats, PartitionSpec partitionSpec, FileType fileType) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.FULL_METADATA_REFRESH);
    return new FullMetadataRefreshCommitter(tableName, datasetPath, tableLocation, tableUuid, batchSchema, configuration,
      partitionColumnNames, icebergCommand, client, datasetConfig, operatorStats, partitionSpec, plugin, fileType);
  }
  ...
  public IcebergOpCommitter getIncrementalMetadataRefreshCommitter(OperatorContext operatorContext, String tableName, List<String> datasetPath, String tableLocation,
                                                                   String tableUuid, IcebergTableIdentifier tableIdentifier,
                                                                   BatchSchema batchSchema, List<String> partitionColumnNames,
                                                                   boolean isFileSystem, DatasetConfig datasetConfig, FileSystem fs, Long metadataExpireAfterMs,
                                                                   IcebergCommandType icebergOpType, FileType fileType) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.INCREMENTAL_METADATA_REFRESH);
    return new IncrementalMetadataRefreshCommitter(operatorContext, tableName, datasetPath, tableLocation, tableUuid, batchSchema, configuration,
      partitionColumnNames, icebergCommand, isFileSystem, client, datasetConfig, plugin, fs, metadataExpireAfterMs, icebergOpType, fileType);
  ...
  public IcebergOpCommitter getAlterTableCommitter(IcebergTableIdentifier tableIdentifier, ColumnOperations.AlterOperationType alterOperationType, BatchSchema droppedColumns, BatchSchema updatedColumns,
    ...
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.ALTER_TABLE);
  ...
  public IcebergOpCommitter getOptimizeCommitter(OperatorStats operatorStats,
                                                 ...
                                                 FileSystem fs) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.OPTIMIZE_REWRITE_DATA_TABLE);
    return new IcebergOptimizeOperationCommitter(icebergCommand, operatorStats, datasetConfig,
      minInputFilesBeforeOptimize,snapshotId, icebergTableProps, fs);
  }

  @Override
  public void rollbackTable(IcebergTableIdentifier tableIdentifier, RollbackOption rollbackOption) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.ROLLBACK_TABLE);
    icebergCommand.rollback(rollbackOption);
  }

  @Override
  public List<SnapshotEntry> expireSnapshots(IcebergTableIdentifier tableIdentifier, long olderThanInMillis, int retainLast) {
  ...
  public void deleteTable(IcebergTableIdentifier tableIdentifier) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.DROP_TABLE);
  ...
  @Override
  public void updateTableProperties(IcebergTableIdentifier tableIdentifier, Map<String, String> properties) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.ALTER_TABLE);
    icebergCommand.updateProperties(properties, false);
  }

  @Override
  public void removeTableProperties(IcebergTableIdentifier tableIdentifier, List<String> propertyNames) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.ALTER_TABLE);
  ...
  @Override
  public long propertyAsLong(IcebergTableIdentifier tableIdentifier, String propertyName, long defaultValue) {
    IcebergCommand icebergCommand = getIcebergCommandWithMetricStat(tableIdentifier, IcebergCommitOrigin.READ_ONLY);
