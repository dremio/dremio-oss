 ...
 */
public abstract class DremioOptimizationRelOptRule extends RelOptRule {
  private static final Logger logger = LoggerFactory.getLogger(DremioOptimizationRelOptRule.class);

  public DremioOptimizationRelOptRule(RelOptRuleOperand operand) {
    super(operand);
  }

  public DremioOptimizationRelOptRule(RelOptRuleOperand operand, String description) {
