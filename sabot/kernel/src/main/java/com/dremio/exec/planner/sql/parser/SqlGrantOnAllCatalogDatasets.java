 ...
 */
public class SqlGrantOnAllCatalogDatasets extends SqlGrantOnAllDatasets
      ...
      new SqlSpecialOperator("GRANT", SqlKind.OTHER) {
        ...
        public SqlCall createCall(
          ...
          Preconditions.checkArgument(
              operands.length == 5,
              "SqlGrantOnAllCatalogDatasets.createCall() has to get 5 operands!");
  ...
  public SqlGrantOnAllCatalogDatasets(
      SqlParserPos pos,
  ...
  public SimpleDirectHandler toDirectHandler(QueryContext context) {
    try {
      final Class<?> cl =
          Class.forName("com.dremio.exec.planner.sql.handlers.GrantOnAllCatalogDatasetsHandler");
