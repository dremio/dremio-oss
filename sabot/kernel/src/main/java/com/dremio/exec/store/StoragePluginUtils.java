...
public final class StoragePluginUtils {
  ...
  /**
   * Generates an error message with the following format: [%s] %s, where the first parameter
   * indicates the source name and the second refers to the error.
   *
   ...
   */
  public static String generateSourceErrorMessage(
      final String storagePluginName, String errorMessage) {
    return String.format("Source '%s' returned error '%s'", storagePluginName, errorMessage);
  }

  /**
   * Given a {@code UserException.Builder} instance, adds a message and the source name as context
   * to the instance.
   *
   * @param builder The UserException.Builder instance
   * @param errorMessage The format string to be used for the error message
   * @param sourceName The name of the source to be added to the context of the
   *     UserException.Builder instance.
   * @param args Arguments referenced by the format specifiers in the format string.
   * @return The modified UserException.Builder instance.
   */
  @FormatMethod
  public static UserException.Builder message(
   ...
   */
  public static UserException.Builder message(
      UserException.Builder builder, String sourceName, String errorMessage) {
    return builder
        .message(generateSourceErrorMessage(sourceName, errorMessage))
