...
public final class OptimizeOutputSchema {
  ...
  public static RelDataType getRelDataType(
      RelDataTypeFactory typeFactory, boolean onlyOptimizeManifests) {
    if (onlyOptimizeManifests) {
      return typeFactory
          .builder()
          .add(
              OptimizeOutputSchema.OPTIMIZE_OUTPUT_SUMMARY,
    ...
    return typeFactory
        .builder()
        .add(
            OptimizeOutputSchema.REWRITTEN_DATA_FILE_COUNT,
            typeFactory.createTypeWithNullability(
                typeFactory.createSqlType(SqlTypeName.BIGINT), true))
        .add(
            OptimizeOutputSchema.REWRITTEN_DELETE_FILE_COUNT,
            typeFactory.createTypeWithNullability(
                typeFactory.createSqlType(SqlTypeName.BIGINT), true))
        .add(
            OptimizeOutputSchema.NEW_DATA_FILES_COUNT,
            typeFactory.createTypeWithNullability(
                typeFactory.createSqlType(SqlTypeName.BIGINT), true))
        .build();
  }
