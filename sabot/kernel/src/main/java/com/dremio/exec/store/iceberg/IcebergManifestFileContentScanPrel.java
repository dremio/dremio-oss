...
/**
 * table_files Metadata Functions use IcebergManifestFileContentScanPrel to fetch data file content
 * from manifest file.
 */
public class IcebergManifestFileContentScanPrel extends ScanPrelBase implements PrelFinalizable {

  public IcebergManifestFileContentScanPrel(
  ...
  public Prel finalizeRel() {
    ...
    HashToRandomExchangePrel manifestSplitsExchange =
        new HashToRandomExchangePrel(
            ...
            TableFunctionUtil.getHashExchangeTableFunctionCreator(tableMetadata, true));
    ...
    RelDataType rowTypeFromProjectedColumns =
        getRowTypeFromProjectedColumns(projectedColumns, manifestFileReaderSchema, getCluster());
