...
public interface Prel extends RelNode, Iterable<Prel> {
  ...
  Convention PHYSICAL =
      new Convention.Impl("PHYSICAL", Prel.class) {
        @Override
        public boolean canConvertConvention(Convention toConvention) {
          // TODO should think about how we can get rid of "toConvention == LOGICAL" here.  It
          // shouldn't be needed, but
          // currently, our Dremio ProjectPrule matches on ProjectRel + Any, and without the
          // abstract converters added,
  ...
  /**
   * Supported 'encodings' of a Prel indicates what are the acceptable modes of SelectionVector of
   * its child Prel
   */
