...
/**
 * A custom implementation of a WriterCommitter Prel used for handling COPY INTO file load events.
 */
@Options
public class CopyIntoHistoryWriterCommitterPrel extends WriterCommitterPrel {

  private final SystemIcebergTablesStoragePlugin systemIcebergTablesStoragePlugin;

  /**
   * Constructs a new {@link CopyIntoHistoryWriterCommitterPrel instance with the given parameters.
   *
   ...
   * @param systemIcebergTablesStoragePlugin The {@link SystemIcebergTablesStoragePlugin} instance
   *     representing the storage plugin for system iceberg tables.
   */
  public CopyIntoHistoryWriterCommitterPrel(
  ...
  /**
   * Retrieves the {@link SystemIcebergTablesStoragePlugin} instance representing the storage
   * plugin.
   *
   * @return The {@link SystemIcebergTablesStoragePlugin} instance representing the storage plugin.
   */
