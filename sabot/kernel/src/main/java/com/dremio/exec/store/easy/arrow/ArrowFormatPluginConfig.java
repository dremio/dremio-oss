...
public class ArrowFormatPluginConfig implements FormatPluginConfig {
  ...
  /**
   * Extensions of files written using the {@link RecordWriter} implementation of this plugin. This
   * needs to be public in order for the query with options to work.
   */
