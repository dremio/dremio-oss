...
/**
 * This class represents the information of an error that occurred during the COPY INTO operation.
 * It implements the ErrorInfo interface.
 */
public final class CopyIntoErrorInfo implements ErrorInfo {
  ...
  private CopyIntoErrorInfo() {}

  private CopyIntoErrorInfo(Builder builder) {
  ...
  /**
   * Builder class for constructing CopyIntoErrorInfo instances.
   */
  public static final class Builder {
    ...
    /**
     * Constructs a new instance of the CopyIntoErrorInfo.Builder with the given parameters.
     *
     ...
     */
    public Builder(String queryId, String queryUser, String tableName, String storageLocation, String filePath,
                   ExtendedFormatOptions formatOptions, String fileFormat, CopyIntoFileState fileState) {
    ...
    /**
     * Constructs a new instance of the CopyIntoErrorInfo.Builder by copying the properties from an existing CopyIntoErrorInfo instance.
     *
     * @param info The existing CopyIntoErrorInfo instance to copy properties from.
     */
    public Builder(CopyIntoErrorInfo info) {
    ...
    /**
     * Builds a new instance of CopyIntoErrorInfo with the properties set in this builder.
     *
     * @return The constructed CopyIntoErrorInfo instance.
     */
    public CopyIntoErrorInfo build() {
      return new CopyIntoErrorInfo(this);
    }
  }

  /**
   * The Util class provides utility methods for serializing and deserializing format options to and from JSON.
   * It contains static methods to format options map to their JSON representation and vice versa using Jackson ObjectMapper.
  ...
  public static final class Util {
    ...
    public static String getJson(Map<FormatOption, Object> formatOptions) {
      try {
        ...
        throw new IllegalStateException(String.format("Cannot serialize format option map to json: %s", formatOptions));
      }
    }
    ...
    public static Map<FormatOption, Object> getFormatOptions(String json) {
      TypeReference<Map<FormatOption, Object>> typeRef = new TypeReference<Map<FormatOption, Object>>() {};
      try {
        return MAPPER.readValue(json, typeRef);
      } catch (JsonProcessingException e) {
        throw new IllegalStateException(String.format("Cannot deserialize json to format option map:\n%s", json));
      }
    }
  }
}
