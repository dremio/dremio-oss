...
public final class DeltaConstants {
  ...
  public static final String DELTA_FIELD_METADATA_CONFIGURATION = "configuration";
  public static final String DELTA_METADATA_COLUMN_MAPPING_MODE = "delta.columnMapping.mode";
  public static final String DELTA_COLUMN_MAPPING_NAME = "name";
  public static final String DELTA_COLUMN_MAPPING_ID = "id";
  ...
  public static final String SCHEMA_STRING_FIELDS_METADATA = "metadata";
  public static final String SCHEMA_STRING_FIELDS_COLUMN_MAPPING_ID = "delta.columnMapping.id";
  public static final String SCHEMA_STRING_FIELDS_COLUMN_MAPPING_PHYSICAL_NAME =
      "delta.columnMapping.physicalName";
  public static final String DREMIO_COLUMN_MAPPING_ORIGINAL_NAME =
      "dremio.columnMapping.originalName";
  ...
  public static final String OPERATION_CREATE_OR_REPLACE_TABLE_AS_SELECT =
      "CREATE OR REPLACE TABLE AS SELECT";
  public static final List<String> CREATE_OPERATIONS =
      Arrays.asList(
          OPERATION_CREATE_TABLE,
          OPERATION_CREATE_TABLE_AS_SELECT,
          OPERATION_CREATE_OR_REPLACE_TABLE,
          OPERATION_CREATE_OR_REPLACE_TABLE_AS_SELECT);
  ...
  public static final String SCHEMA_REMOVE_PATH =
      DELTA_FIELD_REMOVE + DELTA_FIELD_JOINER + SCHEMA_PATH;
  public static final String SCHEMA_ADD_VERSION = DELTA_FIELD_ADD + DELTA_FIELD_JOINER + VERSION;
  public static final String SCHEMA_REMOVE_VERSION =
      DELTA_FIELD_REMOVE + DELTA_FIELD_JOINER + VERSION;
  public static final String SCHMEA_ADD_DATACHANGE =
      DELTA_FIELD_ADD + DELTA_FIELD_JOINER + SCHEMA_DATA_CHANGE;
  public static final String SCHEMA_ADD_SIZE = DELTA_FIELD_ADD + DELTA_FIELD_JOINER + SCHEMA_SIZE;
  public static final String SCHEMA_ADD_MODIFICATION_TIME =
      DELTA_FIELD_ADD + DELTA_FIELD_JOINER + SCHEMA_MODIFICATION_TIME;
