...
public class VacuumTableCrel extends VacuumTableRelBase {
  ...
  public VacuumTableCrel(RelOptCluster cluster,
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new VacuumTableCrel(getCluster(), traitSet, sole(inputs), getTable(), getCreateTableEntry(), getVacuumOptions());
  }

  public VacuumTableCrel createWith(CreateTableEntry createTableEntry) {
    return new VacuumTableCrel(getCluster(), getTraitSet(), getInput(), getTable(), createTableEntry, getVacuumOptions());
  }

  public RelNode createWith(VacuumOptions vacuumOptions) {
    return new VacuumTableCrel(getCluster(), traitSet, getInput(), getTable(), getCreateTableEntry(), vacuumOptions);
  }
}
