  ...
  public static class NullableFloatHash implements SimpleFunction {
    ...
    public void eval() {
      ...
      if (in.isSet == 0) {
        ...
        out.value = com.dremio.exec.expr.fn.impl.HashHelper.hash32(in.value, 0);
      }
    }
  }
  ...
  public static class NullableVarBinaryHash implements SimpleFunction {
    ...
    public void eval() {
      ...
      if (in.isSet == 0) {
        ...
        out.value = com.dremio.exec.expr.fn.impl.HashHelper.hash32(in.start, in.end, in.buffer, 0);
      }
    }
  }
