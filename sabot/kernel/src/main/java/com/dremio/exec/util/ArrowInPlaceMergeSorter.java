...
/**
 * In place merge sorter for fixed length block values.
 * Intended for small value sets only.
 */
public class ArrowInPlaceMergeSorter extends InPlaceMergeSorter {
    ...
    public ArrowInPlaceMergeSorter(final ArrowBuf arrowBuf,
                                   final int blockSize,
                                   final ArrowCrossBufComparator comparator) {
