 ...
 */
public class SqlGrantOnAllCatalogChildren extends SqlGrantOnAllDatasets
      ...
      new SqlSpecialOperator("GRANT", SqlKind.OTHER) {
        ...
        public SqlCall createCall(
          ...
          Preconditions.checkArgument(
              operands.length == 5,
              "SqlGrantOnAllCatalogChildren.createCall() has to get 5 operands!");

          return new SqlGrantOnAllCatalogChildren(
              pos,
  ...
  public SqlGrantOnAllCatalogChildren(
      SqlParserPos pos,
  ...
  public SimpleDirectHandler toDirectHandler(QueryContext context) {
    try {
      final Class<?> cl =
          Class.forName("com.dremio.exec.planner.sql.handlers.GrantOnAllCatalogChildrenHandler");
