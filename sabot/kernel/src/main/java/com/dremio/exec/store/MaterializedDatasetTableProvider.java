...
public class MaterializedDatasetTableProvider implements Provider<MaterializedDatasetTable> {
  ...
  public MaterializedDatasetTable get() {
    ...
    return new MaterializedDatasetTable(pluginId, schemaConfig.getUserName(), datasetConfig, partitionChunks,
        schemaConfig.getOptions().getOption(PlannerSettings.FULL_NESTED_SCHEMA_SUPPORT));
  }
