...
public class DecimalFunctions {
  ...
  public static class CastDecimalVarChar implements SimpleFunction {
    ...
    public void eval() {
      ...
      out.end =
          Math.min(
              (int) len.value,
              istr.length()); // truncate if target type has length smaller than that of input's
      // string
  ...
  @FunctionTemplate(
      names = {"castDECIMAL"},
      derivation = OutputDerivation.DecimalCast.class,
      nulls = NullHandling.NULL_IF_NULL)
  ...
  @SuppressWarnings("unused")
  @FunctionTemplate(
      names = {DECIMAL_CAST_NULL_ON_OVERFLOW},
      derivation = OutputDerivation.DecimalCast.class,
  ...
  public static class CastVarcharDecimalNullOnOverflow implements SimpleFunction {
    ...
    @Inject ArrowBuf buffer;
    @Inject FunctionErrorContext errorContext;
    @Workspace IntHolder expectedSignificantDigits;
  ...
  @FunctionTemplate(
      name = "sum_v2",
      derivation = OutputDerivation.DecimalAggSum.class,
  ...
  /** Sum0 returns 0 instead of nulls in case all aggregation values are null. */
  @SuppressWarnings("unused")
  @FunctionTemplate(
      name = "$sum0_v2",
      derivation = OutputDerivation.DecimalAggSum.class,
  ...
  @FunctionTemplate(
      name = "min_v2",
      derivation = OutputDerivation.DecimalAggMinMax.class,
      scope = FunctionTemplate.FunctionScope.POINT_AGGREGATE)
  public static class NullableDecimalMinV2 implements AggrFunction {
    ...
    public void add() {
      if (in.isSet != 0) {
        ...
        if (compare < 0) {
          in.buffer.getBytes(
              in.start, minVal.buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
        }
      }
    }
  ...
  public static class NullableDecimalMaxV2 implements AggrFunction {
    ...
    public void add() {
      if (in.isSet != 0) {
        ...
        if (compare > 0) {
          in.buffer.getBytes(
              in.start, maxVal.buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
        }
      }
    }
  ...
  /**
   * Decimal comparator where null appears last i.e. nulls are considered larger than all values.
   */
  @FunctionTemplate(
    ...
    public void eval() {
      ...
      outside:
      {
        ...
        out.value =
            com.dremio.exec.util.DecimalUtils.compareSignedDecimalInLittleEndianBytes(
                left.buffer,
                org.apache.arrow.memory.util.LargeMemoryUtil.capAtMaxInt(left.start),
                right.buffer,
                org.apache.arrow.memory.util.LargeMemoryUtil.capAtMaxInt(right.start));
      } // outside
    }
  }

  /**
   * Decimal comparator where null appears first i.e. nulls are considered smaller than all values.
   */
  @FunctionTemplate(
      name = FunctionGenerationHelper.COMPARE_TO_NULLS_LOW,
      scope = FunctionTemplate.FunctionScope.SIMPLE,
      nulls = NullHandling.INTERNAL)
  ...
  public static BigDecimal addOrSubtract(
      boolean isSubtract, BigDecimal left, BigDecimal right, int outPrecision, int outScale) {
    ...
    BigDecimal leftScaled = left.setScale(higherScale, RoundingMode.UNNECESSARY);
    BigDecimal rightScaled = right.setScale(higherScale, RoundingMode.UNNECESSARY);
    BigDecimal result = leftScaled.add(rightScaled);

    if (higherScale > outScale) {
      result = result.setScale(outScale, RoundingMode.HALF_UP);
    }
  ...
  @FunctionTemplate(
      name = "add",
      scope = FunctionScope.SIMPLE,
      derivation = OutputDerivation.DecimalAdd.class,
      nulls = NullHandling.NULL_IF_NULL)
  public static class AddTwoDecimals implements SimpleFunction {

    @Param DecimalHolder in1;
    @Param DecimalHolder in2;
    @Output DecimalHolder out;
    @Inject ArrowBuf buffer;
    @Inject FunctionErrorContext errorContext;
    ...
    public void eval() {
      ...
      org.apache.arrow.vector.types.pojo.ArrowType.Decimal resultTypeForOperation =
          org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.getResultTypeForOperation(
              org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.OperationType.ADD,
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  in1.precision, in1.scale, 128),
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  in2.precision, in2.scale, 128));
      out.precision = resultTypeForOperation.getPrecision();
      out.scale = resultTypeForOperation.getScale();

      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.addOrSubtract(
              false, left, right, out.precision, out.scale);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
      } catch (RuntimeException e) {
  ...
  @FunctionTemplate(
      name = "subtract",
      scope = FunctionScope.SIMPLE,
      derivation = OutputDerivation.DecimalSubtract.class,
      nulls = NullHandling.NULL_IF_NULL)
  public static class SubtractDecimals implements SimpleFunction {

    @Param DecimalHolder leftHolder;
    @Param DecimalHolder rightHolder;
    @Output DecimalHolder resultHolder;
    @Inject ArrowBuf buffer;
    @Inject FunctionErrorContext functionErrorContext;
    ...
    public void eval() {
      ...
      org.apache.arrow.vector.types.pojo.ArrowType.Decimal resultTypeForOperation =
          org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.getResultTypeForOperation(
              org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.OperationType.SUBTRACT,
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  leftHolder.precision, leftHolder.scale, 128),
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  rightHolder.precision, rightHolder.scale, 128));
      resultHolder.precision = resultTypeForOperation.getPrecision();
      resultHolder.scale = resultTypeForOperation.getScale();

      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.addOrSubtract(
              true, left, right, resultHolder.precision, resultHolder.scale);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
      } catch (RuntimeException e) {
  ...
  @FunctionTemplate(
      name = "multiply",
      derivation = OutputDerivation.DecimalMultiply.class,
      scope = FunctionTemplate.FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL)
  public static class MultiplyDecimals implements SimpleFunction {
    ...
    public void eval() {
      ...
      org.apache.arrow.vector.types.pojo.ArrowType.Decimal resultTypeForOperation =
          org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.getResultTypeForOperation(
              org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.OperationType.MULTIPLY,
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  leftHolder.precision, leftHolder.scale, 128),
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  rightHolder.precision, rightHolder.scale, 128));
      ...
      java.math.BigDecimal result =
          left.multiply(right).setScale(resultHolder.scale, java.math.RoundingMode.HALF_UP);
  ...
  @FunctionTemplate(
      name = "divide",
      derivation = OutputDerivation.DecimalDivide.class,
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL)
  public static class DivideDecimals implements SimpleFunction {
    ...
    public void eval() {
      ...
      org.apache.arrow.vector.types.pojo.ArrowType.Decimal resultTypeForOperation =
          org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.getResultTypeForOperation(
              org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.OperationType.DIVIDE,
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  leftHolder.precision, leftHolder.scale, 128),
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  rightHolder.precision, rightHolder.scale, 128));
      ...
      if (resultHolder.scale > leftHolder.scale - rightHolder.scale) {
        left =
            left.setScale(
                resultHolder.scale + rightHolder.scale, java.math.RoundingMode.UNNECESSARY);
      }
      ...
      if (quotientAndRemainder[1]
              .abs()
              .multiply(java.math.BigInteger.valueOf(2))
              .compareTo(rightUnscaled.abs())
          >= 0) {
        resultUnscaled =
            resultUnscaled.add(
                java.math.BigInteger.valueOf((leftUnscaled.signum() ^ rightUnscaled.signum()) + 1));
      }
  ...
  @FunctionTemplate(
      names = {"modulo", "mod"},
      derivation = OutputDerivation.DecimalMod.class,
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL)
  public static class ModuloFunction implements SimpleFunction {
    ...
    public void eval() {
      ...
      org.apache.arrow.vector.types.pojo.ArrowType.Decimal resultTypeForOperation =
          org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.getResultTypeForOperation(
              org.apache.arrow.gandiva.evaluator.DecimalTypeUtil.OperationType.MOD,
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  leftHolder.precision, leftHolder.scale, 128),
              new org.apache.arrow.vector.types.pojo.ArrowType.Decimal(
                  rightHolder.precision, rightHolder.scale, 128));
      ...
      if (leftHolder.scale < rightHolder.scale) {
        left = left.setScale(rightHolder.scale, java.math.RoundingMode.UNNECESSARY);
      } else {
        right = right.setScale(leftHolder.scale, java.math.RoundingMode.UNNECESSARY);
      }
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalMax.class)
  public static class AbsDecimal implements SimpleFunction {

    @Param DecimalHolder inputHolder;
    @Output DecimalHolder resultHolder;
    @Inject ArrowBuf buffer;
    @Inject FunctionErrorContext functionErrorContext;
  ...
  public static java.math.BigDecimal round(
      BigDecimal input, int scale, java.math.RoundingMode roundingMode) {
    if (scale < 0) {
      return com.dremio.exec.expr.fn.impl.DecimalFunctions.roundWithNegativeScale(
          input, scale, roundingMode);
    }
    return com.dremio.exec.expr.fn.impl.DecimalFunctions.roundWithPositiveScale(
        input, scale, roundingMode);
  }

  // scale is negative
  private static BigDecimal roundWithNegativeScale(
      BigDecimal input, int scale, java.math.RoundingMode roundingMode) {
        ...
        new java.math.BigDecimal(
            inputNoFractional
                ...
                .subtract(
                    inputNoFractional
                        .unscaledValue()
                        .remainder(java.math.BigInteger.TEN.pow(-scale))),
            scale);
    result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
    return result;
  }

  public static BigDecimal roundWithPositiveScale(
      BigDecimal input, int scale, java.math.RoundingMode roundingMode) {
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalSetScaleRound.class)
  public static class RoundDecimalWithScale implements SimpleFunction {
    ...
    public void eval() {
      ...
      if (scale.value > input.scale()) {
        ...
        result =
            com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
                input, scale.value, java.math.RoundingMode.HALF_UP);
        result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      }
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
      ...
      com.dremio.common.expression.CompleteType outputType =
          com.dremio.exec.expr.fn.OutputDerivation.DECIMAL_SET_SCALE_ROUND.getOutputType(
              ...
              java.util.Arrays.asList(
                  new com.dremio.common.expression.ValueExpressions.DecimalExpression(
                      input, inputHolder.precision, inputHolder.scale),
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalZeroScaleRound.class)
  public static class RoundDecimal implements SimpleFunction {
    ...
    public void eval() {
      ...
      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
              input, 0, java.math.RoundingMode.HALF_UP);
      result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalSetScaleTruncate.class)
  public static class TruncateDecimalWithScale implements SimpleFunction {
    ...
    public void eval() {
      ...
      if (scale.value > input.scale()) {
        ...
        result =
            com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
                input, scale.value, java.math.RoundingMode.DOWN);
        result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      }
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalZeroScaleTruncate.class)
  public static class TruncateDecimal implements SimpleFunction {
    ...
    public void eval() {
      ...
      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
              input, 0, java.math.RoundingMode.DOWN);
      result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
  ...
  @FunctionTemplate(
      ...
      scope = FunctionScope.SIMPLE,
      nulls = NullHandling.NULL_IF_NULL,
      derivation = OutputDerivation.DecimalZeroScale.class)
  public static class CeilDecimal implements SimpleFunction {
    ...
    public void eval() {
      ...
      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
              input, 0, java.math.RoundingMode.CEILING);
      result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
  ...
  public static class FloorDecimal implements SimpleFunction {
    ...
    public void eval() {
      ...
      java.math.BigDecimal result =
          com.dremio.exec.expr.fn.impl.DecimalFunctions.round(
              input, 0, java.math.RoundingMode.FLOOR);
      result = com.dremio.exec.expr.fn.impl.DecimalFunctions.checkOverflow(result);
      try {
        org.apache.arrow.vector.util.DecimalUtility.writeBigDecimalToArrowBuf(
            result, buffer, 0, org.apache.arrow.vector.DecimalVector.TYPE_WIDTH);
  ...
  @FunctionTemplate(
      name = "single_value",
      scope = FunctionTemplate.FunctionScope.POINT_AGGREGATE,
      derivation = OutputDerivation.DecimalSingleValue.class)
