...
/** Builds partition transform vectors specifically for copy file history. */
public class CopyFileHistoryPartitionTransformVectorBuilder
    extends CopyHistoryPartitionTransformVectorBuilderBase {

  private CopyFileHistoryPartitionTransformVectorBuilder() {
    // no-op
  }
        ...
        switch (partitionField.fieldId()) {
          ...
          default:
            throw new UnsupportedOperationException(
                String.format(
                    "Unrecognized copy_file_history partition column with id %s and name %s",
