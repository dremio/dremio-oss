...
@Deprecated
public class OldPushProjectIntoScanRule extends RelOptRule {
  public static final RelOptRule INSTANCE = new OldPushProjectIntoScanRule(LogicalProject.class, OldScanCrel.class);

  private OldPushProjectIntoScanRule(Class<? extends Project> projectClass, Class<? extends TableScan> scanClass) {
    super(RelOptHelper.some(projectClass, RelOptHelper.any(scanClass)), "OldPushProjectIntoScanRule");
  }
