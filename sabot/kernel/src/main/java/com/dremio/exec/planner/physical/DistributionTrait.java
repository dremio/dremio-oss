...
public class DistributionTrait implements RelTrait {
  ...
  public static final DistributionTrait SINGLETON = new DistributionTrait(DistributionType.SINGLETON);
  // ROUND_ROBIN = load is distributed across multiple fragments evenly
  public static final DistributionTrait ROUND_ROBIN = new DistributionTrait(DistributionType.ROUND_ROBIN_DISTRIBUTED);
  // BROADCAST = sent to all fragments involved
  public static final DistributionTrait BROADCAST = new DistributionTrait(DistributionType.BROADCAST_DISTRIBUTED);
  ...
  private DistributionTrait(DistributionType type) {
    assert (type == DistributionType.SINGLETON || type == DistributionType.ANY
