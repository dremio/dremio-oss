...
public final class StatisticsAggrFunctions {
  ...
  /**
   * The size of the array used in hll will be of size 2^x/6 The accuracy is 1.0/sqrt(2^x) Value of
   * 12 is the highest value where the array is less than 1KB; it still gives error < 3%
   */
  ...
  public static class NullableDecimalHLLFunction implements AggrFunction {
    ...
    public void add() {
      if (in.isSet == 1) {
        ((com.dremio.exec.expr.fn.hll.HLLAccum) work.obj)
            .addBytes(
                in.buffer,
