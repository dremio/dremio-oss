...
public class VarcharTruncationReader implements AutoCloseable {
  ...
  private final NamedExpression castExpr;
  private final NamedExpression noCastExpr;
  private final Stopwatch varcharCheckCastWatch = Stopwatch.createUnstarted();

  private ExpressionSplitter splitter; // used for truncating varchar
  private TransferPair transferPair; // used for direct transfer

  public VarcharTruncationReader(Field field, TypeCoercion typeCoercion) {
    this.field = field;
