...
public class PlannerNormalizerComponentImpl implements PlannerNormalizerComponent {

  private final RelNormalizerTransformer relNormalizerTransformer;

  private PlannerNormalizerComponentImpl(RelNormalizerTransformer relNormalizerTransformer) {
  ...
  public static PlannerNormalizerComponent build(
      PlannerBaseComponent plannerBaseComponent, PlannerNormalizerModule plannerNormalizerModule) {

    NormalizerRuleSets normalizerRuleSet =
        plannerNormalizerModule.buildNormalizeRuleSets(
            plannerBaseComponent.getPlannerSettings().getOptions(),
            plannerBaseComponent.getUserDefinedFunctionExpander(),
            plannerBaseComponent.getFunctionContext().getContextInformation());

    RelNormalizerTransformer relNormalizerTransformer =
