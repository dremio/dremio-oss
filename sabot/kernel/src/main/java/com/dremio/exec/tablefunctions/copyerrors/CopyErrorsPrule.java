  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    if (jobId == null) {
      ...
      jobIdQuery
          .append("SELECT")
          .append(" \"")
          .append(CopyJobHistoryTableSchemaProvider.getJobIdColName(schemaVersion))
          .append("\"")
          .append(" FROM ")
          .append(COPY_JOB_HISTORY_TABLE_NAME)
          .append(" WHERE \"")
          .append(CopyJobHistoryTableSchemaProvider.getTableNameColName(schemaVersion))
          .append("\" = '")
          .append(resolvedTargetTableName)
          .append("'")
          .append(" AND \"")
          .append(CopyJobHistoryTableSchemaProvider.getUserNameColName(schemaVersion))
          .append("\" = '")
          .append(user)
          .append("'")
          .append(" ORDER BY \"")
          .append(CopyJobHistoryTableSchemaProvider.getExecutedAtColName(schemaVersion))
          .append("\" DESC LIMIT 1");
    ...
    joinQuery
        ...
        .append("\",")
        .append(" jh.\"")
        .append(CopyJobHistoryTableSchemaProvider.getStorageLocationColName(schemaVersion))
        .append("\",")
        .append(" jh.\"")
        .append(CopyJobHistoryTableSchemaProvider.getFileFormatColName(schemaVersion))
        .append("\",")
        .append(" jh.\"")
        .append(CopyJobHistoryTableSchemaProvider.getCopyOptionsColName(schemaVersion))
        .append("\",")
        ...
        .append(" lfp.\"")
        .append(CopyFileHistoryTableSchemaProvider.getJobIdColName(schemaVersion))
        .append("\",")
        .append(" LISTAGG(lfp.\"")
        .append(CopyFileHistoryTableSchemaProvider.getFilePathColName(schemaVersion))
        ...
        .append("'")
        .append(" AND (fh.\"")
        .append(CopyFileHistoryTableSchemaProvider.getFileStateColName(schemaVersion))
        .append("\" = '")
