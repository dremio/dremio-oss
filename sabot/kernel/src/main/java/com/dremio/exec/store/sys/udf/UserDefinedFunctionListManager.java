 ...
 */
public interface UserDefinedFunctionListManager extends Service {

  Iterable<FunctionInfo> getFunctionInfos();
  ...
  class FunctionInfo {
    ...
    public FunctionInfo(String name, String sql, String argList, String returnType, Timestamp createdAt, Timestamp modifiedAt) {
