...
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_CHARACTER_MAXIMUM_LENGTH;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_CHARACTER_OCTET_LENGTH;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_COLUMN_DEFAULT;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_COLUMN_NAME;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_COLUMN_SIZE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_DATA_TYPE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_DATETIME_PRECISION;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_INTERVAL_PRECISION;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_INTERVAL_TYPE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_IS_NULLABLE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_PRECISION;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_PRECISION_RADIX;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_SCALE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.COLS_COL_ORDINAL_POSITION;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SCHS_COL_CATALOG_NAME;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SCHS_COL_IS_MUTABLE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SCHS_COL_SCHEMA_NAME;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SCHS_COL_SCHEMA_OWNER;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SCHS_COL_TYPE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.SHRD_COL_TABLE_CATALOG;
...
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TAB_CATALOGS;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TAB_COLUMNS;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TAB_SCHEMATA;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TAB_TABLES;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TAB_VIEWS;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.TBLS_COL_TABLE_TYPE;
import static com.dremio.exec.store.ischema.InfoSchemaConstants.VIEWS_COL_VIEW_DEFINITION;
...
public abstract class InfoSchemaTable<S> {
  ...
  public abstract InfoSchemaRecordGenerator<S> getRecordGenerator(String catalogName);
  ...
  static public class Catalogs extends InfoSchemaTable<Records.Catalog> {
    ...
    @Override
    public InfoSchemaRecordGenerator<Records.Catalog> getRecordGenerator(String catalogName) {
      return new InfoSchemaRecordGenerator.Catalogs(catalogName);
    }
  }
  ...
  public static class Schemata extends InfoSchemaTable<Records.Schema> {
    ...
    @Override
    public InfoSchemaRecordGenerator<Records.Schema> getRecordGenerator(String catalogName) {
      return new InfoSchemaRecordGenerator.Schemata(catalogName);
    }
  }
  ...
  public static class Tables extends InfoSchemaTable<Records.Table> {
    ...
    @Override
    public InfoSchemaRecordGenerator<Records.Table> getRecordGenerator(String catalogName) {
      return new InfoSchemaRecordGenerator.Tables(catalogName);
    }
  }
  ...
  static public class Views extends InfoSchemaTable<Records.View> {
    ...
    @Override
    public InfoSchemaRecordGenerator<Records.View> getRecordGenerator(String catalogName) {
      return new InfoSchemaRecordGenerator.Views(catalogName);
    }
  }
  ...
  public static class Columns extends InfoSchemaTable<Records.Column> {
    ...
    @Override
    public InfoSchemaRecordGenerator<Records.Column> getRecordGenerator(String catalogName) {
      return new InfoSchemaRecordGenerator.Columns(catalogName);
    }
  }
}
