...
/** Class extends {@linnk SqlIdentifier} to include version spec */
public class SqlVersionedIdentifier extends SqlIdentifier {
  private final SqlTableVersionSpec sqlTableVersionSpec;

  public SqlVersionedIdentifier(SqlIdentifier identifier, SqlTableVersionSpec sqlTableVersionSpec) {
