...
public class SchemaUtilities {
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(SchemaUtilities.class);

  public static TableWithPath verify(
    ...
    if (sqlTableVersionSpec != null
        && sqlTableVersionSpec.getTableVersionSpec().getTableVersionType()
      ...
      tableVersionContext =
          TableVersionContext.of(userSession.getSessionVersionForSource(path.getRoot()));
    }
