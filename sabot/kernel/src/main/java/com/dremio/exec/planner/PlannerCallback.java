...
/**
 * A callback that StoragePlugins can initialize to allow further configuration of the Planner at
 * initialization time. Examples could be to allow adding lattices, materializations or additional
 * traits to the planner that will be used in planning.
 */
