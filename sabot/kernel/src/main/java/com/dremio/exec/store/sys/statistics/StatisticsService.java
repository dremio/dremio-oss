...
public interface StatisticsService extends Service, StatisticsAdministrationService {
  ...
  interface Histogram {
    ...
    /**
     * For a filter condition, estimate the selectivity (matching rows/total rows) for this
     * histogram.
     *
      ...
      new StatisticsService() {
        ...
        public Iterable<StatisticsListManager.StatisticsInfo> getStatisticsInfos() {
          throw new UnsupportedOperationException(
              "StatisticsService.getStatisticsInfos called on a non-coordinator node");
        }

        @Override
        public String requestStatistics(List<Field> fields, NamespaceKey key, Double samplingRate) {
          throw new UnsupportedOperationException(
              "StatisticsService.requestStatistics called on a non-coordinator node");
        }

        @Override
        public Long getNDV(String column, NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.getNdv called on a non-coordinator node");
        }

        @Override
        public Long getRowCount(NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.getRowCount called on a non-coordinator node");
        }

        @Override
        public Long getNullCount(String column, NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.getNullCount called on a non-coordinator node");
        }

        @Override
        public Histogram getHistogram(String column, TableMetadata tableMetaData) {
          throw new UnsupportedOperationException(
              "StatisticsService.getHistogram called on a non-coordinator node");
        }
        ...
        public List<String> deleteStatistics(List<String> fields, NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.deleteStatistics called on a non-coordinator node");
        }

        @Override
        public boolean deleteRowCountStatistics(NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.deleteRowCountStatistics called on a non-coordinator node");
        }

        @Override
        public void setNdv(String column, Long val, NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.setNdv called on a non-coordinator node");
        }

        @Override
        public void setRowCount(Long val, NamespaceKey key) {
          throw new UnsupportedOperationException(
              "StatisticsService.setRowCount called on a non-coordinator node");
        }
  ...
  StatisticsService MOCK_STATISTICS_SERVICE =
      new StatisticsService() {
        @Override
        public void close() throws Exception {}
