...
public class BigIntVLongConvertFrom implements SimpleFunction {
  ...
  @Override
  public void eval() {
    out.value = com.dremio.exec.util.ByteBufUtil.HadoopWritables.readVLong(errorContext, in.buffer, in.start, in.end);
  }
}
