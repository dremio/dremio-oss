...
public interface UserDefinedFunctionExpander {
  ...
  RexNode expandScalar(DremioScalarUserDefinedFunction dremioScalarUserDefinedFunction);

  RelNode expandTabularFunction(DremioTabularUserDefinedFunction tabularFunction);
}
