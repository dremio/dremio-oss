...
public class DremioSqlOperatorTable extends ReflectiveSqlOperatorTable {
  ...
  public static final SqlFunction LAST_MATCHING_MAP_ENTRY_FOR_KEY =
    SqlFunctionImpl.create(
      MapFunctions.LAST_MATCHING_ENTRY_FUNC,
  ...
  // ARRAY_AGG Functions
  // ---------------------
  public static final SqlAggFunction PHASE1_ARRAY_AGG = new ArrayAggInternalOperators.Phase1ArrayAgg();
  public static final SqlAggFunction PHASE2_ARRAY_AGG = new ArrayAggInternalOperators.Phase2ArrayAgg();

  // ---------------
  // GEO functions
  // ---------------
  public static final SqlOperator GEO_DISTANCE = SqlOperatorBuilder
    .name("GEO_DISTANCE")
    .returnType(ReturnTypes.DOUBLE)
    .operandTypes(SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT)
    .build();

  public static final SqlOperator GEO_NEARBY = SqlOperatorBuilder
    .name("GEO_NEARBY")
    .returnType(ReturnTypes.BOOLEAN)
    .operandTypes(SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.NUMERIC_TYPES)
    .build();

  public static final SqlOperator GEO_BEYOND = SqlOperatorBuilder
    .name("GEO_BEYOND")
    .returnType(ReturnTypes.BOOLEAN)
    .operandTypes(SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.FLOAT, SqlOperands.NUMERIC_TYPES)
    .build();
  ...
  public static final SqlOperator ROUND = SqlOperatorBuilder
    .name("ROUND")
    .returnType(DremioReturnTypes.NULLABLE_ROUND)
    .operandTypes(OperandTypes.NUMERIC_OPTIONAL_INTEGER)
    .build();

  public static final SqlOperator LOG2 = SqlOperatorBuilder
    .name("LOG2")
    .returnType(ReturnTypes.DOUBLE)
    .operandTypes(SqlOperands.NUMERIC_TYPES)
    .build();

  public static final SqlOperator LOG = SqlOperatorBuilder
    .name("LOG")
    .returnType(ReturnTypes.DOUBLE)
    .operandTypes(SqlOperands.NUMERIC_TYPES, SqlOperands.NUMERIC_TYPES)
    .build();

  public static final SqlOperator TRUNCATE = SqlOperatorBuilder
    .name("TRUNCATE")
  ...
  public static final SqlOperator TYPEOF = SqlOperatorBuilder
    .name("TYPEOF")
    .returnType(SqlTypeName.VARCHAR)
    .operandTypes(SqlOperands.ANY)
    .build();

  public static final SqlOperator IDENTITY = SqlOperatorBuilder
    .name("IDENTITY")
  ...
  public static final SqlOperator REGEXP_SPLIT = SqlOperatorBuilder
    .name("REGEXP_SPLIT")
    .returnType(JavaTypeFactoryImpl.INSTANCE.createArrayType(JavaTypeFactoryImpl.INSTANCE.createSqlType(SqlTypeName.VARCHAR), -1))
    .operandTypes(SqlOperands.CHAR_TYPES, SqlOperands.CHAR_TYPES, SqlOperands.CHAR_TYPES, SqlOperands.EXACT_TYPES)
    .build();
  ...
  public static final SqlOperator CARDINALITY = SqlOperatorBuilder
    .name("CARDINALITY")
  ...
  public static final SqlOperator CONCAT = SqlOperatorBuilder
    .name("CONCAT")
  ...
  public static final SqlOperator REPLACE = SqlOperatorBuilder
    .name("REPLACE")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
  ...
  public static final SqlOperator LENGTH = SqlOperatorBuilder
    .name("LENGTH")
    .returnType(ReturnTypes.INTEGER_NULLABLE)
  ...
  public static final SqlOperator LPAD = SqlOperatorBuilder
    .name("LPAD")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY, SqlOperands.ANY)
    .build();

  public static final SqlOperator RPAD = SqlOperatorBuilder
    .name("RPAD")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY, SqlOperands.ANY)
    .build();

  public static final SqlOperator LTRIM = SqlOperatorBuilder
    .name("LTRIM")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY_OPTIONAL)
    .build();

  public static final SqlOperator RTRIM = SqlOperatorBuilder
    .name("RTRIM")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY_OPTIONAL)
    .build();

  public static final SqlOperator BTRIM = SqlOperatorBuilder
    .name("BTRIM")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY_OPTIONAL)
    .build();

  public static final SqlOperator TRIM = SqlOperatorBuilder
    .name("TRIM")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.ANY, SqlOperands.ANY_OPTIONAL)
    .build();

  // here until CALCITE-2750 is fixed and Dremio has it.
  public static final SqlOperator PI = new SqlBaseContextVariable("PI", ReturnTypes.DOUBLE,
  ...
  public static final SqlOperator REPEAT = SqlOperatorBuilder
    .name("REPEAT")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.VARCHAR, SqlOperands.INTEGER)
    .build();

  public static final SqlOperator SPACE = SqlOperatorBuilder
    .name("SPACE")
    .returnType(DremioReturnTypes.VARCHAR_MAX_PRECISION_NULLABLE)
    .operandTypes(SqlOperands.INTEGER)
    .build();

  public static final SqlOperator SECOND = SqlOperatorBuilder
    .name("SECOND")
  ...
  public static final SqlOperator MINUTE = SqlOperatorBuilder
    .name("MINUTE")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator HOUR = SqlOperatorBuilder
    .name("HOUR")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator DAY = SqlOperatorBuilder
    .name("DAY")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator DAYOFMONTH = SqlOperatorBuilder
    .name("DAYOFMONTH")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator MONTH = SqlOperatorBuilder
    .name("MONTH")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator YEAR = SqlOperatorBuilder
    .name("YEAR")
    .returnType(ReturnTypes.BIGINT_NULLABLE)
    .operandTypes(
      OperandTypes.or(
  ...
  public static final SqlOperator CONVERT_FROMBIGINT_BE = ConvertFromOperators.CONVERT_FROMBIGINT_BE;

  public static final SqlOperator CONVERT_FROMBIGINT_HADOOPV = ConvertFromOperators.CONVERT_FROMBIGINT_HADOOPV;

  public static final SqlOperator CONVERT_FROMBOOLEAN_BYTE = ConvertFromOperators.CONVERT_FROMBOOLEAN_BYTE;

  public static final SqlOperator CONVERT_FROMDATE_EPOCH = ConvertFromOperators.CONVERT_FROMDATE_EPOCH;

  public static final SqlOperator CONVERT_FROMDATE_EPOCH_BE = ConvertFromOperators.CONVERT_FROMDATE_EPOCH_BE;

  public static final SqlOperator CONVERT_FROMDOUBLE = ConvertFromOperators.CONVERT_FROMDOUBLE;

  public static final SqlOperator CONVERT_FROMDOUBLE_BE = ConvertFromOperators.CONVERT_FROMDOUBLE_BE;
  ...
  public static final SqlOperator CONVERT_FROMINT_HADOOPV = ConvertFromOperators.CONVERT_FROMINT_HADOOPV;

  public static final SqlOperator CONVERT_FROMJSON = ConvertFromOperators.CONVERT_FROMJSON;

  public static final SqlOperator CONVERT_FROMTIMESTAMP_EPOCH = ConvertFromOperators.CONVERT_FROMTIMESTAMP_EPOCH;

  public static final SqlOperator CONVERT_FROMTIMESTAMP_EPOCH_BE = ConvertFromOperators.CONVERT_FROMTIMESTAMP_EPOCH_BE;

  public static final SqlOperator CONVERT_FROMTIMESTAMP_IMPALA = ConvertFromOperators.CONVERT_FROMTIMESTAMP_IMPALA;

  public static final SqlOperator CONVERT_FROMTIMESTAMP_IMPALA_LOCALTIMEZONE = ConvertFromOperators.CONVERT_FROMTIMESTAMP_IMPALA_LOCALTIMEZONE;

  public static final SqlOperator CONVERT_FROMTIME_EPOCH = ConvertFromOperators.CONVERT_FROMTIME_EPOCH;

  public static final SqlOperator CONVERT_FROMTIME_EPOCH_BE = ConvertFromOperators.CONVERT_FROMTIME_EPOCH_BE;
  ...
  public static final SqlOperator CONVERT_TOBIGINT_HADOOPV = ConvertToOperators.CONVERT_TOBIGINT_HADOOPV;
  public static final SqlOperator CONVERT_TOBOOLEAN_BYTE = ConvertToOperators.CONVERT_TOBOOLEAN_BYTE;
  ...
  public static final SqlOperator CONVERT_TODATE_EPOCH_BE = ConvertToOperators.CONVERT_TODATE_EPOCH_BE;
  ...
  public static final SqlOperator CONVERT_TOEXTENDEDJSON = ConvertToOperators.CONVERT_TOEXTENDEDJSON;
  ...
  public static final SqlOperator CONVERT_TOTIMESTAMP_EPOCH = ConvertToOperators.CONVERT_TOTIMESTAMP_EPOCH;
  public static final SqlOperator CONVERT_TOTIMESTAMP_EPOCH_BE = ConvertToOperators.CONVERT_TOTIMESTAMP_EPOCH_BE;
  public static final SqlOperator CONVERT_TOTIME_EPOCH = ConvertToOperators.CONVERT_TOTIME_EPOCH;
  public static final SqlOperator CONVERT_TOTIME_EPOCH_BE = ConvertToOperators.CONVERT_TOTIME_EPOCH_BE;
  ...
  // Function for E()
  public static final SqlOperator E = SqlOperatorBuilder
    .name("E")
  ...
  // -----------------------------
  private static final SqlReturnTypeInference HIVE_RETURN_TYPE_INFERENCE = opBinding -> {
  ...
  public static final SqlOperator HIVE_MASK_INTERNAL = SqlOperatorBuilder
    .name("MASK_INTERNAL")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();

  public static final SqlOperator HIVE_MASK = SqlOperatorBuilder
    .name("MASK")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();

  public static final SqlOperator HIVE_MASK_FIRST_N = SqlOperatorBuilder
    .name("MASK_FIRST_N")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();

  public static final SqlOperator HIVE_MASK_LAST_N = SqlOperatorBuilder
    .name("MASK_LAST_N")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();
  public static final SqlOperator HIVE_MASK_SHOW_FIRST_N = SqlOperatorBuilder
    .name("MASK_SHOW_FIRST_N")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();

  public static final SqlOperator HIVE_MASK_SHOW_LAST_N = SqlOperatorBuilder
    .name("MASK_SHOW_LAST_N")
    .returnType(HIVE_RETURN_TYPE_INFERENCE)
    .operandTypes(OperandTypes.ONE_OR_MORE)
    .build();

  public static final SqlOperator HIVE_MASK_HASH = SqlOperatorBuilder
    .name("MASK_HASH")
  ...
  // ------------------------
  public static final SqlOperator HASHSHA256 = SqlOperatorBuilder
    .name("HASHSHA256")
    .returnType(SqlTypeName.VARCHAR)
    .anyOperands()
    .build();

  public static final SqlOperator BITWISE_AND = SqlOperatorBuilder
    .name("BITWISE_AND")
  ...
  /** The "ARRAY_AGG(value) WITHIN GROUP(...) OVER (...)"
   * aggregate function with gathers values into an array.
   */
  ...
  private static final SqlOperandTypeChecker NUMERIC_ARRAY_TYPE_CHECKER = new SqlOperandTypeChecker() {
    @Override
    public boolean checkOperandTypes(SqlCallBinding callBinding, boolean throwOnFailure) {
      RelDataType operandType = callBinding.getOperandType(0);
      if (operandType.getSqlTypeName() != SqlTypeName.ARRAY) {
        if (throwOnFailure) {
          throw UserException.validationError().message("Expected argument to be an ARRAY.").build();
        }

        return false;
      }

      if (!SqlTypeName.NUMERIC_TYPES.contains(operandType.getComponentType().getSqlTypeName())) {
        if (throwOnFailure) {
          throw UserException.validationError().message("Expected argument to be an ARRAY of NUMERIC types.").build();
        }
  ...
  public static final SqlOperator ARRAY_MIN = SqlOperatorBuilder
    .name("ARRAY_MIN")
    .returnType(DremioReturnTypes.ARG0_ARRAY_ELEMENT)
    .operandTypes(NUMERIC_ARRAY_TYPE_CHECKER)
    .build();

  public static final SqlOperator ARRAY_MAX = SqlOperatorBuilder
    .name("ARRAY_MAX")
    .returnType(DremioReturnTypes.ARG0_ARRAY_ELEMENT)
    .operandTypes(NUMERIC_ARRAY_TYPE_CHECKER)
    .build();

  public static final SqlOperator ARRAY_SUM = SqlOperatorBuilder
    .name("ARRAY_SUM")
    .returnType(DremioReturnTypes.ARG0_ARRAY_ELEMENT)
    .operandTypes(NUMERIC_ARRAY_TYPE_CHECKER)
    .build();

  public static final SqlOperator ARRAY_AVG = SqlOperatorBuilder
    .name("ARRAY_AVG")
    .returnType(DremioReturnTypes.DECIMAL_QUOTIENT_DEFAULT_PRECISION_SCALE)
    .operandTypes(NUMERIC_ARRAY_TYPE_CHECKER)
    .build();

  public static final SqlOperator ARRAY_CONTAINS = SqlOperatorBuilder
    .name("ARRAY_CONTAINS")
    .returnType(ReturnTypes.BOOLEAN_NULLABLE)
    .operandTypes(SqlOperands.ARRAY, SqlOperands.ANY)
    .build();

  public static final SqlOperator ARRAY_REMOVE = SqlOperatorBuilder
    .name("ARRAY_REMOVE")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(SqlOperands.ARRAY, SqlOperands.ANY)
    .build();

  private static SqlOperandTypeChecker arraysOfCoercibleType(String functionName, boolean allowVariadic) {
    return new SqlOperandTypeChecker() {
      ...
      public boolean checkOperandTypes(SqlCallBinding callBinding, boolean throwOnFailure) {
        ...
        RelDataType leastRestrictiveType = callBinding
          .getTypeFactory()
          .leastRestrictive(callBinding.collectOperandTypes());
  ...
  private static final SqlReturnTypeInference leastRestrictiveArray = new SqlReturnTypeInference() {
    @Override
    public RelDataType inferReturnType(SqlOperatorBinding sqlOperatorBinding) {
      ...
      List<RelDataType> componentTypes = sqlOperatorBinding
        .collectOperandTypes()
        .stream()
      ...
      boolean anyOperandsNullable = sqlOperatorBinding.collectOperandTypes().stream().anyMatch(RelDataType::isNullable);
      RelDataType arrayTypeWithNullability = typeFactory.createTypeWithNullability(arrayType, anyOperandsNullable);
      return arrayTypeWithNullability;
    }
  };

  public static final SqlOperator ARRAY_CONCAT = SqlOperatorBuilder
    .name("ARRAY_CONCAT")
  ...
  public static final SqlOperator ARRAY_DISTINCT = SqlOperatorBuilder
    .name("ARRAY_DISTINCT")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(SqlOperands.ARRAY)
    .build();

  public static final SqlOperator ARRAY_SORT = SqlOperatorBuilder
    .name("ARRAY_SORT")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(SqlOperands.ARRAY)
    .build();
  ...
  private static SqlOperandTypeChecker arrayPrependAppendOperandChecker(boolean append) {
    return new SqlOperandTypeChecker() {
      ...
      public boolean checkOperandTypes(SqlCallBinding callBinding, boolean throwOnFailure) {
        ...
        RelDataType leastRestrictiveElementType = callBinding.getTypeFactory()
          .leastRestrictive(ImmutableList.of(arrayType.getComponentType(), elementType));
        if (leastRestrictiveElementType == null) {
          if (throwOnFailure) {
            throw UserException
              .validationError()
              .message("'ARRAY_APPEND/PREPEND' expects 'T' to equal 'E' for ARRAY_APPEND(T item, ARRAY<E> arr).")
              .buildSilently();
          }
  ...
  private static SqlReturnTypeInference arrayPrependAppendReturnTypeInference(boolean append) {
    return new SqlReturnTypeInference() {
      ...
      public RelDataType inferReturnType(SqlOperatorBinding opBinding) {
        ...
        RelDataType newElementType = opBinding
          .getTypeFactory()
        ...
        return opBinding
          ...
          .createTypeWithNullability(
            opBinding
              .getTypeFactory()
              .createArrayType(newElementType, -1),
            arrayType.isNullable());
      }
    };
  }

  public static final SqlOperator ARRAY_PREPEND = SqlOperatorBuilder
    .name("ARRAY_PREPEND")
    .returnType(arrayPrependAppendReturnTypeInference(false))
    .operandTypes(arrayPrependAppendOperandChecker(false))
    .build();

  public static final SqlOperator ARRAY_APPEND = SqlOperatorBuilder
    .name("ARRAY_APPEND")
    .returnType(arrayPrependAppendReturnTypeInference(true))
    .operandTypes(arrayPrependAppendOperandChecker(true))
    .build();

  public static final SqlOperator ARRAY_REMOVE_AT = SqlOperatorBuilder
    .name("ARRAY_REMOVE_AT")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(SqlOperands.ARRAY, SqlOperands.INTEGER)
    .build();

  public static final SqlOperator ARRAY_SIZE  = SqlOperatorBuilder
    .name("ARRAY_SIZE")
    .returnType(ReturnTypes.INTEGER_NULLABLE)
    .operandTypes(SqlOperands.ARRAY)
    .build();

  public static final SqlOperator ARRAY_LENGTH = SqlOperatorBuilder.alias("ARRAY_LENGTH", ARRAY_SIZE);

  public static final SqlOperator ARRAY_POSITION = SqlOperatorBuilder
    .name("ARRAY_POSITION")
    .returnType(ReturnTypes.INTEGER_NULLABLE)
  ...
  private static SqlReturnTypeInference integerArrayReturnTypeInference() {
    return new SqlReturnTypeInference() {
      ...
      public RelDataType inferReturnType(SqlOperatorBinding opBinding) {
        ...
        RelDataType withoutNullability = opBinding.getTypeFactory()
          .createTypeWithNullability(typeFactory.createSqlType(SqlTypeName.INTEGER), false);
        RelDataType asArray = opBinding.getTypeFactory()
          .createArrayType(withoutNullability, -1);
        return asArray;
      }
    };
  }

  public static final SqlOperator ARRAY_GENERATE_RANGE = SqlOperatorBuilder
  ...
  public static final SqlOperator SUBLIST = SqlOperatorBuilder
    .name("SUBLIST")
    .returnType(ReturnTypes.ARG0)
  ...
  private static SqlReturnTypeInference arrayRemoveNullsTypeInference() {
    return new SqlReturnTypeInference() {
      ...
      public RelDataType inferReturnType(SqlOperatorBinding opBinding) {
        ...
        RelDataType baseType = opBinding.getTypeFactory().createSqlType(arrayType.getComponentType().getSqlTypeName());
        RelDataType withoutNullability = opBinding.getTypeFactory()
          .createTypeWithNullability(
            baseType, false);
        RelDataType asArray = opBinding.getTypeFactory()
        ...
        RelDataType asArrayWithNullability = opBinding.getTypeFactory()
  ...
  public static final SqlOperator ARRAY_COMPACT = SqlOperatorBuilder
    .name("ARRAY_COMPACT")
    .returnType(arrayRemoveNullsTypeInference())
    .operandTypes(SqlOperands.ARRAY)
    .build();

  public static final SqlOperator ARRAY_SLICE = SqlOperatorBuilder
    .name("ARRAY_SLICE")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(SqlOperands.ARRAY, SqlOperands.INTEGER, SqlOperands.INTEGER_OPTIONAL)
    .build();

  public static final SqlOperator ARRAY_INSERT = SqlOperatorBuilder
    .name("ARRAY_INSERT")
    .returnType(ReturnTypes.ARG0)
    .operandTypes(new SqlOperandTypeChecker() {
      ...
      public boolean checkOperandTypes(SqlCallBinding callBinding, boolean throwOnFailure) {
        ...
        if (arrayType.getSqlTypeName() != SqlTypeName.ARRAY) {
          if (throwOnFailure) {
            throw UserException.validationError().message("'ARRAY_INSERT' expects an ARRAY, but instead got: " + arrayType).build();
          }
          return false;
        }
        if (elementType.getSqlTypeName() != arrayType.getComponentType().getSqlTypeName() && elementType.getSqlTypeName() != SqlTypeName.NULL) {
          if (throwOnFailure) {
            throw UserException.validationError().message("'ARRAY_INSERT' expects 'T' to equal 'E' for ARRAY_INSERT(ARRAY<E> arr, Integer index, T item).").build();
          }
        ...
        if (indexType.getSqlTypeName() != SqlTypeName.INTEGER) {
          if (throwOnFailure) {
            throw UserException.validationError().message("'ARRAY_INSERT' expects an INTEGER, but instead got: " + indexType).build();
          }
          return false;
        }
        return true;
  ...
  public static final SqlOperator ARRAYS_OVERLAP = SqlOperatorBuilder
    .name("ARRAYS_OVERLAP")
    .returnType(ReturnTypes.BOOLEAN_NULLABLE)
    .operandTypes(arraysOfCoercibleType("ARRAYS_OVERLAP", false))
    .build();

  public static final SqlOperator SET_UNION = SqlOperatorBuilder
    .name("SET_UNION")
    .returnType(leastRestrictiveArray)
    .operandTypes(arraysOfCoercibleType("SET_UNION", false))
    .build();

  public static final SqlOperator ARRAY_INTERSECTION = SqlOperatorBuilder
    .name("ARRAY_INTERSECTION")
    .returnType(leastRestrictiveArray)
    .operandTypes(arraysOfCoercibleType("ARRAY_INTERSECTION", false))
    .build();

  public static final SqlOperator ARRAY_TO_STRING = SqlOperatorBuilder
    .name("ARRAY_TO_STRING")
    .returnType(SqlTypeName.VARCHAR)
    .operandTypes(SqlOperands.ARRAY, SqlOperands.VARCHAR)
    .build();

  public static final SqlOperator LIST_TO_DELIMITED_STRING =  SqlOperatorBuilder
    .name("LIST_TO_DELIMITED_STRING")
    .returnType(SqlTypeName.VARCHAR)
  ...
  // We defer the return type to execution (since we don't know what the return type is without inspecting the parameters).
  public static final SqlOperator KVGEN = SqlOperatorBuilder
    .name("KVGEN")
  ...
  public static final SqlOperator MAP_KEYS = SqlOperatorBuilder
    .name("MAP_KEYS")
    .returnType(JavaTypeFactoryImpl.INSTANCE.createArrayType(JavaTypeFactoryImpl.INSTANCE.createSqlType(SqlTypeName.VARCHAR), -1))
    .operandTypes(SqlOperands.MAP)
    .build();

  public static final SqlOperator MAP_VALUES = SqlOperatorBuilder
    .name("MAP_VALUES")
    .returnType(JavaTypeFactoryImpl.INSTANCE.createArrayType(JavaTypeFactoryImpl.INSTANCE.createSqlType(SqlTypeName.ANY), -1))
    .operandTypes(SqlOperands.MAP)
    .build();
  ...
  public static final SqlAggFunction APPROX_PERCENTILE = new TDigest.SqlApproximatePercentileFunction();
  ...
  public static final SqlOperator DATE_TRUNC = SqlOperatorBuilder
    .name("DATE_TRUNC")
    ...
    .operandTypes(SqlOperands.CHAR_TYPES, SqlOperand.union(SqlOperands.DATETIME_TYPES, SqlOperands.INTERVAL_TYPES))
    .build();

  public static final SqlOperator NEXT_DAY = SqlOperatorBuilder
    .name("NEXT_DAY")
    .returnType(ReturnTypes.DATE)
    .operandTypes(SqlOperand.union(SqlOperands.DATE, SqlOperands.TIMESTAMP), SqlOperands.CHAR_TYPES)
    .build();
  ...
  public static final SqlOperator RAND = SqlOperatorBuilder
    .name("RAND")
  ...
  public static final SqlOperator NOW = SqlOperatorBuilder.alias("NOW", SqlStdOperatorTable.CURRENT_TIMESTAMP);
  public static final SqlOperator STATEMENT_TIMESTAMP = SqlOperatorBuilder.alias("STATEMENT_TIMESTAMP", SqlStdOperatorTable.CURRENT_TIMESTAMP);
  public static final SqlOperator TRANSACTION_TIMESTAMP = SqlOperatorBuilder.alias("TRANSACTION_TIMESTAMP", SqlStdOperatorTable.CURRENT_TIMESTAMP);
  public static final SqlOperator CURRENT_TIMESTAMP_UTC = SqlOperatorBuilder.alias("CURRENT_TIMESTAMP_UTC", SqlStdOperatorTable.CURRENT_TIMESTAMP);
  public static final SqlOperator TIMEOFDAY = SqlOperatorBuilder
    .name("TIMEOFDAY")
    .returnType(SqlTypeName.VARCHAR)
    .noOperands()
    .withDynanism(true)
  ...
  public static final SqlOperator IS_MEMBER = SqlOperatorBuilder
    .name("IS_MEMBER")
  ...
  public static final SqlOperator USER = SqlOperatorBuilder
    .name("USER")
    .returnType(SqlTypeName.VARCHAR)
    .noOperands()
    .withDynanism(true)
  ...
  public static final SqlOperator LAST_QUERY_ID = new SqlBaseContextVariable(
    "LAST_QUERY_ID", ReturnTypes.cascade(ReturnTypes.VARCHAR_2000, SqlTypeTransforms.FORCE_NULLABLE),
    SqlFunctionCategory.SYSTEM) {
  };

  public static final SqlOperator CURRENT_DATE_UTC = SqlOperatorBuilder.alias("CURRENT_DATE_UTC", SqlStdOperatorTable.CURRENT_DATE);

  public static final SqlOperator CURRENT_TIME_UTC = SqlOperatorBuilder.alias("CURRENT_TIME_UTC", SqlStdOperatorTable.CURRENT_TIME);

  public static final SqlOperator UNIX_TIMESTAMP = SqlOperatorBuilder
    .name("UNIX_TIMESTAMP")
