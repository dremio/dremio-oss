...
/**
 * This class is responsible for setting up complex field readers
...
public class ComplexTypeCopiers {
   ...
   * @return
   */
  public static ComplexTypeCopier[] createCopiers(OperatorContext context, List<ValueVector> input,
                                                  List<ValueVector> output, TypeCoercion typeCoercion,
   ...
   */
  private static ComplexTypeCopier createCopier(OperatorContext context, ValueVector inVector,
                                                ValueVector outVector, TypeCoercion typeCoercion,
                                                Stopwatch javaCodeGenWatch, Stopwatch gandivaCodeGenWatch) {
  ...
  static class ListCopier implements ComplexTypeCopier {
    ...
    public ListCopier(OperatorContext context, ValueVector in, ValueVector out,
                      TypeCoercion typeCoercion, Stopwatch javaCodeGenWatch, Stopwatch gandivaCodeGenWatch) {
      inVector = (ListVector)in;
      outVector = (ListVector)out;
      ...
      childFieldCompositeReader = new CompositeReader(inChildMutator, context,
    ...
    public void setupProjector(VectorContainer incoming,
                               ExpressionEvaluationOptions projectorOptions,
                               VectorContainer projectorOutput) {
      childFieldCompositeReader.setupProjector(outChildMutator,
  ...
  static class StructCopier implements ComplexTypeCopier {
    ...
    public StructCopier(OperatorContext context, ValueVector in, ValueVector out,
      ...
      childrenFieldCompositeReader = new CompositeReader(inChildMutator, context,
        typeCoercion.getChildTypeCoercion(out.getName(), targetSchema),
        javaCodeGenWatch, gandivaCodeGenWatch, targetSchema);
    }
    ...
    public void setupProjector(VectorContainer incoming,
                               ExpressionEvaluationOptions projectorOptions,
                               VectorContainer projectorOutput) {
      childrenFieldCompositeReader.setupProjector(outChildMutator, inChildMutator.getContainer(), projectorOptions, outChildMutator.getContainer());
    }
