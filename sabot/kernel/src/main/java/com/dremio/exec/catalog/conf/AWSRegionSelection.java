 ...
 * AWS Region Name
 *
 * WARNING:  The Tag numbers are used as the enum's id/value when streaming an enum to storage
 *    The Tags numbers NEED to follow these rules
 *    1. The tag number for any of the existing regions should remain unchanged
 *    2. New regions can be added anywhere within the enum
 *    3. The tag number for new regions should be assigned the next sequentially free number (recommended)
 *    Failure to do so will likely result in the enum being read from storage with an incorrect value
 */
public enum AWSRegionSelection {
  ...
  @Tag(27) @DisplayMetadata(label = "Asia Pacific (Hyderabad) ap-south-2") AP_SOUTH_2("ap-south-2"),
  @Tag(6) @DisplayMetadata(label = "Asia Pacific (Hong Kong) ap-east-1") AP_EAST_1("ap-east-1"),
  @Tag(29) @DisplayMetadata(label = "Asia Pacific (Jakarta) ap-southeast-3") AP_SOUTHEAST_3("ap-southeast-3"),
  @Tag(30) @DisplayMetadata(label = "Asia Pacific (Melbourne) ap-southeast-4") AP_SOUTHEAST_4("ap-southeast-4"),
  ...
  @Tag(14) @DisplayMetadata(label = "China (Beijing) cn-north-1") CN_NORTH_1("cn-north-1"),
  @Tag(15) @DisplayMetadata(label = "China (Ningxia) cn-northwest-1") CN_NORTHWEST_1("cn-northwest-1"),
  ...
  @Tag(31) @DisplayMetadata(label = "Europe (Spain) eu-south-2") EU_SOUTH_2("eu-south-2"),
  ...
  @Tag(26) @DisplayMetadata(label = "Europe (Zurich) eu-central-2") EU_CENTRAL_2("eu-central-2"),
  @Tag(32) @DisplayMetadata(label = "Israel (Tel Aviv) il-central-1") IL_CENTRAL_1("il-central-1"),
  @Tag(22) @DisplayMetadata(label = "Middle East (Bahrain) me-south-1") ME_SOUTH_1("me-south-1"),
  @Tag(28) @DisplayMetadata(label = "Middle East (UAE) me-central-1") ME_CENTRAL_1("me-central-1"),
