...
/**
 * A {@link Sizer} implementation for fixed size list Arrow vectors {@link FixedSizeListVector} A
 * FixedSizeListVector's children can be fixed sized lists of primitive or complex types.It provides
 * validity bitmap to keep track of null values. This Sizer provides support for copier related
 * operations on FixedSizeListVector.
 *
