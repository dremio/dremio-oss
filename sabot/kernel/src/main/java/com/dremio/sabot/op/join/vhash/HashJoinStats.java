...
public class HashJoinStats {
  ...
  public enum Metric implements MetricDef {
    ...
    RUNTIME_FILTER_DROP_COUNT(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.MAX,"RUNTIME_FILTER_DROP_COUNT"),
    RUNTIME_COL_FILTER_DROP_COUNT(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.MAX,"RUNTIME_COL_FILTER_DROP_COUNT"),
    ...
    HEAP_SPILL_COUNT(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.MAX,"HEAP_SPILL_COUNT"), /* Number of times the operator spilled due to low heap memory */
    ...
    SPILL_WR_NANOS(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.MAX,"SPILL_WR_NANOS"), /* time spent in spill write */
    SPILL_RD_NANOS(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.MAX,"SPILL_RD_NANOS"), /* time spent in spill read */
    ...
    Metric() {
      this(UserBitShared.MetricDef.DisplayType.DISPLAY_NEVER, UserBitShared.MetricDef.AggregationType.SUM, "");
    }

    Metric(UserBitShared.MetricDef.DisplayType displayType, UserBitShared.MetricDef.AggregationType aggregationType, String displayCode) {
