...
public final class TimeArrayAggAccumulator extends ArrayAggAccumulator<Integer> {
  ...
  protected ArrayAggAccumulatorHolder<Integer> getAccumulatorHolder(
    ...
    return new TimeArrayAggAccumulatorHolder(allocator, initialCapacity);
  }
