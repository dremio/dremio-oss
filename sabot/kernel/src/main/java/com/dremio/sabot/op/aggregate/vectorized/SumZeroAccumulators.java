...
public class SumZeroAccumulators {
  ...
  public static class FloatSumZeroAccumulator extends BaseSingleAccumulator {
    ...
    public FloatSumZeroAccumulator(
        FieldVector input,
        FieldVector output,
        FieldVector transferVector,
        int maxValuesPerBatch,
  ...
  public static class BigIntSumZeroAccumulator extends BaseSingleAccumulator {
    ...
    public BigIntSumZeroAccumulator(
        FieldVector input,
        FieldVector output,
        FieldVector transferVector,
        int maxValuesPerBatch,
    ...
    private BigIntSumZeroAccumulator(
    ...
    BigIntSumZeroAccumulator(
        final SumZeroAccumulators.IntSumZeroAccumulator intSumZeroAccumulator,
        final FieldVector input,
        final int maxValuesPerBatch,
        final BufferAllocator computationVectorAllocator) {
      this(
          input,
          intSumZeroAccumulator.getOutput(),
  ...
  public static class DoubleSumZeroAccumulator extends BaseSingleAccumulator {
     ...
     *     computed values
     */
    public DoubleSumZeroAccumulator(
        FieldVector input,
        FieldVector output,
        FieldVector transferVector,
        int maxValuesPerBatch,
     ...
     */
    private DoubleSumZeroAccumulator(
        final FieldVector input,
        final FieldVector output,
        final FieldVector transferVector,
        final int maxValuesPerBatch,
    ...
    /**
     * Used during post-spill processing to convert a float sumzero accumulator to a post-spill
     * double sumzero accumulator
     *
     ...
     *     computed values
     */
    DoubleSumZeroAccumulator(
        final SumZeroAccumulators.FloatSumZeroAccumulator floatSumZeroAccumulator,
        final FieldVector input,
        final int maxValuesPerBatch,
        final BufferAllocator computationVectorAllocator) {
      this(
          input,
          floatSumZeroAccumulator.getOutput(),
    ...
    /**
     * Used during post-spill processing to convert a decimal sumzero accumulator to a post-spill
     * double sumzero accumulator
     *
     ...
     */
    DoubleSumZeroAccumulator(
        final SumZeroAccumulators.DecimalSumZeroAccumulator decimalSumZeroAccumulator,
        final FieldVector input,
        final int maxValuesPerBatch,
        final BufferAllocator computationVectorAllocator) {
      this(
          input,
          decimalSumZeroAccumulator.getOutput(),
  ...
  public static class DecimalSumZeroAccumulator extends BaseSingleAccumulator {
    ...
    public DecimalSumZeroAccumulator(
        FieldVector input,
        FieldVector output,
        FieldVector transferVector,
        int maxValuesPerBatch,
  ...
  public static class DecimalSumZeroAccumulatorV2 extends BaseSingleAccumulator {
    ...
    public DecimalSumZeroAccumulatorV2(
        FieldVector input,
        FieldVector output,
        FieldVector transferVector,
        int maxValuesPerBatch,
