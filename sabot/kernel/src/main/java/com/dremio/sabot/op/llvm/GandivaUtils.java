...
public class GandivaUtils {
   ...
   */
  public static VectorSchemaRoot getSchemaRoot(
      VectorAccessible input, Set<ReferencedField> referencedFields) {
    ...
    VectorSchemaRoot root = new VectorSchemaRoot(schemaWithOnlyReferencedFields, fv, 0);
    return root;
  }
