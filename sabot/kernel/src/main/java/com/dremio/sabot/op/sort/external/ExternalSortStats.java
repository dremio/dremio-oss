...
public class ExternalSortStats {
  ...
  public enum Metric implements MetricDef {
    SPILL_COUNT(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.SUM,"Number of times operator spilled to disk"),
    ...
    SPILL_TIME_NANOS(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.SUM,"Time spent spilling to diskRuns while sorting"),
    MERGE_TIME_NANOS(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.SUM,"Time spent merging disk runs and spilling"),
    TOTAL_SPILLED_DATA_SIZE(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.SUM,"Total data spilled by sort operator"),
    BATCHES_SPILLED(DisplayType.DISPLAY_BY_DEFAULT, AggregationType.SUM,"Total batches spilled to disk"),
