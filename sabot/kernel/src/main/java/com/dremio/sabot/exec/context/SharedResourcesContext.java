...
public interface SharedResourcesContext {
  ...
  /**
   * @return the first shared resource that is blocked, if any, in the specified group, null if the
   *     specified group is available.
   *     <p>There can be a race between the call to isRunnable() and the call to this function. Used
