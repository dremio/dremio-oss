...
public class GandivaPushdownSieve
    extends AbstractExprVisitor<CodeGenContext, CodeGenContext, GandivaException>
    implements ExpressionSplitHelper {
  static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(GandivaPushdownSieve.class);

  private static final List<String> supportedBooleanOperators =
      Lists.newArrayList("booleanAnd", "booleanOr");
  ...
  public CodeGenContext annotateExpression(BatchSchema batchSchema, CodeGenContext contextExpr) {
    try {
      BatchSchema.SelectionVectorMode incomingSelectionVectorMode =
      ...
      if (!isSupportedReturnType(contextExpr.getCompleteType())) {
        ...
        codeGenContextModifiedExpr.removeSupporteExecutionEngineForExpression(
  ...
  public CodeGenContext visitUnknown(LogicalExpression e, CodeGenContext context)
    ...
    if (e instanceof ValueVectorReadExpression) {
      ...
      logger.info(
          "GandivaPushdownSieve : unknown expression type {}", e.getClass().getCanonicalName());
    }
  ...
  // Returns true if the entire sub-tree represented by every element in the list can be evaluated
  // in Gandiva
  ...
  @Override
  public CodeGenContext visitBooleanOperator(BooleanOperator operator, CodeGenContext context)
      throws GandivaException {
  ...
  public CodeGenContext visitFunctionHolderExpression(
      FunctionHolderExpression holder, CodeGenContext context) throws GandivaException {
    ...
    // If so, the function can be evaluated in Gandiva even though the entire sub-tree may not be
    // evaluated in Gandiva
  ...
  private boolean isFunctionSupported(FunctionHolderExpression holder, CompleteType completeType)
      throws GandivaException {
    if (this.supportedFunctions == null) {
      GandivaRegistryWrapper instance = GandivaRegistryWrapper.getInstance();
      this.supportedFunctions =
          isDecimalV2Enabled
              ? instance.getSupportedFunctionsIncludingDecimal()
              : instance.getSupportedFunctionsExcludingDecimal();
  ...
  @Override
  public CodeGenContext visitIfExpression(IfExpression ifExpr, CodeGenContext context)
      throws GandivaException {
    List<LogicalExpression> codeGenTree =
        Lists.newArrayList(
            ifExpr.ifCondition.condition, ifExpr.ifCondition.expression, ifExpr.elseExpression);
    ...
    if (((CodeGenContext) ifExpr.ifCondition.condition)
            .isExpressionExecutableInEngine(SupportedEngines.Engine.GANDIVA)
        || ((CodeGenContext) ifExpr.ifCondition.expression)
            .isExpressionExecutableInEngine(SupportedEngines.Engine.GANDIVA)
        || ((CodeGenContext) ifExpr.elseExpression)
            .isExpressionExecutableInEngine(SupportedEngines.Engine.GANDIVA)) {
  ...
  private CodeGenContext annotateAndCheckSupportedType(LogicalExpression e, CodeGenContext context)
      throws GandivaException {
  ...
  @Override
  public CodeGenContext visitQuotedStringConstant(QuotedString e, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(e, context);
  }

  @Override
  public CodeGenContext visitBooleanConstant(BooleanExpression booleanExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(booleanExpr, context);
  }

  @Override
  public CodeGenContext visitIntConstant(IntExpression intExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(intExpr, context);
  }

  @Override
  public CodeGenContext visitLongConstant(LongExpression longExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(longExpr, context);
  }

  @Override
  public CodeGenContext visitFloatConstant(FloatExpression floatExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(floatExpr, context);
  }

  @Override
  public CodeGenContext visitDoubleConstant(DoubleExpression doubleExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(doubleExpr, context);
  }

  @Override
  public CodeGenContext visitNullConstant(TypedNullConstant nullConstant, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(nullConstant, context);
  }

  @Override
  public CodeGenContext visitFunctionCall(FunctionCall call, CodeGenContext context)
      throws GandivaException {
    throw new GandivaException("Function calls should have been replaced before operator.");
  }

  @Override
  public CodeGenContext visitSchemaPath(SchemaPath path, CodeGenContext context)
      throws GandivaException {
    // to do : needed?
  ...
  @Override
  public CodeGenContext visitDecimalConstant(
      ValueExpressions.DecimalExpression decExpr, CodeGenContext context) throws GandivaException {
    return annotateAndCheckSupportedType(decExpr, context);
  }

  @Override
  public CodeGenContext visitDateConstant(
      ValueExpressions.DateExpression dateExpr, CodeGenContext context) throws GandivaException {
    return annotateAndCheckSupportedType(dateExpr, context);
  }

  @Override
  public CodeGenContext visitTimeConstant(
      ValueExpressions.TimeExpression timExpr, CodeGenContext context) throws GandivaException {
    return annotateAndCheckSupportedType(timExpr, context);
  }

  @Override
  public CodeGenContext visitTimeStampConstant(
      ValueExpressions.TimeStampExpression timeStampExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(timeStampExpr, context);
  }

  @Override
  public CodeGenContext visitIntervalYearConstant(
      ValueExpressions.IntervalYearExpression intervalYearExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(intervalYearExpr, context);
  }

  @Override
  public CodeGenContext visitIntervalDayConstant(
      ValueExpressions.IntervalDayExpression intervalDayExpr, CodeGenContext context)
      throws GandivaException {
    return annotateAndCheckSupportedType(intervalDayExpr, context);
  }

  @Override
  public CodeGenContext visitNullExpression(NullExpression e, CodeGenContext context)
      throws GandivaException {
