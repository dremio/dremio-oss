...
public class TestFunctionsQuery extends BaseTestQuery {
  ...
  public void testContains() throws Exception {
    ...
    errorMsgWithTypeTestHelper(
        query, ErrorType.UNSUPPORTED_OPERATION, "Contains operator is not supported for the table");
  }

  @Test
  public void testDecimalPartitionColumns() throws Exception {
    String query =
        "select region_plan_profile_id, plan_profile_id from cp"
  ...
  public void testAbsDecimalFunction() throws Exception {
    ...
    testBuilder()
        ...
        //        .baselineValues(new BigDecimal("1234.45670"), new BigDecimal("1234.45670"), new
        // BigDecimal("99999912399.45670"), new BigDecimal("99999912399.45670"),
  ...
  public void testCeilDecimalFunction() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .baselineColumns(
            "DEC9_1", "DEC9_2", "DEC9_3", "DEC9_4", "DEC18_1", "DEC18_2", "DEC18_3", "DEC18_4",
            "DEC28_1", "DEC28_2", "DEC28_3", "DEC28_4", "DEC28_5", "DEC38_1", "DEC38_2", "DEC38_3",
            "DEC38_4", "DEC38_5")
        .baselineValues(
            new BigDecimal("1235"),
            new BigDecimal("1234"),
            new BigDecimal("-1234"),
            new BigDecimal("-1234"),
            new BigDecimal("99999912400"),
            new BigDecimal("99999912399"),
            new BigDecimal("-99999912399"),
            new BigDecimal("-99999912399"),
            new BigDecimal("12345678912345678913"),
            new BigDecimal("1000000000000000000"),
            new BigDecimal("12345678912345678912"),
            new BigDecimal("-12345678912345678912"),
            new BigDecimal("-12345678912345678912"),
  ...
  public void testTruncateWithParamDecimalFunction() throws Exception {
    ...
    testBuilder()
        ...
        .baselineColumns(
            ...
            "DEC38_4", "DEC38_5")
        .baselineValues(
            new BigDecimal("1234.45"),
            new BigDecimal("1234.4500"),
            new BigDecimal("-1234"),
            new BigDecimal("0.11"),
            new BigDecimal("99999912399.45"),
            new BigDecimal("99999912399.00"),
            new BigDecimal("-99999912399.450000"),
            new BigDecimal("-99999912399.0000"),
            new BigDecimal("12345678912345678912.4"),
            new BigDecimal("999999999999999999.456000"),
            new BigDecimal("12345678912345678912.00"),
            new BigDecimal("-12345678912345678912"),
            new BigDecimal("-12345678912345678912.0"),
            new BigDecimal("999999999.1234567"),
            new BigDecimal("999999999.40000000"),
            new BigDecimal("999999999.123400000000"),
  ...
  public void testRoundWithScaleDecimalFunction() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .baselineColumns(
            "DEC9_1", "DEC9_2", "DEC9_3", "DEC9_4", "DEC9_5", "DEC18_1", "DEC18_2", "DEC18_3",
            "DEC18_4", "DEC28_1", "DEC28_2", "DEC28_3", "DEC28_4", "DEC28_5", "DEC38_1", "DEC38_2",
            "DEC38_3", "DEC38_4", "DEC38_5", "DEC38_6", "DEC38_7")
        .baselineValues(
            new BigDecimal("1234.557"),
            new BigDecimal("1234.10"),
            new BigDecimal("-1234.5567"),
            new BigDecimal("-1234.123"),
            new BigDecimal("-1234.1200"),
            new BigDecimal("99999912399.957"),
            new BigDecimal("99999912399.00"),
            new BigDecimal("-99999912399.56"),
            new BigDecimal("-99999912399"),
            new BigDecimal("12345678912345678912.56"),
            new BigDecimal("999999999999999999.6"),
            new BigDecimal("12345678912345678912.00000000"),
            new BigDecimal("-12345678912345678912.557"),
            new BigDecimal("-12345678912345678912"),
            new BigDecimal("999999999999999999999999999.5"),
            new BigDecimal("99999999.512345679"),
            new BigDecimal("1000000000.000000000"),
            new BigDecimal("999999999.99999999957"),
  ...
  public void testCastDecimalDivide() throws Exception {
    String query =
        "select  (cast('9' as decimal(9, 1)) / cast('2' as decimal(4, 1))) as DEC9_DIV, "
    ...
    testBuilder()
        ...
        .baselineValues(
            new BigDecimal("4.500000000"),
            new BigDecimal("999999999000000000000000000000000000.0"),
  ...
  /**
   * Test for DRILL-2668, that "CAST ( 1.5 AS FLOAT )" really yields type FLOAT (rather than type
   * DOUBLE).
   */
  @Test
  public void testLiteralCastToFLOATYieldsFLOAT() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 1.5 AS FLOAT ) AS ShouldBeFLOAT " + "FROM cp.\"employee.json\" LIMIT 1")
        .unOrdered()
  ...
  @Test
  public void testLiteralCastToDecimal11()
      throws Exception { // suffix 11 denotes precision=1 and scale=1
    testBuilder()
  ...
  public void testCastToDecimal11() throws Exception { // suffix 11 denotes precision=1 and scale=1
    testBuilder()
        .sqlQuery(
            "SELECT cast(columns[0] as Decimal(1,1)) as ShouldBeZERO "
  ...
  public void testLiteralCastToDOUBLEYieldsDOUBLE() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 1.25 AS DOUBLE PRECISION ) AS ShouldBeDOUBLE "
  ...
  public void testLiteralCastToBIGINTYieldsBIGINT() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 64 AS BIGINT ) AS ShouldBeBIGINT " + "FROM cp.\"employee.json\" LIMIT 1")
        .unOrdered()
  ...
  public void testLiteralCastToINTEGERYieldsINTEGER() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 32 AS INTEGER ) AS ShouldBeINTEGER "
                + "FROM cp.\"employee.json\" LIMIT 1")
        .unOrdered()
  ...
  public void testLiteralCastToSMALLINTYieldsSMALLINT() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 16 AS SMALLINT ) AS ShouldBeSMALLINT "
                + "FROM cp.\"employee.json\" LIMIT 1")
        .unOrdered()
  ...
  public void testLiteralCastToTINYINTYieldsTINYINT() throws Exception {
    testBuilder()
        .sqlQuery(
            "SELECT CAST( 8 AS TINYINT ) AS ShouldBeTINYINT " + "FROM cp.\"employee.json\" LIMIT 1")
        .unOrdered()
  ...
  public void testDecimalMultiplicationOverflowHandling() throws Exception {
    String query =
        "select cast('1' as decimal(9, 5)) * cast ('999999999999999999999999999.999999999' as decimal(38, 9)) as DEC38_1, "
    ...
    testBuilder()
        ...
        .baselineValues(
            new BigDecimal("1000000000000000000000000000.00000"),
            new BigDecimal("1000000000000000000"),
  ...
  public void testDecimalRoundUp() throws Exception {
    String query =
        "select cast('999999999999999999.9999999999999999995' as decimal(38, 18)) as DEC38_1, "
    ...
    testBuilder()
        ...
        .baselineValues(
            new BigDecimal("1000000000000000000.000000000000000000"),
            new BigDecimal("999999999999999999.999999999999999999"),
            new BigDecimal("999999999999999999.123456790"),
            new BigDecimal("99999.1235"),
  ...
  public void testDecimalDownwardCast() throws Exception {
    String query =
        "select cast((cast('12345.6789' as decimal(18, 4))) as decimal(9, 4)) as DEC18_DEC9_1, "
    ...
    testBuilder()
        ...
        .baselineValues(
            ...
            new BigDecimal("12345.68"),
            new BigDecimal("-12346"),
            new BigDecimal("1000000000"),
            new BigDecimal("-999999999999999.68"),
            new BigDecimal("-1000000000000000"),
            new BigDecimal("100000001000000000"))
        .go();
  }
  ...
  public void testTruncateWithParamFunction() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            ...
            0,
            0,
            8124674407369523212L,
            BigDecimal.valueOf(81246744073695.3D))
        .go();
  }
  ...
  public void testRoundWithParamFunction() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            ...
            0,
            0,
            8124674407369520000L,
            new BigDecimal("81246744073695.4"),
            BigDecimal.valueOf(6.1D),
            BigDecimal.valueOf(-6.1D))
        .go();
  }
  ...
  public void testRoundWithParamFunction2() throws Exception {
    String query =
        "SELECT round(float4_col, 0) as t1, round(float8_col, 0) as t2 "
  ...
  public void testRoundWithOneParam() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            ...
            23.0f,
            24.0f,
            new BigDecimal("8124674407369"),
            new BigDecimal("8124674407370"))
        .go();
  }
  ...
  public void testToCharFunction() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            ...
            "1,234.56",
            "99999912399.9567",
            "12,345,678,912,345,678,912.5567",
  ...
  public void testTimeStampConstant() throws Exception {
    ...
    testBuilder().sqlQuery(query).unOrdered().baselineColumns("TS").baselineValues(date).go();
  }
  ...
  public void testIntMinToDecimal() throws Exception {
    String query =
        "select cast((employee_id - employee_id + -2147483648) as decimal(28, 2)) as DEC_28,"
  ...
  public void testDecimalAddConstant() throws Exception {
    String query =
        "select (cast('-1' as decimal(37, 3)) + cast (employee_id as decimal(37, 3))) as CNT "
  ...
  public void testDecimalAddIntConstant() throws Exception {
    String query =
        "select 1 + cast(employee_id as decimal(9, 3)) as DEC_9 , 1 + cast(employee_id as decimal(37, 5)) as DEC_38 "
  ...
  public void testSignFunction() throws Exception {
    String query =
        "select sign(cast('1.23' as float)) as SIGN_FLOAT, sign(-1234.4567) as SIGN_DOUBLE, sign(23) as SIGN_INT "
            + "from cp.\"employee.json\" where employee_id < 2";
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
  ...
  public void testPadFunctions() throws Exception {
    String query =
        "select rpad(first_name, 10) as RPAD_DEF, rpad(first_name, 10, '*') as RPAD_STAR, lpad(first_name, 10) as LPAD_DEF, lpad(first_name, 10, '*') as LPAD_STAR, "
    ...
    testBuilder()
        ...
        .unOrdered()
        .baselineColumns(
            "RPAD_DEF", "RPAD_STAR", "LPAD_DEF", "LPAD_STAR", "LPAD_TRUNC", "RPAD_TRUNC")
  ...
  public void testExtractSecond() throws Exception {
    String query =
        "select extract(second from date '2008-2-23') as DATE_EXT, extract(second from timestamp '2008-2-23 10:00:20.123') as TS_EXT, "
  ...
  public void testCastDecimalDouble() throws Exception {
    String query =
        "select cast((cast('1.0001' as decimal(18, 9))) as double) DECIMAL_DOUBLE_CAST "
            + "from cp.\"employee.json\" where employee_id = 1";
  ...
  public void testExtractSecondFromInterval() throws Exception {
    String query =
        "select extract (second from interval '1 2:30:45.100' day to second) as EXT_INTDAY "
            + "from cp.\"employee.json\" where employee_id = 1";
  ...
  public void testFunctionCaseInsensitiveNames() throws Exception {
    String query =
        "SELECT to_date('2003/07/09', 'YYYY/MM/DD') as col1, "
  ...
  public void testDecimal18Decimal38Comparison() throws Exception {
    String query =
        "select cast('-999999999.999999999' as decimal(18, 9)) = cast('-999999999.999999999' as decimal(38, 18)) as CMP "
            + "from cp.\"employee.json\" where employee_id = 1";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("CMP").baselineValues(true).go();
  }
  ...
  public void testOptiqDecimalCapping() throws Exception {
    String query =
        "select  cast('12345.678900000' as decimal(18, 9))=cast('12345.678900000' as decimal(38, 9)) as CMP "
            + "from cp.\"employee.json\" where employee_id = 1";
  ...
  public void testNegative() throws Exception {
    String query =
        "select  negative(2) as NEG " + "from cp.\"employee.json\" where employee_id = 1";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("NEG").baselineValues(-2L).go();
  }

  @Test
  public void testOptiqValidationFunctions() throws Exception {
    String query =
        "select trim(first_name) as TRIM_STR, substring(first_name, 2) as SUB_STR "
            + "from cp.\"employee.json\" where employee_id = 1";
  ...
  public void testToTimeStamp() throws Exception {
    String query =
        "select to_timestamp(cast('800120400.12312' as decimal(38, 5))) as DEC38_TS, to_timestamp(200120400) as INT_TS "
            + "from cp.\"employee.json\" where employee_id < 2";
  ...
  public void testImplicitCastVarcharToDouble() throws Exception {
    ...
    testBuilder()
        .sqlQuery(
            "select \"integer\" i, \"float\" f from cp.\"jsoninput/input1.json\" where \"float\" = '1.2'")
        .unOrdered()
        .baselineColumns("i", "f")
  ...
  public void testConcatSingleInput() throws Exception {
    String query =
        "select concat(employee_id) as col1 from cp.\"employee.json\" where employee_id = 1";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("col1").baselineValues("1").go();

    query = "select concat('foo') as col1 from cp.\"employee.json\" where employee_id = 1";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("col1").baselineValues("foo").go();
  }
  ...
  public void timestampAddMicroSecond() {
    UserExceptionAssert.assertThatThrownBy(
            () ->
                test(
                    "select timestampadd(MICROSECOND, 2, timestamp '2015-03-30 20:49:59.000') as ts from (values(1))"))
  ...
  public void timestampAddNanoSecond() {
    UserExceptionAssert.assertThatThrownBy(
            () ->
                test(
                    "select timestampadd(NANOSECOND, 2, timestamp '2015-03-30 20:49:59.000') as ts from (values(1))"))
        .hasErrorType(ErrorType.UNSUPPORTED_OPERATION)
        .hasMessageContaining(
            "TIMESTAMPADD function supports the following time units: YEAR, QUARTER, MONTH, WEEK, DAY, HOUR, MINUTE, SECOND");
  }
  ...
  public void testTimestampAddTimestamp() throws Exception {
    String queryTemplate =
        "select timestampadd(%s, 2, timestamp '2015-03-30 20:49:59.000') as ts from (values(1))";
    Map<TSI, LocalDateTime> results =
        ImmutableMap.<TSI, LocalDateTime>builder()
            // TODO (DX-11268): Fix TIMESTAMPADD(SQL_TSI_FRAC_SECOND, ..., ...) function
            // .put(TSI.MICROSECOND, formatTimeStampMilli.parseLocalDateTime("2015-03-30
            // 20:49:59.002"))
    ...
    for (Map.Entry<TSI, LocalDateTime> entry : results.entrySet()) {
      for (String name : entry.getKey().getNames()) {
        ...
        testBuilder().sqlQuery(query + " LIMIT 0").schemaBaseLine(expectedSchema).go();
  ...
  public void testTimestampAddDate() throws Exception {
    ...
    Map<TSI, List<Object>> results =
        ImmutableMap.<TSI, List<Object>>builder()
            // TODO (DX-11268): Fix TIMESTAMPADD(SQL_TSI_FRAC_SECOND, ..., ...) function
            // .put(TSI.MICROSECOND,
            // ImmutableList.<Object>of(formatTimeStampMilli.parseLocalDateTime("2015-03-30
            // 00:00:00.002"), timeStampType))
            .put(
                TSI.SECOND,
                ImmutableList.<Object>of(
                    formatTimeStampMilli.parseLocalDateTime("2015-03-30 00:00:02.000"),
                    timeStampType))
            .put(
                TSI.MINUTE,
                ImmutableList.<Object>of(
                    formatTimeStampMilli.parseLocalDateTime("2015-03-30 00:02:00.000"),
                    timeStampType))
            .put(
                TSI.HOUR,
                ImmutableList.<Object>of(
                    formatTimeStampMilli.parseLocalDateTime("2015-03-30 02:00:00.000"),
                    timeStampType))
            .put(
                TSI.DAY,
                ImmutableList.<Object>of(formatDate.parseLocalDateTime("2015-04-01"), dateType))
            .put(
                TSI.WEEK,
                ImmutableList.<Object>of(formatDate.parseLocalDateTime("2015-04-13"), dateType))
            .put(
                TSI.MONTH,
                ImmutableList.<Object>of(formatDate.parseLocalDateTime("2015-05-30"), dateType))
            .put(
                TSI.QUARTER,
                ImmutableList.<Object>of(formatDate.parseLocalDateTime("2015-09-30"), dateType))
            .put(
                TSI.YEAR,
                ImmutableList.<Object>of(formatDate.parseLocalDateTime("2017-03-30"), dateType))
            .build();
  ...
  public void testTimestampDiff() throws Exception {
    String query =
        "select "
            ...
            + "from (values(1))";
    Map<TSI, Integer> results =
        ImmutableMap.<TSI, Integer>builder()
  ...
  public void testTimestampAddTableauQuery() throws Exception {
    final String query =
        "SELECT * FROM (SELECT SUM(1) AS \"sum_Number_of_Records_ok\", "
    ...
    final List<Pair<SchemaPath, MajorType>> expectedSchema =
        ImmutableList.of(
            Pair.of(
                SchemaPath.getSimplePath("sum_Number_of_Records_ok"),
                Types.optional(MinorType.BIGINT)),
            Pair.of(
                SchemaPath.getSimplePath("tyr_yelping_since_ok"), Types.optional(MinorType.DATE)));
  ...
  public void testVarianceWithDecimal() throws Exception {
    final String query =
        "select variance(cast(employee_id as decimal(9, 5))) from cp.\"employee.json\"";
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
  ...
  public void testTimestampDateMinus() throws Exception {
    final String query =
        "select to_timestamp('2016-11-02 10:01:01','YYYY-MM-DD HH:MI:SS') - to_timestamp('2016-01-01 10:00:00','YYYY-MM-DD HH:MI:SS'), \n"
    ...
    final String query2 =
        "select to_timestamp('2016-11-02 10:01:01','YYYY-MM-DD HH:MI:SS') - CAST(NULL AS TIMESTAMP), \n"
  ...
  public void testRandomWithSeed() throws Exception {
    final String query =
        "select random(12), rand(12), random(11) from cp"
  ...
  public void testBitwiseOperators() throws Exception {
    // bitwise AND
    final String andQuery =
        "select bitwise_and(2343, 6332), bitwise_and(34531, -324234),"
    ...
    final String orQuery =
        "select bitwise_or(2343, 6332), bitwise_or(34531, -324234),"
    ...
    // bitwise NOT
    final String notQuery =
        "select bitwise_not(13524231), bitwise_not(-61243113), bitwise_not(0), bitwise_not(453387419419)";
    testBuilder()
        .sqlQuery(notQuery)
        .unOrdered()
  ...
  public void testRoundForZeroArg() throws Exception {
    ...
    String query =
        "select convert_toDOUBLE_BE(round(val)) from cp" + ".\"json/round_arg_zero.json\"";
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
        .baselineColumns("EXPR$0")
    ...
    assertThatThrownBy(
            () ->
                testBuilder()
                    .sqlQuery(
                        "select convert_toDOUBLE_BE(round(val, 12)) from cp.\"json/round_arg_zero.json\"")
                    .unOrdered()
                    .baselineColumns("EXPR$0")
  ...
  public void testKvGen() throws Exception {
    String query =
        "SELECT KVGEN(CONVERT_FROM('{\"1\": 0.123, \"2\": 0.456, \"3\": 0.789}', 'JSON')) FROM (values (1))";
    test(query);
  }
  ...
  public void testDX16973() throws Exception {
    final String query =
        "select cast(c_float8 as decimal(18,3)) from cp"
  ...
  public void testDecimalLiterals() throws Exception {
    final String query =
        "select cast('999999999999999999' as decimal(18,0)) + cast('-0.0000000000000000000000000000000000001' as decimal(38,38)) ";
  ...
  public void testDecimalLiterals11() throws Exception {
    final String query =
        "select cast('-999999999' as decimal(9,0)) / cast('0.000000000000000000000000001' as decimal(28,28))";
  ...
  public void testFlattenOnEmpty() throws Exception {
    ...
    testBuilder()
        ...
        .schemaBaseLine(
            ImmutableList.of(
                Pair.of(SchemaPath.getSimplePath("EXPR$0"), Types.optional(MinorType.STRUCT))))
        .go();
  }
  ...
  public void testGandivaIfElseOptimisation() throws Exception {
    String query =
        "SELECT case when A IS NOT NULL then A else subtract((case when A IS NOT NULL then A else C end), A) end FROM cp.\"test_table.parquet\"";
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
        .baselineColumns("EXPR$0")
  ...
  public void testNegativeIntervalDay() throws Exception {
    ...
    final String query1 =
        String.format(
            "select stringinterval as interval_day "
                + "from dfs.\"%s/test_negative_intervalday.json\" "
                + "where cast(stringinterval as interval day) = negative(interval '0.002' second + interval '2' day)",
            TEST_RES_PATH);
    testBuilder()
        .sqlQuery(query1)
        .unOrdered()
    ...
    final String query2 =
        String.format(
            "select stringinterval as interval_day "
                + "from dfs.\"%s/test_negative_intervalday.json\" "
                + "where cast(stringinterval as interval day) = negative(interval '1.5' second + interval '4' day)",
            TEST_RES_PATH);
    testBuilder()
        .sqlQuery(query2)
        .unOrdered()
  ...
  public void testNegativeIntervalMonth() throws Exception {
    ...
    final String query1 =
        String.format(
            "select stringinterval as interval_month "
                + "from dfs.\"%s/test_negative_intervalmonth.json\" "
                + "where cast(stringinterval as interval month) = negative(interval '99' month)",
            TEST_RES_PATH);
    testBuilder()
        .sqlQuery(query1)
        .unOrdered()
    ...
    final String query2 =
        String.format(
            "select stringinterval as interval_month "
                + "from dfs.\"%s/test_negative_intervalmonth.json\" "
                + "where cast(stringinterval as interval month) = negative(interval '2' month)",
            TEST_RES_PATH);
    testBuilder()
        .sqlQuery(query2)
        .unOrdered()
