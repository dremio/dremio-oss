...
public class TestNotInQueries extends PlanTestBase {
  ...
  public void testMultipleNotIn() throws Exception {
    ...
    String expectedFilterCondition =
        "[AND(NOT(OR(=($0, 'ab'), =($0, 'bc'), =($0, 'cd'), =($0, 'de'), =($0, 'ef'))), NOT(OR(=($1, 67), =($1, 940), =($1, 617), =($1, 10), =($1, 111))), IS NOT NULL($1), IS NOT NULL($0))]";
  ...
  public void testMultipleNotInMixed() throws Exception {
    ...
    String expectedFilterCondition =
        "[AND(NOT(OR(=($0, 'ab'), =($0, 'bc'), =($0, 'cd'), =($0, 'de'), =($0, 'ef'))), NOT(OR(=($1, 67), =($1, 940), =($1, 617), =($1, 10), =($1, 111))), IS NOT NULL($1), IS NOT NULL($0), >($1, -1))]";
