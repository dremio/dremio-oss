...
public class TestNotInQueries extends PlanTestBase {
  ...
  public void testSimpleNotIn() throws Exception {
    ...
    String exprectedFilterCondition =
        "[NOT(OR(=($0, 67), =($0, 940), =($0, 617), =($0, 10), =($0, 111)))]";

    testPlanSubstrPatterns(query,
      new String[]{exprectedFilterCondition}, new String[]{"AND", "<>"});
  }
  ...
  public void testSimpleNotInMixed() throws Exception {
    ...
    String exprectedFilterCondition = "[AND(NOT(OR(=($0, 67), =($0, 940), =($0, 617), =($0, 10), =($0, 111))), >($0, 0))]";

    testPlanSubstrPatterns(query,
      new String[]{exprectedFilterCondition}, new String[]{"<>"});
  }
  ...
  public void testMultipleNotIn() throws Exception {
    ...
    String exprectedFilterCondition =
        "[AND(NOT(OR(=($0, 'ab'), =($0, 'bc'), =($0, 'cd'), =($0, 'de'), =($0, 'ef'))), NOT(OR(=($1, 67), =($1, 940), =($1, 617), =($1, 10), =($1, 111))))]";
  ...
  public void testMultipleNotInMixed() throws Exception {
    ...
    String exprectedFilterCondition =
        "[AND(NOT(OR(=($0, 'ab'), =($0, 'bc'), =($0, 'cd'), =($0, 'de'), =($0, 'ef'))), NOT(OR(=($1, 67), =($1, 940), =($1, 617), =($1, 10), =($1, 111))), >($1, -1))]";
