...
public class TestNotInQueries extends PlanTestBase {
  ...
  public void testSimpleNotIn() throws Exception {
    String query =
        "Select count(*) from cp.\"employees.json\" "
    ...
    testPlanSubstrPatterns(query, new String[] {expectedFilterCondition}, new String[] {"<>"});
  }
  ...
  public void testSimpleNotInMixed() throws Exception {
    ...
    String expectedFilterCondition =
        "[AND(NOT(OR(=($0, 67), =($0, 940), =($0, 617), =($0, 10), =($0, 111))), >($0, 0), IS NOT NULL($0))]";
