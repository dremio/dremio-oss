...
public class TestCaseLargeQueriesJava extends TestAbstractCaseLargeQueries {

  @BeforeClass
  public static void setup() throws Exception {
    testNoResult("ALTER SESSION SET \"%s\" = 1", PlannerSettings.CASE_EXPRESSIONS_THRESHOLD.getOptionName());
    testNoResult("ALTER SESSION SET \"%s\" = 500", ExecConstants.CODE_GEN_CONSTANT_ARRAY_THRESHOLD.getOptionName());
    testNoResult("ALTER SESSION SET \"%s\" = 'Java'", ExecConstants.QUERY_EXEC_OPTION.getOptionName());
  }
