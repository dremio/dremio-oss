...
public class TestTextJoin extends BaseTestQuery {
  ...
  public void testTextJoin1() throws Exception {
    String query1 =
        String.format(
            "select r.columns[0] as v, r.columns[1] as w, r.columns[2] as x, u.columns[0] as y, t.columns[0] as z from dfs.\"%s/uservisits/rankings.tbl\" r, "
                + " dfs.\"%s/uservisits/uservisits.tbl\" u, dfs.\"%s/uservisits/temp1.tbl\" t "
                + " where r.columns[1]=u.columns[1] and r.columns[1] = t.columns[1]",
            TEST_RES_PATH, TEST_RES_PATH, TEST_RES_PATH);
    test(query1);
  }
  ...
  public void testTextJoin2() throws Exception {
    String query1 =
        String.format(
            "select r.columns[0] as v, r.columns[1] as w, r.columns[2] as x, u.columns[0] as y "
