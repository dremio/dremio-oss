...
public class TestUserRpcServerRecordBatchFormat {
  ...
  public void testChooseDremioRecordBatchFormat() {
    ...
    assertEquals(
        RecordBatchFormat.DREMIO_23_0, UserRPCServer.chooseDremioRecordBatchFormat(handshake));
  }
  ...
  public void testChooseDremioRecordBatchFormatForDremio14() {
    ...
    assertEquals(
        RecordBatchFormat.DREMIO_1_4, UserRPCServer.chooseDremioRecordBatchFormat(handshake));
  }
  ...
  public void testChooseDremioRecordBatchFormatForDremio09() {
    ...
    assertEquals(
        RecordBatchFormat.DREMIO_0_9, UserRPCServer.chooseDremioRecordBatchFormat(handshake));
  }
  ...
  public void testChooseDremioRecordBatchFormatOlderClient() {
    UserToBitHandshake handshake =
        UserToBitHandshake.newBuilder().setRecordBatchType(RecordBatchType.DREMIO).build();
