...
public class TestMergeJoin extends BaseTestOperator {
  ...
  private void noNullEmptyLeftData(JoinInfo info, Table expected) throws Exception {
    ...
    final Table right =
        t(th("bool2", "name2"), tr(0L, 1L), tr(1L, 2L), tr(1L, 4L), tr(1L, 5L), tr(0L, 6L));
    validateDual(
        info.operator,
        info.clazz,
  ...
  private void noNullEmptyRightData(JoinInfo info, Table expected) throws Exception {
    final Table left =
        t(th("bool1", "name1"), tr(1L, 1L), tr(0L, 2L), tr(1L, 3L), tr(0L, 4L), tr(0L, 6L));
  ...
  public void noNullEquivalenceInnerEmptyTable() throws Exception {
    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("value"), f("name2"))),
              JoinRelType.INNER);
      final Table expected = t(th("bool2", "name2", "key", "value"), true, tr(0L, 0L, 0L, 0L));
...

    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("name1"), f("value"))),
              JoinRelType.INNER);
      final Table expected = t(th("key", "value", "bool1", "name1"), true, tr(0L, 0L, 0L, 0L));
  ...
  public void noNullEquivalenceLeftEmptyTable() throws Exception {
    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("value"), f("name2"))), JoinRelType.LEFT);
      final Table expected = t(th("bool2", "name2", "key", "value"), true, tr(0L, 0L, 0L, 0L));
      noNullEmptyLeftData(joinInfo, expected);
    }

    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("name1"), f("value"))), JoinRelType.LEFT);
      final Table expected =
          t(
  ...
  public void noNullEquivalenceFullEmptyTable() throws Exception {
    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("value"), f("name2"))), JoinRelType.FULL);
      final Table expected =
          t(
              th("bool2", "name2", "key", "value"),
              tr(0L, 1L, Fixtures.NULL_BIGINT, Fixtures.NULL_BIGINT),
...

    {
      JoinInfo joinInfo =
          getJoinInfo(
              Arrays.asList(new JoinCondition("EQUALS", f("name1"), f("value"))), JoinRelType.FULL);
      final Table expected =
          t(
              th("key", "value", "bool1", "name1"),
              tr(Fixtures.NULL_BIGINT, Fixtures.NULL_BIGINT, 1L, 1L),
  ...
  public void noNullEquivalenceInnerMultipleConditions() throws Exception {
    ...
    {
      final Table expected =
          t(th("bool2", "name2", "bool1", "name1"), tr(false, "a6", false, "a6"));
      noNullSingleRowsData(joinInfo, expected);
    }
