...
public class TestHashAgg extends BaseTestOperator {
  ...
  private void validateAgg(
      HashAggregate conf, TpchTable table, double scale, Fixtures.Table expectedResult)
      throws Exception {
    /* test with row-wise hashagg operator */
    HashAggregate vanillaConf =
        new HashAggregate(
            OpProps.prototype(),
            conf.getChild(),
  ...
  private void validateAgg(HashAggregate conf, Fixtures.Table input, Fixtures.Table expectedResult)
      throws Exception {
    /* test with row-wise hashagg operator */
    HashAggregate vanillaConf =
        new HashAggregate(
  ...
  private void validateAggGenerated(
      HashAggregate conf, Fixtures.Table input, Fixtures.Table expectedResult) throws Exception {
    /* test with row-wise hashagg operator */
    HashAggregate vanillaConf =
        new HashAggregate(
            OpProps.prototype(),
  ...
  public void booleanWork() throws Exception {
    HashAggregate conf =
        new HashAggregate(
            ...
            Arrays.asList(n("sum(int_col)", "sum_int_col"), n("sum(bigint_col)", "sum_bigint_col")),
            true,
            true,
            1f);
  ...
  private static final Table DATA_BOOLEAN =
      t(
  ...
  public void intWork1() throws Exception {
    ...
    final Table expected =
        t(
                th(
                    "gb", "sum-d1", "cnt-d1", "sum0-d1", "min-d1", "max-d1", "sum-d2", "cnt-d2",
                    "sum0-d2", "min-d2", "max-d2"),
                tr("group1", 0L, 2L, 0L, 0, 0, -1L, 2L, -1L, -1, 0),
                tr("group2", -96L, 2L, -96L, -96, 0, -187L, 2L, -187L, -102, -85),
                tr(
                    "group3",
                    Fixtures.NULL_BIGINT,
                    0L,
                    0L,
                    Fixtures.NULL_INT,
                    Fixtures.NULL_INT,
  ...
  private static final Table DATA_INT =
      t(
          th("gb", "d1", "d2"),
          tr("group1", 0, -1),
          tr("group2", -96, -85),
  ...
  private static final Table DATA_BIGINT =
      t(
          th("gb", "d1", "d2"),
  ...
  public void floatWork1() throws Exception {
    ...
    final Table expected =
        t(
                ...
                tr(
                    "group2", -96.25D, 2L, -96.25D, -96.25f, 0.0f, -187.67D, 2L, -187.67D, -102.42f,
                    -85.25f),
                tr(
                    "group3",
                    Fixtures.NULL_DOUBLE,
  ...
  private static final Table DATA_FLOAT =
      t(
          th("gb", "d1", "d2"),
          tr("group1", 0.0f, -1.0f),
  ...
  public void doubleWork1() throws Exception {
    ...
    final Table expected =
        t(
                ...
                tr(
                    "group2", -966.25, 2L, -966.25, -966.25, 0.0, -1873.67, 2L, -1873.67, -1023.42,
                    -850.25),
                tr(
                    "group3",
                    Fixtures.NULL_DOUBLE,
  ...
  private static final Table DATA_DOUBLE =
      t(
          th("gb", "d1", "d2"),
          tr("group1", 0.0, -1.0),
  ...
  public void count1() throws Exception {
    ...
    final Table expected =
        t(th("gb", "cnt"), tr("group1", 3L), tr("group2", 3L), tr("group3", 2L)).orderInsensitive();

    validateAgg(conf, DATA, expected);
  }

  private static final Table DATA =
      t(
  ...
  public void largeSumWithResize() throws Exception {
    ...
    final List<NamedExpression> measure =
        Arrays.asList(n("sum(c_acctbal)", "sum"), n("count(1)", "cnt"));
  ...
  public void decimalSumVsSum0() throws Exception {
    ...
    final List<NamedExpression> dim = Arrays.asList(n("dec_x"));
    final List<NamedExpression> measure =
        Arrays.asList(n("sum(dec_y)", "sum_y"), n("$sum0(dec_y)", "sum0"));
  ...
  public void bitWork() throws Exception {
    ...
    final List<NamedExpression> measure =
        Arrays.asList(n("count(y)", "cnt"), n("min(y)", "min"), n("max(y)", "max"));
  ...
  public void bitWorkWithNulls() throws Exception {
    ...
    final Table expected =
        t(th(column), tr(true), tr(false), tr(Fixtures.NULL_BOOLEAN)).orderInsensitive();
    ...
    final Table expected =
        t(
                ...
                tr(
                    4,
                    1L,
                    Fixtures.interval_day(2, 0),
                    Fixtures.interval_day(2, 0),
                    Fixtures.interval_year(0, 2),
                    Fixtures.interval_year(0, 2)),
                tr(
                    5,
                    2L,
                    Fixtures.interval_day(1, 100),
                    Fixtures.interval_day(9, 20),
                    Fixtures.interval_year(1, 3),
                    Fixtures.interval_year(2, 0)),
                tr(
                    6,
                    2L,
                    Fixtures.interval_day(0, 30),
                    Fixtures.interval_day(0, 30),
                    Fixtures.interval_year(0, 7),
                    Fixtures.interval_year(0, 7)),
                tr(
                    7,
                    1L,
                    Fixtures.interval_day(1, 0),
                    Fixtures.interval_day(1, 0),
                    Fixtures.interval_year(0, 7),
                    Fixtures.interval_year(0, 7)))
            .orderInsensitive();
  ...
  public void minMaxCardinalityLimit() throws Exception {
    ...
    UserExceptionAssert.assertThatThrownBy(
            () -> {
              try (AutoCloseable options =
                  with(HashAggOperator.HASHAGG_MINMAX_CARDINALITY_LIMIT, 1)) {
                HashAggregate vanillaConf =
                    new HashAggregate(
                        OpProps.prototype(),
                        conf.getChild(),
