...
public abstract class BaseTestJoin extends BaseTestOperator {
  ...
  public void emptyRight() throws Exception {
    JoinInfo joinInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("n_nationKey"), f("key"))),
            JoinRelType.INNER);

    final Table expected =
        t(
            th("key", "value", "n_nationKey"), true, tr(0L, 0L, 0L) // fake row to match types.
            );
  ...
  public void emptyRightWithLeftJoin() throws Exception {
    JoinInfo joinInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("r_regionKey"), f("key"))),
            JoinRelType.LEFT);
  ...
  public void isNotDistinctWithNulls() throws Exception {
    JoinInfo includeNullsInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("IS_NOT_DISTINCT_FROM", f("id1"), f("id2"))),
            JoinRelType.INNER);
    final Table includeNulls =
        t(
  ...
  public void noNullEquivalenceWithNulls() throws Exception {
    JoinInfo noNullsInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("id1"), f("id2"))), JoinRelType.INNER);
    final Table noNulls =
        t(th("id2", "name2", "id1", "name1"), tr(4L, "b2", 4L, "a2")).orderInsensitive();
  ...
  public void noNullEquivalenceWithNullsLeft() throws Exception {
    JoinInfo noNullsInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("id1"), f("id2"))), JoinRelType.LEFT);
    final Table noNulls =
        t(
                th("id2", "name2", "id1", "name1"),
  ...
  public void noNullEquivalenceWithNullsRight() throws Exception {
    ...
    JoinInfo noNullsInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("id1"), f("id2"))), JoinRelType.RIGHT);
    final Table noNulls =
        t(
                th("id2", "name2", "id1", "name1"),
                tr(4L, "b2", 4L, "a2"),
  ...
  private void nullKeys(JoinInfo info, Table expected) throws Exception {
    final Table left = t(th("id1", "name1"), tr(Fixtures.NULL_BIGINT, "a1"), tr(4L, "a2"));

    final Table right = t(th("id2", "name2"), tr(Fixtures.NULL_BIGINT, "b1"), tr(4L, "b2"));
  ...
  private void nullKeysForString(JoinInfo info, Table expected) throws Exception {
    final Table left =
        t(th("id1", "name1"), tr(1L, "a1"), tr(2L, "a2"), tr(3L, Fixtures.NULL_VARCHAR));

    final Table right =
        t(th("id2", "name2"), tr(4L, "a1"), tr(5L, "a3"), tr(6L, Fixtures.NULL_VARCHAR));
    validateDual(
        info.operator,
        info.clazz,
        left.toGenerator(getTestAllocator()),
  ...
  public void noNullEquivalenceWithZeroKey() throws Exception {
    JoinInfo includeZeroKeyInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("id1"), f("id2"))), JoinRelType.INNER);
    final Table expected =
        t(th("id2", "name2", "id1", "name1"), tr(0L, "b2", 0L, "a2"), tr(0L, "b4", 0L, "a2"))
            .orderInsensitive()
            .withKeyColumnIndex(1);
    nullWithZeroKey(includeZeroKeyInfo, expected);
  }
  ...
  private void nullWithZeroKey(JoinInfo info, Table expected) throws Exception {
    final Table left = t(th("id1", "name1"), tr(Fixtures.NULL_BIGINT, "a1"), tr(0L, "a2"));
  ...
  public void freeValueInHashTable() throws Exception {
    ...
    final Table left =
        t(th("id1", "name1"), tr(Fixtures.NULL_BIGINT, "a1"), tr(0L, "a2"), tr(freeValue, "a3"));
  ...
  public void isNotDistinctBitKeys() throws Exception {
    JoinInfo includeNullsInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("IS_NOT_DISTINCT_FROM", f("bool1"), f("bool2"))),
            JoinRelType.INNER);
    final Table expected =
        t(
  ...
  public void noNullEquivalenceBitKeys() throws Exception {
    JoinInfo includeZeroKeyInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("bool1"), f("bool2"))), JoinRelType.INNER);
    final Table expected =
        t(
                th("bool2", "name2", "bool1", "name1"),
                tr(true, "b1", true, "a1"),
  ...
  public void noNullEquivalenceBitKeysLeft() throws Exception {
    JoinInfo includeZeroKeyInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("bool1"), f("bool2"))), JoinRelType.LEFT);
    final Table expected =
        t(
                th("bool2", "name2", "bool1", "name1"),
                tr(true, "b1", true, "a1"),
  ...
  public void noNullEquivalenceBitKeysRight() throws Exception {
    ...
    JoinInfo includeZeroKeyInfo =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("bool1"), f("bool2"))), JoinRelType.RIGHT);
    final Table expected =
        t(
                th("bool2", "name2", "bool1", "name1"),
                tr(true, "b1", true, "a1"),
  ...
  private void nullBitKeys(JoinInfo info, Table expected) throws Exception {
    final Table left =
        t(th("bool1", "name1"), tr(true, "a1"), tr(false, "a2"), tr(Fixtures.NULL_BOOLEAN, "a3"));

    final Table right =
        t(th("bool2", "name2"), tr(true, "b1"), tr(false, "b2"), tr(Fixtures.NULL_BOOLEAN, "b3"));
    validateDual(
        info.operator,
        info.clazz,
        left.toGenerator(getTestAllocator()),
  ...
  public void regionNationInner() throws Exception {
    JoinInfo info =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("r_regionKey"), f("n_regionKey"))),
            JoinRelType.INNER);
    ...
    validateDual(
        info.operator,
        info.clazz,
        TpchGenerator.singleGenerator(
            TpchTable.REGION, 0.1, getTestAllocator(), "r_regionKey", "r_name"),
        TpchGenerator.singleGenerator(
            TpchTable.NATION, 0.1, getTestAllocator(), "n_regionKey", "n_name"),
        DEFAULT_BATCH,
        expected);
  }
  ...
  public void nationRegionPartialKeyRight() throws Exception {
    ...
    JoinInfo info =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("n_nationKey"), f("r_regionKey"))),
            JoinRelType.RIGHT);
    ...
    validateDual(
        ...
        info.clazz,
        TpchGenerator.singleGenerator(
            TpchTable.NATION, 0.1, getTestAllocator(), "n_nationKey", "n_name"),
        TpchGenerator.singleGenerator(
            TpchTable.REGION, 0.1, getTestAllocator(), "r_regionKey", "r_name"),
        DEFAULT_BATCH,
        expected);
  ...
  public void regionNationPartialKeyRight() throws Exception {
    ...
    JoinInfo info =
        getJoinInfo(
            Arrays.asList(new JoinCondition("EQUALS", f("r_regionKey"), f("n_nationKey"))),
            JoinRelType.RIGHT);
  ...
  public void manyKeys() throws Exception {
    JoinInfo info =
        getJoinInfo(
            Arrays.asList(
                new JoinCondition("EQUALS", f("col1_1"), f("col2_1")),
    ...
    final Table expected =
        t(
                th(
                    "col2_1", "col2_2", "col2_3", "col2_4", "col2_5", "col2_6", "col2_7", "col2_8",
                    "col2_9", "col2_10", "col2_11", "col2_12", "col2_13", "col2_14", "col2_15",
                    "col2_16", "col2_17", "col2_18", "col2_19", "col2_20", "col2_21", "col2_22",
                    "col2_23", "col2_24", "col2_25", "col2_26", "col2_27", "col2_28", "col2_29",
                    "col2_30", "col2_31", "col2_32", "col2_33", "col2_34", "col1_1", "col1_2",
                    "col1_3", "col1_4", "col1_5", "col1_6", "col1_7", "col1_8", "col1_9", "col1_10",
                    "col1_11", "col1_12", "col1_13", "col1_14", "col1_15", "col1_16", "col1_17",
                    "col1_18", "col1_19", "col1_20", "col1_21", "col1_22", "col1_23", "col1_24",
                    "col1_25", "col1_26", "col1_27", "col1_28", "col1_29", "col1_30", "col1_31",
                    "col1_32", "col1_33", "col1_34"),
                tr(
                ...
                tr(
                    1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L,
                    19L, 20L, 21L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L, 100L,
                    1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L,
                    19L, 20L, 21L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L, 34L))
            .orderInsensitive()
            .withKeyColumnIndex(33);

    final Table left =
        t(
            th(
                "col1_1", "col1_2", "col1_3", "col1_4", "col1_5", "col1_6", "col1_7", "col1_8",
                "col1_9", "col1_10", "col1_11", "col1_12", "col1_13", "col1_14", "col1_15",
                "col1_16", "col1_17", "col1_18", "col1_19", "col1_20", "col1_21", "col1_22",
                "col1_23", "col1_24", "col1_25", "col1_26", "col1_27", "col1_28", "col1_29",
                "col1_30", "col1_31", "col1_32", "col1_33", "col1_34"),
            tr(
                1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L,
                19L, 20L, 21L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L, 34L));
    ...
    final Table right =
        t(
            th(
                ...
                "col2_16", "col2_17", "col2_18", "col2_19", "col2_20", "col2_21", "col2_22",
                "col2_23", "col2_24", "col2_25", "col2_26", "col2_27", "col2_28", "col2_29",
                "col2_30", "col2_31", "col2_32", "col2_33", "col2_34"),
            tr(
                1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L,
                19L, 20L, 21L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L, 34L),
            tr(
  ...
  public void hugeBatch() throws Exception {
    ...
    final Table expected = t(th("b", "a"), expectedRows).orderInsensitive();
  ...
  public void testDecimalJoin() throws Exception {
    ...
    final Table left =
        t(th("id1", "name1"), tr(BigDecimal.valueOf(1), "a2"), tr(BigDecimal.valueOf(2), "a3"));
  ...
  private static final class ManyColumnsGenerator<T extends BaseFixedWidthVector>
    ...
    public ManyColumnsGenerator(
      ...
      for (int i = 0; i < columns; i++) {
        Field field =
            new Field(
                String.format("%s_%d", prefix, i + 1), new FieldType(true, arrowType, null), null);
  ...
  private static void insertIntoDecimalVector(int index, int value, BaseFixedWidthVector vector) {
    ...
    DecimalUtility.writeBigDecimalToArrowBuf(
        new BigDecimal(value), holder.buffer, 0, DecimalVector.TYPE_WIDTH);
    holder.start = 0;
    holder.scale = 0;
    holder.precision = 38;
  ...
  private static HeaderRow getHeader(
      String leftPrefix, int leftColumns, String rightPrefix, int rightColumns) {
  ...
  private static DataRow[] getData(
      int leftFrom, int leftColumns, int rightFrom, int rightColumns, int count) {
  ...
  private static DataRow[] getDataDecimal(int leftColumns, int rightColumns, int count) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      for (int j = 0; j < rightColumns; j++) {
        objects[j + leftColumns] =
            new BigDecimal(i).multiply(new BigDecimal(rightColumns)).add(new BigDecimal(j));
      }
      rows[i] = tr(objects);
    }
  ...
  protected void baseManyColumns() throws Exception {
    ...
    Table expected =
        t(
            getHeader("right", rightColumns, "left", leftColumns),
            false,
            getData(columns, leftColumns, 1));
    validateDual(
        joinInfo.operator,
        joinInfo.clazz,
        new ManyColumnsGenerator<IntVector>(
            getTestAllocator(),
            "left",
            leftColumns,
            1,
            ...
            BaseTestJoin::insertIntoIntVector),
        new ManyColumnsGenerator<IntVector>(
            getTestAllocator(),
            "right",
            rightColumns,
  ...
  protected void baseManyColumnsDecimal() throws Exception {
    ...
    Table expected =
        t(
            getHeader("right", rightColumns, "left", leftColumns),
            false,
            getDataDecimal(columns, leftColumns, 1));
    validateDual(
        joinInfo.operator,
        joinInfo.clazz,
        new ManyColumnsGenerator<DecimalVector>(
            getTestAllocator(),
            "left",
            leftColumns,
            1,
            DecimalVector.class,
            new ArrowType.Decimal(38, 0, 128),
            BaseTestJoin::insertIntoDecimalVector),
        new ManyColumnsGenerator<DecimalVector>(
            getTestAllocator(),
            "right",
            rightColumns,
