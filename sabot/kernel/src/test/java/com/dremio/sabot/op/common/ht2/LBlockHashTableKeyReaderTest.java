...
public class LBlockHashTableKeyReaderTest {
    ...
    private ArrowBuf setupTableData(List<String>... colKeys) {
        ...
        checkArgument(Arrays.stream(colKeys).allMatch(list -> list.size() == rowCount), "All input col key lists should be of same size.");
    ...
    private HashTableKeyReader newKeyReader(List<String> fieldNames, PivotDef pivot, boolean setVarFieldLenInFirstByte) {
        HashTableKeyReader.Builder builder = new HashTableKeyReader.Builder()
