 ...
 */
public class BatchDataGenerator implements Generator {
  ...
  private Map<ArrowTypeID, RandomGenerator<?>> getTypeIDRandomGeneratorMap(int varcharLen) {
    ...
    generators.put(
        ...
        () -> {
          ...
          return rand.nextInt(maxRandomInt);
        });
