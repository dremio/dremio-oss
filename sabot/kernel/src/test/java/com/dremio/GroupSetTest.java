...
public class GroupSetTest extends BaseTestQuery {
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(GroupSetTest.class);
  ...
  public void testGroupSet1() throws Exception {
    String query =
        "select n_regionkey, count(*) as cnt from "
  ...
  public void testGroupSet2() throws Exception {
    String query =
        "SELECT c1, c2, count(*) AS my_count\n"
  ...
  public void testRollup1() throws Exception {
    String query =
        "select n_regionkey, n_name, count(*) as cnt from "
  ...
  public void testGroupingSetWithAggFunctionOnGroupColumn() throws Exception {
    String query =
        "select n_regionkey, count(n_regionkey) cnt from cp.\"tpch/nation.parquet\" group by rollup (n_regionkey);";
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
        .baselineColumns("n_regionkey", "cnt")
  ...
  public void testGroupingSetWithAvgFunctionOnGroupColumn() throws Exception {
    String query =
        "select n_regionkey, avg(n_regionkey) \"avg\" from cp.\"tpch/nation.parquet\" group by rollup (n_regionkey);";
