...
/**
 * Tests streaming aggregates when no group by clause is present. Uses test file that is equivalent
 * of [ {"a":"1", "val" : "123.12345678901234567890"}, {"a":"1", "val" : "1.12345678901234567890"},
 * {"a":"1", "val" : "-11.12345678901234567890"}, {"a":"2", "val" : "11.12345678901234567890"},
 * {"a":"2"}, {"a":"2", "val" : "2.12345678901234567890"}, {"a":"2", "val" : "0.01"}, {"a":"2",
 * "val" : "-2.0"}, {"a":"3"}, {"a":"3"}, {"a":"4", "val" : "0.01"}, {"a":"4", "val" :
 * "2.12345678901234567890"}, {"a":"4", "val" : "32.1020"} ]
 */
public class TestDecimalStreamAgg extends BaseTestQuery {

  @Test
  public void testDecimalSumAgg_Parquet() throws Exception {

    final String query =
        "select sum(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalSumAggOverflow_Parquet() {
    final String query = "select sum(val) from cp" + ".\"parquet/decimals/overflow.parquet\"";
  ...
  public void testDecimalSumZeroAgg_Parquet() throws Exception {
    ...
    final String query =
        "select $sum0(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalSumZeroAggOverflow_Parquet() {
    ...
    final String query = "select $sum0(val) from cp" + ".\"parquet/decimals/overflow.parquet\"";
  ...
  public void testDecimalMin_Parquet() throws Exception {
    ...
    final String query =
        "select min(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalMax_Parquet() throws Exception {
    ...
    final String query =
        "select max(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalMaxByteValuesSameAsMinDecimal_Json() throws Exception {
    ...
    final String query =
        "select max(cast(a as decimal(38,2))) from cp" + ".\"decimal/test_agg_max.json\"";
  ...
  public void testDecimalAvg_Parquet() throws Exception {
    ...
    final String query =
        "select avg(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalVariance_Parquet() throws Exception {
    ...
    final String query =
        "select variance(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalVarPop_Parquet() throws Exception {
    ...
    final String query =
        "select var_pop(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalStdDev_Parquet() throws Exception {
    ...
    final String query =
        "select stddev(val) from cp" + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";
  ...
  public void testDecimalSingleValueAgg_Parquet1() throws Exception {
    ...
    final String query =
        "select SINGLE_VALUE(val) from (select * from cp"
  ...
  public void testDecimalSingleValueAgg_Parquet2() throws Exception {
    ...
    final String query =
        "select SINGLE_VALUE(val) from cp"
            + ".\"parquet/decimals/simple-decimals-with-nulls.parquet\"";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("EXPR$0").go();
  }
}
