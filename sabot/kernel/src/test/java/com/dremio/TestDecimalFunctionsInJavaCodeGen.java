 ...
 * generator set to java.
 */
public class TestDecimalFunctionsInJavaCodeGen extends TestMixedDecimalFunctionTests {

  public TestDecimalFunctionsInJavaCodeGen() {
    execPreference = CodeGenOption.Java.toString();
  }
  ...
  public void testCot() {
    testFunctions(
        new Object[][] {
          {"truncate(cot(c0),5)", -2147483649D, 2.91304D},
