...
public class TestHiveMaskFunctions extends PlanTestBase {
  ...
  public void testMaskHashCharWithLen() throws Exception {
    String query =
        "select mask_hash(cast(c1 as char(24))) as cc from (values('TestString-123')) as t1(c1)";
  ...
  public void testMaskHashVarChar() throws Exception {
    String query =
        "select mask_hash(cast(c1 as varchar(24))) as cc from (values('TestString-123')) as t1(c1)";
  ...
  /**
   * bug most likely unrelated to the mask function - select from dataset is ok @Test public void
   * testMaskCharUnicodeArg() throws Exception { String query = "select \n" + "
   * mask(cast('TestString-12345' as varchar(100)), '大', '小', '数', ':') as c1";
   *
   * <p>testBuilder() .unOrdered() .sqlQuery(query) .baselineColumns("c1")
   * .baselineValues("大小小小大小小小小小:数数数数数") .build() .run(); }
   */

  /**
   * bug unrelated to the mask function - select 'TestString-世界-你好-一二三-12345' also fails @Test
   * public void testMaskCharUnicodeInput() throws Exception { String query = "select \n" + "
   * mask(cast('TestString-世界-你好-一二三-12345' as varchar(100)), 'Y', 'y', '0', ':') as c1";
   *
   * <p>testBuilder() .unOrdered() .sqlQuery(query) .baselineColumns("c1")
   * .baselineValues("YyyyYyyyyy:::::::::::00000") .build() .run(); }
   */
  @Test
  ...
  public void testMaskCharWithArgs() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            "XxxxXxxxxx-nnnnn", "YyyyYyyyyy-zzzzz", "YyyyYyyyyy:00000", "xxxxxxxxxx-xxxxx")
        .build()
        .run();
  }
  ...
  public void testMaskInt0() throws Exception {
    ...
    testBuilder().unOrdered().sqlQuery(query).baselineColumns("c1").baselineValues(0).build().run();
  }
  ...
  public void testMaskDateFromDataset() throws Exception {
    String query =
        "select extract(year from masked_date) y, extract(month from masked_date) m, extract(day from masked_date) d from\n"
  ...
  public void testMaskShowFirstNIntWithArgs() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(
            23451, 23411, 23411, 23411, 23411, 23411, 23488, 23488, 23411, 23488, 23411, 23451,
            23488)
        .build()
        .run();
  }
