...
public class KeyFairSliceCalculatorTest {
  ...
  public void testUnderflowSize() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", 4, "k2", 4, "k3", 4), 16);
  ...
  public void testAllOverflowSizes() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", 12, "k2", 8, "k3", 8, "k4", 6, "k5", 4), 16);
    assertEquals("Invalid combined key size", 16, keyFairSliceCalculator.getTotalSize());

    assertEquals(
        Integer.valueOf(3),
        keyFairSliceCalculator.getKeySlice("k1")); // biggest key gets the remainder
  ...
  public void testMixedOverflow() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", 12, "k2", 8, "k3", 2, "k4", 2), 16);
    assertEquals("Invalid combined key size", 16, keyFairSliceCalculator.getTotalSize());
  ...
  public void testMixedOverflowWithVariableLengthKeys() {
    ...
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(
            newHashMap("k1", 12, "k2", Integer.MAX_VALUE, "k3", 2, "k4", Integer.MAX_VALUE), 16);
    assertEquals("Invalid combined key size", 16, keyFairSliceCalculator.getTotalSize());
  ...
  public void testOrderByKeysForSameSize() {
    ...
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(
            newHashMap("k9", Integer.MAX_VALUE, "k1", Integer.MAX_VALUE, "k4", Integer.MAX_VALUE),
            16);
    assertEquals("Invalid combined key size", 16, keyFairSliceCalculator.getTotalSize());
  ...
  public void testOrderWithOnlyBitKeys() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", -1, "k2", -1), 16);
  ...
  public void testOrderWithMixedBitKeys() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", 4, "k2", -1, "k3", Integer.MAX_VALUE), 16);
  ...
  public void testOrderWithOverflowingValidityRegion() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(
            newHashMap("k1", 4, "k2", -1, "k3", -1, "k4", -1, "k5", 4, "k6", Integer.MAX_VALUE),
            16);
    assertEquals("Invalid key size", 16, keyFairSliceCalculator.getTotalSize());
    ...
    keyFairSliceCalculator =
        new KeyFairSliceCalculator(
            newHashMap("k1", 4, "k2", -1, "k3", -1, "k4", -1, "k5", 4, "k6", 4), 16);
  ...
  public void testOrderWithOnlyBitValuesAndOverflow() {
    KeyFairSliceCalculator keyFairSliceCalculator =
        new KeyFairSliceCalculator(newHashMap("k1", -1, "k2", -1, "k3", -1, "k4", -1), 16);
    assertEquals("Invalid key size", 1, keyFairSliceCalculator.getTotalSize());
    ...
    keyFairSliceCalculator =
        new KeyFairSliceCalculator(
            newHashMap("k1", -1, "k2", -1, "k3", -1, "k4", -1, "k5", -1), 16);
