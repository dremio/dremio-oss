...
public class TestIcebergDeleteFileAggTableFunction extends BaseTestTableFunction {
  ...
  public void testBasicAgg() throws Exception {
    ...
    RecordSet output = rs(SystemSchemas.ICEBERG_DELETE_FILE_AGG_SCHEMA,
        r("data1", 100L, PARTITION_1, COL_IDS_1, li(DELETE_1, DELETE_2, DELETE_3, DELETE_4), PARTITION_SPEC_ID_1),
    ...
    validateSingle(getPop(), TableFunctionOperator.class, input, new RecordBatchValidatorDefaultImpl(output), 3);
  }
