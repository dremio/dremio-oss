...
public class TestEnhancedFilterJoinSimplifier {
  ...
  private static final RexNode intLit40 =
      rexBuilder.makeLiteral(40, typeFactory.createSqlType(INTEGER), false);
  ...
  public void testAndRootNoPush() {
    RexNode simplifiedFilter =
        EnhancedFilterJoinSimplifier.simplifyConjunction(
            rexBuilder,
            Arrays.asList(rEq(col_R_a, intLit10), rEq(col_R_b, intLit20)),
            Arrays.asList(
  ...
  public void testAndRootPartialPush() {
    RexNode simplifiedFilter =
        EnhancedFilterJoinSimplifier.simplifyConjunction(
            rexBuilder,
            Arrays.asList(rEq(col_R_a, intLit10), rEq(col_S_x, intLit20)),
            Arrays.asList(
                Pair.of(rEq(col_R_a, intLit10), rEq(col_R_a, intLit10)),
  ...
  public void testOrRootAllEntirelyPushed() {
    RexNode simplifiedFilter =
        EnhancedFilterJoinSimplifier.simplifyDisjunction(
            rexBuilder,
            Arrays.asList(rEq(col_R_a, intLit10), rEq(col_R_b, intLit20), rEq(col_R_c, intLit30)),
            Arrays.asList(
                Pair.of(rEq(col_R_a, intLit10), rEq(col_R_a, intLit10)),
                Pair.of(rEq(col_R_b, intLit20), rEq(col_R_b, intLit20)),
  ...
  public void testOrNonEntirelyPushedHasCommonExtraction() {
    RexNode simplifiedFilter =
        EnhancedFilterJoinSimplifier.simplifyDisjunction(
            ...
            Arrays.asList(
                Pair.of(
                    rEq(col_R_a, intLit10), rAnd(rEq(col_R_a, intLit10), rEq(col_S_x, intLit20))),
                Pair.of(
                    rEq(col_R_a, intLit10), rAnd(rEq(col_R_a, intLit10), rEq(col_S_y, intLit30))),
        ...
        EnhancedFilterJoinSimplifier.simplifyDisjunction(
            ...
            Arrays.asList(
                Pair.of(
                    rEq(col_R_a, intLit10), rAnd(rEq(col_R_a, intLit10), rEq(col_S_x, intLit20))),
                Pair.of(
                    rEq(col_R_a, intLit20), rAnd(rEq(col_R_a, intLit20), rEq(col_S_y, intLit30))),
                Pair.of(rEq(col_R_b, intLit40), rEq(col_R_b, intLit40))),
            true);
    Assert.assertEquals(
        "OR(AND(=($0, 10), =($3, 20)), AND(=($0, 20), =($4, 30)), =($1, 40))",
        ...
        EnhancedFilterJoinSimplifier.simplifyDisjunction(
            ...
            Arrays.asList(
                rAnd(
                    rOr(
                        rAnd(
                            rEq(col_S_x, intLit10), rEq(col_S_y, intLit10), rEq(col_R_a, intLit10)),
                        rAnd(
                            rEq(col_S_x, intLit10),
                            rEq(col_S_y, intLit10),
                            rEq(col_R_b, intLit10))),
                    rEq(col_S_w, intLit10)),
                rAnd(
                    rOr(
                        rAnd(
                            rEq(col_S_x, intLit10), rEq(col_S_z, intLit10), rEq(col_R_a, intLit10)),
                        rAnd(
                            rEq(col_S_x, intLit10),
                            rEq(col_S_z, intLit10),
                            rEq(col_R_c, intLit10))),
                    rEq(col_S_w, intLit10))),
            Arrays.asList(
                Pair.of(
                    rAnd(rEq(col_S_x, intLit10), rEq(col_S_y, intLit10), rEq(col_S_w, intLit10)),
                    rAnd(
                        rOr(rEq(col_R_a, intLit10), rEq(col_R_b, intLit10)),
                        rEq(col_S_w, intLit10))),
                Pair.of(
                    rAnd(rEq(col_S_x, intLit10), rEq(col_S_z, intLit10), rEq(col_S_w, intLit10)),
                    rAnd(
                        rOr(rEq(col_R_a, intLit10), rEq(col_R_c, intLit10)),
                        rEq(col_S_w, intLit10)))),
            true);
    Assert.assertEquals(
        "OR(AND(OR(=($0, 10), =($1, 10)), =($4, 10)), "
