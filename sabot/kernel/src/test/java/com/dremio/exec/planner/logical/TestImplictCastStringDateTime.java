...
public class TestImplictCastStringDateTime extends PlanTestBase {

  @Test
  public void testSimpleSelectExprList() throws Exception {
    // Casting to TIMESTAMP
    String sql =
        "SELECT EXTRACT(hour from ts) FROM (\n"
    ...
    testPlanMatchingPatterns(
        sql,
        new String[] {
          "Project\\(EXPR\\$0=\\[12:BIGINT\\]\\) : rowType = RecordType\\(BIGINT EXPR\\$0\\)"
        });
  }
}
