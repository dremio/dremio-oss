...
public class BatchSchemaDifferTest {
  ...
  public void testBatchSchemaDifferSimpleColumns() {
    ...
    BatchSchemaDiff diff = batchSchemaDiffer.diff(tableSchema1.getFields(),tableSchema2.getFields());

    assertEquals(diff.getAddedFields().size(), 0);
    assertEquals(diff.getModifiedFields(), ImmutableList.of(CompleteType.VARCHAR.toField("bitField")));
    assertEquals(diff.getDroppedFields(), ImmutableList.of(CompleteType.DOUBLE.toField("doubleCol")));
  }
  ...
  public void testBatchSchemaDifferStruct() {
    ...
    Field structField1 = new Field("a", FieldType.nullable(STRUCT.getType()),
      childrenField1);

    BatchSchema tableSchema1 =
      BatchSchema.of(CompleteType.INT.toField("integerCol"),
        structField1);


    List<Field> childrenField2 = ImmutableList.of(CompleteType.VARCHAR.toField("doubleCol"));

    Field structField2 = new Field("a", FieldType.nullable(STRUCT.getType()),
      childrenField2);
    ...
    Field assertField = new Field("a", FieldType.nullable(STRUCT.getType()),
  ...
  public void testBatchSchemaDifferStructInsideStructChange() {
    List<Field> childrenField1 = ImmutableList.of(CompleteType.INT.toField("id"),
      CompleteType.DOUBLE.toField("col"));

    Field structField1 = new Field("b", FieldType.nullable(STRUCT.getType()),
      childrenField1);

    Field structField2 = new Field("a", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        structField1,
        CompleteType.INT.toField("c")
      ));

    BatchSchema tableSchema1 =
      BatchSchema.of(structField2,
        CompleteType.INT.toField("integerCol")
        );

    Field structFieldNew1 = new Field("a", FieldType.nullable(STRUCT.getType()), ImmutableList.of(CompleteType.DOUBLE.toField("c")));

      BatchSchema tableSchema2 =
      BatchSchema.of(structFieldNew1,
        CompleteType.INT.toField("integerCol")
      );
    ...
    Field assertField1 = new Field("a", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        CompleteType.DOUBLE.toField("c")
      ));

    Field assertField2 = new Field("a", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        new Field("b", FieldType.nullable(STRUCT.getType()),
          ImmutableList.of(CompleteType.INT.toField("id")))
      ));

    Field assertField3 = new Field("a", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        new Field("b", FieldType.nullable(STRUCT.getType()),
  ...
  public void testBatchSchemaDifferStructInsideStruct() {
    ...
    List<Field> childrenField2 = ImmutableList.of(CompleteType.INT.toField("id"),
      CompleteType.VARCHAR.toField("col"));

    Field structFieldNew1 = new Field("b", FieldType.nullable(STRUCT.getType()),
      childrenField2);

    Field structFieldNew2 = new Field("a", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        structFieldNew1));

    BatchSchema tableSchema2 =
      BatchSchema.of(structFieldNew2);
  ...
  public void testBatchSchemaDifferListOfStruct() {
    ...
    Field listStruct1 = new Field("listStruct", FieldType.nullable(LIST.getType()), ImmutableList.of(structField1));

    BatchSchema tableSchema1 =
      BatchSchema.of(listStruct1);

    List<Field> childrenField2 = ImmutableList.of(CompleteType.DOUBLE.toField("integerCol"));

    Field structField2 = new Field("structField", FieldType.nullable(STRUCT.getType()), childrenField2);
    Field listStruct2 = new Field("listStruct", FieldType.nullable(LIST.getType()), ImmutableList.of(structField2));

    BatchSchema tableSchema2 =
      BatchSchema.of(listStruct2);
    ...
    Field assertField1 = new Field("listStruct", FieldType.nullable(LIST.getType()),
      ImmutableList.of(
        new Field("structField", FieldType.nullable(STRUCT.getType()),
          ImmutableList.of(CompleteType.DOUBLE.toField("integerCol")))
      ));

    Field assertField2 = new Field("listStruct", FieldType.nullable(LIST.getType()),
      ImmutableList.of(
        new Field("structField", FieldType.nullable(STRUCT.getType()),
  ...
  public void testBatchSchemaDifferDropTopLevelStruct() {
    ...
    Field assertField1 = new Field("structField", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        CompleteType.INT.toField("integerCol")
      ));

    Field assertField2 = new Field("structField", FieldType.nullable(STRUCT.getType()),
      ImmutableList.of(
        CompleteType.DOUBLE.toField("doubleCol")
      ));
