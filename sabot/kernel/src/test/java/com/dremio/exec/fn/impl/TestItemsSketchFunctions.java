...
public class TestItemsSketchFunctions extends PlanTestBase {
  ...
  public void testVarchar() throws Exception {
    ...
    sketchMap.put(
        "`varchar_cms`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(
            expected, null, new ArrayOfStringsSerDe()));
  ...
  public void test(
      String query,
      String col,
      Map<String, DremioTestWrapper.BaselineValuesForItemsSketch> sketchMap,
      boolean twoPhase)
      throws Exception {
    if (twoPhase) {
      test("set planner.slice_target = 1");
  ...
  private void verifyAllTypes() throws Exception {
    ...
    sketchMap.put(
        "`a`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(a, null, new ArrayOfBooleansSerDe()));
    sketchMap.put(
        "`b`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(b, null, new ArrayOfNumbersSerDe()));
    sketchMap.put(
        "`c`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(c, null, new ArrayOfLongsSerDe()));
    sketchMap.put(
        "`d`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(d, null, new ArrayOfNumbersSerDe()));
    sketchMap.put(
        "`e`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(e, null, new ArrayOfDoublesSerDe()));
    sketchMap.put(
        "`f`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(f, null, new ArrayOfLongsSerDe()));
    sketchMap.put(
        "`g`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(g, null, new ArrayOfLongsSerDe()));
    sketchMap.put(
        "`h`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(h, null, new ArrayOfNumbersSerDe()));
    sketchMap.put(
        "`i`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(i, null, new ArrayOfStringsSerDe()));
    sketchMap.put(
        "`j`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(j, null, new ArrayOfNumbersSerDe()));
    sketchMap.put(
        "`k`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(k, null, new ArrayOfNumbersSerDe()));
  ...
  public void testHeavyHitters() throws Exception {
    ...
    sketchMap.put(
        "`a`",
        new DremioTestWrapper.BaselineValuesForItemsSketch(
            null, heavyHitters, new ArrayOfStringsSerDe()));
