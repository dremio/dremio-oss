...
public class TestHardAssignmentCreator extends ExecTest {
  ...
  private CompleteWork newWork(String id, long sizeInBytes, NodeEndpoint endpoint, double affinity) {
  ...
  public void simpleOneFileOnAHost() throws Exception {
    ...
    // Negative case - fails because the assigned list contains more ENDPOINTS running on 10.0.0.1 than the files on
    // 10.0.0.1
  ...
  public void oneOrMoreFilesOnEachHost() throws Exception {
    ...
    // Negative case - fails because the assigned list contains more ENDPOINTS running on 10.0.0.4 than the number of
    // files on 10.0.0.4
    verifyAssignmentFails(workUnits, ENDPOINT_1_1, ENDPOINT_2_1, ENDPOINT_3_1, ENDPOINT_4_1, ENDPOINT_4_2);
  }
  ...
  private static final String summary(ListMultimap<Integer, CompleteWork> assignments,
      List<NodeEndpoint> inputEps, List<CompleteWork> inputWorks) {
    return "Assignments: " + assignments + ", input endpoints: " + inputEps + ", input works: " + inputWorks;
  }

  private static final void verifyAssignmentFails(List<CompleteWork> workUnits, NodeEndpoint... endpoints) {
    try {
