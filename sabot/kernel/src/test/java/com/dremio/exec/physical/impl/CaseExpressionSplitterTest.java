...
public class CaseExpressionSplitterTest extends BaseExpressionSplitterTest {
  private static final String simpleCaseQuery =
      "case when (c0 / 2) >= (c1 * 2) then c0 - c1 else c1 + c0 end";
  ...
  private static final String simpleCaseThenSplit =
      "(case when (equal(_xxx0, 0i)) then (subtract(c0, c1)) " + "else (add(c1, c0)) end)";
  ...
  final Fixtures.Table mixedCaseInput =
      Fixtures.split(th("c0", "c1", "c2"), 3, tr(12, 11, 23), tr(11, 12, 6), tr(4, 22, 14));

  final Fixtures.Table mixedCaseOutput = t(th("out"), tr("null"), tr("Not Done"), tr("Done"));

  private static final Fixtures.Table caseInputSimple =
      Fixtures.split(th("c0", "c1"), 2, tr(20, 4), tr(10, 11), tr(40, 10));

  Fixtures.Table caseOutputSimple = t(th("out"), tr(16), tr(21), tr(30));

  private static final Fixtures.Table caseInputMulti =
      Fixtures.split(
          th("c0", "c1"), 2, tr(11, 10), tr(11, 15), tr(10, 115), tr(10, 101), tr(10, 25));

  private static final Fixtures.Table caseOutputMulti =
      t(th("out"), tr(1), tr(6), tr(105), tr(81), tr(35));

  private static final Fixtures.Table altInputMulti =
      Fixtures.split(
          th("c0", "c1", "c2", "c3", "c4"),
          5,
  ...
  private static final Fixtures.Table altOutputMulti =
      t(th("out"), tr(0), tr(72), tr(3), tr(80), tr(281));

  private static final Fixtures.Table multiCaseMixedThenAsArgToFunctionQueryInput =
      Fixtures.split(
          th("c0", "c1", "c2", "c3"),
          5,
          tr(20, -400, 350, 110),
  ...
  private static final Fixtures.Table multiCaseMixedThenAsArgToFunctionQueryOutput =
      t(th("out"), tr(363), tr(-77), tr(-77), tr(113), tr(-97));

  @Test
  public void testZeroSplitsSimpleJava() throws Exception {
    GandivaAnnotator annotator = new GandivaAnnotatorCase();
    Split[] expSplits = new Split[] {new Split(false, "out", simpleCaseExpr, 1, 0)};
  ...
  public void testZeroSplitsMultiJava() throws Exception {
    GandivaAnnotator annotator = new GandivaAnnotatorCase();
    Split[] expSplits = new Split[] {new Split(false, "out", multiCaseExpr, 1, 0)};
  ...
  public void testZeroSplitsSimpleGandiva() throws Exception {
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase(
            "greater_than_or_equal_to", "subtract", "add", "divide", "multiply");
    Split[] expSplits = new Split[] {new Split(true, "out", simpleCaseExpr, 1, 0)};
    splitAndVerifyCase(simpleCaseQuery, caseInputSimple, caseOutputSimple, expSplits, annotator);
  }
  ...
  public void testZeroSplitsMultiGandiva() throws Exception {
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase(
            "greater_than_or_equal_to", "less_than_or_equal_to", "subtract", "add");
    Split[] expSplits = new Split[] {new Split(true, "out", multiCaseExpr, 1, 0)};
    splitAndVerifyCase(multiCaseQuery, caseInputMulti, caseOutputMulti, expSplits, annotator);
  }
  ...
  public void testVerticalSplitThenInJava() throws Exception {
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase("greater_than_or_equal_to", "divide", "multiply");
    Split[] expSplits =
        new Split[] {
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              false,
              "_xxx2",
              "(case when (greater_than_or_equal_to(_xxx0, _xxx1)) then (0i) else (1i) end)",
              2,
              1,
              "_xxx0",
              "_xxx1"),
          new Split(
              true,
              "out",
              "(case when (equal(_xxx2, 0i)) then (subtract(c0, c1)) else (add(c1, c0)) end)",
              3,
              0,
              "_xxx2")
        };
  ...
  public void testMixedSplitWhenMiddle() throws Exception {
    final String xxx0 =
        "(case when (greater_than_or_equal_to(c0, c1)) then (0i) "
            + "when (greater_than_or_equal_to(c0, subtract(c1, 10i))) then (1i) "
            + "else (-1i) end)";
    final String xxx1 =
        "(if (less_than(_xxx0, 0i)) then (subtract(c1, 100i)) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx2 =
        "(case when (greater_than(_xxx0, -1i)) then (_xxx0) "
            + "when (less_than_or_equal_to(c0, _xxx1)) then (2i) else (-1i) end)";
    final String xxx3 =
        "(if (less_than(_xxx2, 0i)) then (subtract(c1, 90i)) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx4 =
        "(case when (greater_than(_xxx2, -1i)) then (_xxx2) "
            + "when (less_than_or_equal_to(c0, _xxx3)) then (3i) else (4i) end)";
    final String xxx5 =
        "(case when (equal(_xxx4, 0i)) then (subtract(c0, c1)) "
    ...
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase("greater_than_or_equal_to", "add", "subtract");
    Split[] expSplits =
        new Split[] {
  ...
  public void testAlternateWhenSplits() throws Exception {
    final String xxx0 =
        "(case when (greater_than_or_equal_to(c0, c1)) then (0i) " + "else (-1i) end)";
    final String xxx1 =
        "(case when (greater_than(_xxx0, -1i)) then (_xxx0) "
            + "when (less_than_or_equal_to(c2, add(c1,1i))) then (1i) "
            + "else (-1i) end)";
    final String xxx2 =
        "(case when (greater_than(_xxx1, -1i)) then (_xxx1) "
    ...
    final String xxx3 =
        "(case when (greater_than(_xxx2, -1i)) then (_xxx2) "
            ...
            + "else (4i) end)";
    final String xxx4 =
        "(case when (equal(_xxx3, 0i)) then (subtract(c0, c1)) "
    ...
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase("less_than_or_equal_to", "add", "subtract", "multiply", "divide");
    Split[] expSplits =
        new Split[] {
  ...
  public void testAlternateMixedSplitsGandivaLast() throws Exception {
    ...
    final String xxx1 =
        "(if (less_than(_xxx0, 0i)) then (subtract(c1, c2)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx2 =
        "(case when (greater_than(_xxx0, -1i)) then (_xxx0) "
            + "when (less_than_or_equal_to(c0, _xxx1)) then (1i) else (2i) end)";
    final String xxx3 =
        "(case when (equal(_xxx2, 0i)) then ('null') when (equal(_xxx2, 1i)) then ('Done') "
            + "else ('Not Done') end)";
  ...
  public void testAlternateThenSplits() throws Exception {
    ...
    final String xxx1 =
        "(case when (equal(_xxx0, 0i)) then (subtract(c0, c1)) "
            ...
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end) ";
    final String xxx2 =
        "(case when (equal(_xxx0, 1i)) then (add(c1, multiply(c2, 10i))) "
            + "when (equal(_xxx0, 3i)) then (divide(add(c1, c4), 2i)) "
            + "else (_xxx1) end)";

    GandivaAnnotator annotator =
        new GandivaAnnotatorCase(
            "less_than_or_equal_to", "greater_than_or_equal_to", "add", "multiply", "divide");
    Split[] expSplits =
        new Split[] {
          new Split(true, "_xxx0", xxx0, 1, 2),
          new Split(false, "_xxx1", xxx1, 2, 1, "_xxx0"),
  ...
  public void testMixedThenSplits() throws Exception {
    final String xxx0 =
        "(case when (greater_than_or_equal_to(c0, c1)) then (0i) "
            ...
            + "else (4i) end)";
    final String xxx1 =
        "(if (equal(_xxx0, 1i)) then (multiply(c2, 10i)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx2 =
        "(if (equal(_xxx0, 3i)) then (add(c1, c4)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx3 =
        "(case when (equal(_xxx0, 3i)) then (divide(_xxx2, 2i)) "
            + "when (equal(_xxx0, 0i)) then (subtract(c0, c1)) "
            + "when (equal(_xxx0, 2i)) then (subtract(c3, c1)) "
            + "when (equal(_xxx0, 4i)) then (subtract(c4, c0)) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end) ";
    final String xxx4 =
        "(case when (equal(_xxx0, 1i)) then (add(c1, _xxx1)) " + "else (_xxx3) end)";

    GandivaAnnotator annotator =
        new GandivaAnnotatorCase("less_than_or_equal_to", "greater_than_or_equal_to", "add");
    Split[] expSplits =
        new Split[] {
  ...
  public void testNormalWhenAndThenSplits() throws Exception {
    ...
    final String xxx4 =
        "(case when (equal(_xxx3, 1i)) then (add(c1, multiply(c2, 10i))) "
            + "when (equal(_xxx3, 3i)) then (divide(add(c1, c4), 2i)) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx5 =
        "(case when (equal(_xxx3, 0i)) then (subtract(c0, c1)) "
  ...
  public void testMixedWhenAndThenSplits() throws Exception {
    final String xxx0 = "(case when (greater_than_or_equal_to(c0, c1)) then (0i) else (-1i) end)";
    final String xxx1 =
        "(if (less_than(_xxx0, 0i)) then (add(c1, 1i)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx2 =
        "(case when (greater_than(_xxx0, -1i)) then (_xxx0)  "
    ...
    final String xxx3 =
        "(case when (greater_than(_xxx2, -1i)) then (_xxx2) "
            + "when (greater_than_or_equal_to(c3, c1)) then (2i) else (-1i) end)";
    final String xxx4 =
        "(case when (greater_than(_xxx3, -1i)) then (_xxx3) "
            + "when (less_than_or_equal_to(c4, c1)) then (3i) else (4i) end)";
    final String xxx5 =
        "(if (equal(_xxx4, 3i)) then (add(c1, c4)) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx6 =
        "(case when (equal(_xxx4, 1i)) then (add(c1, multiply(c2, 10i))) "
            + "else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx7 =
        "(case when (equal(_xxx4, 3i)) then (divide(_xxx5, 2i)) "
    ...
    GandivaAnnotator annotator =
        new GandivaAnnotatorCase("less_than_or_equal_to", "subtract", "divide");
    Split[] expSplits =
        new Split[] {
          new Split(false, "_xxx0", xxx0, 1, 2),
          new Split(false, "_xxx1", xxx1, 2, 1, "_xxx0"),
  ...
  public void testMultiCaseMixedThenAsArgToFunction() throws Exception {
    final String xxx0 =
        "(case when (equal(c0, 10i)) then (0i) when (equal(c0, 20i)) then (1i) else (2i) end)";
    final String xxx1 =
        "(if (equal(_xxx0, 0i)) then (subtract(c1, 10i)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx2 =
        "(if (equal(_xxx0, 1i)) then (subtract(c2, 30i)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx3 =
        "(if (equal(_xxx0, 2i)) then (subtract(c3, 50i)) else (cast((__$INTERNAL_NULL$__) as INT)) end)";
    final String xxx4 =
        "(case when (equal(_xxx0, 0i)) then (add(_xxx1, 20i)) when (equal(_xxx0, 1i)) then (add(_xxx2, 50i)) "
    ...
    splitAndVerifyCase(
        multiCaseMixedThenAsArgToFunctionQuery,
        multiCaseMixedThenAsArgToFunctionQueryInput,
        multiCaseMixedThenAsArgToFunctionQueryOutput,
        expSplits,
        annotator);
  }
}
