...
public class TestStringFunctions extends BaseTestQuery {
  ...
  public void testLpadWithSingleChar() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 20, 'a') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithMultiChars() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 20, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithAddingPartOfFillValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 12, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithValueLengthMoreThenLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 2, 'char') l1 ")
        .baselineColumns("l1")
        .baselineValues("te")
        .go();
  }
  ...
  public void testLpadForEmptyString() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('', 12, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadForEmptyPadString() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 12, '') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithNegativeLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', -1, 'char') l1 ")
        .baselineColumns("l1")
        .baselineValues("")
        .go();
  }
  ...
  public void testLpadWithIntValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad(111, 20, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithIntPadValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 20, 1) l1 ")
        .baselineColumns("l1")
  ...
  public void testLpadWithoutPadValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "lpad('testString', 20) l1 ")
        .baselineColumns("l1")
        .baselineValues("          testString")
        .go();
  }
  ...
  public void testRpadWithSingleChar() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 20, 'a') l1 ")
        .baselineColumns("l1")
  ...
  public void testRpadWithMultiChars() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 20, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testRpadWithAddingPartOfFillValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 12, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testRpadWithValueLengthMoreThenLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 2, 'char') l1 ")
        .baselineColumns("l1")
        .baselineValues("te")
        .go();
  }
  ...
  public void testRpadForEmptyString() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('', 12, 'char') l1 ")
        .baselineColumns("l1")
        .baselineValues("charcharchar")
        .go();
  }
  ...
  public void testRpadForEmptyPadString() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 12, '') l1 ")
        .baselineColumns("l1")
        .baselineValues("testString")
        .go();
  }
  ...
  public void testRpadWithNegativeLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', -1, 'char') l1 ")
        .baselineColumns("l1")
        .baselineValues("")
        .go();
  }
  ...
  public void testRpadWithIntValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad(111, 20, 'char') l1 ")
        .baselineColumns("l1")
  ...
  public void testRpadWithIntPadValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "Rpad('testString', 20, 1) l1 ")
        .baselineColumns("l1")
  ...
  public void testRpadWithoutPadValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "rpad('testString', 20) l1 ")
        .baselineColumns("l1")
        .baselineValues("testString          ")
        .go();
  }
  ...
  public void testCharSubstringFromStart() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', 1,2) l1 ")
        .baselineColumns("l1")
        .baselineValues("ch")
        .go();
  }
  ...
  public void testCharSubstringFromMiddle() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', 4,3) l1 ")
        .baselineColumns("l1")
        .baselineValues("ckC")
        .go();
  }
  ...
  public void testCharSubstringInTheEnd() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', 16,3) l1 ")
        .baselineColumns("l1")
        .baselineValues("ing")
        .go();
  }
  ...
  public void testCharSubstringOffsetOutOfLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', 20,3) l1 ")
        .baselineColumns("l1")
        .baselineValues("")
        .go();
  }
  ...
  public void testCharSubstringLengthOutOfValueLength() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', 4,20) l1 ")
        .baselineColumns("l1")
  ...
  public void testCharSubstringWithOutLength() throws Exception {
    errorMsgTestHelper(
        "SELECT charsubstring('checkCharSubstring', 4)",
  ...
  public void testCharSubstringForEmptyValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('', 2,2) l1 ")
        .baselineColumns("l1")
        .baselineValues("")
        .go();
  }
  ...
  public void testCharSubstringWithNegativeOffset() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring('checkCharSubstring', -5,2) l1 ")
        .baselineColumns("l1")
        .baselineValues("tr")
        .go();
  }
  ...
  public void testCharSubstringWithIntegerValue() throws Exception {
    testBuilder()
        .unOrdered()
        .sqlQuery("SELECT " + "charsubstring(123456, 5,2) l1 ")
        .baselineColumns("l1")
        .baselineValues("56")
        .go();
  }
  ...
  public void testCharSubstringIncompatibleTypeForOffset() throws Exception {
    errorMsgTestHelper(
        "SELECT charsubstring('checkCharSubstring', 'bla', 2)",
  ...
  public void testCharSubstringIncompatibleTypeForLength() throws Exception {
    errorMsgTestHelper(
        "SELECT charsubstring('checkCharSubstring', 2, 'bla')",
        "Failure while attempting to cast value 'bla' to Bigint.");
  }
}
