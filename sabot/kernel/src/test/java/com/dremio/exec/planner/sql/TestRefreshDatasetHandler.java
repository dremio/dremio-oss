...
public class TestRefreshDatasetHandler extends PlanTestBase {
  ...
  public void testQuery() throws Exception {
    ...
    final QueryContext queryContext =
        spy(new QueryContext(session, context, UserBitShared.QueryId.getDefaultInstance()));
    ...
    when(catalogService.getManagedSource(eq("dfs")))
        .thenReturn(context.getCatalogService().getManagedSource("dfs"));
    ...
    assertTrue(
        "SqlNode is not an instance of SqlRefreshDataset", node instanceof SqlRefreshDataset);
