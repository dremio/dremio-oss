...
public class TestMasterLessCatalogServiceImpl {
  ...
  public static class MockUpConfig extends ConnectionConf<TestCatalogServiceImpl.MockUpConfig, TestCatalogServiceImpl.MockUpPlugin> {
    ...
    @Override
    public TestCatalogServiceImpl.MockUpPlugin newPlugin(SabotContext context, String name,
  ...
  public void setup() throws Exception {
    ...
    when(sabotContext.getClusterCoordinator())
      .thenReturn(localClusterCoordinator);
    when(sabotContext.getExecutors())
      .thenReturn(localClusterCoordinator.getServiceSet(ClusterCoordinator.Role.EXECUTOR)
        .getAvailableEndpoints());
    when(sabotContext.getCoordinators())
      .thenReturn(localClusterCoordinator.getServiceSet(ClusterCoordinator.Role.COORDINATOR)
        .getAvailableEndpoints());
    ...
    catalogService = new CatalogServiceImpl(
      ...
      () -> new ModifiableWrappedSchedulerService(2, true, "modifiable-scheduler-", () -> localClusterCoordinator, () -> localClusterCoordinator, () -> nodeEndpoint2,
        ExecConstants.MAX_CONCURRENT_METADATA_REFRESHES, () -> optionManager, () -> null, false),
  ...
  public void shutdown() throws Exception {
    AutoCloseables.close(catalogService /* closes mockUpPlugin as well */, fabricService, pool,
