...
public class TestDecimal extends PopUnitTestBase {
  ...
  public void testCastFromFloat() throws Exception {
    ...
    try (ClusterCoordinator clusterCoordinator = LocalClusterCoordinator.newRunningCoordinator();
      ...
      String[] decimal9Output = {"99.0000", "11.1235", "0.1000", "-0.1200", "-123.1234", "-1.0001"};
      String[] decimal38Output = {
        "123456789.0000", "11.1235", "0.1000", "-0.1004", "-987654321.1235", "-2.0301"
      };
  ...
  public void testSimpleDecimalArithmetic() throws Exception {
    ...
    try (ClusterCoordinator clusterCoordinator = LocalClusterCoordinator.newRunningCoordinator();
      ...
      String[] multiplyOutput = {
        "12222222111.00", "123.21", "0.01", "0.01", "121580246927.41", "2.00"
      };
  ...
  public void testComplexDecimal() throws Exception {
    ...
    try (ClusterCoordinator clusterCoordinator = LocalClusterCoordinator.newRunningCoordinator();
      ...
      String[] addOutput = {
        "-99999998877.700000000",
        "11.423456789",
        "123456789.100000000",
        "-0.119998000",
        "100000000112.423456789",
        "-99999999879.907000000",
        "123456789123456801.300000000"
      };
      String[] subtractOutput = {
        "-100000001124.300000000",
        "10.823456789",
        "-123456788.900000000",
        "-0.120002000",
        "99999999889.823456789",
        "-100000000122.093000000",
