...
public class TestExtractFunction2 extends BaseTestQuery {
  ...
  public void extractOnDate() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .baselineColumns(
            "second", "minute", "hour", "day", "dow", "doy", "week", "month", "year", "epoch", "q1",
            "q2", "q3", "decade1", "decade2", "decade3", "c1", "c2", "c3", "c4", "c5", "m1", "m2",
            "m3", "m4", "m5")
        .baselineValues(
            0L, // seconds
            0L, // minute
  ...
  public void extractOnIntervalYear() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .baselineColumns(
            "month", "year", "q1", "q2", "q3", "decade1", "decade2", "decade3", "c1", "c2", "c3",
            "c4", "c5", "m1", "m2", "m3", "m4", "m5")
        .baselineValues(
            7L, // month
            217L, // year
            3L, // quarter-1
  ...
  public void datePartMillennium() throws Exception {
    final String query =
        "SELECT DATE_PART('MILLENNIUM', date '2018-04-22') AS col1 FROM (VALUES(1))";

    testBuilder().sqlQuery(query).unOrdered().baselineColumns("col1").baselineValues(3L).go();
  }
}
