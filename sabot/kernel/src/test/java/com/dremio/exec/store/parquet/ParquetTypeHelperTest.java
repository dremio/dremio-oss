...
public class ParquetTypeHelperTest extends BaseTestQuery {
  ...
  public void testUnWrapVeryComplexSchema() throws Exception {
    ...
    // col1[][][].f1[][][], col1[][][].f2.sub_f1[][][], col1[][][].f2.sub_f2[][][].sub_sub_f1,
    // col1[][][].f2.sub_f2[][][].sub_sub_f2, col2
    ...
    Map<String, ColumnChunkMetaData> unwrapSchema =
        ParquetTypeHelper.unWrapParquetSchema(
            block, parquetMetadata.getFileMetaData().getSchema(), null);
  ...
  public void testUnWrapNestedMapSchema() throws Exception {
    ...
    // Total there are 5 leaf level fields:
    // col1.key, col1.value[].key, col1.value[].value.f1.key, col1.value[].value.f1.value.key,
    // col1.value[].value.f1.value.value[]
    Set<String> expectedKeys =
        new HashSet<>(
            Arrays.asList(
  ...
  public void testUnWrapScalarTypes() throws Exception {
    // file has following schema
    // boolean bool_col, int32 int_col, int64 bigint_col, float float4_col, double float8_col, int32
    // date_col, int64 timestamp_col,
  ...
  public void testUnwrapSimplePath() throws Exception {
    ...
    SortedMap<String, ColumnChunkMetaData> chunks =
        ParquetTypeHelper.unWrapParquetSchema(
  ...
  public void testUnwrapComplexPartialPath() throws Exception {
    ...
    SchemaPath compoundPath =
        SchemaPath.getCompoundPath("col1", "list", "element", "list", "element", "list", "element");
    ...
    compoundPath =
        SchemaPath.getCompoundPath(
            "col1", "list", "element", "list", "element", "list", "element", "f1");
    ...
    compoundPath =
        SchemaPath.getCompoundPath(
            "col1", "list", "element", "list", "element", "list", "element", "f2");
    ...
    compoundPath =
        SchemaPath.getCompoundPath(
            "col1", "list", "element", "list", "element", "list", "element", "f2", "sub_f2");
    ...
    compoundPath =
        SchemaPath.getCompoundPath(
            "col1", "list", "element", "list", "element", "list", "element", "f2", "sub_f1");
    projectedColumns.add(compoundPath.toDotString());
