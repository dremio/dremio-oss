...
public class TestIncrementalReflectionByPartitionUtils  {
  ...
  public void setup() throws Exception {
    ...
    final FunctionImplementationRegistry functionImplementationRegistry = FunctionImplementationRegistry.create(
  ...
  public void testBuildReflectionPartitionColumn2TransformInfoMapEmpty() {
    final PartitionSpec partitionSpec = PartitionSpec
      .builderFor(icebergSchema)
      .build();
    final Map<String, IncrementalReflectionByPartitionUtils.TransformInfo> reflectionPartitionColumn2TransformInfo
  ...
  public void testBuildReflectionPartitionColumn2TransformInfoMap(){
    ...
    final IncrementalReflectionByPartitionUtils.TransformInfo idTransformInfo = reflectionPartitionColumn2TransformInfo.get("id");
    assertEquals(PartitionProtobuf.IcebergTransformType.IDENTITY, idTransformInfo.getTransformType());
    assertNull(idTransformInfo.getBaseColumnName());
    assertNull(idTransformInfo.getArgument());

    final IncrementalReflectionByPartitionUtils.TransformInfo intPartTransformInfo = reflectionPartitionColumn2TransformInfo.get("int_part");
    assertEquals(PartitionProtobuf.IcebergTransformType.TRUNCATE, intPartTransformInfo.getTransformType());
    assertNull(intPartTransformInfo.getBaseColumnName());
    assertEquals((Integer)10, intPartTransformInfo.getArgument());

    final IncrementalReflectionByPartitionUtils.TransformInfo timestampPartTransformInfo = reflectionPartitionColumn2TransformInfo.get("timestamp_part");
    assertEquals(PartitionProtobuf.IcebergTransformType.HOUR, timestampPartTransformInfo.getTransformType());
    assertNull(timestampPartTransformInfo.getBaseColumnName());
    assertNull(timestampPartTransformInfo.getArgument());

    final IncrementalReflectionByPartitionUtils.TransformInfo datePartTransformInfo = reflectionPartitionColumn2TransformInfo.get("date_part");
    assertEquals(PartitionProtobuf.IcebergTransformType.MONTH, datePartTransformInfo.getTransformType());
  ...
  public void testEliminateInvalidPartitionCandidatesSameSpec(){
    final PartitionSpec partitionSpecReflection = PartitionSpec
      .builderFor(icebergSchema)
      .identity("id")
      .truncate("int_part", 10)
      .hour("timestamp_part")
    ...
    final PartitionSpec partitionSpecBase = PartitionSpec
      .builderFor(icebergSchema)
      .identity("id")
      .truncate("int_part", 10)
      .hour("timestamp_part")
  ...
  public void testTruncateHelper(final String column_name, final int reflectionWidth, final int baseWidth, final int expectedSize){
    final PartitionSpec partitionSpecReflection = PartitionSpec
      .builderFor(icebergSchema)
      .truncate(column_name, reflectionWidth)
      .build();
    ...
    final PartitionSpec partitionSpecBase = PartitionSpec
      .builderFor(icebergSchema)
      .truncate(column_name, baseWidth)
      .build();

    final Map<String, IncrementalReflectionByPartitionUtils.TransformInfo> result =
      eliminateInvalidPartitionCandidates(reflectionPartitionColumn2TransformInfo, partitionSpecBase);
  ...
  public void testPartitionCandidatesDateDayAndMonth(){
    final PartitionSpec partitionSpecLow = PartitionSpec
      .builderFor(icebergSchema)
      .day("date_part")
      .build();

    final PartitionSpec partitionSpecHigh = PartitionSpec
      .builderFor(icebergSchema)
      .month("date_part")
      .build();
  ...
  public void testPartitionCandidatesHelper(final PartitionSpec partitionSpecReflection, final PartitionSpec partitionSpecBase, final int expectedSize){
  ...
  public void testEliminateSimilarPartitionCandidatesEmpty()
  {
    ...
    final Map<String, IncrementalReflectionByPartitionUtils.TransformInfo> result = eliminateSimilarPartitionCandidates(input);
  ...
  public void testGenerateResolvedReflectionTransformInfoIdentity(){
    ...
    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.IDENTITY,
      null, PartitionProtobuf.IcebergTransformType.IDENTITY,
      null, createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE)));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.DAY,
      null, PartitionProtobuf.IcebergTransformType.DAY,
      null, createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE)));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.MONTH,
      null, PartitionProtobuf.IcebergTransformType.MONTH,
      null, createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE)));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.YEAR,
      null, PartitionProtobuf.IcebergTransformType.YEAR,
      null, createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE)));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.TRUNCATE,
      null, PartitionProtobuf.IcebergTransformType.TRUNCATE,
      null, createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE)));
  }
  ...
  public void testGenerateResolvedReflectionTransformInfoToDate(){
    ...
    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.IDENTITY,
      null, PartitionProtobuf.IcebergTransformType.DAY,
      null, createToDateFunc(baseColumnName));
  ...
  public void testGenerateResolvedReflectionTransformInfoTruncateLeft(){
    ...
    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.IDENTITY,
      null, PartitionProtobuf.IcebergTransformType.TRUNCATE,
      5, createLeftFunc(baseColumnName, 5));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.TRUNCATE,
      3, PartitionProtobuf.IcebergTransformType.TRUNCATE,
      3, createLeftFunc(baseColumnName, 5));

    //this fails because top is greater length than bottom
    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.TRUNCATE,
      7, null,
      null, createLeftFunc(baseColumnName, 5));
    ...
    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.TRUNCATE,
      3, null,
      3, createLeftFunc(baseColumnName, 0));
  ...
  public void testGenerateResolvedReflectionTransformInfoTruncateSubstr(){
    ...
    for(final String funcName : funcNames) {
      ...
      testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
        PartitionProtobuf.IcebergTransformType.IDENTITY,
        null, PartitionProtobuf.IcebergTransformType.TRUNCATE,
        5, createSubstrFunc(baseColumnName, 5, 0, funcName));

      //the bottom is SUBSTR(COL, 0, 5) , top is TRUNCATE(3)
      testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
        PartitionProtobuf.IcebergTransformType.TRUNCATE,
        3, PartitionProtobuf.IcebergTransformType.TRUNCATE,
        3, createSubstrFunc(baseColumnName, 5, 0, funcName));

      //this fails because top is greater length than bottom
      testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
        PartitionProtobuf.IcebergTransformType.TRUNCATE,
        7, null,
        null, createSubstrFunc(baseColumnName, 5, 0, funcName));

      //this will not work, as beginning offset is non-zero
      testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
        PartitionProtobuf.IcebergTransformType.TRUNCATE,
        3, null,
        null, createSubstrFunc(baseColumnName, 5, 1, funcName));
      ...
      testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
        PartitionProtobuf.IcebergTransformType.TRUNCATE,
        3, null,
        null, createSubstrFunc(baseColumnName, 0, 0, funcName));
    }
  }
...
@Test
  ...
  testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
    PartitionProtobuf.IcebergTransformType.IDENTITY,
    null, PartitionProtobuf.IcebergTransformType.HOUR,
    null, createDateTrunc(baseColumnName, "HOUR"));

    testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
      PartitionProtobuf.IcebergTransformType.IDENTITY,
      null, PartitionProtobuf.IcebergTransformType.DAY,
      null, createDateTrunc(baseColumnName, "DAY"));

  testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
    PartitionProtobuf.IcebergTransformType.IDENTITY,
    null, PartitionProtobuf.IcebergTransformType.MONTH,
    null, createDateTrunc(baseColumnName, "MONTH"));

  testGenerateResolvedReflectionTransformInfoHelper(baseColumnName,
    PartitionProtobuf.IcebergTransformType.IDENTITY,
    null, PartitionProtobuf.IcebergTransformType.YEAR,
    null, createDateTrunc(baseColumnName, "YEAR"));
  ...
  public void testGenerateResolvedReflectionTransformInfoHelper(final String baseColumnName,
    ...
    final IncrementalReflectionByPartitionUtils.TransformInfo result =
      generateResolvedReflectionTransformInfo(identityTransformInfo, rexNode);
  ...
  public RexCall createDateTrunc(final String baseColumnName, final String granularity){
    ...
    final SqlOperator sqlOperator = operatorTable.getOperatorList().stream().filter(f->f.getName().equalsIgnoreCase("DATE_TRUNC")).collect(Collectors.toList()).get(0);
    return (RexCall) rexBuilder.makeCall(sqlOperator,
      ImmutableList.of(createRexLiteral(granularity), createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.DATE))));
  }
  public RexCall createLeftFunc(final String baseColumnName, final int length){
    final RexBuilder rexBuilder =  new RexBuilder(typeFactory);
    final SqlOperator sqlOperator = operatorTable.getOperatorList().stream().filter(f->f.getName().equalsIgnoreCase("LEFT")).collect(Collectors.toList()).get(0);
    return (RexCall) rexBuilder.makeCall(sqlOperator,
      ImmutableList.of(createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.VARCHAR)), createRexLiteral(length)));
  }

  public RexCall createSubstrFunc(final String baseColumnName, final int length, final int begin_offset, final String functionName){
    final RexBuilder rexBuilder =  new RexBuilder(typeFactory);
    final List<SqlOperator> sqlOperators = operatorTable.getOperatorList().stream().filter(f->f.getName().equalsIgnoreCase(functionName)).collect(Collectors.toList());
    for(final SqlOperator sqlOperator: sqlOperators) {
      try {
        return (RexCall) rexBuilder.makeCall(sqlOperator,
          ImmutableList.of(createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.VARCHAR)), createRexLiteral(begin_offset), createRexLiteral(length)));
  ...
  public RexLiteral createRexLiteral(final Integer contents){
    final RexBuilder rexBuilder =  new RexBuilder(typeFactory);
    return (RexLiteral) rexBuilder.makeLiteral(contents, typeFactory.createSqlType(SqlTypeName.INTEGER), true);
  }
  public RexTableInputRef createRexTableInputRef(final String baseColumnName, final RelDataType dataType){
    final RelDataTypeField relDataTypeField = new RelDataTypeFieldImpl(
      baseColumnName, 0, dataType);
    final RelOptTable relOptTable = mock(RelOptTable.class);
    final RelDataType relDataType = mock(RelDataType.class);
    when(relOptTable.getRowType()).thenReturn(relDataType);
    when(relDataType.getFieldList()).thenReturn(ImmutableList.of(relDataTypeField));
    final RelTableRef tableRef = RelTableRef.of(relOptTable, 0);
    return RexTableInputRef.of(tableRef, 0, dataType);
  }

  public RexCall createToDateFunc(final String baseColumnName){
    final RexBuilder rexBuilder =  new RexBuilder(typeFactory);
    final List<SqlOperator> sqlOperators = operatorTable.getOperatorList().stream().filter(f->f.getName().equalsIgnoreCase("TO_DATE")).collect(Collectors.toList());
    for(final SqlOperator sqlOperator: sqlOperators) {
      try {
        return (RexCall) rexBuilder.makeCall(sqlOperator,
          ImmutableList.of(createRexTableInputRef(baseColumnName, typeFactory.createSqlType(SqlTypeName.VARCHAR))));
      } catch (final UserException e){
        //ignore the exception and move to the next operator
        //substr has many signatures, we want to find the one that matches the passed in signature
      }
