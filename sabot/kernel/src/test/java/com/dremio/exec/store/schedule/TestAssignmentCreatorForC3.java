...
public class TestAssignmentCreatorForC3 extends ExecTest {
  ...
  private static final CoordinationProtos.NodeEndpoint ENDPOINT1_1 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.1", 1234);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT1_2 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.1", 4567);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT2_1 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.2", 1234);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT2_2 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.2", 4567);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT3_1 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.3", 1234);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT3_2 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.3", 4567);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT4_1 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.4", 1234);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT4_2 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.4", 4567);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT5_1 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.5", 1234);
  private static final CoordinationProtos.NodeEndpoint ENDPOINT5_2 =
      TestHardAssignmentCreator.newNodeEndpoint("10.0.0.5", 4567);
  ...
  // EP4: S4, S9, S14
  // EP5: S5, S10, S15
  private static final TestHardAssignmentCreator.TestWork S1 =
      newWork(
          "S1",
          10000,
          newAffinity(ENDPOINT1_1, 9000),
          newAffinity(ENDPOINT2_1, 8000),
          newAffinity(ENDPOINT3_1, 4000));
  private static final TestHardAssignmentCreator.TestWork S2 =
      newWork(
          "S2",
          9992,
          newAffinity(ENDPOINT2_1, 9500),
          newAffinity(ENDPOINT3_1, 8000),
          newAffinity(ENDPOINT4_1, 6200));
  private static final TestHardAssignmentCreator.TestWork S3 =
      newWork(
          "S3",
          9990,
          newAffinity(ENDPOINT3_1, 8000),
          newAffinity(ENDPOINT4_1, 7500),
          newAffinity(ENDPOINT5_1, 5000));
  private static final TestHardAssignmentCreator.TestWork S4 =
      newWork(
          "S4",
          9980,
          newAffinity(ENDPOINT4_1, 8500),
          newAffinity(ENDPOINT5_1, 8200),
          newAffinity(ENDPOINT1_1, 3000));
  private static final TestHardAssignmentCreator.TestWork S5 =
      newWork(
          "S5",
          9800,
          newAffinity(ENDPOINT5_1, 9000),
          newAffinity(ENDPOINT1_1, 8000),
          newAffinity(ENDPOINT2_1, 4500));
  private static final TestHardAssignmentCreator.TestWork S6 =
      newWork(
          "S6",
          9778,
          newAffinity(ENDPOINT1_1, 8500),
          newAffinity(ENDPOINT3_1, 7000),
          newAffinity(ENDPOINT5_1, 5000));
  private static final TestHardAssignmentCreator.TestWork S7 =
      newWork(
          "S7",
          9776,
          newAffinity(ENDPOINT2_1, 8600),
          newAffinity(ENDPOINT4_1, 8000),
          newAffinity(ENDPOINT1_1, 4000));
  private static final TestHardAssignmentCreator.TestWork S8 =
      newWork(
          "S8",
          9774,
          newAffinity(ENDPOINT3_1, 8700),
          newAffinity(ENDPOINT5_1, 7000),
          newAffinity(ENDPOINT2_1, 4500));
  private static final TestHardAssignmentCreator.TestWork S9 =
      newWork(
          "S9",
          9770,
          newAffinity(ENDPOINT4_1, 8400),
          newAffinity(ENDPOINT1_1, 6000),
          newAffinity(ENDPOINT3_1, 4000));
  private static final TestHardAssignmentCreator.TestWork S10 =
      newWork(
          "S10",
          9700,
          newAffinity(ENDPOINT5_1, 9000),
          newAffinity(ENDPOINT2_1, 6200),
          newAffinity(ENDPOINT4_1, 5000));
  private static final TestHardAssignmentCreator.TestWork S11 =
      newWork(
          "S11",
          9680,
          newAffinity(ENDPOINT1_2, 8800),
          newAffinity(ENDPOINT4_2, 6000),
          newAffinity(ENDPOINT2_2, 3000));
  private static final TestHardAssignmentCreator.TestWork S12 =
      newWork(
          "S12",
          9600,
          newAffinity(ENDPOINT2_2, 8000),
          newAffinity(ENDPOINT5_2, 7500),
          newAffinity(ENDPOINT3_2, 5000));
  private static final TestHardAssignmentCreator.TestWork S13 =
      newWork(
          "S13",
          9500,
          newAffinity(ENDPOINT3_2, 9500),
          newAffinity(ENDPOINT1_2, 5000),
          newAffinity(ENDPOINT4_2, 2800));
  private static final TestHardAssignmentCreator.TestWork S14 =
      newWork(
          "S14",
          9450,
          newAffinity(ENDPOINT4_2, 8000),
          newAffinity(ENDPOINT2_2, 5900),
          newAffinity(ENDPOINT5_2, 3300));
  private static final TestHardAssignmentCreator.TestWork S15 =
      newWork(
          "S15",
          9400,
          newAffinity(ENDPOINT5_2, 9000),
          newAffinity(ENDPOINT3_2, 5000),
          newAffinity(ENDPOINT1_2, 4800));
  private static final TestHardAssignmentCreator.TestWork S16 =
      newWork(
          "S16",
          9390,
          newAffinity(ENDPOINT1_2, 9200),
          newAffinity(ENDPOINT5_2, 7200),
          newAffinity(ENDPOINT4_2, 3600));
  private static final TestHardAssignmentCreator.TestWork S17 =
      newWork(
          "S17",
          9380,
          newAffinity(ENDPOINT2_2, 9000),
          newAffinity(ENDPOINT1_2, 6800),
          newAffinity(ENDPOINT5_2, 4000));
  private static final TestHardAssignmentCreator.TestWork S18 =
      newWork(
          "S18",
          9376,
          newAffinity(ENDPOINT3_2, 8800),
          newAffinity(ENDPOINT2_2, 6200),
          newAffinity(ENDPOINT1_2, 3800));
  private static final TestHardAssignmentCreator.TestWork S19 =
      newWork(
          "S19",
          9372,
          newAffinity(ENDPOINT4_2, 8600),
          newAffinity(ENDPOINT3_2, 5800),
          newAffinity(ENDPOINT2_2, 2400));
  private static final TestHardAssignmentCreator.TestWork S20 =
      newWork(
          "S20",
          9370,
          newAffinity(ENDPOINT5_2, 8770),
          newAffinity(ENDPOINT4_2, 7000),
          newAffinity(ENDPOINT3_2, 3000));

  // splits with no affinity. These can get assigned randomly
  private static final TestSplitInfo S110 =
      newSplitWork(
          "S110",
          10000,
          new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1},
          ":/qa1.dremio.com/tpcds_1000/household_demographics/000000_0%10%04%18��%03%20%00*G%0A:/qa1.dremio.com/tpcds_1000/household_demographics/000000_0%10�����.%18��%032%11%0A%0Chd_dep_count%10�82%15%0A%10hd_vehicle_count%10�82%0F%0A%0Ahd_demo_sk%10�82%16%0A%11hd_income_band_sk%10�8");
  private static final TestSplitInfo S111 =
      newSplitWork("S111", 9992, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path2");
  private static final TestSplitInfo S112 =
      newSplitWork("S112", 9990, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path3");
  private static final TestSplitInfo S113 =
      newSplitWork("S113", 9980, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path4");
  private static final TestSplitInfo S114 =
      newSplitWork("S114", 9800, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path5");
  private static final TestSplitInfo S115 =
      newSplitWork("S115", 9778, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path6");
  private static final TestSplitInfo S116 =
      newSplitWork("S116", 9776, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path7");
  private static final TestSplitInfo S117 =
      newSplitWork("S117", 9774, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path8");
  private static final TestSplitInfo S118 =
      newSplitWork("S118", 9770, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path9");
  private static final TestSplitInfo S119 =
      newSplitWork("S119", 9700, new CoordinationProtos.NodeEndpoint[] {ENDPOINT1_1}, "path10");

  // splits with only one affinity. These can get assigned randomly
  private static final TestHardAssignmentCreator.TestWork S101 =
      newWork("S101", 10000, newAffinity(ENDPOINT1_1, 10000));
  private static final TestHardAssignmentCreator.TestWork S102 =
      newWork("S102", 9900, newAffinity(ENDPOINT1_1, 9000));
  ...
  public static class TestSplitInfo {
    ...
    public TestSplitInfo(
        String id, long sizeInBytes, CoordinationProtos.NodeEndpoint[] nodeEndpoints, String path) {
      this.id = id;
  ...
  private static EndpointAffinity newAffinity(
      CoordinationProtos.NodeEndpoint endpoint, double affinity) {
    return new EndpointAffinity(endpoint, affinity);
  }

  private static EndpointAffinity newInstanceAffinity(
      CoordinationProtos.NodeEndpoint endpoint, double affinity) {
  ...
  private static TestHardAssignmentCreator.TestWork cloneInstanceWork(
      TestHardAssignmentCreator.TestWork work) {
  ...
  private static TestSplitInfo newSplitWork(
      String id, long sizeInBytes, CoordinationProtos.NodeEndpoint[] nodeEndpoints, String path) {
    return new TestSplitInfo(id, sizeInBytes, nodeEndpoints, path);
  }

  private static TestHardAssignmentCreator.TestWork newWork(
      String id, long sizeInBytes, EndpointAffinity... affinityList) {
  ...
  void verifyMappings(
      ...
      Multimap<Integer, TestHardAssignmentCreator.TestWork> mappings,
      Map<String, String> expectedMappings) {
    boolean isInstanceAffinity =
        mappings.values().iterator().next().getAffinity().get(0).isInstanceAffinity();
      ...
      for (TestHardAssignmentCreator.TestWork split : mappings.get(id)) {
        ...
        Assert.assertTrue(
            "Split "
                ...
                + " was assigned to "
                + hostname,
            expValue.equalsIgnoreCase(hostname));
      }
    }
  }

  void verifyMappingsWithNoAffinity(
      List<CoordinationProtos.NodeEndpoint> endpoints,
      Multimap<Integer, SplitWorkWithRuntimeAffinity> mappings,
      Map<String, String> expectedMappings) {
  ...
  void assignAndVerifySplits(
      List<CoordinationProtos.NodeEndpoint> endpoints,
      List<TestHardAssignmentCreator.TestWork> splits,
      Map<String, String> expectedMappings)
      throws Exception {
    verifyMappings(
        endpoints, AssignmentCreator2.getMappings(endpoints, splits, 1.5), expectedMappings);
  }

  void assignAndVerifySplitsWithoutAffinity(
      List<CoordinationProtos.NodeEndpoint> endpoints,
      List<SplitWorkWithRuntimeAffinity> splits,
      Map<String, String> expectedMappings)
      throws Exception {
    try {
  ...
  Map<String, String> assignSplitToHighestAffinity(
      List<TestHardAssignmentCreator.TestWork> splits) {
    ...
    for (TestHardAssignmentCreator.TestWork split : splits) {
      ...
      for (EndpointAffinity endpointAffinity : split.getAffinity()) {
        if (endpointAffinity.getAffinity() >= affinity) {
          hostname =
              getHostname(endpointAffinity.getEndpoint(), endpointAffinity.isInstanceAffinity());
  ...
  Map<String, String> assignSplitWithRendezvousHashing(
      List<SplitWorkWithRuntimeAffinity> splits, List<TestSplitInfo> testSplitInfoList) {
    Map<String, String> results = Maps.newHashMap();
    ...
    for (SplitWorkWithRuntimeAffinity split : splits) {
      RendezvousPageHasher hasher =
          new RendezvousPageHasher(
              workToNodeMap.get(split.getDatasetSplit().getSplitExtendedProperty().toStringUtf8()));
  ...
  public void testAllSplits() throws Exception {
    List<TestHardAssignmentCreator.TestWork> splits =
        asList(
            ...
            S20);
    assignAndVerifySplits(ENDPOINTS, splits, assignSplitToHighestAffinity(splits));
  }
  ...
  public void testAllSplitsNoAffinity() throws Exception {
    ...
    List<TestSplitInfo> testSplitInfoList =
        asList(S110, S111, S112, S113, S114, S115, S116, S117, S118, S119);
    for (TestSplitInfo testSplitInfo : testSplitInfoList) {
      final PartitionProtobuf.PartitionChunk partitionChunk =
          PartitionProtobuf.PartitionChunk.newBuilder().build();
      final PartitionProtobuf.DatasetSplit.Builder dataSplit =
    ...
    assignAndVerifySplitsWithoutAffinity(
        ENDPOINTS, splits, assignSplitWithRendezvousHashing(splits, testSplitInfoList));
  }
  ...
  public void testNoSplitsToEndpoint5() throws Exception {
    List<TestHardAssignmentCreator.TestWork> splits =
        asList(S1, S2, S3, S4, S6, S7, S8, S9, S11, S12, S13, S14, S16, S17, S18, S19);
    assignAndVerifySplits(ENDPOINTS, splits, assignSplitToHighestAffinity(splits));
  }
  ...
  public void testSplitsWithAffinityToEndpoint1() throws Exception {
    ...
    assignAndVerifySplits(ENDPOINTS, splits, expectedAssignments);
  }

  @Test
  public void testSplitsWithInstanceAffinityToEndpoint1() throws Exception {
    List<TestHardAssignmentCreator.TestWork> splits =
        asList(Instance_S1, Instance_S6, Instance_S11, Instance_S16);
    Map<String, String> expectedAssignments = Maps.newHashMap();
  ...
  public void testFilterOutOneSplit() throws Exception {
    List<TestHardAssignmentCreator.TestWork> masterList =
        asList(
            S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19,
            S20);
    int i = 0;
  ...
  public void testUnAssignedSplits() throws Exception {
    ...
    // there is no affinity in the assignments. Should get assigned after 3 passes via the
    // unassigned list
    AssignmentCreator2.LEFTOVER_ASSIGNMENTS.set(0);
    AssignmentCreator2.getMappings(
        asList(ENDPOINT2_1, ENDPOINT3_1, ENDPOINT4_1, ENDPOINT5_1), splits, 1.5);
    Assert.assertTrue(
        "assignLeftOvers should have been invoked",
        AssignmentCreator2.LEFTOVER_ASSIGNMENTS.get() == 1);
  }
  ...
  public void timedTestAssignments() throws Exception {
    int[] splitsArr = new int[] {20000, 50000};

    for (int i = 0; i < splitsArr.length; i++) {
      long timeTaken = testManyAssignments(5, splitsArr[i], 20, 8);
      System.out.println(
          "Avg time taken for assigning " + splitsArr[i] + " splits is " + timeTaken + "ms");
    }
  }
}
