...
public class UpdateTests {
  ...
  public static void testUpdateOnView(BufferAllocator allocator, String source) throws Exception {
    ...
    try (AutoCloseable ignored = createView(source, name)) {
      assertThatThrownBy(
              () ->
                  testDmlQuery(
                      allocator, "UPDATE %s.%s SET id = 0", new Object[] {source, name}, null, -1))
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.columns[1], table.originalData[0][1]},
            table,
            10,
            Collections.nCopies(table.originalData.length, table.originalData[0])
                .toArray(new Object[table.originalData.length][]));
      }
    }
  }
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            allocator,
            "UPDATE %s SET id = %s WHERE id = %s",
            new Object[] {table.fqn, (int) table.originalData[5][0] * 10, null},
            table,
            0,
  ...
  public static void testUpdateWithInClauseFilter(
    ...
    try (Table table = createBasicTable(source, 1, 10)) {
      ...
      testDmlQuery(
          ...
          5,
          ArrayUtils.addAll(
              ArrayUtils.subarray(table.originalData, 0, 5), newId, newId, newId, newId, newId));
    }
  }
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.originalData[4][1], table.originalData[4][1]},
            table,
            1,
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 4),
                new Object[] {
                  table.originalData[4][0], table.originalData[4][1], table.originalData[4][1]
                },
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, newValue, table.originalData[9][0], table.originalData[4][1]},
            table,
            2,
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 4),
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, newColumn0, newColumn1, table.originalData[5][0]},
            table,
            1,
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 5),
  ...
  public static void testUpdateByIdWithDecimals(
    ...
    try (Table table = createBasicTableWithDecimals(source, 3, 10)) {
      ...
      testDmlQuery(
          ...
          new Object[] {table.fqn, table.originalData[5][0]},
          table,
          1,
          ArrayUtils.addAll(
              ArrayUtils.subarray(table.originalData, 0, 5),
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            ""
                ...
                + "WHERE id = %s",
            new Object[] {table.fqn, table.fqn, table.originalData[5][0], table.originalData[5][0]},
            table,
            1,
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 5),
                new Object[] {
                  table.originalData[5][0], table.originalData[5][2], table.originalData[5][2]
                },
                table.originalData[6],
                table.originalData[7],
                table.originalData[8],
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.fqn},
            table,
            10,
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 5),
                new Object[] {
                  table.originalData[5][0], table.originalData[5][2], table.originalData[5][1]
                },
                table.originalData[6],
                table.originalData[7],
                table.originalData[8],
  ...
  public static void testUpdateWithViewAsSourceTable(
    ...
    try (Table sourceTable = createBasicTable(source, 3, 10);
      ...
      testDmlQuery(
          ...
          new Object[] {targetTable.fqn, source, viewName, targetTable.name},
          targetTable,
          3,
          new Object[] {0, "ASDF"},
          new Object[] {-1, "ASDF"},
    ...
    try (Table sourceTable1 = createBasicTable(source, 3, 2);
      ...
      testDmlQuery(
          ...
          ArrayUtils.addAll(
              new Object[][] {
                new Object[] {
                  0, "s2_" + sourceTable1.originalData[0][1], targetTable.originalData[0][2]
                },
                new Object[] {
                  -1, "s2_" + sourceTable1.originalData[1][1], targetTable.originalData[1][2]
                }
              },
  ...
  public static void testUpdateWithTwoSourceTableOneSourceQuery(
    ...
    try (Table sourceTable1 = createBasicTable(source, 3, 2);
      ...
      testDmlQuery(
          ...
          new Object[] {targetTable.fqn, sourceTable1.fqn, sourceTable2.fqn, sourceTable3.fqn},
          targetTable,
          2,
          ArrayUtils.addAll(
              new Object[][] {
                new Object[] {
                  0,
                  "s2_" + sourceTable1.originalData[0][1],
                  "s3_" + sourceTable2.originalData[0][2],
                  targetTable.originalData[0][3]
                },
                new Object[] {
                  -1,
                  "s2_" + sourceTable1.originalData[1][1],
                  "s3_" + sourceTable2.originalData[1][2],
                  targetTable.originalData[1][3]
                }
              },
              ArrayUtils.subarray(targetTable.originalData, 2, 5)));
    }
  ...
  public static void testUpdateWithImplicitTypeCasting1(
    ...
    try (Table table1 =
      ...
      testDmlQuery(
          ...
          new Object[] {table2.fqn, table1.fqn},
          table2,
          3,
          new Object[][] {
  ...
  public static void testUpdateWithImplicitTypeCasting2(
    ...
    try (Table table1 =
      ...
      testDmlQuery(
          allocator,
          "UPDATE %s AS t Set data1 = s.data1, data2 = s.data2 from %s s where s.id = t.id",
          new Object[] {table1.fqn, table2.fqn},
          table1,
          3,
          new Object[][] {
  ...
  private static void testUpdateWithPartitionTransformation(
    ...
    if (droppedPartitionTransformField != null) {
      String partitionTransformQuery =
          String.format(
              "ALTER TABLE  %s DROP PARTITION FIELD %s", table.fqn, droppedPartitionTransformField);
      BaseTestQuery.test(partitionTransformQuery);
    }

    String partitionTransformQuery =
        String.format(
            "ALTER TABLE  %s ADD PARTITION FIELD %s", table.fqn, addedPartitionTransformClause);
    BaseTestQuery.test(partitionTransformQuery);
      ...
      assertThatThrownBy(
              () ->
                  testDmlQuery(
                      ...
                      new Object[] {table.paths[0], table.name, table.originalData[0][0]},
                      table,
                      -1))
          .isInstanceOf(Exception.class)
  ...
  public static void testUpdateWithContextWithPathTable(
    ...
    try (Table table = createBasicTable(source, 1, 2, 2);
      ...
      testDmlQuery(
          ...
          new Object[] {table.paths[0], table.name, table.columns[1], table.originalData[0][0]},
          table,
          1,
          new Object[] {0, "One"},
