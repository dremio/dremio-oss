  ...
  public void extendedMath() {
    ...
    testFunctions(
        new Object[][] {
          ...
          {"pi()", Math.PI},
          {
            "cbrt(100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
            Math.cbrt(d.doubleValue())
          },
          {
            "log(100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
            Math.log(d.doubleValue())
          },
          {
            "log(2, 100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
            (Math.log(d.doubleValue()) / Math.log(2))
          },
          {
            "exp(100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
            Math.exp(d.doubleValue())
          },
          {
            "degrees(100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
            Math.toDegrees(d.doubleValue())
          },
          {
            "radians(100111111111111111111111111111111111.00000000000000000000000000000000000000000000000000001d)",
