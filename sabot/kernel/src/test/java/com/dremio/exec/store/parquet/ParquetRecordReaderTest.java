...
public class ParquetRecordReaderTest extends BaseTestQuery {
  ...
  public void testExceedSplitLimit() {
    UserExceptionAssert.assertThatThrownBy(() -> {
      ...
      .hasMessageContaining("Too many splits encountered when processing parquet metadata at file /tmp/parquet_test_file_many_types, maximum is 1 but encountered 2 splits thus far.");
  }
  ...
  public void testNonNullableDictionaries() throws Exception {
    testFull(QueryType.SQL,
        "select * from dfs.\"/tmp/dremiotest/non_nullable_dictionary.parquet\"", "", 1, 1, 30000000, false);
  }
  ...
  public void testParquetFullEngineEventBased(boolean testValues, boolean generateNew, String plan,
    ...
    System.out.println(String.format("Took %f s to run query", (D-C) / 1E9));
  }
}
