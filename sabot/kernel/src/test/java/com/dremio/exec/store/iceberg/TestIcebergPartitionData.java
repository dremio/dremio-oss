...
public class TestIcebergPartitionData extends BaseTestQuery {
  ...
  public void testIntSpec() throws Exception {
    ...
    PartitionSpec partitionSpec = PartitionSpec.builderFor(schema).identity(columnName).build();
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, Integer.class, expectedValue);
  }
  ...
  public void testStringSpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, String.class, expectedValue);
  }
  ...
  public void testLongSpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, Long.class, expectedValue);
  }
  ...
  public void testBigDecimalpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, BigDecimal.class, expectedValue);
  }
  ...
  public void testFloatSpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, Float.class, expectedValue);
  }
  ...
  public void testDoubleSpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, Double.class, expectedValue);
  }
  ...
  public void testBooleanSpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, Boolean.class, expectedValue);
  }
  ...
  public void testBinarySpec() throws Exception {
    ...
    verifyPartitionValue(
        partitionSpec, icebergPartitionData, columnName, ByteBuffer.class, expectedValue);
  }
  ...
  private void verifyPartitionValue(
    ...
    try {
      ...
      committer =
          icebergHadoopModel.getInsertTableCommitter(
              icebergHadoopModel.getTableIdentifier(tableFolder.toPath().toString()),
              operatorStats);
      ...
      for (FileScanTask fileScanTask : table.newScan().planFiles()) {
        ...
        if (expectedClass == ByteBuffer.class) {
          Assert.assertEquals(
              structLike.get(0, expectedClass).hashCode(),
              ByteBuffer.wrap((byte[]) expectedValue).hashCode());
        } else {
  ...
  ManifestFile writeManifest(String fileName, List<DataFile> files, File tableFolder)
      throws IOException {
    return writeManifest(fileName, null, files, tableFolder);
  }

  ManifestFile writeManifest(
      String fileName, Long snapshotId, List<DataFile> files, File tableFolder) throws IOException {
