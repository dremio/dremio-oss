...
public class TestPartitionStatsTableFunction extends BaseTestTableFunction {
  ...
  public void prepareMocks() throws Exception {
    ...
    DatasetCatalogServiceGrpc.DatasetCatalogServiceBlockingStub stub = mock(DatasetCatalogServiceGrpc.DatasetCatalogServiceBlockingStub.class);
    when(context.getDatasetCatalogBlockingStub()).thenReturn(() -> stub);
    IcebergModel model = IcebergModelCreator.createIcebergModel(
  ...
  public void testPartitionStatsFromDifferentMetadata() throws Exception{
    ...
    Fixtures.Table input = t(
      th(SystemSchemas.METADATA_FILE_PATH, SystemSchemas.SNAPSHOT_ID, SystemSchemas.MANIFEST_LIST_PATH),
      tr(p("v3"), 4709042947025192029L, "/tmp/iceberg/metadata/snap-4709042947025192029-1-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro"),
      tr(p("v4"), 4447362982003292979L, "/tmp/iceberg/metadata/snap-4447362982003292979-1-9f0488cd-235e-44d2-b88b-c901424ee372.avro")
    );

    Fixtures.Table output = t(
      // Entries from v3.metadata.json
      th(SystemSchemas.FILE_PATH, SystemSchemas.FILE_TYPE, SystemSchemas.METADATA_FILE_PATH, SystemSchemas.SNAPSHOT_ID, SystemSchemas.MANIFEST_LIST_PATH),
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v3"), 4709042947025192029L, "/tmp/iceberg/metadata/snap-4709042947025192029-1-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro"),
      tr("/tmp/iceberg/metadata/dremio-partitionStatsMetadata-4709042947025192029.json", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr("file:///tmp/iceberg/metadata/dremio-partitionStats-0-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),

      // Entries from v4.metadata.json
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v4"), 4447362982003292979L, "/tmp/iceberg/metadata/snap-4447362982003292979-1-9f0488cd-235e-44d2-b88b-c901424ee372.avro"),
      tr("/tmp/iceberg/metadata/dremio-partitionStatsMetadata-4447362982003292979.json", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr("file:///tmp/iceberg/metadata/dremio-partitionStats-0-9f0488cd-235e-44d2-b88b-c901424ee372.avro", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR)
    );
  ...
  public void testExceedBatchSizeWithCarryForward() throws Exception{
    ...
    Fixtures.Table input = t(
      th(SystemSchemas.FILE_PATH, SystemSchemas.FILE_TYPE, SystemSchemas.METADATA_FILE_PATH, SystemSchemas.SNAPSHOT_ID, SystemSchemas.MANIFEST_LIST_PATH),
      tr("/tmp/iceberg/metadata-a.json", METADATA_JSON.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr("/tmp/iceberg/metadata-b.json", METADATA_JSON.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v3"), 4709042947025192029L, "/tmp/iceberg/metadata/snap-4709042947025192029-1-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro"),
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v4"), 4447362982003292979L, "/tmp/iceberg/metadata/snap-4447362982003292979-1-9f0488cd-235e-44d2-b88b-c901424ee372.avro")
    );
    ...
    Fixtures.Table output = t(
      ...
      // Entries from v3.metadata.json
      tr("/tmp/iceberg/metadata/v3.metadata.json", METADATA_JSON.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v3"), 4709042947025192029L, "/tmp/iceberg/metadata/snap-4709042947025192029-1-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro"),
      tr("/tmp/iceberg/metadata/dremio-partitionStatsMetadata-4709042947025192029.json", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr("file:///tmp/iceberg/metadata/dremio-partitionStats-0-348cabd1-9bc4-442c-92b4-7f8ac8e26a6d.avro", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),

      // Entries from v4.metadata.json
      tr("/tmp/iceberg/metadata/v4.metadata.json", METADATA_JSON.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr(NULL_VARCHAR, NULL_VARCHAR, p("v4"), 4447362982003292979L, "/tmp/iceberg/metadata/snap-4447362982003292979-1-9f0488cd-235e-44d2-b88b-c901424ee372.avro"),
      tr("/tmp/iceberg/metadata/dremio-partitionStatsMetadata-4447362982003292979.json", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR),
      tr("file:///tmp/iceberg/metadata/dremio-partitionStats-0-9f0488cd-235e-44d2-b88b-c901424ee372.avro", IcebergFileType.PARTITION_STATS.name(), NULL_VARCHAR, NULL_BIGINT, NULL_VARCHAR)
    );
  ...
  protected static void copy(String sourceElement, final java.nio.file.Path target) throws URISyntaxException, IOException {
  ...
  private TableFunctionPOP getPop(boolean enableCarryForward) {
    BatchSchema schema = SystemSchemas.ICEBERG_SNAPSHOTS_SCAN_SCHEMA.merge(SystemSchemas.CARRY_FORWARD_FILE_PATH_TYPE_SCHEMA);
    return new TableFunctionPOP(
      ...
      new TableFunctionConfig(
        ...
        true,
        new CarryForwardAwareTableFunctionContext(schema, pluginId,
          enableCarryForward, ImmutableMap.of(SchemaPath.getSimplePath(METADATA_FILE_PATH),
          SchemaPath.getSimplePath(FILE_PATH)), FILE_TYPE, METADATA_JSON.name())));
  }
}
