...
public class TestEasyImplicitColumnValuesProvider extends TestPartitionImplicitColumnValuesProvider {
  ...
  private static final long SPLIT_MOD_TIME = LocalDateTime.of(2023, 1, 1, 0, 0, 0)
      .toEpochSecond(ZoneOffset.UTC) * 1000;

  @Test
  public void testModifiedTime() {
    String modTimeColumn = ImplicitFilesystemColumnFinder.getModifiedTimeColumnName(OPTION_RESOLVER);
    Map<String, Field> implicitColumns = ImmutableMap.of(modTimeColumn,
  ...
  public void testFilePath() {
    ...
    Map<String, Field> implicitColumns = ImmutableMap.of(fileColumn,
  ...
  public void testUpdateColumn() {
    Map<String, Field> implicitColumns = ImmutableMap.of(IncrementalUpdateUtils.UPDATE_COLUMN,
        Field.nullable(IncrementalUpdateUtils.UPDATE_COLUMN, Types.MinorType.BIGINT.getType()));
    Map<String, Object> expectedImplicitValues = ImmutableMap.of(IncrementalUpdateUtils.UPDATE_COLUMN, SPLIT_MOD_TIME);
  ...
  public void testEasyImplicitsWithPartitions() {
    ...
    Map<String, Field> implicitColumns = ImmutableMap.of(
      ...
      fileColumn, Field.nullable(fileColumn, Types.MinorType.VARCHAR.getType()));
    Map<String, Object> partitionImplicitValues = ImmutableMap.of(
        IMPLICIT_1, "100",
        IMPLICIT_2, 200,
        IMPLICIT_3, 300);
    Map<String, Object> expectedImplicitValues = ImmutableMap.of(
        IMPLICIT_1, "100",
        IMPLICIT_3, 300,
        modTimeColumn, SPLIT_MOD_TIME,
      fileColumn, SPLIT_FILE);
  ...
  protected SplitAndPartitionInfo createSplitAndPartitionInfo(Map<String, Object> values) {
    ...
    EasyProtobuf.EasyDatasetSplitXAttr splitExtended = EasyProtobuf.EasyDatasetSplitXAttr.newBuilder()
        ...
        .build();
    PartitionProtobuf.NormalizedDatasetSplitInfo splitInfo = PartitionProtobuf.NormalizedDatasetSplitInfo.newBuilder()
