...
public class TestEasyScanTableFunction extends BaseTestEasyScanTableFunction {
  ...
  private static final String ALL_PRIMITIVE_TYPE_OUTPUT = "/store/text/data/allprimitiveoutput.csvh";
  ...
  private static final String DATA_FILE_ALL_TYPE_WITH_HEADER = "/store/text/data/allprimitivetype.csvh";
  ...
  public void testDataFileScan() throws Exception {
    ...
    validate(input, new RecordBatchValidatorDefaultImpl(output), CAR_COLUMNS, CAR_OUTPUT_SCHEMA, FileType.TEXT);
  }
  ...
  public void testAllTypeDataFileScan() throws Exception {
    ...
    validate(input, new RecordBatchValidatorDefaultImpl(output), ALL_TYPE_COLUMNS, OUTPUT_SCHEMA_ALL_TYPE, FileType.TEXT);
  }
  ...
  public void testColumnMismatchCSV() throws Exception {
    ...
    validate(input, new RecordBatchValidatorDefaultImpl(output), COLUMNS_MISMATCH, OUTPUT_SCHEMA_COLUMN_MISMATCH, FileType.TEXT);
  }
  ...
  public void testDataFileScanWithRandomColumnOrder() throws Exception {
    ...
    validate(input, new RecordBatchValidatorDefaultImpl(output), COLUMNS_YEAR_PRICE, OUTPUT_SCHEMA_WITH_YEAR_AND_PRICE, FileType.TEXT);
  }
  ...
  public void testAllTypeJsonDataFileScan() throws Exception {
    ...
    RecordSet output = outputRecordSet(ALL_PRIMITIVE_TYPE_OUTPUT, OutputRecordType.ALL_DATA_TYPE_COLUMNS, OUTPUT_SCHEMA_ALL_TYPE, ",");
    validate(input, new RecordBatchValidatorDefaultImpl(output), ALL_TYPE_COLUMNS, OUTPUT_SCHEMA_ALL_TYPE, FileType.JSON);
  }
  ...
  public void testComplexJsonDataFileScan() throws Exception {
    ...
    validate(input, new RecordBatchValidatorDefaultImpl(output), JSON_COMPLEX, JSON_COMPLEX_OUTPUT_SCHEMA, FileType.JSON);
  }
  ...
  public void testComplexJsonMapType() throws Exception {
    ...
    try {
      validate(input, new RecordBatchValidatorDefaultImpl(output), projected, fields, FileType.JSON);
    } catch (Exception e) {
  ...
  private void validate(RecordSet input, RecordBatchValidator output, List<SchemaPath> projectedColumns, BatchSchema batchSchema, FileType fileType) throws Exception {
