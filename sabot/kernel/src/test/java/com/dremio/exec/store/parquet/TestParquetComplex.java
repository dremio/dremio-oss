...
public class TestParquetComplex extends BaseTestQuery {
    ...
    String query =
        String.format(
            "select t1.amount, t1.\"date\", t1.marketing_info, t1.\"time\", t1.trans_id, t1.trans_info, t1.user_info "
                + "from %s t1, %s t2 where t1.amount = t2.amount",
            DATAFILE, DATAFILE);
    testBuilder()
        .sqlQuery(query)
        .unOrdered()
  ...
  private void runFilterNonComplexColumn() throws Exception {
    String query =
        String.format(
            "select t1.user_info.cust_id as cust_id from %s t1 where t1.trans_id > 0 and "
                + "t1.trans_id < 4",
            DATAFILE);
    TestBuilder builder =
        testBuilder()
    ...
    builder.baselineValues(86623L).baselineValues(11L).baselineValues(666L).build().run();
  }
  ...
  public void selectAllColumns() throws Exception {
    String query =
        String.format(
            "select amount, \"date\", marketing_info, \"time\", trans_id, trans_info, user_info from %s",
            DATAFILE);
    testBuilder()
        .sqlQuery(query)
        .ordered()
  ...
  public void selectMapAndElements() throws Exception {
    String query =
        "select marketing_info, t.marketing_info.camp_id as camp_id, t.marketing_info.keywords[2] as keyword2 from cp.\"store/parquet/complex/complex.parquet\" t";
    testBuilder()
        .sqlQuery(query)
        .ordered()
  ...
  public void selectMultiElements() throws Exception {
    String query =
        "select t.marketing_info.camp_id as camp_id, t.marketing_info.keywords as keywords from cp.\"store/parquet/complex/complex.parquet\" t";
    testBuilder()
        .sqlQuery(query)
        .ordered()
  ...
  public void missingColumnInMap() throws Exception {
    String query =
        "select t.trans_info.keywords as keywords from cp.\"store/parquet/complex/complex.parquet\" t";
  ...
  public void secondElementInMap() throws Exception {
    String query =
        String.format("select t.\"marketing_info\".keywords as keywords from %s t", DATAFILE);
    String[] columns = {"keywords"};
    testBuilder()
        .sqlQuery(query)
        .ordered()
  ...
  public void elementsOfArray() throws Exception {
    String query =
        String.format(
            "select t.\"marketing_info\".keywords[0] as keyword0, t.\"marketing_info\".keywords[2] as keyword2 from %s t",
            DATAFILE);
  ...
  public void notxistsField() throws Exception {
    String query =
        String.format(
            "select t.\"marketing_info\".notexists as notexists, t.\"marketing_info\".camp_id as id from %s t",
            DATAFILE);
  ...
  public void testLegacyRepeatedMap() throws Exception {
    final String query =
        "SELECT sub.fmap.str1 as str FROM ("
  ...
  private void filterListsWithNulls(String columnName) throws Exception {
    String query =
        "SELECT "
            ...
            + "FROM cp.\"/parquet/list_null_test.parquet\" where "
            + columnName
            + "[2] is null";
    testBuilder()
        .sqlQuery(query)
  ...
  public void testListsWithNulls() throws Exception {
    ...
    testBuilder()
        ...
        .baselineColumns(
            ...
            "datecol",
            "timestampcol")
        .baselineValues(4, 4L, 4.4F, 4.4D, new BigDecimal("4"), "d", "d", "d", null, null)
        .build()
        .run();
  }
  ...
  public void testListofListWithNulls() throws Exception {
    ...
    String query = "SELECT " + "col1 " + "FROM cp.\"/parquet/list_list_null_test.parquet\"";
    testBuilder()
        .sqlQuery(query)
        .ordered()
  ...
  public void testListofStructWithNulls() throws Exception {
    ...
    String query = "SELECT " + "col1 " + "FROM cp.\"/parquet/list_struct_null_test.parquet\"";
    testBuilder()
        .sqlQuery(query)
        .ordered()
        .baselineColumns("col1")
    ...
    query =
        "SELECT " + "col1[0].\"f1\" as c1 " + "FROM cp.\"/parquet/list_struct_null_test.parquet\"";
    testBuilder()
        .sqlQuery(query)
        .ordered()
        .baselineColumns("c1")
