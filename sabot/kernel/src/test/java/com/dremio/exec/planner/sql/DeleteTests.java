  ...
  public static void testMalformedDeleteQueries(String source) throws Exception {
    try (Table sourceTable = createBasicTable(source, 3, 0);
      ...
      testMalformedDmlQueries(
          new Object[] {
            targetTable.fqn, sourceTable.fqn, targetTable.columns[0], sourceTable.columns[0]
          },
          "DELETE",
          "DELETE FROM",
          "DELETE %s",
  ...
  public static void testDeleteOnView(BufferAllocator allocator, String source) throws Exception {
    ...
    try (AutoCloseable ignored = createView(source, name)) {
      assertThatThrownBy(
              () ->
                  testDmlQuery(
                      allocator, "DELETE FROM %s.%s", new Object[] {source, name}, null, -1))
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.originalData[0][0]},
            table,
            1,
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.originalData[4][1]},
            table,
            1,
            ArrayUtils.addAll(
    ...
    try (Tables tables =
      ...
      for (Table table : tables.tables) {
        ...
        testDmlQuery(
            ...
            new Object[] {table.fqn, table.originalData[9][0], table.originalData[4][1]},
            table,
            2,
            ArrayUtils.addAll(
                ArrayUtils.subarray(table.originalData, 0, 4),
  ...
  public static void testDeleteWithOneSourceTable(
    ...
    try (Table sourceTable = createBasicTable(source, 3, 5);
      ...
      testDmlQuery(
          ...
          new Object[] {targetTable.fqn, sourceTable.fqn, sourceTable.fqn},
          targetTable,
          5,
  ...
  public static void testDeleteWithViewUsedAsSourceTable(
    ...
    try (Table targetTable = createBasicTable(source, 3, 5);
      ...
      testDmlQuery(
          ...
          new Object[] {targetTable.fqn, source, viewName, source, viewName},
          targetTable,
          5,
          EMPTY_EXPECTED_DATA);
    }
  ...
  public static void testDeleteWithSourceTableAsQueryUsingTarget(
    ...
    try (Table targetTable = createBasicTable(source, 2, 10)) {
      ...
      testDmlQuery(
          allocator,
          "DELETE FROM %s AS t using (SELECT id from %s WHERE id < 4) AS s where t.id = s.id",
          new Object[] {targetTable.fqn, targetTable.fqn},
          targetTable,
          4,
          ArrayUtils.subarray(targetTable.originalData, 4, 10));
    }
  ...
  public static void testDeleteWithTwoSourceTables(
    ...
    try (Table sourceTable1 = createBasicTable(source, 3, 4);
      ...
      testDmlQuery(
          ...
          new Object[] {
            targetTable.fqn, sourceTable1.fqn, sourceTable2.fqn, sourceTable1.fqn, sourceTable2.fqn
          },
          targetTable,
          4,
          ArrayUtils.subarray(targetTable.originalData, 4, 10));
      ...
      assertThatThrownBy(
              () ->
                  testDmlQuery(
                      allocator,
                      "DELETE FROM %s WHERE id = %s",
                      new Object[] {table.name, table.originalData[0][0]},
                      table,
                      -1))
          .isInstanceOf(Exception.class)
  ...
  public static void testDeleteWithSourceAsPathTableWithWrongContextWithPathTable(
    ...
    try (Table sourceTable =
      ...
      testDmlQuery(
          allocator,
          "DELETE FROM %s.%s WHERE id = %s",
          new Object[] {source, tableName, 0},
          sourceTable,
          1,
          sourceTable.originalData[1]);
    ...
    try (Table sourceTable =
      ...
      try (Table sourceSourceTable =
        ...
        testDmlQuery(
            ...
            sourceSourceTable,
            1,
            sourceSourceTable.originalData[1]);
      }
