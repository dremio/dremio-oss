...
public class ExpressionSplitterTest extends BaseExpressionSplitterTest {
  ...
  Fixtures.Table ifInput = Fixtures.split(th("c0", "c1"), 2, tr(10, 11), tr(4, 3), tr(5, 5));

  Fixtures.Table ifOutput = t(th("out"), tr(21), tr(1), tr(10));
    ...
    Split[] expSplits =
        new Split[] {
          new Split(
              true,
              "_xxx0",
              "(if (greater_than(c0, c1)) then (subtract(c0, c1)) else (add(c1, c0)) end)",
              1,
              0)
        };
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              true,
              "_xxx1",
              "(if (_xxx0) then (subtract(c0, c1)) else (add(c1, c0)) end)",
              2,
              0,
              "_xxx0")
        };
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              true,
              "_xxx1",
              "(if (_xxx0) then (cast((__$internal_null$__) as int)) else (add(c1, c0)) end)",
              2,
              1,
              "_xxx0"),
          new Split(
              false,
              "_xxx2",
              "(if (_xxx0) then (subtract(c0, c1)) else (_xxx1) end)",
              3,
              0,
              "_xxx0",
              "_xxx1")
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              true,
              "_xxx1",
              "(if (_xxx0) then (subtract(c0, c1)) else (cast((__$internal_null$__) as int)) end)",
              2,
              1,
              "_xxx0"),
          new Split(
              false,
              "_xxx2",
              "(if (_xxx0) then (_xxx1) else (add(c1, c0)) end)",
              3,
              0,
              "_xxx0",
              "_xxx1")
  ...
  public void testNestedIfInFunction() throws Exception {
    ...
    String query =
        "case when c0 > c1 then (case when c0 > 10 then 10i else c0 end) + c0 else c1 + c0 end";
    Fixtures.Table input = Fixtures.split(th("c0", "c1"), 2, tr(10, 11), tr(4, 3), tr(11, 5));

    Fixtures.Table output = t(th("out"), tr(21), tr(8), tr(21));
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              false,
              "_xxx1",
              "(if (_xxx0) then (greater_than(c0, 10i)) else(cast((__$internal_null$__) as bit)) end)",
              2,
              1,
              "_xxx0"),
          new Split(
              true,
              "_xxx2",
              "(if (_xxx0) then (add((if (_xxx1) then (10i) else (c0) end), c0)) else (add(c1, c0)) end)",
              3,
              0,
              "_xxx0",
              "_xxx1")
  ...
  public void testNestedIfInFunctionSplitThen() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(1), tr(8), tr(21));
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              true,
              "_xxx1",
              "(if (_xxx0) then ((if (greater_than(c0, 10i)) then (10i) else (c0) end)) else(cast((__$internal_null$__) as int)) end)",
              2,
              1,
              "_xxx0"),
          new Split(
              true,
              "_xxx2",
              "(if (_xxx0) then (cast((__$internal_null$__) as int)) else (subtract(c1, c0)) end)",
              2,
              1,
              "_xxx0"),
          new Split(
              false,
              "_xxx3",
              "(if (_xxx0) then (add(_xxx1, c0)) else (_xxx2) end)",
              3,
              0,
              "_xxx0",
              "_xxx1",
  ...
  public void ifTimestamp() throws Exception {
    ...
    String query =
        "case when (c0 < castTIMESTAMP(698457600000l) AND (c1 > castTIMESTAMP(909619200000l))) then (castTIMESTAMP(1395822273000l))  else (castTIMESTAMP(1395822273999l)) end";
    Fixtures.Table input = Fixtures.t(th("c0", "c1"), tr(date("2001-01-01"), date("2001-12-31")));

    Fixtures.Table output = Fixtures.t(th("out"), tr(ts("2014-03-26T08:24:33.999")));
    ...
    Split[] splits = {
      ...
      new Split(
          false,
          "_xxx3",
          "(if (_xxx2) then (casttimestamp(c1)) else (cast((__$internal_null$__) as timestamp)) end)",
          3,
          1,
          "_xxx2"),
      new Split(
          false,
          "_xxx4",
          "(if (_xxx2) then (casttimestamp(909619200000l)) else (cast((__$internal_null$__) as timestamp)) end)",
          3,
          1,
          "_xxx2"),
      new Split(
          true,
          "_xxx5",
          "(if (_xxx2) then(greater_than(_xxx3, _xxx4)) else (false) end)",
          4,
          1,
          "_xxx2",
          "_xxx3",
      ...
      new Split(
          false,
          "_xxx6",
          "(if (_xxx5) then(casttimestamp(1395822273000l)) else(casttimestamp(1395822273999l)) end)",
          5,
          0,
          "_xxx5")
    };
  ...
  public void testConstantExpression() throws Exception {
    ...
    Fixtures.Table input = Fixtures.t(th("c0"), tr(date("2001-01-01")));

    Fixtures.Table output = Fixtures.t(th("out"), tr(ts("2014-03-26T08:24:33.999")));

    Split[] splits = {
      new Split(
          false, "_xxx0", "greater_than(castTIMESTAMP(698457600000l), castTIMESTAMP(3l))", 1, 1),
      new Split(
          true,
          "_xxx1",
          "(if (_xxx0 ) then (castTIMESTAMP(1395822273999l))  else (castTIMESTAMP(1396762453000l)) end)",
          2,
          0,
          "_xxx0")
    };
  ...
  public void testBooleanAnd() throws Exception {
    ...
    Fixtures.Table input = Fixtures.split(th("c0"), 2, tr(18), tr(9), tr(24));
    ...
    Split[] splits = {
      ...
      new Split(
          false, "_xxx1", "(if (_xxx0) then (less_than(c0, 20i)) else (false) end)", 2, 0, "_xxx0")
    };
    ...
    splits =
        new Split[] {
          ...
          new Split(
              true,
              "_xxx1",
              "(if (_xxx0) then (less_than(c0, 20i)) else (false) end)",
              2,
              0,
              "_xxx0")
        };
  ...
  public void test3AndBCGandiva() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(true), tr(false), tr(false), tr(false));
    ...
    Split[] splits = {
      ...
      new Split(
          true,
          "_xxx1",
          "(if (_xxx0) then ((if (less_than(c0, 24i)) then(equal(c1, 0i)) else (false) end)) else (false) end)",
          2,
          0,
          "_xxx0")
    };
  ...
  public void test3AndACGandiva() throws Exception {
    ...
    String query = "c0 > 10 AND c0 < 24 AND c1 == 0";
    Fixtures.Table input =
        Fixtures.split(th("c0", "c1"), 2, tr(18, 0), tr(9, 0), tr(28, 0), tr(20, 10));
    ...
    Split[] splits = {
      ...
      new Split(
          false,
          "_xxx1",
          "(if (_xxx0) then (less_than(c0, 24i)) else (cast((__$internal_null$__) as bit)) end)",
          2,
          1,
          "_xxx0"),
      new Split(
          true,
          "_xxx2",
          "(if (_xxx0) then ((if (_xxx1) then (equal(c1, 0i)) else (false) end)) else (false) end)",
          3,
          0,
          "_xxx0",
          "_xxx1")
  ...
  public void test4AndBDGandiva() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(true), tr(false), tr(false), tr(false), tr(false));
    ...
    Split[] splits = {
      ...
      new Split(
          false,
          "_xxx2",
          "(if (_xxx0) then ((if (_xxx1) then (equal(c1, 0i)) else (cast((__$internal_null$__) as bit)) end)) else (cast((__$internal_null$__) as bit)) end)",
          3,
          1,
          "_xxx0",
          "_xxx1"),
      new Split(
          true,
          "_xxx3",
          "(if (_xxx0) then ((if (_xxx1) then ((if (_xxx2) then (less_than(c2, 4i)) else (false) end)) else (false) end)) else (false) end)",
          4,
          0,
          "_xxx0",
          "_xxx1",
  ...
  public void testNestedIfConditions() throws Exception {
    String query =
        "case when c0 = 0 then c0 + c1 else (case when c1 = 0 then c1 + c0 else 1/c0 end) end";
    Fixtures.Table input = Fixtures.split(th("c0", "c1"), 2, tr(0, 11));

    Fixtures.Table output = t(th("out"), tr(11));
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              false,
              "_xxx1",
              "(if (_xxx0) then (cast((__$internal_null$__) as bit)) else(equal(c1, 0i)) end)",
              2,
              2,
              "_xxx0"),
          new Split(
              true,
              "_xxx2",
              "(if (_xxx0) then (cast((__$internal_null$__) as int)) else ((if (_xxx1) then (cast((__$internal_null$__) as int)) else (divide(1i, c0)) end)) end)",
              3,
              1,
              "_xxx0",
              "_xxx1"),
          new Split(
              false,
              "_xxx3",
              "(if (_xxx0) then (add(c0, c1)) else ((if (_xxx1) then (add(c1, c0)) else (_xxx2) end)) end)",
              4,
              0,
              "_xxx0",
              "_xxx1",
  ...
  public void testSplitElseInNestedIfCondition() throws Exception {
    String query =
        "case when c0 = 0 then c0 + c1 else (case when c1 = 0 then c1 + c0 else c1 + 1/c0 end) end";
    Fixtures.Table input = Fixtures.split(th("c0", "c1"), 2, tr(0, 11));
    ...
    Split[] expSplits =
        new Split[] {
          ...
          new Split(
              false,
              "_xxx3",
              "(if (_xxx0) then (add(c0, c1)) else ((if (_xxx1) then (add(c1, c0)) else (add(c1, _xxx2)) end)) end)",
              4,
              0,
              "_xxx0",
              "_xxx1",
  ...
  public void testBooleanOr() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(true), tr(false), tr(true));

    GandivaAnnotator annotator = new GandivaAnnotator("greater_than");
    Split[] splits = {
      new Split(true, "_xxx0", "greater_than(c0, 10i)", 1, 1),
      new Split(
          false, "_xxx1", "(if (_xxx0) then (true) else (less_than(c0, 0i)) end)", 2, 0, "_xxx0")
    };
    ...
    splits =
        new Split[] {
          new Split(false, "_xxx0", "greater_than(c0, 10i)", 1, 1),
          new Split(
              true, "_xxx1", "(if (_xxx0) then (true) else (less_than(c0, 0i)) end)", 2, 0, "_xxx0")
        };
  ...
  public void test3OrBCGandiva() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(true), tr(true), tr(true), tr(false));
    ...
    Split[] splits = {
      ...
      new Split(
          true,
          "_xxx1",
          "(if (_xxx0) then (true) else ((if (less_than(c0, 10i)) then (true) else(equal(c1, 0i)) end)) end)",
          2,
          0,
          "_xxx0")
    };
  ...
  public void test3OrACGandiva() throws Exception {
    ...
    Split[] splits = {
      ...
      new Split(
          false,
          "_xxx1",
          "(if (_xxx0) then (cast((__$internal_null$__) as bit)) else (less_than(c0, 10i)) end)",
          2,
          1,
          "_xxx0"),
      new Split(
          true,
          "_xxx2",
          "(if (_xxx0) then (true) else ((if (_xxx1) then (true) else (equal(c1, 0i)) end)) end)",
          3,
          0,
          "_xxx0",
          "_xxx1")
  ...
  public void test4OrBCGandiva() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(true), tr(true), tr(true), tr(true), tr(false));
    ...
    Split[] splits = {
      ...
      new Split(
          true,
          "_xxx2",
          "(if (_xxx0) then (cast((__$internal_null$__) as bit)) else ((if (_xxx1) then (cast((__$internal_null$__) as bit)) else (equal(c1, 0i)) end)) end)",
          3,
          1,
          "_xxx0",
          "_xxx1"),
      new Split(
          false,
          "_xxx3",
          "(if (_xxx0) then (true) else ((if (_xxx1) then (true) else ((if (_xxx2) then (true) else (greater_than(c2, 4i)) end)) end)) end)",
          4,
          0,
          "_xxx0",
          "_xxx1",
  ...
  public void testBooleanOperator() throws Exception {
    ...
    Split[] splits = {
      new Split(
          true,
          "_xxx0",
          "(if (booleanAnd(greater_than(c0, castBIGINT(10i)),less_than(c0, castBIGINT(20i)))) then (true) else(equal(mod(c0, 2i),0i)) end)",
          1,
          0)
    };
    ...
    annotator =
        new GandivaAnnotator(
            "booleanOr", "booleanAnd", "greater_than", "less_than", "mod", "equal", "castBIGINT");
    splits =
        new Split[] {
          new Split(
              true,
  ...
  public void testExceptionHandling() {
    ...
    Fixtures.Table output = t(th("out"), tr(14), tr(5), tr(4));
  ...
  public void testCastDateIsNotUsingCastVarchar() throws Exception {
    ...
    Fixtures.Table output = t(th("out"), tr(2014L), tr(2019L), tr(2015L));
    Split[] expSplits = new Split[] {new Split(false, "_xxx0", "extractyear(castdate(c0))", 1, 0)};
  ...
  public void testTruncAndNullCast() throws Exception {
    ...
    Fixtures.Table input =
        Fixtures.split(
            ...
            tr(ts("2019-02-01T17:20:36")),
            tr(ts("2015-02-01T17:20:50")));
    Fixtures.Table output = t(th("out"), tr(NULL_BIGINT), tr(NULL_BIGINT), tr(NULL_BIGINT));
    Split[] expSplits =
        new Split[] {
          new Split(
              false, "_xxx0", "trunc(extractyear(cast((__$INTERNAL_NULL$__) as TIMESTAMP)))", 1, 0)
        };
