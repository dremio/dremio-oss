    ...
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String[] queries = {
          ...
          String.format(
              "ALTER TABLE %s.%s ADD COLUMNS(col1 varchar, col2 int, col3)", testSchema, tableName)
        };
        for (String q : queries) {
  ...
  public void invalidType() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col1 varchar, col2 int, col3 inte)",
                testSchema, tableName);
  ...
  public void unsupportedType() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col1 varchar, col2 int, col4 ARRAY(INT), col5 ROW(col6 INT), col3 map)",
                testSchema, tableName);
  ...
  public void noContextFail() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s ADD COLUMNS(col1 varchar, col2 int, col3 MAP)", tableName);
  ...
  public void addExistingColumn() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(CATALOG_NAME varchar, col2 int, col3 int)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [CATALOG_NAME] already in the table.");

        query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col1 varchar, col1 int, col3 int)",
                testSchema, tableName);
  ...
  public void addExistingColumnInStruct() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col STRUCT<col1 :int,COL1: double>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInListOfStruct() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col LIST<STRUCT<col1: int,COL1: double>>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInListOfListOfStruct() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col LIST<LIST<STRUCT<col1: int,COL1: double>>>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInStructOfListOfStruct() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col STRUCT<col: LIST<STRUCT<col :int, col1: int,COL1: double>>>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInStructOfListOfRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col STRUCT<col: LIST<ROW(col int, col1 int,COL1 double)>>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInStructOfStruct() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col STRUCT<col STRUCT<col: int, col1 :int,COL1 :double>>)",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col ROW(col1 int,COL1 double))",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInArrayOfRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col ARRAY(ROW(col1 int,COL1 double)))",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInArrayOfArrayOfRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col ARRAY(ARRAY(ROW(col1 int,COL1 double))))",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInRowOfArrayOfRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col ROW(col ARRAY(ROW(col int, col1 int,COL1 double))))",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void addExistingColumnInRowOfRow() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(col ROW(col ROW(col int, col1 int,COL1 double)))",
                testSchema, tableName);
        errorMsgTestHelper(query, "Column [COL1] specified multiple times.");
      } finally {
        FileUtils.deleteQuietly(new File(getDfsTestTmpSchemaLocation(), tableName));
  ...
  public void invalidTable() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String query =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(version varchar, col2 int, col3 int)",
                testSchema, tableName);
  ...
  public void addColumnAndInsert() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        String alterQuery =
            String.format(
                "ALTER TABLE %s.%s ADD COLUMNS(newcol1 varchar, newcol2 int, newcol3 int)",
                testSchema, tableName);
        test(alterQuery);
        ...
        Thread.sleep(1001);
        String insertQuery =
            String.format("INSERT INTO %s.%s VALUES(2, 'ab', 1, 2)", testSchema, tableName);
        test(insertQuery);
  ...
  public void addColumnOnTableWithPath() throws Exception {
    for (String testSchema : SCHEMAS_FOR_TEST) {
      ...
      try {
        ...
        final String selectFromCreatedTable =
            String.format("select * from %s.%s.%s", testSchema, path, tableName);
        testBuilder()
            .sqlQuery(selectFromCreatedTable)
            .unOrdered()
            .baselineColumns("n_regionkey")
