...
public class TestFileLoadInfo {
  ...
  public void testGetJsonAndDeserializeInfo() {
    ...
    String json = FileLoadInfo.Util.getJson(testErrorInfo);

    // Deserialize the JSON back to an ErrorInfo object using ErrorInfo.Util.getInfo
    TestInfo deserializedErrorInfo = FileLoadInfo.Util.getInfo(json, TestInfo.class);
  ...
  private static class TestInfo implements FileLoadInfo {
