...
/**
 * Unit tests for {@code TestFileSystemPlugin}
 */
public class TestFileSystemPlugin extends DremioTest {
  ...
  public void testHdfsConfApplied() throws Exception {
    ...
    try(FileSystemPlugin fileSystemPlugin = new FileSystemPlugin(conf, context, "test-plugin", null, idProvider)) {
