...
public class TestDateTimeFunctions extends BaseTestFunction {
  ...
  public void timezone() {
    testFunctions(
        new Object[][] {
          {
            "convert_timezone('+02:00', c0)",
            ts("2020-06-03T21:33:20.007"),
            ts("2020-06-03T23:33:20.007")
          },
          {
            "convert_timezone('+04:00', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-04T03:33:20.007")
          },
          {
            "convert_timezone('+01:00', '+02:00', c0)",
            ts("2020-06-03T21:33:20.007"),
            ts("2020-06-03T22:33:20.007")
          },
          {
            "convert_timezone('+02:00', '+01:00', c0)",
            ts("2020-06-03T21:33:20.007"),
            ts("2020-06-03T20:33:20.007")
          },
          {
            "convert_timezone('Asia/Kolkata', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-04T05:03:20.007")
          },
          {
            "convert_timezone('America/New_York', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T19:33:20.007")
          },
          {
            "convert_timezone('Asia/Kolkata', 'America/New_York', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T14:03:20.007")
          },
          // America/New_York will be 1 more hour behind during winter
          {
            "convert_timezone('America/New_York', c0)",
            ts("2020-12-03T23:33:20.007"),
            ts("2020-12-03T18:33:20.007")
          },
          {
            "convert_timezone('Asia/Kolkata', 'America/New_York', c0)",
            ts("2020-12-03T23:33:20.007"),
            ts("2020-12-03T13:03:20.007")
          },
        });
  }
  ...
  public void timezoneWithAbbr() {
    testFunctions(
        new Object[][] {
          {
            "convert_timezone('UTC', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T23:33:20.007")
          },
          {
            "convert_timezone('IST', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-04T01:33:20.007")
          },
          {
            "convert_timezone('EDT', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T19:33:20.007")
          },
          {
            "convert_timezone('IST', 'EDT', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T17:33:20.007")
          },
          {
            "convert_timezone('IST', 'UTC', c0)",
            ts("2020-06-03T23:33:20.007"),
            ts("2020-06-03T21:33:20.007")
          },
        });
  ...
  public void toTimstamp() {
    testFunctions(
        new Object[][] {
          {
            "to_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZD')",
            "2018-11-23T15:36:00.000PST",
            ts("2018-11-23T23:36:00.000")
          },
          {
            "to_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZD')",
            "2018-11-23T15:36:00.000PDT",
            ts("2018-11-23T22:36:00.000")
          },
          {
            "to_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZO')",
            "2018-11-23T15:36:00.000+01:00",
            ts("2018-11-23T14:36:00.000")
          },
          {
            "extractDay(to_date(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZD'))",
            "2018-11-23T19:36:00.000PST",
            24L
          },
        });
  }
  ...
  public void testUnixTimestampWithTZOffset() {
    testFunctions(
        new Object[][] {
          {
            "unix_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZO')",
            "1970-01-01T01:00:00.000-01:00",
            7200L /*1970-01-01T02:00:00*/
          },
          {
            "unix_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZO')",
            "1970-01-01T01:00:00.000+01:00",
            0L /*1970-01-01T00:00:00*/
          },
          {
            "unix_timestamp(c0, 'YYYY-MM-DD\"T\"HH24:MI:SS.FFFTZO')",
            "1970-01-01T02:00:00.000+01:00",
            3600L /*1970-01-01T01:00:00*/
          },
        });
  }
  ...
  public void invalidTimezoneAbbrev() {
    ...
    try {
      ...
      assertTrue(
          uex.getMessage()
              .contains(
                  "Zone offset hours not in valid range: value 24 is not in the range -18 to 18"));
    }
    ...
    try {
      ...
      UserException uex = (UserException) e.getCause().getCause();
      assertTrue(
          uex.getContextStrings().stream()
              .anyMatch(s -> s.contains("Invalid timezone abbreviation ABC")));
    }
  }
    ...
    testFunctions(
        new Object[][] {
          ...
          // Test add times
          {
            ...
            30,
            fixedDate,
            dateTimeFormatter.parseLocalDateTime("2003-07-09 00:00:30")
          },
          {
            "add_Minutes(c0, c1)",
            -30L,
            fixedDate,
            dateTimeFormatter.parseLocalDateTime("2003-07-08 23:30:00")
          },
          {
            "add_Hours(c0, c1)",
            20,
            fixedDate,
            dateTimeFormatter.parseLocalDateTime("2003-07-09 20:00:00")
          },
          ...
          {
            "timestampaddSecond(c0, c1)",
            fixedDate,
            30,
            dateTimeFormatter.parseLocalDateTime("2003-07-09 00:00:30")
          },
          {
            "timestampaddMinute(c0, c1)",
            fixedDate,
            -30L,
            dateTimeFormatter.parseLocalDateTime("2003-07-08 23:30:00")
          },
          {
            "timestampaddHour(c0, c1)",
            fixedDate,
            20,
            dateTimeFormatter.parseLocalDateTime("2003-07-09 20:00:00")
          },
  ...
  public void testDateType() {
    ...
    assertThatThrownBy(
            () ->
                testFunction(
                    "cast(datetype(2020, 1, 0) as TIMESTAMP)", ts("2020-1-1T00:00:00.000")))
        .cause()
        .cause()
  ...
  public void testTimestampType() {
    ...
    assertThatThrownBy(
            () ->
                testFunction(
                    "timestamptype(2021, 1, 0, 1, 2, 3, 500)", ts("2021-1-1T01:02:03.500")))
        .cause()
        .cause()
        .hasMessageContaining("Unable to convert");
  }
