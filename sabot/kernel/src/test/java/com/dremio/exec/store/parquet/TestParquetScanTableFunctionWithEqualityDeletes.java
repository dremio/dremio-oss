...
public class TestParquetScanTableFunctionWithEqualityDeletes extends BaseTestParquetScanTableFunction {
  ...
  private static final ByteString EXTENDED_PROPS = getExtendedProperties(IcebergTestTables.PRODUCTS_SCHEMA);
  ...
  private RecordSet.Record inputRow(String relativePath, long offset, long length, List<DeleteFileInfo> deleteFiles)
      throws Exception {
