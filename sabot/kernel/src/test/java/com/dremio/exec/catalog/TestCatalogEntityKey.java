...
public class TestCatalogEntityKey {
  ...
  public void testSerialize() {
    ...
    TableVersionContext tableVersionContext = new TableVersionContext(TableVersionType.BRANCH, "testBranch");
  ...
  public void testDeserialize() {
    ...
    String stringKey = new StringBuilder()
  ...
  public void testKeyWithInvalidName() {
    TableVersionContext tableVersionContext = new TableVersionContext(TableVersionType.BRANCH, "testBranch");
    String tablename = new StringBuilder().append("tableWithInvalidCharacter").append(getInformationSeparatorOne()).toString();
    ...
    assertThatThrownBy(() -> catalogEntityKeyBuilder.keyComponents(keyComponents)
      .tableVersionContext(tableVersionContext).build()).isInstanceOf(UserException.class);
    assertThatThrownBy(() -> catalogEntityKeyBuilder.keyComponents(keyComponents)
      .tableVersionContext(tableVersionContext).build()).hasMessageContaining("Invalid CatalogEntityKey format ");
  }

  @Test
  public void testKeyWithInvalidFolder() {
    TableVersionContext tableVersionContext = new TableVersionContext(TableVersionType.BRANCH, "testBranch");
    String foldername = new StringBuilder().append("folderWithInvalidCharacter").append(getInformationSeparatorOne()).toString();
  ...
  public void testKeyForImmutableEntity() {
    List<String> key1 = ImmutableList.of("x","y","z");
    TableVersionContext tableVersionContextImmutable = new TableVersionContext(TableVersionType.SNAPSHOT_ID, "1234564");
    final CatalogEntityKey catalogEntityKeyImmutable = CatalogEntityKey.newBuilder()
      .keyComponents(key1)
      .tableVersionContext(tableVersionContextImmutable)
      .build();
    TableVersionContext tableVersionContextImmutable2 = new TableVersionContext(TableVersionType.TIMESTAMP, 1000L);
    final CatalogEntityKey catalogEntityKeyImmutable2 = CatalogEntityKey.newBuilder()
      .keyComponents(key1)
    ...
    TableVersionContext tableVersionContext1 = new TableVersionContext(TableVersionType.BRANCH, "foo");
    final CatalogEntityKey catalogEntityKey1 = CatalogEntityKey.newBuilder()
      .keyComponents(key1)
    ...
    final CatalogEntityKey catalogEntityKey2 = CatalogEntityKey.newBuilder()
      .keyComponents(key1)
