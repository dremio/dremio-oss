...
public class ComplexTypeCopiersTest extends ExecTest {
  ...
  public void testStructCopier() {
    try (final StructVector s1 = StructVector.empty("s1", allocator);
      ...
      int rowcount = 5000;
      s1.addOrGet(
          "struct_child", FieldType.nullable(Types.MinorType.INT.getType()), IntVector.class);
      s2.addOrGet(
          "struct_child", FieldType.nullable(Types.MinorType.INT.getType()), IntVector.class);
      s1.allocateNew();
  ...
  public void testListCopier() {
    int rowcount = 5000;
    try (final ListVector l1 =
            new ListVector(
                "colList", allocator, FieldType.nullable(ArrowType.List.INSTANCE), null);
        final ListVector l2 =
            new ListVector(
                "colList", allocator, FieldType.nullable(ArrowType.List.INSTANCE), null);
