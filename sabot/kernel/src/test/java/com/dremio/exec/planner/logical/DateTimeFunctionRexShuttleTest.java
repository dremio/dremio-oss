...
public final class DateTimeFunctionRexShuttleTest {
  ...
  public void testSARGableDateTruncTransformTime(String timeUnit) {
    new GoldenFileTestBuilder<>(this::sargableTransform, Objects::toString, timeUnit)
      .add("DATE_TRUNC", eq(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .add("DATE_TRUNC", notEq(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .add("DATE_TRUNC", gt(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .add("DATE_TRUNC", gte(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .add("DATE_TRUNC", lt(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .add("DATE_TRUNC", lte(dateTrunc(timeUnit, timestampInput(1)), literalTimestamp("2020-08-01 00:00:00")))
      .runTests();
  }
  ...
  public void testSARGableDateAddTransform() {
    new GoldenFileTestBuilder<>(this::sargableTransform, Objects::toString)
      ...
      .add("DATE_ADD", eq(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_ADD", notEq(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_ADD", gt(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_ADD", gte(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_ADD", lt(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_ADD", lte(dateAdd(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
  ...
  public void testSARGableDateSubTransform() {
    new GoldenFileTestBuilder<>(this::sargableTransform, Objects::toString)
      ...
      .add("DATE_SUB", eq(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_SUB", notEq(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_SUB", gt(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_SUB", gte(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_SUB", lt(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .add("DATE_SUB", lte(dateSub(dateInput(0), literalInterval(1L, TimeUnit.MONTH)), literalDate("2020-08-01")))
      .runTests();
  }
  ...
  public void testSARGableConvertTimezoneTransform() {
    new GoldenFileTestBuilder<>(this::sargableTransform, Objects::toString)
      .add("CONVERT_TIMEZONE", eq(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", notEq(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", gt(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", gte(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", lt(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", lte(convertTimezone(literal("America/Los_Angeles"), literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))

      .add("CONVERT_TIMEZONE", eq(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", notEq(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", gt(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", gte(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", lt(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .add("CONVERT_TIMEZONE", lte(convertTimezone(literal("America/New_York"), dateInput(0)), literalDate("2020-08-05")))
      .runTests();
  }
  ...
  public void testSARGableMonthsBetweenTransform() {
    new GoldenFileTestBuilder<>(this::sargableTransform, Objects::toString)
      ...
      .add("MONTHS_BETWEEN", eq(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", eq(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", eq(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", eq(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))

      .add("MONTHS_BETWEEN", notEq(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", notEq(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", notEq(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", notEq(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))

      .add("MONTHS_BETWEEN", gt(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", gt(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", gt(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", gt(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))

      .add("MONTHS_BETWEEN", gte(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", gte(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", gte(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", gte(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))

      .add("MONTHS_BETWEEN", lt(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", lt(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", lt(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", lt(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))

      .add("MONTHS_BETWEEN", lte(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.0F)))
      .add("MONTHS_BETWEEN", lte(monthsBetween(literal("2020-08-05"), dateInput(0)), literal(1.5F)))
      .add("MONTHS_BETWEEN", lte(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.0F)))
      .add("MONTHS_BETWEEN", lte(monthsBetween(dateInput(0), literal("2020-08-05")), literal(1.5F)))
      .runTests();
  }
  ...
  private static RexNode dateTrunc(String strInterval, RexNode dateExpr) {
    return rexBuilder.makeCall(
      ...
      rexBuilder.makeLiteral(strInterval),
      dateExpr
    );
  }
  ...
  private String sargableTransform(RexNode filterExpr) {
    LogicalFilter filter = (LogicalFilter) relBuilder
  ...
  private static RelDataType createSimpleRowType(String name, SqlTypeName typeName, String name2, SqlTypeName typeName2) {
