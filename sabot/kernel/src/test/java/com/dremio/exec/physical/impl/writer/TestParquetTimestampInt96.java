...
public class TestParquetTimestampInt96 extends BaseTestQuery {
  ...
  */
  ...
  public void testImpalaParquetBinaryAsTimeStamp_DictChange() throws Exception {
    ...
    testBuilder()
        .sqlQuery(
            "select int96_ts from dfs.\"%s/parquet/int96_dict_change\" order by int96_ts",
            testResPath)
        .ordered()
  ...
  public void testInt96TimeStampValueWidth() throws Exception {
    testBuilder()
        .ordered()
        .sqlQuery(
            "select c, d from cp.\"parquet/data.snappy.parquet\" where d = '2015-07-18 13:52:51'")
        .baselineColumns("c", "d")
        .baselineValues(
            DateFunctionsUtils.getISOFormatterForFormatString("YYYY-MM-DD")
                .parseLocalDateTime("2011-04-11"),
            DateFunctionsUtils.getISOFormatterForFormatString("YYYY-MM-DD HH24:MI:SS")
                .parseLocalDateTime("2015-07-18 13:52:51"))
        .build()
        .run();
  }
  ...
  public void testInt96TimeStampDeltaReader() throws Exception {
    ...
    testBuilder()
        .ordered()
        .sqlQuery(
            "SELECT varchar_field, timestamp_field\n"
        ...
        .baselineValues(
            ...
            DateFunctionsUtils.getISOFormatterForFormatString("YYYY-MM-DD HH24:MI:SS.FFF")
                .parseLocalDateTime("1969-12-31 08:03:00.000"))
        .build()
        .run();
  }
}
