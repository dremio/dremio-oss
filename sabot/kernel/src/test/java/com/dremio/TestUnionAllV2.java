...
public class TestUnionAllV2 extends BaseTestQuery {
  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(TestUnionAllV2.class);
  ...
  private static final String enableDistribute =
      "alter session set \"planner.enable_unionall_distribute\" = true";
  private static final String defaultDistribute =
      "alter session reset \"planner.enable_unionall_distribute\"";
  private static final String enableRoundRobinUnionAll =
      "alter session set \"planner.enable_union_all_round_robin\" = true";
  private static final String disableRoundRobinUnionAll =
      "alter session set \"planner.enable_union_all_round_robin\" = false";
  ...
  public void testUnionAll3() throws Exception {
    String query =
        "select n1.n_nationkey from cp.\"tpch/nation.parquet\" n1 where n1.n_nationkey in (1, 2) group by n1.n_nationkey union all select r1.r_regionkey from cp.\"tpch/region.parquet\" r1 group by r1.r_regionkey";
  ...
  public void testUnionAll7() throws Exception {
    String query =
        "select 'abc' from cp.\"tpch/region.parquet\" union all select 'abcdefgh' from cp.\"tpch/region.parquet\"";
  ...
  public void testUnionAllViewExpandableStar() throws Exception {
    try {
      ...
      test("use dfs_test");
      test(
          "create view nation_view_testunionall as select n_name, n_nationkey from cp.\"tpch/nation.parquet\";");
      test(
          "create view region_view_testunionall as select r_name, r_regionkey from cp.\"tpch/region.parquet\";");
  ...
  public void testAggregationOnUnionAllOperator() throws Exception {
    ...
    testBuilder()
        ...
        .ordered()
        .csvBaselineFile(
            "testframework/testExampleQueries/testAggregationOnUnionAllOperator/q1.tsv")
    ...
    testBuilder()
        ...
        .ordered()
        .csvBaselineFile(
            "testframework/testExampleQueries/testAggregationOnUnionAllOperator/q2.tsv")
        .baselineTypes(MinorType.BIGINT, MinorType.BIGINT, MinorType.BIGINT, MinorType.BIGINT)
  ...
  public void testFilterPushDownOverUnionAll() throws Exception {
    ...
    final String[] expectedPlan = {
      "TableFunction.*columns=\\[`n_regionkey`\\]", "TableFunction.*columns=\\[`r_regionkey`\\]"
    };
  ...
  public void testInListOnUnionAll() throws Exception {
    ...
    // Validate the plan
    final String[] expectedPlan = {
      ".*Filter.*\n" + ".*TableFunction.*columns=\\[`n_nationkey`, `n_regionkey`\\].*\n",
      ".*TableFunction.*columns=\\[`r_regionkey`\\].*\n",
      ".*Project.*\n"
          + ".*HashJoin.*\n"
  ...
  public void testProjectPushDownOverUnionAllWithProject() throws Exception {
    ...
    // Validate the plan
    final String[] expectedPlan = {
      "Project\\(n_nationkey=\\[\\$0\\], n_name=\\[\\$1\\]\\).*\n"
          + ".*UnionAll.*\n"
          + ".*Project.*\n"
          + ".*TableFunction.*columns=\\[`n_nationkey`, `n_name`\\].*\n",
      ".*Project.*\n" + ".*TableFunction.*columns=\\[`r_regionkey`, `r_name`\\].*"
    };
    final String[] excludedPlan = {};
    PlanTestBase.testPlanMatchingPatterns(query, expectedPlan, excludedPlan);
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectPushDownOverUnionAllWithProject.tsv")
        .baselineTypes(MinorType.INT, MinorType.VARCHAR)
  ...
  public void testProjectPushDownOverUnionAllWithoutProject() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectPushDownOverUnionAllWithoutProject.tsv")
        .baselineTypes(MinorType.INT)
        .baselineColumns("n_nationkey")
        .build()
        .run();
  ...
  public void testProjectWithExpressionPushDownOverUnionAll() throws Exception {
    ...
    // Validate the plan
    final String[] expectedPlan = {
      "TableFunction.*columns=\\[`n_nationkey`\\]", "TableFunction.*columns=\\[`r_regionkey`\\]"
    };
    final String[] excludedPlan = {};
    PlanTestBase.testPlanMatchingPatterns(query, expectedPlan, excludedPlan);
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectWithExpressionPushDownOverUnionAll.tsv")
        .baselineTypes(MinorType.INT)
        .baselineColumns("col")
        .build()
        .run();
  ...
  public void testProjectDownOverUnionAllImplicitCasting() throws Exception {
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectDownOverUnionAllImplicitCasting.tsv")
        .baselineTypes(MinorType.INT)
        .baselineColumns("col")
        .build()
        .run();
  ...
  public void testProjectPushDownProjectColumnReorderingAndAlias() throws Exception {
    ...
    // Validate the plan
    final String[] expectedPlan = {
      "TableFunction.*columns=\\[`n_nationkey`, `n_name`, `n_comment`\\]",
      "TableFunction.*columns=\\[`r_regionkey`, `r_name`, `r_comment`\\]"
    };
    final String[] excludedPlan = {};
    PlanTestBase.testPlanMatchingPatterns(query, expectedPlan, excludedPlan);
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectPushDownProjectColumnReorderingAndAlias.tsv")
  ...
  public void testProjectFiltertPushDownOverUnionAll() throws Exception {
    ...
    /**
     * 00-07 Filter(condition=[AND(>($0, 0), <($0, 2))]) : rowType = RecordType(INTEGER
     * n_regionkey): rowcount = 6.25, cumulative cost = {50.0 rows, 450.0 cpu, 250.0 io, 250.0
     * network, 0.0 memory}, id = 27288 00-09 ParquetScan(table=[cp.`tpch/nation.parquet`],
     * columns=[`n_regionkey`], splits=[1]) : rowType = RecordType(INTEGER n_regionkey): rowcount =
     * 25.0, cumulative cost = {25.0 rows, 250.0 cpu, 250.0 io, 250.0 network, 0.0 memory}, id =
     * 27287 00-04 SelectionVectorRemover : rowType = RecordType(INTEGER r_regionkey): rowcount =
     * 1.25, cumulative cost = {11.25 rows, 91.25 cpu, 50.0 io, 50.0 network, 0.0 memory}, id =
     * 27292 00-06 Filter(condition=[AND(>($0, 0), <($0, 2))]) : rowType = RecordType(INTEGER
     * r_regionkey): rowcount = 1.25, cumulative cost = {10.0 rows, 90.0 cpu, 50.0 io, 50.0 network,
     * 0.0 memory}, id = 27291 00-08 ParquetScan(table=[cp.`tpch/region.parquet`],
     * columns=[`r_regionkey`], splits=[1]) : rowType = RecordType(INTEGER r_regionkey): rowcount =
     * 5.0, cumulative cost = {5.0 rows, 50.0 cpu, 50.0 io, 50.0 network, 0.0 memory}, id = 27290
     */
    // Validate the plan
    final String[] expectedPlan = {
      "Filter.*\n.*TableFunction.*columns=\\[`n_nationkey`\\]",
    ...
    testBuilder()
        ...
        .unOrdered()
        .csvBaselineFile(
            "testframework/testUnionAllQueries/testProjectFiltertPushDownOverUnionAll.tsv")
        .baselineTypes(MinorType.INT)
        .baselineColumns("n_nationkey")
        .build()
        .run();
  ...
  public void testDrill4147_2() throws Exception {
    ...
    final String query =
        String.format(
            "Select o_custkey, count(*) as cnt from \n"
                + " (SELECT o_custkey FROM dfs_test.\"%s\" \n"
                + "Union All SELECT o_custkey FROM dfs_test.\"%s\") \n"
                + "group by o_custkey",
            l, r);
    ...
    final String query =
        String.format(
            "SELECT o_custkey FROM \n"
                ...
                + " Union All SELECT o_custkey FROM dfs_test.\"%s\" where o_custkey < 10",
            l, r, l);
  ...
  public void testDrill4833_1() throws Exception {
    ...
    final String query =
        String.format(
            "SELECT o_custkey FROM \n"
                + " ((select o1.o_custkey from dfs_test.\"%s\" o1 inner join dfs_test.\"%s\" o2 on o1.o_orderkey = o2.o_custkey) \n"
                + " Union All (SELECT o_custkey FROM dfs_test.\"%s\" order by dir0 limit 1))",
            l, r, l);
