...
public final class RelFieldCollationSerde {
  ...
  private static RelFieldCollation.NullDirection fromProto(
      PRelFieldCollation.PNullDirection pNullDirection) {
    switch (pNullDirection) {
      case FIRST:
        return RelFieldCollation.NullDirection.FIRST;
      case LAST:
        return RelFieldCollation.NullDirection.LAST;
      case UNSPECIFIED_NULL_DIRECTION:
        return RelFieldCollation.NullDirection.UNSPECIFIED;
      default:
        throw new UnsupportedOperationException(
            String.format("Unknown null direction %s.", pNullDirection));
    }
  }
  ...
  public static PRelFieldCollation.PDirection toProto(RelFieldCollation.Direction direction) {
    switch (direction) {
      case ASCENDING:
        return PRelFieldCollation.PDirection.ASCENDING;
      case CLUSTERED:
        return PRelFieldCollation.PDirection.CLUSTERED;
      case DESCENDING:
        return PRelFieldCollation.PDirection.DESCENDING;
      case STRICTLY_ASCENDING:
        return PRelFieldCollation.PDirection.STRICTLY_ASCENDING;
      case STRICTLY_DESCENDING:
        return PRelFieldCollation.PDirection.STRICTLY_DESCENDING;
      default:
        throw new UnsupportedOperationException(String.format("Unknown direction %s.", direction));
    }
  }

  public static PRelFieldCollation.PNullDirection toProto(
      RelFieldCollation.NullDirection nullDirection) {
    switch (nullDirection) {
      case FIRST:
        return PRelFieldCollation.PNullDirection.FIRST;
      case LAST:
        return PRelFieldCollation.PNullDirection.LAST;
      case UNSPECIFIED:
        return PRelFieldCollation.PNullDirection.UNSPECIFIED_NULL_DIRECTION;
      default:
        throw new UnsupportedOperationException(
            String.format("Unknown null direction %s.", nullDirection));
    }
  }
}
