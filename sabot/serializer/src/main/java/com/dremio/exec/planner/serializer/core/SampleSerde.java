...
public final class SampleSerde implements RelNodeSerde<Sample, PSample> {
  ...
  public Sample deserialize(PSample pSample, RelFromProto s) {
    ...
    return new Sample(
        input.getCluster(), input, RelOptSamplingParametersSerde.fromProto(pSample.getParams()));
  }

  private static final class RelOptSamplingParametersSerde {
    public static RelOptSamplingParameters fromProto(
        PSample.PRelOptSampleParamters pRelOptSampleParamters) {
    ...
    public static PSample.PRelOptSampleParamters toProto(
        RelOptSamplingParameters relOptSamplingParameters) {
