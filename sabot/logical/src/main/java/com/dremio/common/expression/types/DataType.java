...
abstract class DataType {
  ...
  public static final DataType SIGNED_BYTE =
      new AtomType("SIGNED_BYTE", Comparability.ORDERED, true);
  public static final DataType SIGNED_INT16 =
      new AtomType("SIGNED_INT16", Comparability.ORDERED, true);
  ...
  //  public static final DataType INT16 = new AtomType("int16", Comparability.ORDERED, true);
  //  public static final DataType BIG_INTEGER = new AtomType("bigint", Comparability.ORDERED,
  // true);
  //  public static final DataType BIG_DECIMAL = new AtomType("bigdecimal", Comparability.ORDERED,
  // true);
