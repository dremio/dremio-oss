...
public class TestSchemaPathDeserializer {
  ...
  private final ObjectMapper mapper = new ObjectMapper().registerModule(new SimpleModule()
    .addDeserializer(SchemaPath.class, new SchemaPathDeserializer()));
  ...
  public void testErrorScenarios(String serialized, String expectedError) throws JsonProcessingException {
