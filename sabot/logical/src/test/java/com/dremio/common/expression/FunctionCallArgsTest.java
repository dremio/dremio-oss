...
public class FunctionCallArgsTest {
  ...
  public void testToStringOfFunctionCall() {
    ...
    Assert.assertEquals(
        "FunctionCall toString() returned unexpected results",
        "FunctionCall [func=test, args=[]]",
        s);
    ...
    Assert.assertEquals(
        "FunctionCall [func=test, args=[ValueExpression[int=2], ValueExpression[int=3], ValueExpression[int=4], ValueExpression[int=5], ValueExpression[int=6], ValueExpression[int=7], ValueExpression[int=8], ValueExpression[int=9]]]",
        s);
    ...
    s = functionCall.toString();
    Assert.assertEquals(
        "FunctionCall [func=test, args=[ValueExpression[int=2], ValueExpression[int=3], ValueExpression[int=4], ValueExpression[int=5], ValueExpression[int=6], ValueExpression[int=7], ValueExpression[int=8], ValueExpression[int=9], ValueExpression[int=10], ValueExpression[int=11]]]",
        s);
  }
}
