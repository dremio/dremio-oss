...
public interface VectorWrapper<T extends ValueVector> extends AutoCloseable {
  ...
  /**
   * Traverse the object graph and determine whether the provided BasePath matches data within the Wrapper.  If so, return a TypedFieldId associated with this path.
   * @return TypedFieldId
   */
