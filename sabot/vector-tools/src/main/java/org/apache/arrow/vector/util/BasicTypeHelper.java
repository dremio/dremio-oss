...
public class BasicTypeHelper {
  ...
  public static Class<?> getHolderReaderImpl(MinorType type) {
    ...
    throw new UnsupportedOperationException(
        buildErrorMessage("get holder reader implementation", type));
  }
  ...
  public static FieldVector getNewVector(
  ...
  public static com.dremio.common.types.TypeProtos.MajorType getValueHolderMajorType(
    ...
    if (holderClass.equals(TinyIntHolder.class)) {
      return com.dremio.common.types.Types.required(
          com.dremio.common.types.TypeProtos.MinorType.TINYINT);
      ...
      return com.dremio.common.types.Types.required(
          com.dremio.common.types.TypeProtos.MinorType.FLOAT4);
    ...
    // unsupported type DateDay
      ...
      return com.dremio.common.types.Types.required(
          com.dremio.common.types.TypeProtos.MinorType.INTERVALYEAR);
  ...
  public static MinorType getValueHolderType(ValueHolder holder) {
    ...
    throw new UnsupportedOperationException(
        "ValueHolder is not supported for 'getValueHolderType' method.");
  }
            ...
            if (holder instanceof NullableTimeStampMilliHolder) {
              if (((NullableTimeStampMilliHolder) holder).isSet == 1) {
                ((TimeStampMilliVector) vector)
                    .setSafe(index, (NullableTimeStampMilliHolder) holder);
              } else {
            ...
            if (holder instanceof NullableFixedSizeBinaryHolder) {
              if (((NullableFixedSizeBinaryHolder) holder).isSet == 1) {
                ((FixedSizeBinaryVector) vector)
                    .setSafe(index, (NullableFixedSizeBinaryHolder) holder);
              } else {
  ...
  public static ValueHolder getValue(ValueVector vector, int index) {
    ...
    switch (type) {
      ...
      case TIMESTAMPMILLI:
        ...
        ((NullableTimeStampMilliHolder) holder).isSet =
            ((TimeStampMilliVector) vector).isSet(index);
        if (((NullableTimeStampMilliHolder) holder).isSet == 1) {
          ((NullableTimeStampMilliHolder) holder).value =
              ((TimeStampMilliVector) vector).get(index);
        }
        return holder;
      case INTERVALDAY:
      ...
      case FIXEDSIZEBINARY:
        ...
        ((NullableFixedSizeBinaryHolder) holder).isSet =
            ((FixedSizeBinaryVector) vector).isSet(index);
        if (((NullableFixedSizeBinaryHolder) holder).isSet == 1) {
  ...
  public static ValueHolder deNullify(ValueHolder holder) {
    ...
    switch (type.getMinorType()) {
        ...
        switch (type.getMode()) {
          ...
          case OPTIONAL:
            if (((NullableTinyIntHolder) holder).isSet == 1) {
              ...
              throw new UnsupportedOperationException(
                  "You can not convert a null value into a non-null value!");
            }
          default:
      ...
      default:
        throw new UnsupportedOperationException(
            buildErrorMessage("deNullify", getArrowMinorType(type.getMinorType())));
    }
  }
  ...
  public static ValueHolder nullify(ValueHolder holder) {
    ...
    switch (type.getMinorType()) {
      ...
      default:
        throw new UnsupportedOperationException(
            buildErrorMessage("nullify", getArrowMinorType(type.getMinorType())));
    }
  }
}
